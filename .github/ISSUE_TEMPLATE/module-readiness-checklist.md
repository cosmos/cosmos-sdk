...
- [ ] API audit (at least 1 person) (@assignee)
  ...
  - [ ] Is everything well documented (inline godoc as well as [`/spec/` folder](https://github.com/pointnetwork/cosmos-point-sdk/blob/main/docs/spec/SPEC-SPEC.md) in module directory)
