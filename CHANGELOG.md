...
* (client/tx) [#26759](https://github.com/cosmos/cosmos-sdk/issues/26759) Populate the multisig bit array when building a simulation transaction so `--gas auto` works for multisig senders.
