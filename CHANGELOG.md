...
* [\#11234](https://github.com/cosmos/cosmos-sdk/pull/11234) Add `GRPCClient` filed to Client Context. If `GRPCClient` field is set to nil, the `Invoke` method would use ABCI query, otherwise use gprc.
