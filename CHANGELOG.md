...
* (all) [#16537](https://github.com/cosmos/cosmos`osmos/cosmos-sdk/pull/16798) Remove aliases in `types/math.go` (part 2).
...
* (x/bank) []() With the migration to AutoCLI some bank commands have been split in two: 
