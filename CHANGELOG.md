...
* (store) [#26586](https://github.com/cosmos/cosmos-sdk/pull/26586) Bound the maximum decompressed size read per state-sync snapshot chunk to prevent a decompression-bomb style aggregate-work DoS during snapshot restore.
