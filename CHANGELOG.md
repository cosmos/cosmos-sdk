...
* (store/iavl) [#25914](https://github.com/cosmos/cosmos-sdk/pull/25914) Use versioned store for /subspace historical queries; previously explicit-height queries silently returned latest state.
