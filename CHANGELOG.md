...
* (baseapp) [\#6053](https://github.com/cosmos/cosmos-sdk/pull/6053) Panic recovery custom handling (middleware) added for `app.runTx()` method. Adds ability for developers to register custom panic handlers extending standard ones.
