...
* (x/slashing) [#]() Move `x/slashing/testslashing` to `x/slashing/testutil` for consistency with other modules.
* (x/staking) [#]() Move `x/staking/teststaking` to `x/staking/testutil` for consistency with other modules.
