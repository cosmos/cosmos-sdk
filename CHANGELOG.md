...
* (runtime) [#26474](https://github.com/cosmos/cosmos-sdk/pull/26474) Register the autocli query/tx descriptors for every module that implements `HasAutoCLIConfig`, instead of only the last one in the iteration, so all modules' autocli commands are exposed.
