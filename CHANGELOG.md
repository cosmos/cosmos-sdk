...
* (baseapp) [#24074](https://github.com/cosmos/cosmos-sdk/pull/24074) Fix SelectTxForProposal the calculation method of tx bytes size is inconsistent with CometBFT
