...
* (x/upgrade) [\#9534](https://github.com/cosmos/cosmos-sdk/pull/9534) Upgrade `Plan`'s `upgraded_client_state` field has been deprecated, and will error if not empty.
