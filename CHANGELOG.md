...
* [#14847](https://github.com/cosmos/cosmos-sdk/pull/14847) App's and ModuleManager methods `InitGenesis`, `ExportGenesis`, `BeginBlock` and `EndBlock` now also return an error.
