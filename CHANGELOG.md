...
* (x/distribution) [#26406](https://github.com/cosmos/cosmos-sdk/pull/26406) Add fallback paths when trying to withdraw funds to blocked address during `Begin/EndBlockers`, or return `ErrWithdrawAddressBlocked`.
