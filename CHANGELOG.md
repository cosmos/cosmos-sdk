...
* (baseapp) [#17677](https://github.com/cosmos/cosmos-sdk/pull/17677) Use `baseapp.MessageRouter` interface in baseapp instead of conrecrete type, and extend the MessageRouter interface.
