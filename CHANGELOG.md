...
* (x/auth) [#18746](https://github.com/cosmos/cosmos-sdk/pull/18746) Fixed duplicated `vesting` subcommand of `<appd> tx --help` and missing `<appd> tx auth update-params-proposal` subcommand.
