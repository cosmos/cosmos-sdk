...
* (blockstm) [#25879](https://github.com/cosmos/cosmos-sdk/pull/25879) Fix STMRunner passing nil transaction bytes to deliverTx when preEstimate is not triggered.
