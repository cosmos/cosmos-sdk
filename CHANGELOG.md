...
* (keyring) [#15572](https://github.com/cosmos/cosmos-sdk/pull/15572) Proper error message when using a headless linux which is incmpatible with 'os' backend keyring option.
