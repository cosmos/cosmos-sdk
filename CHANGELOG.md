...
* (x/upgrade) [\#11551](https://github.com/cosmos/cosmos-sdk/pull/11551) Implement `ScheduleUpgradeNoHeightValidation` for chains to perform an automated upgrade without having to go though governance.
