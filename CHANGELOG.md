...
* (server) [#](https://github.com/cosmos/cosmos-sdk/pull/) When `mempool.max-txs` is set to a negative value, use a no-op mempool (effectively disable the app mempool).
