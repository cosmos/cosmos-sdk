...
* (x/gov) [#13043](https://github.com/cosmos/cosmos-sdk/pull/13043) Remove the simulation's `DefaultWeightMsg{Deposit,Vote,VoteWeighted}` from the simapp package, put them locally into `x/gov/simulations`.
