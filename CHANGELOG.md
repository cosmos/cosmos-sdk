...
## [Unreleased]
* (types) [\#11410](https://github.com/cosmos/cosmos-sdk/issues/11410) Remove the compile-time `types.DBbackend` variable. Removes usage of the same in server/util.go
### Features
