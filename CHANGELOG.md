...
* (bank) [#13247](https://github.com/cosmos/cosmos-sdk/pull/13247) When adding coin metadata into state, only allow valid metadata (e.g. with valid denoms). Also, the coin denom regex has been changed to be more permissive.
