...
* (codec) [\#6330](https://github.com/cosmos/cosmos-sdk/pull/6330) the global `codec.Cdc` Amino instance has been deprecated and moved to the `codec/legacy_global` package. `codec.RegisterCrypto` 
has been moved to the `crypto/codec` package.
