...
* (types/query) [#26574](https://github.com/cosmos/cosmos-sdk/pull/26574) reject `ParsePagination` limits above 10,000 and cap `Paginate` limits to the same value, to prevent unbounded store iteration DoS
