...
* (x/capability) [14804](https://github.com/cosmos/cosmos-sdk/pull/14804) Extract Capability in its own go.mod and rename the package to `cosmossdk.io/x/capability`.
