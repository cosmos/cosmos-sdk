...
* [#13794](https://github.com/cosmos/cosmos-sdk/pull/13794) Deprecate `types/module.AppModule` and `types/module.NewManager` in favor of `cosmossdk.io/core/appmodule.AppModule` and `types/module.NewManagerFromMap`
