...
* [\#6231](https://github.com/cosmos/cosmos-sdk/pull/6231) Simplify `AppModule` interface, `Route` and `Handler` methods become only `Route`
and returns a new Route interface type.
