...
* (types) [#25860](https://github.com/cosmos/cosmos-sdk/pull/25860) Optimize `Coins.safeAdd` using two-pointer merge algorithm for O(n) complexity instead of map-based O(n log n).
