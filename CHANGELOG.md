...
* (x/staking) [#17164](https://github.com/cosmos/cosmos-sdk/pull/17164) Add `CmtConsPublicKeyByConsAddr` and `BondedTokensByConsAddr` to the keeper to enable vote extension verification.
