...
* (baseapp) [#24015](https://github.com/cosmos/cosmos-sdk/pull/24015) Ensure that `BaseApp.Init` firstly returns any errors from a nil commit multistore instead of panicking on nil dereferencing and before sealing the app.
