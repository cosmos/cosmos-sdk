...
* (auth) [\#6653](https://github.com/cosmos/cosmos-sdk/pull/6653) `NewTxBuilderFromCLI` is removed due to removal of viper dependency, use NewTxBuilderFromFlags instead.
