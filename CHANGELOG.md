...
* [\#10839](https://github.com/cosmos/cosmos-sdk/pull/10839) Restore creation of concurrent iterators over state, when there are no writes between iterator creations on state that subsequently gets iterated over.
