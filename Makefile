...
proto-update-deps:
	...
	@sed -i '' '8 s|proto/types/types.proto|third_party/proto/tendermint/proto/types/types.proto|g' $(TM_ABCI_TYPES)/types.proto
	@sed -i '' '9 s|proto/crypto/keys/types.proto|third_party/proto/tendermint/proto/crypto/keys/types.proto|g' $(TM_ABCI_TYPES)/types.proto
