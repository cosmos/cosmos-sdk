...
Core dependencies not mentionned here as compatible across all SDK versions.

> Note: the X signals that the version of the Cosmos SDK does not need to import the dependency.
