...
See the [Module Configuration Documentation](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/build/building-modules/15-depinject.md) for more details.
