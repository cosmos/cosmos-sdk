...
func init() {
	file_cometbft_crypto_v1_proof_proto_init()
	md_Proof = File_cometbft_crypto_v1_proof_proto.Messages().ByName("Proof")
...
func (x *fastReflection_Proof) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cometbft.crypto.v1.Proof.total":
		return x.Total != int64(0)
	case "cometbft.crypto.v1.Proof.index":
		return x.Index != int64(0)
	case "cometbft.crypto.v1.Proof.leaf_hash":
		return len(x.LeafHash) != 0
	case "cometbft.crypto.v1.Proof.aunts":
		return len(x.Aunts) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.Proof"))
		}
		panic(fmt.Errorf("message cometbft.crypto.v1.Proof does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Proof) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cometbft.crypto.v1.Proof does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Proof) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cometbft.crypto.v1.Proof.total":
		panic(fmt.Errorf("field total of message cometbft.crypto.v1.Proof is not mutable"))
	case "cometbft.crypto.v1.Proof.index":
		panic(fmt.Errorf("field index of message cometbft.crypto.v1.Proof is not mutable"))
	case "cometbft.crypto.v1.Proof.leaf_hash":
		panic(fmt.Errorf("field leaf_hash of message cometbft.crypto.v1.Proof is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.Proof"))
		}
...
func (x *fastReflection_Proof) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cometbft.crypto.v1.Proof", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cometbft_crypto_v1_proof_proto_init()
	md_ValueOp = File_cometbft_crypto_v1_proof_proto.Messages().ByName("ValueOp")
...
func (x *fastReflection_ValueOp) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cometbft.crypto.v1.ValueOp.key":
		return len(x.Key) != 0
	case "cometbft.crypto.v1.ValueOp.proof":
		return x.Proof != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.ValueOp"))
		}
		panic(fmt.Errorf("message cometbft.crypto.v1.ValueOp does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ValueOp) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cometbft.crypto.v1.ValueOp does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ValueOp) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cometbft.crypto.v1.ValueOp.key":
		panic(fmt.Errorf("field key of message cometbft.crypto.v1.ValueOp is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.ValueOp"))
		}
...
func (x *fastReflection_ValueOp) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cometbft.crypto.v1.ValueOp", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cometbft_crypto_v1_proof_proto_init()
	md_DominoOp = File_cometbft_crypto_v1_proof_proto.Messages().ByName("DominoOp")
...
func (x *fastReflection_DominoOp) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cometbft.crypto.v1.DominoOp.key":
		return x.Key != ""
	case "cometbft.crypto.v1.DominoOp.input":
		return x.Input != ""
	case "cometbft.crypto.v1.DominoOp.output":
		return x.Output != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.DominoOp"))
		}
		panic(fmt.Errorf("message cometbft.crypto.v1.DominoOp does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DominoOp) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cometbft.crypto.v1.DominoOp does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DominoOp) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cometbft.crypto.v1.DominoOp.key":
		panic(fmt.Errorf("field key of message cometbft.crypto.v1.DominoOp is not mutable"))
	case "cometbft.crypto.v1.DominoOp.input":
		panic(fmt.Errorf("field input of message cometbft.crypto.v1.DominoOp is not mutable"))
	case "cometbft.crypto.v1.DominoOp.output":
		panic(fmt.Errorf("field output of message cometbft.crypto.v1.DominoOp is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.DominoOp"))
		}
...
func (x *fastReflection_DominoOp) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cometbft.crypto.v1.DominoOp", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cometbft_crypto_v1_proof_proto_init()
	md_ProofOp = File_cometbft_crypto_v1_proof_proto.Messages().ByName("ProofOp")
...
func (x *fastReflection_ProofOp) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cometbft.crypto.v1.ProofOp.type":
		return x.Type_ != ""
	case "cometbft.crypto.v1.ProofOp.key":
		return len(x.Key) != 0
	case "cometbft.crypto.v1.ProofOp.data":
		return len(x.Data) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.ProofOp"))
		}
		panic(fmt.Errorf("message cometbft.crypto.v1.ProofOp does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ProofOp) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cometbft.crypto.v1.ProofOp does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ProofOp) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cometbft.crypto.v1.ProofOp.type":
		panic(fmt.Errorf("field type of message cometbft.crypto.v1.ProofOp is not mutable"))
	case "cometbft.crypto.v1.ProofOp.key":
		panic(fmt.Errorf("field key of message cometbft.crypto.v1.ProofOp is not mutable"))
	case "cometbft.crypto.v1.ProofOp.data":
		panic(fmt.Errorf("field data of message cometbft.crypto.v1.ProofOp is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.ProofOp"))
		}
...
func (x *fastReflection_ProofOp) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cometbft.crypto.v1.ProofOp", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cometbft_crypto_v1_proof_proto_init()
	md_ProofOps = File_cometbft_crypto_v1_proof_proto.Messages().ByName("ProofOps")
...
func (x *fastReflection_ProofOps) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cometbft.crypto.v1.ProofOps.ops":
		return len(x.Ops) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cometbft.crypto.v1.ProofOps"))
		}
		panic(fmt.Errorf("message cometbft.crypto.v1.ProofOps does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ProofOps) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cometbft.crypto.v1.ProofOps does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ProofOps) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cometbft.crypto.v1.ProofOps", d.FullName()))
	}
	panic("unreachable")
}
...
var file_cometbft_crypto_v1_proof_proto_rawDesc = []byte{
	...
	0x70, 0x73, 0x42, 0xbc, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x65, 0x74,
	0x62, 0x66, 0x74, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x50,
	0x72, 0x6f, 0x6f, 0x66, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2c, 0x63, 0x6f, 0x73,
...
var file_cometbft_crypto_v1_proof_proto_goTypes = []interface{}{
...
func file_cometbft_crypto_v1_proof_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cometbft_crypto_v1_proof_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Proof); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cometbft_crypto_v1_proof_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cometbft_crypto_v1_proof_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cometbft_crypto_v1_proof_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cometbft_crypto_v1_proof_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
