...
var _ protoreflect.List = (*_UnbondingEntry_2_list)(nil)

type _UnbondingEntry_2_list struct {
	list *[]*v1beta1.Coin
}

func (x *_UnbondingEntry_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_UnbondingEntry_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_UnbondingEntry_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_UnbondingEntry_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_UnbondingEntry_2_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_UnbondingEntry_2_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_UnbondingEntry_2_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_UnbondingEntry_2_list) IsValid() bool {
	return x.list != nil
}
...
func (x *fastReflection_UnbondingEntry) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Amount) != 0 {
		value := protoreflect.ValueOfList(&_UnbondingEntry_2_list{list: &x.Amount})
...
func (x *fastReflection_UnbondingEntry) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.accounts.defaults.lockup.UnbondingEntry.amount":
		if len(x.Amount) == 0 {
			return protoreflect.ValueOfList(&_UnbondingEntry_2_list{})
		}
		listValue := &_UnbondingEntry_2_list{list: &x.Amount}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.accounts.defaults.lockup.UnbondingEntry.validator_address":
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.accounts.defaults.lockup.UnbondingEntry does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_UnbondingEntry) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.accounts.defaults.lockup.UnbondingEntry.amount":
		...
		value := &_UnbondingEntry_2_list{list: &x.Amount}
		return protoreflect.ValueOfList(value)
	case "cosmos.accounts.defaults.lockup.UnbondingEntry.validator_address":
...
func (x *fastReflection_UnbondingEntry) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.accounts.defaults.lockup.UnbondingEntry.amount":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_UnbondingEntry_2_list{list: &list})
	case "cosmos.accounts.defaults.lockup.UnbondingEntry.validator_address":
...
func (x *fastReflection_UnbondingEntry) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.accounts.defaults.lockup.UnbondingEntry", d.FullName()))
	}
	panic("unreachable")
}
...
var file_cosmos_accounts_defaults_lockup_lockup_proto_rawDesc = []byte{
	...
	0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa1, 0x02, 0x0a,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x79, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
...
var file_cosmos_accounts_defaults_lockup_lockup_proto_depIdxs = []int32{
	...
	4, // 2: cosmos.accounts.defaults.lockup.UnbondingEntry.end_time:type_name -> google.protobuf.Timestamp
	3, // 3: cosmos.accounts.defaults.lockup.UnbondingEntry.amount:type_name -> cosmos.base.v1beta1.Coin
