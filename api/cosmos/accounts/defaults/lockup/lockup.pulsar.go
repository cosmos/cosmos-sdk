...
var _ protoreflect.List = (*_UnbondingClawback_2_list)(nil)

type _UnbondingClawback_2_list struct {
	list *[]*v1beta1.Coin
}

func (x *_UnbondingClawback_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_UnbondingClawback_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_UnbondingClawback_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_UnbondingClawback_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_UnbondingClawback_2_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_UnbondingClawback_2_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_UnbondingClawback_2_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_UnbondingClawback_2_list) IsValid() bool {
	return x.list != nil
}

var (
	md_UnbondingClawback               protoreflect.MessageDescriptor
	fd_UnbondingClawback_end_time      protoreflect.FieldDescriptor
	fd_UnbondingClawback_unbonding_amt protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_accounts_defaults_lockup_lockup_proto_init()
	md_UnbondingClawback = File_cosmos_accounts_defaults_lockup_lockup_proto.Messages().ByName("UnbondingClawback")
	fd_UnbondingClawback_end_time = md_UnbondingClawback.Fields().ByName("end_time")
	fd_UnbondingClawback_unbonding_amt = md_UnbondingClawback.Fields().ByName("unbonding_amt")
}

var _ protoreflect.Message = (*fastReflection_UnbondingClawback)(nil)

type fastReflection_UnbondingClawback UnbondingClawback

func (x *UnbondingClawback) ProtoReflect() protoreflect.Message {
	return (*fastReflection_UnbondingClawback)(x)
}

func (x *UnbondingClawback) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_accounts_defaults_lockup_lockup_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_UnbondingClawback_messageType fastReflection_UnbondingClawback_messageType
var _ protoreflect.MessageType = fastReflection_UnbondingClawback_messageType{}

type fastReflection_UnbondingClawback_messageType struct{}

func (x fastReflection_UnbondingClawback_messageType) Zero() protoreflect.Message {
	return (*fastReflection_UnbondingClawback)(nil)
}
func (x fastReflection_UnbondingClawback_messageType) New() protoreflect.Message {
	return new(fastReflection_UnbondingClawback)
}
func (x fastReflection_UnbondingClawback_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_UnbondingClawback
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_UnbondingClawback) Descriptor() protoreflect.MessageDescriptor {
	return md_UnbondingClawback
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_UnbondingClawback) Type() protoreflect.MessageType {
	return _fastReflection_UnbondingClawback_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_UnbondingClawback) New() protoreflect.Message {
	return new(fastReflection_UnbondingClawback)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_UnbondingClawback) Interface() protoreflect.ProtoMessage {
	return (*UnbondingClawback)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_UnbondingClawback) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.EndTime != nil {
		value := protoreflect.ValueOfMessage(x.EndTime.ProtoReflect())
		if !f(fd_UnbondingClawback_end_time, value) {
			return
		}
	}
	if len(x.UnbondingAmt) != 0 {
		value := protoreflect.ValueOfList(&_UnbondingClawback_2_list{list: &x.UnbondingAmt})
		if !f(fd_UnbondingClawback_unbonding_amt, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_UnbondingClawback) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.end_time":
		return x.EndTime != nil
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt":
		return len(x.UnbondingAmt) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.defaults.lockup.UnbondingClawback"))
		}
		panic(fmt.Errorf("message cosmos.accounts.defaults.lockup.UnbondingClawback does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UnbondingClawback) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.end_time":
		x.EndTime = nil
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_UnbondingClawback) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.end_time":
		value := x.EndTime
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt":
		if len(x.UnbondingAmt) == 0 {
			return protoreflect.ValueOfList(&_UnbondingClawback_2_list{})
		}
		listValue := &_UnbondingClawback_2_list{list: &x.UnbondingAmt}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.defaults.lockup.UnbondingClawback"))
		}
		panic(fmt.Errorf("message cosmos.accounts.defaults.lockup.UnbondingClawback does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UnbondingClawback) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.end_time":
		x.EndTime = value.Message().Interface().(*timestamppb.Timestamp)
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt":
		lv := value.List()
		clv := lv.(*_UnbondingClawback_2_list)
		x.UnbondingAmt = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.defaults.lockup.UnbondingClawback"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UnbondingClawback) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.end_time":
		if x.EndTime == nil {
	...
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt":
		if x.UnbondingAmt == nil {
			x.UnbondingAmt = []*v1beta1.Coin{}
		}
		value := &_UnbondingClawback_2_list{list: &x.UnbondingAmt}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.defaults.lockup.UnbondingClawback"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_UnbondingClawback) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.end_time":
	...
	case "cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_UnbondingClawback_2_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.defaults.lockup.UnbondingClawback"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_UnbondingClawback) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.accounts.defaults.lockup.UnbondingClawback", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_UnbondingClawback) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UnbondingClawback) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_UnbondingClawback) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_UnbondingClawback) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*UnbondingClawback)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UnbondingAmt) > 0 {
			for iNdEx := len(x.UnbondingAmt) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.UnbondingAmt[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: UnbondingClawback: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: UnbondingClawback: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UnbondingAmt", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.UnbondingAmt = append(x.UnbondingAmt, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.UnbondingAmt[len(x.UnbondingAmt)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type UnbondingClawback struct {
	...
	// end_time defines expected end time of unbonding periods
	UnbondingAmt []*v1beta1.Coin `protobuf:"bytes,2,rep,name=unbonding_amt,json=unbondingAmt,proto3" json:"unbonding_amt,omitempty"`
}

func (x *UnbondingClawback) Reset() {
	*x = UnbondingClawback{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_accounts_defaults_lockup_lockup_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *UnbondingClawback) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnbondingClawback) ProtoMessage() {}

// Deprecated: Use UnbondingClawback.ProtoReflect.Descriptor instead.
func (*UnbondingClawback) Descriptor() ([]byte, []int) {
	return file_cosmos_accounts_defaults_lockup_lockup_proto_rawDescGZIP(), []int{1}
}

func (x *UnbondingClawback) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
func (x *UnbondingClawback) GetUnbondingAmt() []*v1beta1.Coin {
	if x != nil {
		return x.UnbondingAmt
	}
	return nil
}
...
var file_cosmos_accounts_defaults_lockup_lockup_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x01, 0x0a, 0x06, 0x50, 0x65,
	0x72, 0x69, 0x6f, 0x64, 0x12, 0x40, 0x0a, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42,
	0x0d, 0xc8, 0xde, 0x1f, 0x00, 0x98, 0xdf, 0x1f, 0x01, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x06,
	0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x79, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x74, 0x22, 0xe2, 0x01, 0x0a, 0x11, 0x55, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43,
	0x6c, 0x61, 0x77, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x44, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x0d, 0xc8, 0xde, 0x1f, 0x00, 0x90, 0xdf, 0x1f, 0x01, 0xa8,
	0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x86, 0x01,
	0x0a, 0x0d, 0x75, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x61, 0x6d, 0x74, 0x18,
	...
	,
...
var file_cosmos_accounts_defaults_lockup_lockup_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cosmos_accounts_defaults_lockup_lockup_proto_goTypes = []interface{}{
	...
	(*UnbondingClawback)(nil),     // 1: cosmos.accounts.defaults.lockup.UnbondingClawback
...
var file_cosmos_accounts_defaults_lockup_lockup_proto_depIdxs = []int32{
	2, // 0: cosmos.accounts.defaults.lockup.Period.length:type_name -> google.protobuf.Duration
	3, // 1: cosmos.accounts.defaults.lockup.Period.amount:type_name -> cosmos.base.v1beta1.Coin
	4, // 2: cosmos.accounts.defaults.lockup.UnbondingClawback.end_time:type_name -> google.protobuf.Timestamp
	3, // 3: cosmos.accounts.defaults.lockup.UnbondingClawback.unbonding_amt:type_name -> cosmos.base.v1beta1.Coin
...
func file_cosmos_accounts_defaults_lockup_lockup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_accounts_defaults_lockup_lockup_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnbondingClawback); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
