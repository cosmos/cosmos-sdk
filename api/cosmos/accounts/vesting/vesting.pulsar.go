...
func init() {
	...
	md_Period = File_cosmos_accounts_vesting_vesting_proto.Messages().ByName("Period")
...
func (x *Period) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_accounts_vesting_vesting_proto_msgTypes[0]
...
func (x *fastReflection_Period) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.accounts.vesting.Period.length":
		return x.Length != nil
	case "cosmos.accounts.vesting.Period.amount":
		return len(x.Amount) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.vesting.Period"))
		}
		panic(fmt.Errorf("message cosmos.accounts.vesting.Period does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Period) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.accounts.vesting.Period does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Period) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.accounts.vesting.Period", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Period) Descriptor() ([]byte, []int) {
	return file_cosmos_accounts_vesting_vesting_proto_rawDescGZIP(), []int{0}
}
...
var File_cosmos_accounts_vesting_vesting_proto protoreflect.FileDescriptor

var file_cosmos_accounts_vesting_vesting_proto_rawDesc = []byte{
	0x0a, 0x25, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x73, 0x2f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x01, 0x0a, 0x06, 0x50, 0x65,
	...
	0x74, 0x42, 0xd3, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e,
	0x67, 0x42, 0x0c, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	...
	0x6e, 0x74, 0x73, 0x2f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0xa2, 0x02, 0x03, 0x43, 0x41,
	0x56, 0xaa, 0x02, 0x17, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x73, 0x2e, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0xca, 0x02, 0x17, 0x43, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x5c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x5c, 0x56, 0x65,
	0x73, 0x74, 0x69, 0x6e, 0x67, 0xe2, 0x02, 0x23, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5c, 0x41,
	...
	0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_cosmos_accounts_vesting_vesting_proto_rawDescOnce sync.Once
	file_cosmos_accounts_vesting_vesting_proto_rawDescData = file_cosmos_accounts_vesting_vesting_proto_rawDesc
)

func file_cosmos_accounts_vesting_vesting_proto_rawDescGZIP() []byte {
	file_cosmos_accounts_vesting_vesting_proto_rawDescOnce.Do(func() {
		file_cosmos_accounts_vesting_vesting_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_accounts_vesting_vesting_proto_rawDescData)
	})
	return file_cosmos_accounts_vesting_vesting_proto_rawDescData
}

var file_cosmos_accounts_vesting_vesting_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cosmos_accounts_vesting_vesting_proto_goTypes = []interface{}{
	(*Period)(nil),              // 0: cosmos.accounts.vesting.Period
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
	(*v1beta1.Coin)(nil),        // 2: cosmos.base.v1beta1.Coin
}
var file_cosmos_accounts_vesting_vesting_proto_depIdxs = []int32{
	1, // 0: cosmos.accounts.vesting.Period.length:type_name -> google.protobuf.Duration
	2, // 1: cosmos.accounts.vesting.Period.amount:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_cosmos_accounts_vesting_vesting_proto_init() }
func file_cosmos_accounts_vesting_vesting_proto_init() {
	if File_cosmos_accounts_vesting_vesting_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_accounts_vesting_vesting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Period); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_accounts_vesting_vesting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_accounts_vesting_vesting_proto_goTypes,
		DependencyIndexes: file_cosmos_accounts_vesting_vesting_proto_depIdxs,
		MessageInfos:      file_cosmos_accounts_vesting_vesting_proto_msgTypes,
	}.Build()
	File_cosmos_accounts_vesting_vesting_proto = out.File
	file_cosmos_accounts_vesting_vesting_proto_rawDesc = nil
	file_cosmos_accounts_vesting_vesting_proto_goTypes = nil
	file_cosmos_accounts_vesting_vesting_proto_depIdxs = nil
}
