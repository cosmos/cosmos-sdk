...
func (x *fastReflection_Period) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.accounts.vesting.Period.length":
		panic(fmt.Errorf("field length of message cosmos.accounts.vesting.Period is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.accounts.vesting.Period"))
		}
...
var file_cosmos_accounts_vesting_vesting_proto_rawDesc = []byte{
	...
	0x6f, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x01, 0x0a, 0x06, 0x50, 0x65,
	...
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0xd3, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e,
	0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x42, 0x0c, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67,
...
var file_cosmos_accounts_vesting_vesting_proto_depIdxs = []int32{
	1, // 0: cosmos.accounts.vesting.Period.amount:type_name -> cosmos.base.v1beta1.Coin
