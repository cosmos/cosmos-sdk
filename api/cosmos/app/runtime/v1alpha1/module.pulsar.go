...
func (x *_Module_7_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Module at list field AdminModules as it is not of Message kind"))
}
...
var (
	...
	fd_Module_admin_modules       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Module_admin_modules = md_Module.Fields().ByName("admin_modules")
}
...
func (x *fastReflection_Module) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.AdminModules) != 0 {
		value := protoreflect.ValueOfList(&_Module_7_list{list: &x.AdminModules})
		if !f(fd_Module_admin_modules, value) {
			return
		}
	}
}
...
func (x *fastReflection_Module) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.app.runtime.v1alpha1.Module.admin_modules":
		return len(x.AdminModules) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Module) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.app.runtime.v1alpha1.Module.admin_modules":
		...
		listValue := &_Module_7_list{list: &x.AdminModules}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_Module) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.app.runtime.v1alpha1.Module.override_store_keys":
		...
		return protoreflect.ValueOfList(value)
	case "cosmos.app.runtime.v1alpha1.Module.admin_modules":
		if x.AdminModules == nil {
			x.AdminModules = []string{}
		}
		value := &_Module_7_list{list: &x.AdminModules}
		return protoreflect.ValueOfList(value)
	case "cosmos.app.runtime.v1alpha1.Module.app_name":
...
func (x *fastReflection_Module) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AdminModules) > 0 {
			for iNdEx := len(x.AdminModules) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.AdminModules[iNdEx])
				copy(dAtA[i:], x.AdminModules[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AdminModules[iNdEx])))
				i--
				dAtA[i] = 0x3a
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AdminModules", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AdminModules = append(x.AdminModules, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type Module struct {
	...
	// admin_modules are modules that have admin privileges with respect to inter-module
	// communication, meaning that they can invoke any message from any sender.
	AdminModules []string `protobuf:"bytes,7,rep,name=admin_modules,json=adminModules,proto3" json:"admin_modules,omitempty"`
}
...
func (x *Module) GetAdminModules() []string {
	if x != nil {
...
var file_cosmos_app_runtime_v1alpha1_module_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfe, 0x02, 0x0a, 0x06, 0x4d, 0x6f,
	...
	0x12, 0x23, 0x0a, 0x0d, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x5f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65,
	0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x4d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x73, 0x3a, 0x43, 0xba, 0xc0, 0x96, 0xda, 0x01, 0x3d, 0x0a, 0x24, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x72, 0x75, 0x6e, 0x74,
	0x69, 0x6d, 0x65, 0x12, 0x15, 0x0a, 0x13, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x61, 0x70,
