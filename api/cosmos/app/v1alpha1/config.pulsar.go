...
var (
	...
	fd_ModuleConfig_type_url        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ModuleConfig_type_url = md_ModuleConfig.Fields().ByName("type_url")
}
...
func (x *fastReflection_ModuleConfig) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TypeUrl != "" {
		...
		if !f(fd_ModuleConfig_type_url, value) {
			return
		}
	}
}
...
func (x *fastReflection_ModuleConfig) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.app.v1alpha1.ModuleConfig.golang_bindings":
		return len(x.GolangBindings) != 0
	case "cosmos.app.v1alpha1.ModuleConfig.type_url":
		return x.TypeUrl != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ModuleConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.app.v1alpha1.ModuleConfig.type_url":
		panic(fmt.Errorf("field type_url of message cosmos.app.v1alpha1.ModuleConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.app.v1alpha1.ModuleConfig"))
		}
...
func (x *ModuleConfig) GetTypeUrl() string {
	if x != nil {
		return x.TypeUrl
	}
	return ""
...
var file_cosmos_app_v1alpha1_config_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x22, 0xb8, 0x01, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x75,
	...
	,
	...
	0x6f, 0x6e, 0x42, 0xc6, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x0b,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x30, 0x63,
