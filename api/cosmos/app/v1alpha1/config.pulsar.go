...
var (
	...
	fd_Config_version protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Config_version = md_Config.Fields().ByName("version")
}
...
func (x *fastReflection_Config) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.app.v1alpha1.Config.version":
		return x.Version != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Config) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.app.v1alpha1.Config.version":
		panic(fmt.Errorf("field version of message cosmos.app.v1alpha1.Config is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.app.v1alpha1.Config"))
		}
...
type Config struct {
	...
	// version is used to specify the app config version being used when using
	// JSON and YAML serialization. It MUST be equal to v1alpha1 when using this
	// version.
...
var file_cosmos_app_v1alpha1_config_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x5f, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3b, 0x0a, 0x07,
	...
	0x52, 0x07, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x22, 0x50, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x43, 0x6f, 0x6e,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0xd6, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f,
