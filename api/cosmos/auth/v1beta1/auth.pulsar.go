...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.PubkeyChangeCost) != 0 {
		value := protoreflect.ValueOfList(&_Params_6_list{list: &x.PubkeyChangeCost})
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.auth.v1beta1.Params.pubkey_change_cost":
		return len(x.PubkeyChangeCost) != 0
	case "cosmos.auth.v1beta1.Params.enable_change_pubkey":
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.auth.v1beta1.Params.pubkey_change_cost":
		...
		listValue := &_Params_6_list{list: &x.PubkeyChangeCost}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.auth.v1beta1.Params.enable_change_pubkey":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.Params.pubkey_change_cost":
		if x.PubkeyChangeCost == nil {
			x.PubkeyChangeCost = []*v1beta1.Coin{}
		}
		value := &_Params_6_list{list: &x.PubkeyChangeCost}
		return protoreflect.ValueOfList(value)
	case "cosmos.auth.v1beta1.Params.max_memo_characters":
	...
	case "cosmos.auth.v1beta1.Params.enable_change_pubkey":
		panic(fmt.Errorf("field enable_change_pubkey of message cosmos.auth.v1beta1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.PubkeyChangeCost) > 0 {
			for _, e := range x.PubkeyChangeCost {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.PubkeyChangeCost) > 0 {
			for iNdEx := len(x.PubkeyChangeCost) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.PubkeyChangeCost[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				...
				x.PubkeyChangeCost = append(x.PubkeyChangeCost, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PubkeyChangeCost[len(x.PubkeyChangeCost)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 7:
...
type Params struct {
	...
	PubkeyChangeCost       []*v1beta1.Coin `protobuf:"bytes,6,rep,name=pubkey_change_cost,json=pubkeyChangeCost,proto3" json:"pubkey_change_cost,omitempty"`
...
func (x *Params) GetPubkeyChangeCost() []*v1beta1.Coin {
	if x != nil {
...
var file_cosmos_auth_v1beta1_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0xec,
	...
	,
...
var file_cosmos_auth_v1beta1_auth_proto_depIdxs = []int32{
	...
	5, // 2: cosmos.auth.v1beta1.Params.pubkey_change_cost:type_name -> cosmos.base.v1beta1.Coin
