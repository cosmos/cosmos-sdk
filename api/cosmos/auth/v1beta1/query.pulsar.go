...
var (
	...
	fd_GetPubKeyFromStoreResponse_pubKeyMapping protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_auth_v1beta1_query_proto_init()
	md_GetPubKeyFromStoreResponse = File_cosmos_auth_v1beta1_query_proto.Messages().ByName("GetPubKeyFromStoreResponse")
	fd_GetPubKeyFromStoreResponse_pubKeyMapping = md_GetPubKeyFromStoreResponse.Fields().ByName("pubKeyMapping")
}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.PubKeyMapping != nil {
		value := protoreflect.ValueOfMessage(x.PubKeyMapping.ProtoReflect())
		if !f(fd_GetPubKeyFromStoreResponse_pubKeyMapping, value) {
			return
		}
	}
}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.pubKeyMapping":
		return x.PubKeyMapping != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.pubKeyMapping":
		x.PubKeyMapping = value.Message().Interface().(*PubKeyMapping)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.GetPubKeyFromStoreResponse"))
		}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.pubKeyMapping":
		if x.PubKeyMapping == nil {
			x.PubKeyMapping = new(PubKeyMapping)
		}
		return protoreflect.ValueOfMessage(x.PubKeyMapping.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.GetPubKeyFromStoreResponse"))
		}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		_ = l
		if x.PubKeyMapping != nil {
			l = options.Size(x.PubKeyMapping)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.PubKeyMapping != nil {
			encoded, err := options.Marshal(x.PubKeyMapping)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PubKeyMapping", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.PubKeyMapping == nil {
					x.PubKeyMapping = &PubKeyMapping{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PubKeyMapping); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *GetPubKeyFromStoreResponse) GetPubKeyMapping() *PubKeyMapping {
	if x != nil {
		return x.PubKeyMapping
	}
	return nil
}
...
var file_cosmos_auth_v1beta1_query_proto_rawDesc = []byte{
	...
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x42, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x50, 0x75,
	0x62, 0x4b, 0x65, 0x79, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x71,
	...
	,
	...
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x8f, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63,
	...
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73,
	0x2f, 0x7b, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x12, 0xb0, 0x01, 0x0a, 0x12, 0x41,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x79, 0x49,
	0x44, 0x12, 0x33, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	...
	0x73, 0x73, 0x5f, 0x62, 0x79, 0x5f, 0x69, 0x64, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x80, 0x01,
	...
	0x12, 0xa1, 0x01, 0x0a, 0x0e, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x75, 0x6e, 0x74, 0x73, 0x12, 0x88, 0x01, 0x0a, 0x0c, 0x42, 0x65, 0x63, 0x68, 0x33, 0x32, 0x50,
	0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x28, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x42, 0x65, 0x63, 0x68,
	0x33, 0x32, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	...
	0x69, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x23, 0x82, 0xd3, 0xe4, 0x93,
	...
	0xb0, 0x01, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x79, 0x74, 0x65, 0x73,
	...
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x33, 0x82,
	...
	0x73, 0x7d, 0x12, 0xb1, 0x01, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74,
	...
	,
...
var file_cosmos_auth_v1beta1_query_proto_goTypes = []interface{}{
	...
	(*PubKeyMapping)(nil),                   // 22: cosmos.auth.v1beta1.PubKeyMapping
}
var file_cosmos_auth_v1beta1_query_proto_depIdxs = []int32{
	...
	22, // 6: cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.pubKeyMapping:type_name -> cosmos.auth.v1beta1.PubKeyMapping
	...
	17, // 24: cosmos.auth.v1beta1.Query.GetPubKeyFromStore:output_type -> cosmos.auth.v1beta1.GetPubKeyFromStoreResponse
