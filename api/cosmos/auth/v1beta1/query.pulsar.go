...
var (
	...
	fd_GetPubKeyFromStoreResponse_addressToPubKey protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_auth_v1beta1_query_proto_init()
	md_GetPubKeyFromStoreResponse = File_cosmos_auth_v1beta1_query_proto.Messages().ByName("GetPubKeyFromStoreResponse")
	fd_GetPubKeyFromStoreResponse_addressToPubKey = md_GetPubKeyFromStoreResponse.Fields().ByName("addressToPubKey")
}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AddressToPubKey != nil {
		value := protoreflect.ValueOfMessage(x.AddressToPubKey.ProtoReflect())
		if !f(fd_GetPubKeyFromStoreResponse_addressToPubKey, value) {
			return
		}
	}
}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.addressToPubKey":
		return x.AddressToPubKey != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.addressToPubKey":
		x.AddressToPubKey = value.Message().Interface().(*AddressToPubKey)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.GetPubKeyFromStoreResponse"))
		}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.addressToPubKey":
		if x.AddressToPubKey == nil {
			x.AddressToPubKey = new(AddressToPubKey)
		}
		return protoreflect.ValueOfMessage(x.AddressToPubKey.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.GetPubKeyFromStoreResponse"))
		}
...
func (x *fastReflection_GetPubKeyFromStoreResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		_ = l
		if x.AddressToPubKey != nil {
			l = options.Size(x.AddressToPubKey)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.AddressToPubKey != nil {
			encoded, err := options.Marshal(x.AddressToPubKey)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AddressToPubKey", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.AddressToPubKey == nil {
					x.AddressToPubKey = &AddressToPubKey{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.AddressToPubKey); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *GetPubKeyFromStoreResponse) GetAddressToPubKey() *AddressToPubKey {
	if x != nil {
		return x.AddressToPubKey
	}
	return nil
}
...
var file_cosmos_auth_v1beta1_query_proto_rawDesc = []byte{
	...
	,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x8f,
	...
	0x12, 0xb0, 0x01, 0x0a, 0x12, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x42, 0x79, 0x49, 0x44, 0x12, 0x33, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	...
	0x73, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x34, 0x2e, 0x63,
	...
	0x69, 0x64, 0x7d, 0x12, 0x80, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x27,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0xa1, 0x01, 0x0a, 0x0e, 0x4d, 0x6f, 0x64, 0x75, 0x6c,
	...
	0x75, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2c, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x26, 0x12, 0x24, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x61, 0x75,
	0x74, 0x68, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c,
	0x65, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x88, 0x01, 0x0a, 0x0c, 0x42,
	...
	0x65, 0x63, 0x68, 0x33, 0x32, 0x12, 0xb0, 0x01, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x42, 0x79, 0x74, 0x65, 0x73, 0x54, 0x6f, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x30,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x62,
	...
	0x73, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x7d, 0x12, 0xb1, 0x01, 0x0a, 0x14, 0x41, 0x64, 0x64,
	...
	,
	...
	0x61, 0x31, 0x2f, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x2f, 0x7b, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x5f, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x7d, 0x42, 0xc5, 0x01, 0x0a, 0x17,
...
var file_cosmos_auth_v1beta1_query_proto_goTypes = []interface{}{
	...
	(*AddressToPubKey)(nil),                 // 22: cosmos.auth.v1beta1.AddressToPubKey
}
var file_cosmos_auth_v1beta1_query_proto_depIdxs = []int32{
	...
	22, // 6: cosmos.auth.v1beta1.GetPubKeyFromStoreResponse.addressToPubKey:type_name -> cosmos.auth.v1beta1.AddressToPubKey
