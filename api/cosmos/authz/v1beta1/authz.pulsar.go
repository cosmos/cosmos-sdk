...
func (x *fastReflection_Grant) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Rules) != 0 {
		value := protoreflect.ValueOfBytes(x.Rules)
...
func (x *fastReflection_Grant) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.authz.v1beta1.Grant.rules":
		panic(fmt.Errorf("field rules of message cosmos.authz.v1beta1.Grant is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.authz.v1beta1.Grant"))
		}
...
func (x *fastReflection_Grant) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Rules) > 0 {
			i -= len(x.Rules)
			copy(dAtA[i:], x.Rules)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Rules)))
			i--
			dAtA[i] = 0x1a
		}
		if x.Expiration != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				x.Rules = append(x.Rules[:0], dAtA[iNdEx:postIndex]...)
				if x.Rules == nil {
					x.Rules = []byte{}
				}
				iNdEx = postIndex
...
var (
	md_AuthzRuleKeys          protoreflect.MessageDescriptor
	fd_AuthzRuleKeys_raw_json protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_authz_v1beta1_authz_proto_init()
	md_AuthzRuleKeys = File_cosmos_authz_v1beta1_authz_proto.Messages().ByName("AuthzRuleKeys")
	fd_AuthzRuleKeys_raw_json = md_AuthzRuleKeys.Fields().ByName("raw_json")
}

var _ protoreflect.Message = (*fastReflection_AuthzRuleKeys)(nil)

type fastReflection_AuthzRuleKeys AuthzRuleKeys

func (x *AuthzRuleKeys) ProtoReflect() protoreflect.Message {
	return (*fastReflection_AuthzRuleKeys)(x)
}

func (x *AuthzRuleKeys) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_AuthzRuleKeys_messageType fastReflection_AuthzRuleKeys_messageType
var _ protoreflect.MessageType = fastReflection_AuthzRuleKeys_messageType{}

type fastReflection_AuthzRuleKeys_messageType struct{}

func (x fastReflection_AuthzRuleKeys_messageType) Zero() protoreflect.Message {
	return (*fastReflection_AuthzRuleKeys)(nil)
}
func (x fastReflection_AuthzRuleKeys_messageType) New() protoreflect.Message {
	return new(fastReflection_AuthzRuleKeys)
}
func (x fastReflection_AuthzRuleKeys_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_AuthzRuleKeys
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_AuthzRuleKeys) Descriptor() protoreflect.MessageDescriptor {
	return md_AuthzRuleKeys
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_AuthzRuleKeys) Type() protoreflect.MessageType {
	return _fastReflection_AuthzRuleKeys_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_AuthzRuleKeys) New() protoreflect.Message {
	return new(fastReflection_AuthzRuleKeys)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_AuthzRuleKeys) Interface() protoreflect.ProtoMessage {
	return (*AuthzRuleKeys)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_AuthzRuleKeys) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.RawJson) != 0 {
		value := protoreflect.ValueOfBytes(x.RawJson)
		if !f(fd_AuthzRuleKeys_raw_json, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_AuthzRuleKeys) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.authz.v1beta1.AuthzRuleKeys.raw_json":
		return len(x.RawJson) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.authz.v1beta1.AuthzRuleKeys"))
		}
		panic(fmt.Errorf("message cosmos.authz.v1beta1.AuthzRuleKeys does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AuthzRuleKeys) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.authz.v1beta1.AuthzRuleKeys.raw_json":
		x.RawJson = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_AuthzRuleKeys) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.authz.v1beta1.AuthzRuleKeys.raw_json":
		value := x.RawJson
		return protoreflect.ValueOfBytes(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.authz.v1beta1.AuthzRuleKeys does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AuthzRuleKeys) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.authz.v1beta1.AuthzRuleKeys.raw_json":
		x.RawJson = value.Bytes()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.authz.v1beta1.AuthzRuleKeys"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AuthzRuleKeys) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.authz.v1beta1.AuthzRuleKeys.raw_json":
		panic(fmt.Errorf("field raw_json of message cosmos.authz.v1beta1.AuthzRuleKeys is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.authz.v1beta1.AuthzRuleKeys"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_AuthzRuleKeys) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.authz.v1beta1.AuthzRuleKeys.raw_json":
		return protoreflect.ValueOfBytes(nil)
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_AuthzRuleKeys) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.authz.v1beta1.AuthzRuleKeys", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_AuthzRuleKeys) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AuthzRuleKeys) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_AuthzRuleKeys) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_AuthzRuleKeys) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*AuthzRuleKeys)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.RawJson) > 0 {
			i -= len(x.RawJson)
			copy(dAtA[i:], x.RawJson)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.RawJson)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: AuthzRuleKeys: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: AuthzRuleKeys: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RawJson", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.RawJson = append(x.RawJson[:0], dAtA[iNdEx:postIndex]...)
				if x.RawJson == nil {
					x.RawJson = []byte{}
				}
				iNdEx = postIndex
...
var file_cosmos_authz_v1beta1_authz_proto_rawDesc = []byte{
	...
	0x63, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xc7,
	...
	0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x22, 0xa2, 0x02, 0x0a, 0x12, 0x47, 0x72, 0x61,
	...
	0x67, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x65, 0x12, 0x62, 0x0a, 0x0d, 0x61, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x41, 0x6e, 0x79, 0x42, 0x26, 0xca, 0xb4, 0x2d, 0x22, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	...
	0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x40, 0x0a, 0x0a, 0x65,
	...
	,
...
var file_cosmos_authz_v1beta1_authz_proto_goTypes = []interface{}{
	...
	(*AuthzRuleKeys)(nil),         // 4: cosmos.authz.v1beta1.AuthzRuleKeys
...
var file_cosmos_authz_v1beta1_authz_proto_depIdxs = []int32{
	...
	5, // 2: cosmos.authz.v1beta1.GrantAuthorization.authorization:type_name -> google.protobuf.Any
	6, // 3: cosmos.authz.v1beta1.GrantAuthorization.expiration:type_name -> google.protobuf.Timestamp
