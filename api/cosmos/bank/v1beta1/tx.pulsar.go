...
func (x *_MsgSetSendEnabled_3_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message MsgSetSendEnabled at list field UseDefault as it is not of Message kind"))
}
...
var (
	...
	fd_MsgSetSendEnabled_use_default              protoreflect.FieldDescriptor
	fd_MsgSetSendEnabled_set_default_send_enabled protoreflect.FieldDescriptor
	fd_MsgSetSendEnabled_default_send_enabled     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgSetSendEnabled_use_default = md_MsgSetSendEnabled.Fields().ByName("use_default")
	fd_MsgSetSendEnabled_set_default_send_enabled = md_MsgSetSendEnabled.Fields().ByName("set_default_send_enabled")
	fd_MsgSetSendEnabled_default_send_enabled = md_MsgSetSendEnabled.Fields().ByName("default_send_enabled")
}
...
func (x *fastReflection_MsgSetSendEnabled) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.UseDefault) != 0 {
		value := protoreflect.ValueOfList(&_MsgSetSendEnabled_3_list{list: &x.UseDefault})
		if !f(fd_MsgSetSendEnabled_use_default, value) {
			return
		}
	}
	if x.SetDefaultSendEnabled != false {
		value := protoreflect.ValueOfBool(x.SetDefaultSendEnabled)
		if !f(fd_MsgSetSendEnabled_set_default_send_enabled, value) {
			return
		}
	}
	if x.DefaultSendEnabled != false {
		value := protoreflect.ValueOfBool(x.DefaultSendEnabled)
		if !f(fd_MsgSetSendEnabled_default_send_enabled, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgSetSendEnabled) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.use_default":
		return len(x.UseDefault) != 0
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.set_default_send_enabled":
		return x.SetDefaultSendEnabled != false
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.default_send_enabled":
...
func (x *fastReflection_MsgSetSendEnabled) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.use_default":
		...
		listValue := &_MsgSetSendEnabled_3_list{list: &x.UseDefault}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.set_default_send_enabled":
		value := x.SetDefaultSendEnabled
...
func (x *fastReflection_MsgSetSendEnabled) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.use_default":
		...
		x.UseDefault = *clv.list
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.set_default_send_enabled":
		x.SetDefaultSendEnabled = value.Bool()
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.default_send_enabled":
...
func (x *fastReflection_MsgSetSendEnabled) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.use_default":
		...
		value := &_MsgSetSendEnabled_3_list{list: &x.UseDefault}
		return protoreflect.ValueOfList(value)
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.authority":
		panic(fmt.Errorf("field authority of message cosmos.bank.v1beta1.MsgSetSendEnabled is not mutable"))
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.set_default_send_enabled":
		panic(fmt.Errorf("field set_default_send_enabled of message cosmos.bank.v1beta1.MsgSetSendEnabled is not mutable"))
	case "cosmos.bank.v1beta1.MsgSetSendEnabled.default_send_enabled":
		panic(fmt.Errorf("field default_send_enabled of message cosmos.bank.v1beta1.MsgSetSendEnabled is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.bank.v1beta1.MsgSetSendEnabled"))
		}
...
func (x *fastReflection_MsgSetSendEnabled) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.UseDefault) > 0 {
			for _, s := range x.UseDefault {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if x.SetDefaultSendEnabled {
			n += 2
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UseDefault) > 0 {
			for iNdEx := len(x.UseDefault) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.UseDefault[iNdEx])
				copy(dAtA[i:], x.UseDefault[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.UseDefault[iNdEx])))
				i--
				dAtA[i] = 0x1a
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UseDefault", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.UseDefault = append(x.UseDefault, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SetDefaultSendEnabled", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.SetDefaultSendEnabled = bool(v != 0)
			case 5:
				if wireType != 0 {
...
type MsgSetSendEnabled struct {
	...
	// use_default is a list of denoms that should use the params.default_send_enabled value.
	// Denoms listed here will have their SendEnabled entries deleted.
	// If a denom is included that doesn't have a SendEnabled entry,
	// it will be ignored.
	UseDefault []string `protobuf:"bytes,3,rep,name=use_default,json=useDefault,proto3" json:"use_default,omitempty"`
...
func (x *MsgSetSendEnabled) GetUseDefault() []string {
	if x != nil {
		return x.UseDefault
	}
	return nil
...
func (x *MsgSetSendEnabled) GetSetDefaultSendEnabled() bool {
	if x != nil {
		return x.SetDefaultSendEnabled
	}
	return false
}

func (x *MsgSetSendEnabled) GetDefaultSendEnabled() bool {
	if x != nil {
...
var file_cosmos_bank_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0xac, 0x02, 0x0a, 0x11, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x74, 0x53, 0x65,
	0x6e, 0x64, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x36, 0x0a, 0x09, 0x61, 0x75, 0x74,
	...
	0x79, 0x12, 0x43, 0x0a, 0x0c, 0x73, 0x65, 0x6e, 0x64, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	0x64, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	...
	,
	...
	0x74, 0x69, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68,
	0x0a, 0x0e, 0x53, 0x65, 0x74, 0x53, 0x65, 0x6e, 0x64, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
	0x12, 0x26, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x6e, 0x6b, 0x2e, 0x76,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x74, 0x53, 0x65, 0x6e,
	0x64, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x1a, 0x2e, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2e, 0x62, 0x61, 0x6e, 0x6b, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4d,
	0x73, 0x67, 0x53, 0x65, 0x74, 0x53, 0x65, 0x6e, 0x64, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
...
var file_cosmos_bank_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cosmos_bank_v1beta1_tx_proto_goTypes = []interface{}{
	...
	(*MsgSetSendEnabled)(nil),         // 4: cosmos.bank.v1beta1.MsgSetSendEnabled
	(*MsgSetSendEnabledResponse)(nil), // 5: cosmos.bank.v1beta1.MsgSetSendEnabledResponse
	(*v1beta1.Coin)(nil),              // 6: cosmos.base.v1beta1.Coin
	(*Input)(nil),                     // 7: cosmos.bank.v1beta1.Input
	(*Output)(nil),                    // 8: cosmos.bank.v1beta1.Output
	(*SendEnabled)(nil),               // 9: cosmos.bank.v1beta1.SendEnabled
}
var file_cosmos_bank_v1beta1_tx_proto_depIdxs = []int32{
	6, // 0: cosmos.bank.v1beta1.MsgSend.amount:type_name -> cosmos.base.v1beta1.Coin
	7, // 1: cosmos.bank.v1beta1.MsgMultiSend.inputs:type_name -> cosmos.bank.v1beta1.Input
	8, // 2: cosmos.bank.v1beta1.MsgMultiSend.outputs:type_name -> cosmos.bank.v1beta1.Output
	9, // 3: cosmos.bank.v1beta1.MsgSetSendEnabled.send_enabled:type_name -> cosmos.bank.v1beta1.SendEnabled
	0, // 4: cosmos.bank.v1beta1.Msg.Send:input_type -> cosmos.bank.v1beta1.MsgSend
	2, // 5: cosmos.bank.v1beta1.Msg.MultiSend:input_type -> cosmos.bank.v1beta1.MsgMultiSend
	4, // 6: cosmos.bank.v1beta1.Msg.SetSendEnabled:input_type -> cosmos.bank.v1beta1.MsgSetSendEnabled
	1, // 7: cosmos.bank.v1beta1.Msg.Send:output_type -> cosmos.bank.v1beta1.MsgSendResponse
	3, // 8: cosmos.bank.v1beta1.Msg.MultiSend:output_type -> cosmos.bank.v1beta1.MsgMultiSendResponse
	5, // 9: cosmos.bank.v1beta1.Msg.SetSendEnabled:output_type -> cosmos.bank.v1beta1.MsgSetSendEnabledResponse
