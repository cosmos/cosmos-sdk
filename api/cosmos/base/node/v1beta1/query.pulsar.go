...
var (
	...
	fd_StatusResponse_latest_block_height           protoreflect.FieldDescriptor
	fd_StatusResponse_latest_block_height_timestamp protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_StatusResponse_latest_block_height = md_StatusResponse.Fields().ByName("latest_block_height")
	fd_StatusResponse_latest_block_height_timestamp = md_StatusResponse.Fields().ByName("latest_block_height_timestamp")
}
...
func (x *fastReflection_StatusResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.LatestBlockHeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.LatestBlockHeight)
		if !f(fd_StatusResponse_latest_block_height, value) {
			return
		}
	}
	if x.LatestBlockHeightTimestamp != nil {
		value := protoreflect.ValueOfMessage(x.LatestBlockHeightTimestamp.ProtoReflect())
		if !f(fd_StatusResponse_latest_block_height_timestamp, value) {
			return
		}
	}
}
...
func (x *fastReflection_StatusResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height":
		return x.LatestBlockHeight != uint64(0)
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height_timestamp":
		return x.LatestBlockHeightTimestamp != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_StatusResponse) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height":
		x.LatestBlockHeight = uint64(0)
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height_timestamp":
		x.LatestBlockHeightTimestamp = nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.node.v1beta1.StatusResponse"))
		}
...
func (x *fastReflection_StatusResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height":
		...
		return protoreflect.ValueOfUint64(value)
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height_timestamp":
		value := x.LatestBlockHeightTimestamp
...
func (x *fastReflection_StatusResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height":
		x.LatestBlockHeight = value.Uint()
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height_timestamp":
		x.LatestBlockHeightTimestamp = value.Message().Interface().(*timestamppb.Timestamp)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.node.v1beta1.StatusResponse"))
		}
...
func (x *fastReflection_StatusResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height_timestamp":
		if x.LatestBlockHeightTimestamp == nil {
			x.LatestBlockHeightTimestamp = new(timestamppb.Timestamp)
		}
		return protoreflect.ValueOfMessage(x.LatestBlockHeightTimestamp.ProtoReflect())
	case "cosmos.base.node.v1beta1.StatusResponse.earliest_store_height":
		panic(fmt.Errorf("field earliest_store_height of message cosmos.base.node.v1beta1.StatusResponse is not mutable"))
	case "cosmos.base.node.v1beta1.StatusResponse.latest_block_height":
		panic(fmt.Errorf("field latest_block_height of message cosmos.base.node.v1beta1.StatusResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.node.v1beta1.StatusResponse"))
		}
...
func (x *fastReflection_StatusResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.LatestBlockHeightTimestamp != nil {
			l = options.Size(x.LatestBlockHeightTimestamp)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.LatestBlockHeightTimestamp != nil {
			encoded, err := options.Marshal(x.LatestBlockHeightTimestamp)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
		...
		for iNdEx < l {
			...
			case 2:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.LatestBlockHeight |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field LatestBlockHeightTimestamp", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.LatestBlockHeightTimestamp == nil {
					x.LatestBlockHeightTimestamp = &timestamppb.Timestamp{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.LatestBlockHeightTimestamp); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type StatusResponse struct {
	...
	LatestBlockHeightTimestamp *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=latest_block_height_timestamp,json=latestBlockHeightTimestamp,proto3" json:"latest_block_height_timestamp,omitempty"`
}
...
func (x *StatusResponse) GetLatestBlockHeightTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.LatestBlockHeightTimestamp
	}
	return nil
}
...
var file_cosmos_base_node_v1beta1_query_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xd9, 0x01, 0x0a, 0x0e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x72, 0x65, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x6c, 0x61, 0x74, 0x65,
	0x73, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x63, 0x0a, 0x1d, 0x6c, 0x61, 0x74, 0x65,
	0x73, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x5f,
	...
	0x01, 0x52, 0x1a, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x99, 0x02,
	...
	0x67, 0x12, 0x85, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x27, 0x2e, 0x63,
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e,
	...
	0x2f, 0x62, 0x61, 0x73, 0x65, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74,
	0x61, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0xe4, 0x01, 0x0a, 0x1c, 0x63, 0x6f,
	0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x6e, 0x6f,
	0x64, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0a, 0x51, 0x75, 0x65, 0x72,
...
var file_cosmos_base_node_v1beta1_query_proto_depIdxs = []int32{
	4, // 0: cosmos.base.node.v1beta1.StatusResponse.latest_block_height_timestamp:type_name -> google.protobuf.Timestamp
