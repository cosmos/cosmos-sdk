...
<<<<<<< HEAD:api/cosmos/base/store/v1beta1/commit_info.pulsar.go
	case "cosmos.base.store.v1beta1.CommitInfo.version":
...
>>>>>>> ee9774af2 (feat: auto-set block timestamp for historical queries (#15448)):api/cosmos/store/v1beta1/commit_info.pulsar.go
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.store.v1beta1.CommitInfo"))
		}
