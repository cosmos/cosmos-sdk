...
func init() {
	...
	md_PageRequest = File_cosmos_base_tendermint_v1beta1_pagination_proto.Messages().ByName("PageRequest")
...
func (x *PageRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_base_tendermint_v1beta1_pagination_proto_msgTypes[0]
...
func (x *fastReflection_PageRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.base.tendermint.v1beta1.PageRequest.key":
		return len(x.Key) != 0
	case "cosmos.base.tendermint.v1beta1.PageRequest.offset":
		return x.Offset != uint64(0)
	case "cosmos.base.tendermint.v1beta1.PageRequest.limit":
		return x.Limit != uint64(0)
	case "cosmos.base.tendermint.v1beta1.PageRequest.count_total":
		return x.CountTotal != false
	case "cosmos.base.tendermint.v1beta1.PageRequest.reverse":
		return x.Reverse != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.PageRequest"))
		}
		panic(fmt.Errorf("message cosmos.base.tendermint.v1beta1.PageRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PageRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.base.tendermint.v1beta1.PageRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PageRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.base.tendermint.v1beta1.PageRequest.key":
		panic(fmt.Errorf("field key of message cosmos.base.tendermint.v1beta1.PageRequest is not mutable"))
	case "cosmos.base.tendermint.v1beta1.PageRequest.offset":
		panic(fmt.Errorf("field offset of message cosmos.base.tendermint.v1beta1.PageRequest is not mutable"))
	case "cosmos.base.tendermint.v1beta1.PageRequest.limit":
		panic(fmt.Errorf("field limit of message cosmos.base.tendermint.v1beta1.PageRequest is not mutable"))
	case "cosmos.base.tendermint.v1beta1.PageRequest.count_total":
		panic(fmt.Errorf("field count_total of message cosmos.base.tendermint.v1beta1.PageRequest is not mutable"))
	case "cosmos.base.tendermint.v1beta1.PageRequest.reverse":
		panic(fmt.Errorf("field reverse of message cosmos.base.tendermint.v1beta1.PageRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.PageRequest"))
		}
...
func (x *fastReflection_PageRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.base.tendermint.v1beta1.PageRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_base_tendermint_v1beta1_pagination_proto_init()
	md_PageResponse = File_cosmos_base_tendermint_v1beta1_pagination_proto.Messages().ByName("PageResponse")
...
func (x *PageResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_base_tendermint_v1beta1_pagination_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PageResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.base.tendermint.v1beta1.PageResponse.next_key":
		return len(x.NextKey) != 0
	case "cosmos.base.tendermint.v1beta1.PageResponse.total":
		return x.Total != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.PageResponse"))
		}
		panic(fmt.Errorf("message cosmos.base.tendermint.v1beta1.PageResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PageResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.base.tendermint.v1beta1.PageResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PageResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.base.tendermint.v1beta1.PageResponse.next_key":
		panic(fmt.Errorf("field next_key of message cosmos.base.tendermint.v1beta1.PageResponse is not mutable"))
	case "cosmos.base.tendermint.v1beta1.PageResponse.total":
		panic(fmt.Errorf("field total of message cosmos.base.tendermint.v1beta1.PageResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.PageResponse"))
		}
...
func (x *fastReflection_PageResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.base.tendermint.v1beta1.PageResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cosmos/base/tendermint/v1beta1/pagination.proto
...
func (*PageRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescGZIP(), []int{0}
}
...
func (*PageResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescGZIP(), []int{1}
}
...
var File_cosmos_base_tendermint_v1beta1_pagination_proto protoreflect.FileDescriptor

var file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDesc = []byte{
	0x0a, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x2f, 0x74, 0x65,
	...
	0x6f, 0x12, 0x1e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x74,
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x22, 0x88, 0x01, 0x0a, 0x0b, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x01, 0x28, 0x08, 0x52, 0x07, 0x72, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x22, 0x3f, 0x0a, 0x0c,
	...
	0x6e, 0x65, 0x78, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x93, 0x02,
	...
	0x65, 0x74, 0x61, 0x31, 0x42, 0x0f, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var (
	file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescOnce sync.Once
	file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescData = file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDesc
)

func file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescGZIP() []byte {
	file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescOnce.Do(func() {
		file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescData)
	})
	return file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDescData
}

var file_cosmos_base_tendermint_v1beta1_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cosmos_base_tendermint_v1beta1_pagination_proto_goTypes = []interface{}{
	(*PageRequest)(nil),  // 0: cosmos.base.tendermint.v1beta1.PageRequest
	(*PageResponse)(nil), // 1: cosmos.base.tendermint.v1beta1.PageResponse
}
var file_cosmos_base_tendermint_v1beta1_pagination_proto_depIdxs = []int32{
...
func init() { file_cosmos_base_tendermint_v1beta1_pagination_proto_init() }
func file_cosmos_base_tendermint_v1beta1_pagination_proto_init() {
	if File_cosmos_base_tendermint_v1beta1_pagination_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_base_tendermint_v1beta1_pagination_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_base_tendermint_v1beta1_pagination_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_base_tendermint_v1beta1_pagination_proto_goTypes,
		DependencyIndexes: file_cosmos_base_tendermint_v1beta1_pagination_proto_depIdxs,
		MessageInfos:      file_cosmos_base_tendermint_v1beta1_pagination_proto_msgTypes,
	}.Build()
	File_cosmos_base_tendermint_v1beta1_pagination_proto = out.File
	file_cosmos_base_tendermint_v1beta1_pagination_proto_rawDesc = nil
	file_cosmos_base_tendermint_v1beta1_pagination_proto_goTypes = nil
	file_cosmos_base_tendermint_v1beta1_pagination_proto_depIdxs = nil
}
