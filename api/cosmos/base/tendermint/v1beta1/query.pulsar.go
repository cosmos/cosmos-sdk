...
var (
	...
	fd_GetSyncingResponse_earliest_block_height protoreflect.FieldDescriptor
	fd_GetSyncingResponse_latest_block_height   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GetSyncingResponse_earliest_block_height = md_GetSyncingResponse.Fields().ByName("earliest_block_height")
	fd_GetSyncingResponse_latest_block_height = md_GetSyncingResponse.Fields().ByName("latest_block_height")
}
...
func (x *fastReflection_GetSyncingResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EarliestBlockHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.EarliestBlockHeight)
		if !f(fd_GetSyncingResponse_earliest_block_height, value) {
			return
		}
	}
	if x.LatestBlockHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.LatestBlockHeight)
		if !f(fd_GetSyncingResponse_latest_block_height, value) {
			return
		}
	}
}
...
func (x *fastReflection_GetSyncingResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.earliest_block_height":
		return x.EarliestBlockHeight != int64(0)
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.latest_block_height":
		return x.LatestBlockHeight != int64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GetSyncingResponse) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.syncing":
		x.Syncing = false
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.earliest_block_height":
		x.EarliestBlockHeight = int64(0)
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.latest_block_height":
		x.LatestBlockHeight = int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.GetSyncingResponse"))
		}
...
func (x *fastReflection_GetSyncingResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.earliest_block_height":
		x.EarliestBlockHeight = value.Int()
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.latest_block_height":
		x.LatestBlockHeight = value.Int()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.GetSyncingResponse"))
		}
...
func (x *fastReflection_GetSyncingResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.earliest_block_height":
		panic(fmt.Errorf("field earliest_block_height of message cosmos.base.tendermint.v1beta1.GetSyncingResponse is not mutable"))
	case "cosmos.base.tendermint.v1beta1.GetSyncingResponse.latest_block_height":
		panic(fmt.Errorf("field latest_block_height of message cosmos.base.tendermint.v1beta1.GetSyncingResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.tendermint.v1beta1.GetSyncingResponse"))
		}
...
func (x *fastReflection_GetSyncingResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.EarliestBlockHeight != 0 {
			n += 1 + runtime.Sov(uint64(x.EarliestBlockHeight))
		}
		if x.LatestBlockHeight != 0 {
			n += 1 + runtime.Sov(uint64(x.LatestBlockHeight))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.LatestBlockHeight != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.LatestBlockHeight))
			i--
			dAtA[i] = 0x18
		}
		if x.EarliestBlockHeight != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.EarliestBlockHeight))
			i--
			dAtA[i] = 0x10
		}
		if x.Syncing {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EarliestBlockHeight", wireType)
				}
				x.EarliestBlockHeight = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.EarliestBlockHeight |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field LatestBlockHeight", wireType)
				}
				x.LatestBlockHeight = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.LatestBlockHeight |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *GetSyncingResponse) GetEarliestBlockHeight() int64 {
	if x != nil {
...
func (x *GetSyncingResponse) GetLatestBlockHeight() int64 {
	if x != nil {
...
var file_cosmos_base_tendermint_v1beta1_query_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2f, 0x61, 0x62, 0x63, 0x69, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0xe5, 0x01, 0x0a, 0x15,
	0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x3c, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62,
	...
	0x65, 0x73, 0x74, 0x1a, 0x3d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73,
	0x65, 0x2e, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x4f, 0xca, 0xb4, 0x2d, 0x0f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73,
	0x64, 0x6b, 0x20, 0x30, 0x2e, 0x35, 0x33, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x36, 0x12, 0x34, 0x2f,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x2f, 0x6c, 0x61, 0x74,
	0x65, 0x73, 0x74, 0x12, 0xd5, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x36, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74,
	...
	,
