...
const (
	...
	Service_GetBlockResults_FullMethodName         = "/cosmos.base.tendermint.v1beta1.Service/GetBlockResults"
	Service_GetLatestBlockResults_FullMethodName   = "/cosmos.base.tendermint.v1beta1.Service/GetLatestBlockResults"
)
...
func (c *serviceClient) GetBlockResults(ctx context.Context, in *GetBlockResultsRequest, opts ...grpc.CallOption) (*GetBlockResultsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_GetBlockResults_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetLatestBlockResults(ctx context.Context, in *GetLatestBlockResultsRequest, opts ...grpc.CallOption) (*GetLatestBlockResultsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLatestBlockResultsResponse)
	err := c.cc.Invoke(ctx, Service_GetLatestBlockResults_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) GetBlockResults(context.Context, *GetBlockResultsRequest) (*GetBlockResultsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBlockResults not implemented")
}
func (UnimplementedServiceServer) GetLatestBlockResults(context.Context, *GetLatestBlockResultsRequest) (*GetLatestBlockResultsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLatestBlockResults not implemented")
}
...
func _Service_GetBlockResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_GetBlockResults_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_GetLatestBlockResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_GetLatestBlockResults_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
