...
func (x *fastReflection_ConsensusMsgParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.consensus.v1.ConsensusMsgParams.version":
		x.Version = value.Message().Interface().(*v11.VersionParams)
	case "cosmos.consensus.v1.ConsensusMsgParams.block":
		x.Block = value.Message().Interface().(*v11.BlockParams)
	case "cosmos.consensus.v1.ConsensusMsgParams.evidence":
		x.Evidence = value.Message().Interface().(*v11.EvidenceParams)
	case "cosmos.consensus.v1.ConsensusMsgParams.validator":
		x.Validator = value.Message().Interface().(*v11.ValidatorParams)
	case "cosmos.consensus.v1.ConsensusMsgParams.abci":
		x.Abci = value.Message().Interface().(*v11.ABCIParams)
	case "cosmos.consensus.v1.ConsensusMsgParams.synchrony":
		x.Synchrony = value.Message().Interface().(*v11.SynchronyParams)
	case "cosmos.consensus.v1.ConsensusMsgParams.feature":
		x.Feature = value.Message().Interface().(*v11.FeatureParams)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.consensus.v1.ConsensusMsgParams"))
		}
...
func (x *fastReflection_ConsensusMsgParams) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.consensus.v1.ConsensusMsgParams.version":
		m := new(v11.VersionParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.consensus.v1.ConsensusMsgParams.block":
		m := new(v11.BlockParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.consensus.v1.ConsensusMsgParams.evidence":
		m := new(v11.EvidenceParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.consensus.v1.ConsensusMsgParams.validator":
		m := new(v11.ValidatorParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.consensus.v1.ConsensusMsgParams.abci":
		m := new(v11.ABCIParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.consensus.v1.ConsensusMsgParams.synchrony":
		m := new(v11.SynchronyParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.consensus.v1.ConsensusMsgParams.feature":
		m := new(v11.FeatureParams)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.consensus.v1.ConsensusMsgParams"))
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				...
				if x.Validator == nil {
					x.Validator = &v11.ValidatorParams{}
				}
			...
			case 6:
				...
				if x.Synchrony == nil {
					x.Synchrony = &v11.SynchronyParams{}
				}
...
type ConsensusMsgParams struct {
	...
	Abci      *v11.ABCIParams      `protobuf:"bytes,5,opt,name=abci,proto3" json:"abci,omitempty"`
...
func (x *ConsensusMsgParams) GetVersion() *v11.VersionParams {
	if x != nil {
		return x.Version
	}
	return nil
...
func (x *ConsensusMsgParams) GetBlock() *v11.BlockParams {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *ConsensusMsgParams) GetEvidence() *v11.EvidenceParams {
	if x != nil {
		return x.Evidence
	}
	return nil
...
func (x *ConsensusMsgParams) GetValidator() *v11.ValidatorParams {
	if x != nil {
		return x.Validator
	}
	return nil
...
// Deprecated: Do not use.
func (x *ConsensusMsgParams) GetAbci() *v11.ABCIParams {
	if x != nil {
		return x.Abci
	}
	return nil
...
func (x *ConsensusMsgParams) GetSynchrony() *v11.SynchronyParams {
	if x != nil {
		return x.Synchrony
	}
	return nil
...
func (x *ConsensusMsgParams) GetFeature() *v11.FeatureParams {
	if x != nil {
		return x.Feature
	}
	return nil
...
var file_cosmos_consensus_v1_consensus_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x63, 0x6f, 0x6d, 0x65, 0x74, 0x62,
	0x66, 0x74, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x01, 0x0a, 0x09, 0x43, 0x6f, 0x6d,
	...
	,
	...
	,
...
var file_cosmos_consensus_v1_consensus_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_cosmos_consensus_v1_consensus_proto_goTypes = []interface{}{
	(*CometInfo)(nil),                  // 0: cosmos.consensus.v1.CometInfo
	(*ConsensusMsgParams)(nil),         // 1: cosmos.consensus.v1.ConsensusMsgParams
	(*ConsensusMsgParamsResponse)(nil), // 2: cosmos.consensus.v1.ConsensusMsgParamsResponse
	(*v1.Misbehavior)(nil),             // 3: cometbft.abci.v1.Misbehavior
	(*v1.CommitInfo)(nil),              // 4: cometbft.abci.v1.CommitInfo
	(*v11.VersionParams)(nil),          // 5: cometbft.types.v1.VersionParams
	(*v11.BlockParams)(nil),            // 6: cometbft.types.v1.BlockParams
	(*v11.EvidenceParams)(nil),         // 7: cometbft.types.v1.EvidenceParams
	(*v11.ValidatorParams)(nil),        // 8: cometbft.types.v1.ValidatorParams
	(*v11.ABCIParams)(nil),             // 9: cometbft.types.v1.ABCIParams
	(*v11.SynchronyParams)(nil),        // 10: cometbft.types.v1.SynchronyParams
	(*v11.FeatureParams)(nil),          // 11: cometbft.types.v1.FeatureParams
}
var file_cosmos_consensus_v1_consensus_proto_depIdxs = []int32{
	3,  // 0: cosmos.consensus.v1.CometInfo.evidence:type_name -> cometbft.abci.v1.Misbehavior
	4,  // 1: cosmos.consensus.v1.CometInfo.last_commit:type_name -> cometbft.abci.v1.CommitInfo
	5,  // 2: cosmos.consensus.v1.ConsensusMsgParams.version:type_name -> cometbft.types.v1.VersionParams
	6,  // 3: cosmos.consensus.v1.ConsensusMsgParams.block:type_name -> cometbft.types.v1.BlockParams
	7,  // 4: cosmos.consensus.v1.ConsensusMsgParams.evidence:type_name -> cometbft.types.v1.EvidenceParams
	8,  // 5: cosmos.consensus.v1.ConsensusMsgParams.validator:type_name -> cometbft.types.v1.ValidatorParams
	9,  // 6: cosmos.consensus.v1.ConsensusMsgParams.abci:type_name -> cometbft.types.v1.ABCIParams
	10, // 7: cosmos.consensus.v1.ConsensusMsgParams.synchrony:type_name -> cometbft.types.v1.SynchronyParams
	11, // 8: cosmos.consensus.v1.ConsensusMsgParams.feature:type_name -> cometbft.types.v1.FeatureParams
