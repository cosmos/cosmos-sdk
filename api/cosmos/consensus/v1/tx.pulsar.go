...
var _ protoreflect.List = (*_MsgCometInfo_2_list)(nil)

type _MsgCometInfo_2_list struct {
	list *[]*v11.Misbehavior
}

func (x *_MsgCometInfo_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_MsgCometInfo_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_MsgCometInfo_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v11.Misbehavior)
	(*x.list)[i] = concreteValue
}

func (x *_MsgCometInfo_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v11.Misbehavior)
	*x.list = append(*x.list, concreteValue)
}

func (x *_MsgCometInfo_2_list) AppendMutable() protoreflect.Value {
	v := new(v11.Misbehavior)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_MsgCometInfo_2_list) Truncate(n int) {
...
func (x *_MsgCometInfo_2_list) NewElement() protoreflect.Value {
	v := new(v11.Misbehavior)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_MsgCometInfo_2_list) IsValid() bool {
	return x.list != nil
}

var (
	md_MsgCometInfo                  protoreflect.MessageDescriptor
	fd_MsgCometInfo_authority        protoreflect.FieldDescriptor
	fd_MsgCometInfo_evidence         protoreflect.FieldDescriptor
	fd_MsgCometInfo_validators_hash  protoreflect.FieldDescriptor
	fd_MsgCometInfo_proposer_address protoreflect.FieldDescriptor
	fd_MsgCometInfo_last_commit      protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_consensus_v1_tx_proto_init()
	md_MsgCometInfo = File_cosmos_consensus_v1_tx_proto.Messages().ByName("MsgCometInfo")
	fd_MsgCometInfo_authority = md_MsgCometInfo.Fields().ByName("authority")
	fd_MsgCometInfo_evidence = md_MsgCometInfo.Fields().ByName("evidence")
	fd_MsgCometInfo_validators_hash = md_MsgCometInfo.Fields().ByName("validators_hash")
	fd_MsgCometInfo_proposer_address = md_MsgCometInfo.Fields().ByName("proposer_address")
	fd_MsgCometInfo_last_commit = md_MsgCometInfo.Fields().ByName("last_commit")
}

var _ protoreflect.Message = (*fastReflection_MsgCometInfo)(nil)

type fastReflection_MsgCometInfo MsgCometInfo

func (x *MsgCometInfo) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgCometInfo)(x)
}

func (x *MsgCometInfo) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgCometInfo_messageType fastReflection_MsgCometInfo_messageType
var _ protoreflect.MessageType = fastReflection_MsgCometInfo_messageType{}

type fastReflection_MsgCometInfo_messageType struct{}

func (x fastReflection_MsgCometInfo_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgCometInfo)(nil)
}
func (x fastReflection_MsgCometInfo_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgCometInfo)
}
func (x fastReflection_MsgCometInfo_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCometInfo
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgCometInfo) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCometInfo
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgCometInfo) Type() protoreflect.MessageType {
	return _fastReflection_MsgCometInfo_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgCometInfo) New() protoreflect.Message {
	return new(fastReflection_MsgCometInfo)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgCometInfo) Interface() protoreflect.ProtoMessage {
	return (*MsgCometInfo)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgCometInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Authority != "" {
		value := protoreflect.ValueOfString(x.Authority)
		if !f(fd_MsgCometInfo_authority, value) {
			return
		}
	}
	if len(x.Evidence) != 0 {
		value := protoreflect.ValueOfList(&_MsgCometInfo_2_list{list: &x.Evidence})
		if !f(fd_MsgCometInfo_evidence, value) {
			return
		}
	}
	if len(x.ValidatorsHash) != 0 {
		value := protoreflect.ValueOfBytes(x.ValidatorsHash)
		if !f(fd_MsgCometInfo_validators_hash, value) {
			return
		}
	}
	if len(x.ProposerAddress) != 0 {
		value := protoreflect.ValueOfBytes(x.ProposerAddress)
		if !f(fd_MsgCometInfo_proposer_address, value) {
			return
		}
	}
	if x.LastCommit != nil {
		value := protoreflect.ValueOfMessage(x.LastCommit.ProtoReflect())
		if !f(fd_MsgCometInfo_last_commit, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgCometInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.consensus.v1.MsgCometInfo.authority":
		return x.Authority != ""
	case "cosmos.consensus.v1.MsgCometInfo.evidence":
		return len(x.Evidence) != 0
	case "cosmos.consensus.v1.MsgCometInfo.validators_hash":
		return len(x.ValidatorsHash) != 0
	case "cosmos.consensus.v1.MsgCometInfo.proposer_address":
		return len(x.ProposerAddress) != 0
	case "cosmos.consensus.v1.MsgCometInfo.last_commit":
		return x.LastCommit != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.consensus.v1.MsgCometInfo"))
		}
		panic(fmt.Errorf("message cosmos.consensus.v1.MsgCometInfo does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCometInfo) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.consensus.v1.MsgCometInfo.authority":
		x.Authority = ""
	case "cosmos.consensus.v1.MsgCometInfo.evidence":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgCometInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.consensus.v1.MsgCometInfo.authority":
		value := x.Authority
		return protoreflect.ValueOfString(value)
	case "cosmos.consensus.v1.MsgCometInfo.evidence":
		if len(x.Evidence) == 0 {
			return protoreflect.ValueOfList(&_MsgCometInfo_2_list{})
		}
		listValue := &_MsgCometInfo_2_list{list: &x.Evidence}
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.consensus.v1.MsgCometInfo does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCometInfo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.consensus.v1.MsgCometInfo.authority":
		x.Authority = value.Interface().(string)
	case "cosmos.consensus.v1.MsgCometInfo.evidence":
		lv := value.List()
		clv := lv.(*_MsgCometInfo_2_list)
		x.Evidence = *clv.list
	case "cosmos.consensus.v1.MsgCometInfo.validators_hash":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCometInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.consensus.v1.MsgCometInfo.evidence":
		if x.Evidence == nil {
			x.Evidence = []*v11.Misbehavior{}
		}
		value := &_MsgCometInfo_2_list{list: &x.Evidence}
	...
	case "cosmos.consensus.v1.MsgCometInfo.authority":
		panic(fmt.Errorf("field authority of message cosmos.consensus.v1.MsgCometInfo is not mutable"))
	case "cosmos.consensus.v1.MsgCometInfo.validators_hash":
		panic(fmt.Errorf("field validators_hash of message cosmos.consensus.v1.MsgCometInfo is not mutable"))
	case "cosmos.consensus.v1.MsgCometInfo.proposer_address":
		panic(fmt.Errorf("field proposer_address of message cosmos.consensus.v1.MsgCometInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.consensus.v1.MsgCometInfo"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgCometInfo) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.consensus.v1.MsgCometInfo.authority":
		return protoreflect.ValueOfString("")
	case "cosmos.consensus.v1.MsgCometInfo.evidence":
		list := []*v11.Misbehavior{}
		return protoreflect.ValueOfList(&_MsgCometInfo_2_list{list: &list})
	case "cosmos.consensus.v1.MsgCometInfo.validators_hash":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgCometInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.consensus.v1.MsgCometInfo", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgCometInfo) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCometInfo) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgCometInfo) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgCometInfo) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgCometInfo)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCometInfo: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCometInfo: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func init() {
	file_cosmos_consensus_v1_tx_proto_init()
	md_MsgCometInfoResponse = File_cosmos_consensus_v1_tx_proto.Messages().ByName("MsgCometInfoResponse")
}
...
func (x *MsgCometInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgCometInfo) ProtoMessage() {}

// Deprecated: Use MsgCometInfo.ProtoReflect.Descriptor instead.
func (*MsgCometInfo) Descriptor() ([]byte, []int) {
	return file_cosmos_consensus_v1_tx_proto_rawDescGZIP(), []int{2}
}

func (x *MsgCometInfo) GetAuthority() string {
	if x != nil {
		return x.Authority
	}
	return ""
...
func (x *MsgCometInfo) GetEvidence() []*v11.Misbehavior {
	if x != nil {
		return x.Evidence
	}
	return nil
...
func (x *MsgCometInfo) GetValidatorsHash() []byte {
	if x != nil {
...
func (x *MsgCometInfo) GetProposerAddress() []byte {
	if x != nil {
...
func (x *MsgCometInfo) GetLastCommit() *v11.CommitInfo {
	if x != nil {
		return x.LastCommit
	}
	return nil
...
var file_cosmos_consensus_v1_tx_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c, 0x63, 0x6f, 0x6d, 0x65,
	0x74, 0x62, 0x66, 0x74, 0x2f, 0x61, 0x62, 0x63, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x79, 0x70,
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x04, 0x0a, 0x0f, 0x4d, 0x73, 0x67,
	...
	0x72, 0x69, 0x74, 0x79, 0x12, 0x34, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x6d, 0x65, 0x74, 0x62, 0x66, 0x74, 0x2e, 0x74,
	0x79, 0x70, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x73, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x3d, 0x0a, 0x08, 0x65, 0x76,
	0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x63,
	...
	,
	...
	0x31, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x42,
	0x13, 0xda, 0xb4, 0x2d, 0x0f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x20,
	0x30, 0x2e, 0x35, 0x32, 0x52, 0x07, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x3a, 0x39, 0x82,
	...
	,
	...
	,
	...
	0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x20, 0x30, 0x2e, 0x34, 0x37, 0x12, 0x59, 0x0a, 0x09, 0x43,
	0x6f, 0x6d, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x21, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
	0x73, 0x67, 0x43, 0x6f, 0x6d, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x29, 0x2e, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x2e, 0x76,
	0x31, 0x2e, 0x4d, 0x73, 0x67, 0x43, 0x6f, 0x6d, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65,
...
var file_cosmos_consensus_v1_tx_proto_goTypes = []interface{}{
	...
	(*MsgCometInfo)(nil),            // 2: cosmos.consensus.v1.MsgCometInfo
	(*MsgCometInfoResponse)(nil),    // 3: cosmos.consensus.v1.MsgCometInfoResponse
	(*v1.BlockParams)(nil),          // 4: cometbft.types.v1.BlockParams
	(*v1.EvidenceParams)(nil),       // 5: cometbft.types.v1.EvidenceParams
	(*v1.ValidatorParams)(nil),      // 6: cometbft.types.v1.ValidatorParams
	(*v1.ABCIParams)(nil),           // 7: cometbft.types.v1.ABCIParams
	(*v1.SynchronyParams)(nil),      // 8: cometbft.types.v1.SynchronyParams
	(*v1.FeatureParams)(nil),        // 9: cometbft.types.v1.FeatureParams
	(*v11.Misbehavior)(nil),         // 10: cometbft.abci.v1.Misbehavior
	(*v11.CommitInfo)(nil),          // 11: cometbft.abci.v1.CommitInfo
}
var file_cosmos_consensus_v1_tx_proto_depIdxs = []int32{
	4,  // 0: cosmos.consensus.v1.MsgUpdateParams.block:type_name -> cometbft.types.v1.BlockParams
	5,  // 1: cosmos.consensus.v1.MsgUpdateParams.evidence:type_name -> cometbft.types.v1.EvidenceParams
	6,  // 2: cosmos.consensus.v1.MsgUpdateParams.validator:type_name -> cometbft.types.v1.ValidatorParams
	7,  // 3: cosmos.consensus.v1.MsgUpdateParams.abci:type_name -> cometbft.types.v1.ABCIParams
	8,  // 4: cosmos.consensus.v1.MsgUpdateParams.synchrony:type_name -> cometbft.types.v1.SynchronyParams
	9,  // 5: cosmos.consensus.v1.MsgUpdateParams.feature:type_name -> cometbft.types.v1.FeatureParams
	10, // 6: cosmos.consensus.v1.MsgCometInfo.evidence:type_name -> cometbft.abci.v1.Misbehavior
	11, // 7: cosmos.consensus.v1.MsgCometInfo.last_commit:type_name -> cometbft.abci.v1.CommitInfo
	0,  // 8: cosmos.consensus.v1.Msg.UpdateParams:input_type -> cosmos.consensus.v1.MsgUpdateParams
	2,  // 9: cosmos.consensus.v1.Msg.CometInfo:input_type -> cosmos.consensus.v1.MsgCometInfo
	1,  // 10: cosmos.consensus.v1.Msg.UpdateParams:output_type -> cosmos.consensus.v1.MsgUpdateParamsResponse
	3,  // 11: cosmos.consensus.v1.Msg.CometInfo:output_type -> cosmos.consensus.v1.MsgCometInfoResponse
