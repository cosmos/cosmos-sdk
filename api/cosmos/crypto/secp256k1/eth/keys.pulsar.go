...
func init() {
	...
	md_PubKey = File_cosmos_crypto_secp256k1_eth_keys_proto.Messages().ByName("PubKey")
...
func (x *fastReflection_PubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.crypto.secp256k1.eth.PubKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.crypto.secp256k1.eth.PubKey"))
		}
		panic(fmt.Errorf("message cosmos.crypto.secp256k1.eth.PubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.crypto.secp256k1.eth.PubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.crypto.secp256k1.eth.PubKey.key":
		panic(fmt.Errorf("field key of message cosmos.crypto.secp256k1.eth.PubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.crypto.secp256k1.eth.PubKey"))
		}
...
func (x *fastReflection_PubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.crypto.secp256k1.eth.PubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_crypto_secp256k1_eth_keys_proto_init()
	md_PrivKey = File_cosmos_crypto_secp256k1_eth_keys_proto.Messages().ByName("PrivKey")
...
func (x *fastReflection_PrivKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.crypto.secp256k1.eth.PrivKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.crypto.secp256k1.eth.PrivKey"))
		}
		panic(fmt.Errorf("message cosmos.crypto.secp256k1.eth.PrivKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.crypto.secp256k1.eth.PrivKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.crypto.secp256k1.eth.PrivKey.key":
		panic(fmt.Errorf("field key of message cosmos.crypto.secp256k1.eth.PrivKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.crypto.secp256k1.eth.PrivKey"))
		}
...
func (x *fastReflection_PrivKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.crypto.secp256k1.eth.PrivKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cosmos/crypto/secp256k1/eth/keys.proto
...
var file_cosmos_crypto_secp256k1_eth_keys_proto_rawDesc = []byte{
	...
	,
}
...
var file_cosmos_crypto_secp256k1_eth_keys_proto_goTypes = []interface{}{
	(*PubKey)(nil),  // 0: cosmos.crypto.secp256k1.eth.PubKey
	(*PrivKey)(nil), // 1: cosmos.crypto.secp256k1.eth.PrivKey
}
