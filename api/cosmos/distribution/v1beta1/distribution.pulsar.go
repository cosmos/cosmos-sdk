...
var _ protoreflect.List = (*_UserOutstandingRewards_1_list)(nil)

type _UserOutstandingRewards_1_list struct {
	list *[]*v1beta1.Coin
}

func (x *_UserOutstandingRewards_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_UserOutstandingRewards_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_UserOutstandingRewards_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_UserOutstandingRewards_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_UserOutstandingRewards_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_UserOutstandingRewards_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_UserOutstandingRewards_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_UserOutstandingRewards_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_UserOutstandingRewards         protoreflect.MessageDescriptor
	fd_UserOutstandingRewards_rewards protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_distribution_proto_init()
	md_UserOutstandingRewards = File_cosmos_distribution_v1beta1_distribution_proto.Messages().ByName("UserOutstandingRewards")
	fd_UserOutstandingRewards_rewards = md_UserOutstandingRewards.Fields().ByName("rewards")
}

var _ protoreflect.Message = (*fastReflection_UserOutstandingRewards)(nil)

type fastReflection_UserOutstandingRewards UserOutstandingRewards

func (x *UserOutstandingRewards) ProtoReflect() protoreflect.Message {
	return (*fastReflection_UserOutstandingRewards)(x)
}

func (x *UserOutstandingRewards) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_UserOutstandingRewards_messageType fastReflection_UserOutstandingRewards_messageType
var _ protoreflect.MessageType = fastReflection_UserOutstandingRewards_messageType{}

type fastReflection_UserOutstandingRewards_messageType struct{}

func (x fastReflection_UserOutstandingRewards_messageType) Zero() protoreflect.Message {
	return (*fastReflection_UserOutstandingRewards)(nil)
}
func (x fastReflection_UserOutstandingRewards_messageType) New() protoreflect.Message {
	return new(fastReflection_UserOutstandingRewards)
}
func (x fastReflection_UserOutstandingRewards_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_UserOutstandingRewards
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_UserOutstandingRewards) Descriptor() protoreflect.MessageDescriptor {
	return md_UserOutstandingRewards
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_UserOutstandingRewards) Type() protoreflect.MessageType {
	return _fastReflection_UserOutstandingRewards_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_UserOutstandingRewards) New() protoreflect.Message {
	return new(fastReflection_UserOutstandingRewards)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_UserOutstandingRewards) Interface() protoreflect.ProtoMessage {
	return (*UserOutstandingRewards)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_UserOutstandingRewards) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Rewards) != 0 {
		value := protoreflect.ValueOfList(&_UserOutstandingRewards_1_list{list: &x.Rewards})
		if !f(fd_UserOutstandingRewards_rewards, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_UserOutstandingRewards) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.UserOutstandingRewards.rewards":
		return len(x.Rewards) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.UserOutstandingRewards"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.UserOutstandingRewards does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UserOutstandingRewards) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.UserOutstandingRewards.rewards":
		x.Rewards = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_UserOutstandingRewards) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.distribution.v1beta1.UserOutstandingRewards.rewards":
		if len(x.Rewards) == 0 {
			return protoreflect.ValueOfList(&_UserOutstandingRewards_1_list{})
		}
		listValue := &_UserOutstandingRewards_1_list{list: &x.Rewards}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.UserOutstandingRewards"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.UserOutstandingRewards does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UserOutstandingRewards) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.UserOutstandingRewards.rewards":
		lv := value.List()
		clv := lv.(*_UserOutstandingRewards_1_list)
		x.Rewards = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.UserOutstandingRewards"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UserOutstandingRewards) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.UserOutstandingRewards.rewards":
		if x.Rewards == nil {
			x.Rewards = []*v1beta1.Coin{}
		}
		value := &_UserOutstandingRewards_1_list{list: &x.Rewards}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.UserOutstandingRewards"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_UserOutstandingRewards) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.UserOutstandingRewards.rewards":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_UserOutstandingRewards_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.UserOutstandingRewards"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_UserOutstandingRewards) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.distribution.v1beta1.UserOutstandingRewards", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_UserOutstandingRewards) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_UserOutstandingRewards) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_UserOutstandingRewards) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_UserOutstandingRewards) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*UserOutstandingRewards)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: UserOutstandingRewards: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: UserOutstandingRewards: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
// UserPendingRewards represents a pending withdrawn rewards
// that is a reward that has not been claimed yet, but that
// is outside of the reward pool.
...
func (x *UserOutstandingRewards) Reset() {
	*x = UserOutstandingRewards{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_distribution_v1beta1_distribution_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *UserOutstandingRewards) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserOutstandingRewards) ProtoMessage() {}

// Deprecated: Use UserOutstandingRewards.ProtoReflect.Descriptor instead.
...
func (x *UserOutstandingRewards) GetRewards() []*v1beta1.Coin {
	if x != nil {
		return x.Rewards
	}
	return nil
...
var file_cosmos_distribution_v1beta1_distribution_proto_rawDesc = []byte{
	...
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x84,
	0x01, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x4f, 0x75, 0x74, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x6a, 0x0a, 0x07, 0x72, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73,
	...
	0x73, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x07, 0x72, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x73, 0x42, 0x88, 0x02, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f,
...
var file_cosmos_distribution_v1beta1_distribution_proto_goTypes = []interface{}{
	...
	(*UserOutstandingRewards)(nil),                // 12: cosmos.distribution.v1beta1.UserOutstandingRewards
...
var file_cosmos_distribution_v1beta1_distribution_proto_depIdxs = []int32{
	...
	14, // 6: cosmos.distribution.v1beta1.CommunityPoolSpendProposal.amount:type_name -> cosmos.base.v1beta1.Coin
	13, // 7: cosmos.distribution.v1beta1.DelegationDelegatorReward.reward:type_name -> cosmos.base.v1beta1.DecCoin
	14, // 8: cosmos.distribution.v1beta1.UserOutstandingRewards.rewards:type_name -> cosmos.base.v1beta1.Coin
...
func file_cosmos_distribution_v1beta1_distribution_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_distribution_v1beta1_distribution_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserOutstandingRewards); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
