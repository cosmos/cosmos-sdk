...
var (
	...
	fd_Params_endblock_prunes protoreflect.FieldDescriptor
	fd_Params_manual_prunes   protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_feegrant_v1beta1_feegrant_proto_init()
	md_Params = File_cosmos_feegrant_v1beta1_feegrant_proto.Messages().ByName("Params")
	fd_Params_endblock_prunes = md_Params.Fields().ByName("endblock_prunes")
	fd_Params_manual_prunes = md_Params.Fields().ByName("manual_prunes")
}
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_feegrant_v1beta1_feegrant_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.EndblockPrunes != uint64(0) {
		value := protoreflect.ValueOfUint64(x.EndblockPrunes)
		if !f(fd_Params_endblock_prunes, value) {
			return
		}
	}
	if x.ManualPrunes != uint64(0) {
		value := protoreflect.ValueOfUint64(x.ManualPrunes)
		if !f(fd_Params_manual_prunes, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.feegrant.v1beta1.Params.endblock_prunes":
		return x.EndblockPrunes != uint64(0)
	case "cosmos.feegrant.v1beta1.Params.manual_prunes":
		return x.ManualPrunes != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.feegrant.v1beta1.Params"))
		}
		panic(fmt.Errorf("message cosmos.feegrant.v1beta1.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.feegrant.v1beta1.Params.endblock_prunes":
		x.EndblockPrunes = uint64(0)
	case "cosmos.feegrant.v1beta1.Params.manual_prunes":
		x.ManualPrunes = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.feegrant.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.feegrant.v1beta1.Params.endblock_prunes":
		value := x.EndblockPrunes
		return protoreflect.ValueOfUint64(value)
	case "cosmos.feegrant.v1beta1.Params.manual_prunes":
		value := x.ManualPrunes
		return protoreflect.ValueOfUint64(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.feegrant.v1beta1.Params"))
		}
		panic(fmt.Errorf("message cosmos.feegrant.v1beta1.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.feegrant.v1beta1.Params.endblock_prunes":
		x.EndblockPrunes = value.Uint()
	case "cosmos.feegrant.v1beta1.Params.manual_prunes":
		x.ManualPrunes = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.feegrant.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.feegrant.v1beta1.Params.endblock_prunes":
		panic(fmt.Errorf("field endblock_prunes of message cosmos.feegrant.v1beta1.Params is not mutable"))
	case "cosmos.feegrant.v1beta1.Params.manual_prunes":
		panic(fmt.Errorf("field manual_prunes of message cosmos.feegrant.v1beta1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.feegrant.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.feegrant.v1beta1.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		var l int
		_ = l
		if x.EndblockPrunes != 0 {
			n += 1 + runtime.Sov(uint64(x.EndblockPrunes))
		}
		if x.ManualPrunes != 0 {
			n += 1 + runtime.Sov(uint64(x.ManualPrunes))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ManualPrunes != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.ManualPrunes))
			i--
			dAtA[i] = 0x10
		}
		if x.EndblockPrunes != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.EndblockPrunes))
			i--
			dAtA[i] = 0x8
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EndblockPrunes", wireType)
				}
				x.EndblockPrunes = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.EndblockPrunes |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ManualPrunes", wireType)
				}
				x.ManualPrunes = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.ManualPrunes |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_cosmos_feegrant_v1beta1_feegrant_proto_rawDescGZIP(), []int{4}
}

func (x *Params) GetEndblockPrunes() uint64 {
	if x != nil {
		return x.EndblockPrunes
	}
	return 0
}

func (x *Params) GetManualPrunes() uint64 {
	if x != nil {
		return x.ManualPrunes
	}
	return 0
}
...
var file_cosmos_feegrant_v1beta1_feegrant_proto_rawDesc = []byte{
	...
	,
...
var file_cosmos_feegrant_v1beta1_feegrant_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cosmos_feegrant_v1beta1_feegrant_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                // 4: cosmos.feegrant.v1beta1.Params
...
var file_cosmos_feegrant_v1beta1_feegrant_proto_depIdxs = []int32{
	5, // 0: cosmos.feegrant.v1beta1.BasicAllowance.spend_limit:type_name -> cosmos.base.v1beta1.Coin
	6, // 1: cosmos.feegrant.v1beta1.BasicAllowance.expiration:type_name -> google.protobuf.Timestamp
	0, // 2: cosmos.feegrant.v1beta1.PeriodicAllowance.basic:type_name -> cosmos.feegrant.v1beta1.BasicAllowance
	7, // 3: cosmos.feegrant.v1beta1.PeriodicAllowance.period:type_name -> google.protobuf.Duration
	5, // 4: cosmos.feegrant.v1beta1.PeriodicAllowance.period_spend_limit:type_name -> cosmos.base.v1beta1.Coin
	5, // 5: cosmos.feegrant.v1beta1.PeriodicAllowance.period_can_spend:type_name -> cosmos.base.v1beta1.Coin
	6, // 6: cosmos.feegrant.v1beta1.PeriodicAllowance.period_reset:type_name -> google.protobuf.Timestamp
	8, // 7: cosmos.feegrant.v1beta1.AllowedMsgAllowance.allowance:type_name -> google.protobuf.Any
	8, // 8: cosmos.feegrant.v1beta1.Grant.allowance:type_name -> google.protobuf.Any
...
func file_cosmos_feegrant_v1beta1_feegrant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_feegrant_v1beta1_feegrant_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
