...
var _ protoreflect.List = (*_ProposalContents_1_list)(nil)

type _ProposalContents_1_list struct {
	list *[]*anypb.Any
}

func (x *_ProposalContents_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ProposalContents_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ProposalContents_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*anypb.Any)
	(*x.list)[i] = concreteValue
}

func (x *_ProposalContents_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*anypb.Any)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ProposalContents_1_list) AppendMutable() protoreflect.Value {
	v := new(anypb.Any)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProposalContents_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ProposalContents_1_list) NewElement() protoreflect.Value {
	v := new(anypb.Any)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProposalContents_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_ProposalContents          protoreflect.MessageDescriptor
	fd_ProposalContents_messages protoreflect.FieldDescriptor
	fd_ProposalContents_metadata protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_gov_proto_init()
	md_ProposalContents = File_cosmos_gov_v1_gov_proto.Messages().ByName("ProposalContents")
	fd_ProposalContents_messages = md_ProposalContents.Fields().ByName("messages")
	fd_ProposalContents_metadata = md_ProposalContents.Fields().ByName("metadata")
}

var _ protoreflect.Message = (*fastReflection_ProposalContents)(nil)

type fastReflection_ProposalContents ProposalContents

func (x *ProposalContents) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ProposalContents)(x)
}

func (x *ProposalContents) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ProposalContents_messageType fastReflection_ProposalContents_messageType
var _ protoreflect.MessageType = fastReflection_ProposalContents_messageType{}

type fastReflection_ProposalContents_messageType struct{}

func (x fastReflection_ProposalContents_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ProposalContents)(nil)
}
func (x fastReflection_ProposalContents_messageType) New() protoreflect.Message {
	return new(fastReflection_ProposalContents)
}
func (x fastReflection_ProposalContents_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalContents
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ProposalContents) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalContents
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ProposalContents) Type() protoreflect.MessageType {
	return _fastReflection_ProposalContents_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ProposalContents) New() protoreflect.Message {
	return new(fastReflection_ProposalContents)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ProposalContents) Interface() protoreflect.ProtoMessage {
	return (*ProposalContents)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ProposalContents) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Messages) != 0 {
		value := protoreflect.ValueOfList(&_ProposalContents_1_list{list: &x.Messages})
		if !f(fd_ProposalContents_messages, value) {
			return
		}
	}
	if x.Metadata != "" {
		value := protoreflect.ValueOfString(x.Metadata)
		if !f(fd_ProposalContents_metadata, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ProposalContents) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalContents.messages":
		return len(x.Messages) != 0
	case "cosmos.gov.v1.ProposalContents.metadata":
		return x.Metadata != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalContents"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.ProposalContents does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalContents) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalContents.messages":
		x.Messages = nil
	case "cosmos.gov.v1.ProposalContents.metadata":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ProposalContents) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.ProposalContents.messages":
		if len(x.Messages) == 0 {
			return protoreflect.ValueOfList(&_ProposalContents_1_list{})
		}
		listValue := &_ProposalContents_1_list{list: &x.Messages}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.gov.v1.ProposalContents.metadata":
		value := x.Metadata
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1.ProposalContents does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalContents) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalContents.messages":
		lv := value.List()
		clv := lv.(*_ProposalContents_1_list)
		x.Messages = *clv.list
	case "cosmos.gov.v1.ProposalContents.metadata":
		x.Metadata = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalContents) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalContents.messages":
		if x.Messages == nil {
			x.Messages = []*anypb.Any{}
		}
		value := &_ProposalContents_1_list{list: &x.Messages}
		return protoreflect.ValueOfList(value)
	case "cosmos.gov.v1.ProposalContents.metadata":
		panic(fmt.Errorf("field metadata of message cosmos.gov.v1.ProposalContents is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalContents"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ProposalContents) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalContents.messages":
		list := []*anypb.Any{}
		return protoreflect.ValueOfList(&_ProposalContents_1_list{list: &list})
	case "cosmos.gov.v1.ProposalContents.metadata":
		return protoreflect.ValueOfString("")
	default:
		if fd.IsExtension() {
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ProposalContents) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.ProposalContents", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ProposalContents) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalContents) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ProposalContents) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ProposalContents) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ProposalContents)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalContents: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalContents: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ProposalContents) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProposalContents) ProtoMessage() {}

// Deprecated: Use ProposalContents.ProtoReflect.Descriptor instead.
func (*ProposalContents) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_gov_proto_rawDescGZIP(), []int{3}
}

func (x *ProposalContents) GetMessages() []*anypb.Any {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *ProposalContents) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
var file_cosmos_gov_v1_gov_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x74, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04,
	...
	0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x03,
	...
	0x72, 0x69, 0x6f, 0x64, 0x22, 0x9a, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x6c, 0x6c, 0x79, 0x50, 0x61,
	...
	0x64, 0x22, 0xb7, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x40, 0x0a, 0x0b,
	...
	0x1f, 0x00, 0x52, 0x0a, 0x6d, 0x69, 0x6e, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x4d,
...
var file_cosmos_gov_v1_gov_proto_goTypes = []interface{}{
	...
	(*ProposalContents)(nil),      // 5: cosmos.gov.v1.ProposalContents
...
var file_cosmos_gov_v1_gov_proto_depIdxs = []int32{
	...
	13, // 10: cosmos.gov.v1.ProposalContents.messages:type_name -> google.protobuf.Any
