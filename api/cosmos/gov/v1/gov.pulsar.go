...
var _ protoreflect.List = (*_ProposalMessages_1_list)(nil)

type _ProposalMessages_1_list struct {
	list *[]*anypb.Any
}

func (x *_ProposalMessages_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ProposalMessages_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ProposalMessages_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*anypb.Any)
	(*x.list)[i] = concreteValue
}

func (x *_ProposalMessages_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*anypb.Any)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ProposalMessages_1_list) AppendMutable() protoreflect.Value {
	v := new(anypb.Any)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProposalMessages_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ProposalMessages_1_list) NewElement() protoreflect.Value {
	v := new(anypb.Any)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProposalMessages_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_ProposalMessages          protoreflect.MessageDescriptor
	fd_ProposalMessages_messages protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_gov_proto_init()
	md_ProposalMessages = File_cosmos_gov_v1_gov_proto.Messages().ByName("ProposalMessages")
	fd_ProposalMessages_messages = md_ProposalMessages.Fields().ByName("messages")
}

var _ protoreflect.Message = (*fastReflection_ProposalMessages)(nil)

type fastReflection_ProposalMessages ProposalMessages

func (x *ProposalMessages) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ProposalMessages)(x)
}

func (x *ProposalMessages) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ProposalMessages_messageType fastReflection_ProposalMessages_messageType
var _ protoreflect.MessageType = fastReflection_ProposalMessages_messageType{}

type fastReflection_ProposalMessages_messageType struct{}

func (x fastReflection_ProposalMessages_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ProposalMessages)(nil)
}
func (x fastReflection_ProposalMessages_messageType) New() protoreflect.Message {
	return new(fastReflection_ProposalMessages)
}
func (x fastReflection_ProposalMessages_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalMessages
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ProposalMessages) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalMessages
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ProposalMessages) Type() protoreflect.MessageType {
	return _fastReflection_ProposalMessages_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ProposalMessages) New() protoreflect.Message {
	return new(fastReflection_ProposalMessages)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ProposalMessages) Interface() protoreflect.ProtoMessage {
	return (*ProposalMessages)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ProposalMessages) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Messages) != 0 {
		value := protoreflect.ValueOfList(&_ProposalMessages_1_list{list: &x.Messages})
		if !f(fd_ProposalMessages_messages, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ProposalMessages) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalMessages.messages":
		return len(x.Messages) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalMessages"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.ProposalMessages does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalMessages) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalMessages.messages":
		x.Messages = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ProposalMessages) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.ProposalMessages.messages":
		if len(x.Messages) == 0 {
			return protoreflect.ValueOfList(&_ProposalMessages_1_list{})
		}
		listValue := &_ProposalMessages_1_list{list: &x.Messages}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalMessages"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.ProposalMessages does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalMessages) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalMessages.messages":
		lv := value.List()
		clv := lv.(*_ProposalMessages_1_list)
		x.Messages = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalMessages"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalMessages) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalMessages.messages":
		if x.Messages == nil {
			x.Messages = []*anypb.Any{}
		}
		value := &_ProposalMessages_1_list{list: &x.Messages}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalMessages"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ProposalMessages) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalMessages.messages":
		list := []*anypb.Any{}
		return protoreflect.ValueOfList(&_ProposalMessages_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalMessages"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ProposalMessages) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.ProposalMessages", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ProposalMessages) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalMessages) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ProposalMessages) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ProposalMessages) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ProposalMessages)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalMessages: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalMessages: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ProposalMessages) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProposalMessages) ProtoMessage() {}

// Deprecated: Use ProposalMessages.ProtoReflect.Descriptor instead.
func (*ProposalMessages) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_gov_proto_rawDescGZIP(), []int{3}
}

func (x *ProposalMessages) GetMessages() []*anypb.Any {
	if x != nil {
		return x.Messages
	}
	return nil
...
var file_cosmos_gov_v1_gov_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x44, 0x0a,
	0x10, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x73, 0x12, 0x30, 0x0a, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x73, 0x22, 0xd7, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x6c, 0x6c, 0x79, 0x52, 0x65, 0x73,
	...
	0x73, 0x68, 0x6f, 0x6c, 0x64, 0x22, 0xb7, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	0x12, 0x40, 0x0a, 0x0b, 0x6d, 0x69, 0x6e, 0x5f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62,
	0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e,
	0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0a, 0x6d, 0x69, 0x6e, 0x44, 0x65, 0x70, 0x6f, 0x73,
	...
	0x69, 0x61, 0x6c, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x2a,
...
var file_cosmos_gov_v1_gov_proto_goTypes = []interface{}{
	...
	(*ProposalMessages)(nil),      // 5: cosmos.gov.v1.ProposalMessages
...
var file_cosmos_gov_v1_gov_proto_depIdxs = []int32{
	...
	13, // 10: cosmos.gov.v1.ProposalMessages.messages:type_name -> google.protobuf.Any
