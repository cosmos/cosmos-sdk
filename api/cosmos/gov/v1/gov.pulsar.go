...
var _ protoreflect.List = (*_ProposalStaticData_1_list)(nil)

type _ProposalStaticData_1_list struct {
	list *[]*anypb.Any
}

func (x *_ProposalStaticData_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ProposalStaticData_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ProposalStaticData_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*anypb.Any)
	(*x.list)[i] = concreteValue
}

func (x *_ProposalStaticData_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*anypb.Any)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ProposalStaticData_1_list) AppendMutable() protoreflect.Value {
	v := new(anypb.Any)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProposalStaticData_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_ProposalStaticData_1_list) NewElement() protoreflect.Value {
	v := new(anypb.Any)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ProposalStaticData_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_ProposalStaticData          protoreflect.MessageDescriptor
	fd_ProposalStaticData_messages protoreflect.FieldDescriptor
	fd_ProposalStaticData_metadata protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_gov_proto_init()
	md_ProposalStaticData = File_cosmos_gov_v1_gov_proto.Messages().ByName("ProposalStaticData")
	fd_ProposalStaticData_messages = md_ProposalStaticData.Fields().ByName("messages")
	fd_ProposalStaticData_metadata = md_ProposalStaticData.Fields().ByName("metadata")
}

var _ protoreflect.Message = (*fastReflection_ProposalStaticData)(nil)

type fastReflection_ProposalStaticData ProposalStaticData

func (x *ProposalStaticData) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ProposalStaticData)(x)
}

func (x *ProposalStaticData) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ProposalStaticData_messageType fastReflection_ProposalStaticData_messageType
var _ protoreflect.MessageType = fastReflection_ProposalStaticData_messageType{}

type fastReflection_ProposalStaticData_messageType struct{}

func (x fastReflection_ProposalStaticData_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ProposalStaticData)(nil)
}
func (x fastReflection_ProposalStaticData_messageType) New() protoreflect.Message {
	return new(fastReflection_ProposalStaticData)
}
func (x fastReflection_ProposalStaticData_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalStaticData
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ProposalStaticData) Descriptor() protoreflect.MessageDescriptor {
	return md_ProposalStaticData
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ProposalStaticData) Type() protoreflect.MessageType {
	return _fastReflection_ProposalStaticData_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ProposalStaticData) New() protoreflect.Message {
	return new(fastReflection_ProposalStaticData)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ProposalStaticData) Interface() protoreflect.ProtoMessage {
	return (*ProposalStaticData)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ProposalStaticData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Messages) != 0 {
		value := protoreflect.ValueOfList(&_ProposalStaticData_1_list{list: &x.Messages})
		if !f(fd_ProposalStaticData_messages, value) {
			return
		}
	}
	if x.Metadata != "" {
		value := protoreflect.ValueOfString(x.Metadata)
		if !f(fd_ProposalStaticData_metadata, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ProposalStaticData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalStaticData.messages":
		return len(x.Messages) != 0
	case "cosmos.gov.v1.ProposalStaticData.metadata":
		return x.Metadata != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalStaticData"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.ProposalStaticData does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalStaticData) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalStaticData.messages":
		x.Messages = nil
	case "cosmos.gov.v1.ProposalStaticData.metadata":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ProposalStaticData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.ProposalStaticData.messages":
		if len(x.Messages) == 0 {
			return protoreflect.ValueOfList(&_ProposalStaticData_1_list{})
		}
		listValue := &_ProposalStaticData_1_list{list: &x.Messages}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.gov.v1.ProposalStaticData.metadata":
		value := x.Metadata
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1.ProposalStaticData does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalStaticData) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalStaticData.messages":
		lv := value.List()
		clv := lv.(*_ProposalStaticData_1_list)
		x.Messages = *clv.list
	case "cosmos.gov.v1.ProposalStaticData.metadata":
		x.Metadata = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalStaticData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalStaticData.messages":
		if x.Messages == nil {
			x.Messages = []*anypb.Any{}
		}
		value := &_ProposalStaticData_1_list{list: &x.Messages}
		return protoreflect.ValueOfList(value)
	case "cosmos.gov.v1.ProposalStaticData.metadata":
		panic(fmt.Errorf("field metadata of message cosmos.gov.v1.ProposalStaticData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.ProposalStaticData"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ProposalStaticData) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.ProposalStaticData.messages":
		list := []*anypb.Any{}
		return protoreflect.ValueOfList(&_ProposalStaticData_1_list{list: &list})
	case "cosmos.gov.v1.ProposalStaticData.metadata":
		return protoreflect.ValueOfString("")
	default:
		if fd.IsExtension() {
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ProposalStaticData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.ProposalStaticData", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ProposalStaticData) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProposalStaticData) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ProposalStaticData) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ProposalStaticData) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ProposalStaticData)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalStaticData: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProposalStaticData: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ProposalStaticData) Reset() {
	*x = ProposalStaticData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1_gov_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *ProposalStaticData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProposalStaticData) ProtoMessage() {}

// Deprecated: Use ProposalStaticData.ProtoReflect.Descriptor instead.
func (*ProposalStaticData) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_gov_proto_rawDescGZIP(), []int{3}
}

func (x *ProposalStaticData) GetMessages() []*anypb.Any {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *ProposalStaticData) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
var file_cosmos_gov_v1_gov_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x62, 0x0a,
	0x12, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x44,
	...
	0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x22, 0xd7, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x6c, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x12, 0x2b, 0x0a, 0x09, 0x79, 0x65, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x49, 0x6e, 0x74, 0x52, 0x08, 0x79, 0x65, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x33,
	...
	0x75, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x08, 0x6e, 0x6f, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x07, 0x6e, 0x6f, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x3b,
	0x0a, 0x12, 0x6e, 0x6f, 0x5f, 0x77, 0x69, 0x74, 0x68, 0x5f, 0x76, 0x65, 0x74, 0x6f, 0x5f, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xd2, 0xb4, 0x2d, 0x0a,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x0f, 0x6e, 0x6f, 0x57, 0x69,
	0x74, 0x68, 0x56, 0x65, 0x74, 0x6f, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xb6, 0x01, 0x0a, 0x04,
	...
	0x08, 0x03, 0x10, 0x04, 0x22, 0xd9, 0x01, 0x0a, 0x0d, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	...
	0x22, 0x54, 0x0a, 0x0c, 0x56, 0x6f, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x22, 0x9a, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x6c, 0x6c, 0x79,
	...
	0x6f, 0x6c, 0x64, 0x22, 0xb7, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x40,
	...
	0x12, 0x4d, 0x0a, 0x12, 0x6d, 0x61, 0x78, 0x5f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x5f,
	0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44,
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x04, 0x98, 0xdf, 0x1f, 0x01, 0x52, 0x10, 0x6d,
	0x61, 0x78, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x12,
	...
	0x65, 0x72, 0x69, 0x6f, 0x64, 0x12, 0x26, 0x0a, 0x06, 0x71, 0x75, 0x6f, 0x72, 0x75, 0x6d, 0x18,
	...
	0x65, 0x74, 0x6f, 0x5f, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x06, 0x20,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x16, 0x6d, 0x69, 0x6e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
	0x6c, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x2a, 0x89, 0x01,
	...
	0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x42, 0x99, 0x01, 0x0a, 0x11, 0x63,
	0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x67, 0x6f, 0x76, 0x2e, 0x76, 0x31,
	0x42, 0x08, 0x47, 0x6f, 0x76, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x24, 0x63, 0x6f,
...
var file_cosmos_gov_v1_gov_proto_goTypes = []interface{}{
	...
	(*ProposalStaticData)(nil),    // 5: cosmos.gov.v1.ProposalStaticData
...
var file_cosmos_gov_v1_gov_proto_depIdxs = []int32{
	...
	13, // 10: cosmos.gov.v1.ProposalStaticData.messages:type_name -> google.protobuf.Any
...
func file_cosmos_gov_v1_gov_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_gov_v1_gov_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProposalStaticData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
