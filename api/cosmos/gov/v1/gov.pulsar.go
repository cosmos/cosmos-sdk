...
var (
	...
	fd_Params_proposal_cancel_burn_rate protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_proposal_cancel_burn_rate = md_Params.Fields().ByName("proposal_cancel_burn_rate")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ProposalCancelBurnRate != "" {
		value := protoreflect.ValueOfString(x.ProposalCancelBurnRate)
		if !f(fd_Params_proposal_cancel_burn_rate, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1.Params.proposal_cancel_burn_rate":
		return x.ProposalCancelBurnRate != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1.Params.min_initial_deposit_ratio":
		...
		return protoreflect.ValueOfString(value)
	case "cosmos.gov.v1.Params.proposal_cancel_burn_rate":
		value := x.ProposalCancelBurnRate
		return protoreflect.ValueOfString(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.Params"))
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.gov.v1.Params.proposal_cancel_burn_rate":
		x.ProposalCancelBurnRate = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1.Params.proposal_cancel_burn_rate":
		panic(fmt.Errorf("field proposal_cancel_burn_rate of message cosmos.gov.v1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.ProposalCancelBurnRate)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ProposalCancelBurnRate) > 0 {
			i -= len(x.ProposalCancelBurnRate)
			copy(dAtA[i:], x.ProposalCancelBurnRate)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ProposalCancelBurnRate)))
			i--
			dAtA[i] = 0x42
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 8:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ProposalCancelBurnRate", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ProposalCancelBurnRate = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *Params) GetProposalCancelBurnRate() string {
	if x != nil {
		return x.ProposalCancelBurnRate
	}
	return ""
...
var file_cosmos_gov_v1_gov_proto_rawDesc = []byte{
	...
	0x6c, 0x64, 0x22, 0x87, 0x04, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x45, 0x0a,
	...
	0x6f, 0x12, 0x49, 0x0a, 0x19, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x5f, 0x63, 0x61,
	0x6e, 0x63, 0x65, 0x6c, 0x5f, 0x62, 0x75, 0x72, 0x6e, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x44, 0x65, 0x63, 0x52, 0x16, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x43, 0x61,
	0x6e, 0x63, 0x65, 0x6c, 0x42, 0x75, 0x72, 0x6e, 0x52, 0x61, 0x74, 0x65, 0x2a, 0x89, 0x01, 0x0a,
