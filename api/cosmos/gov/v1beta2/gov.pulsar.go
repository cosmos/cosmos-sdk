...
var (
	...
	fd_DepositParams_burn_vote_quorum      protoreflect.FieldDescriptor
	fd_DepositParams_burn_proposal_deposit protoreflect.FieldDescriptor
	fd_DepositParams_burn_vote_veto        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_DepositParams_burn_vote_quorum = md_DepositParams.Fields().ByName("burn_vote_quorum")
	fd_DepositParams_burn_proposal_deposit = md_DepositParams.Fields().ByName("burn_proposal_deposit")
	fd_DepositParams_burn_vote_veto = md_DepositParams.Fields().ByName("burn_vote_veto")
}
...
func (x *fastReflection_DepositParams) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.BurnVoteQuorum != false {
		...
		if !f(fd_DepositParams_burn_vote_quorum, value) {
			return
		}
	}
	if x.BurnProposalDeposit != false {
		value := protoreflect.ValueOfBool(x.BurnProposalDeposit)
		if !f(fd_DepositParams_burn_proposal_deposit, value) {
			return
		}
	}
	if x.BurnVoteVeto != false {
		value := protoreflect.ValueOfBool(x.BurnVoteVeto)
		if !f(fd_DepositParams_burn_vote_veto, value) {
			return
		}
	}
}
...
func (x *fastReflection_DepositParams) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1beta2.DepositParams.burn_vote_quorum":
		return x.BurnVoteQuorum != false
	case "cosmos.gov.v1beta2.DepositParams.burn_proposal_deposit":
		return x.BurnProposalDeposit != false
	case "cosmos.gov.v1beta2.DepositParams.burn_vote_veto":
...
func (x *fastReflection_DepositParams) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.gov.v1beta2.DepositParams.burn_proposal_deposit":
		x.BurnProposalDeposit = value.Bool()
	case "cosmos.gov.v1beta2.DepositParams.burn_vote_veto":
...
func (x *fastReflection_DepositParams) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1beta2.DepositParams.burn_vote_quorum":
		panic(fmt.Errorf("field burn_vote_quorum of message cosmos.gov.v1beta2.DepositParams is not mutable"))
	case "cosmos.gov.v1beta2.DepositParams.burn_proposal_deposit":
		panic(fmt.Errorf("field burn_proposal_deposit of message cosmos.gov.v1beta2.DepositParams is not mutable"))
	case "cosmos.gov.v1beta2.DepositParams.burn_vote_veto":
		panic(fmt.Errorf("field burn_vote_veto of message cosmos.gov.v1beta2.DepositParams is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1beta2.DepositParams"))
		}
...
func (x *fastReflection_DepositParams) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field BurnProposalDeposit", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.BurnProposalDeposit = bool(v != 0)
			case 5:
				if wireType != 0 {
...
func (x *DepositParams) GetBurnVoteQuorum() bool {
	if x != nil {
...
func (x *DepositParams) GetBurnProposalDeposit() bool {
	if x != nil {
		return x.BurnProposalDeposit
	}
	return false
}

func (x *DepositParams) GetBurnVoteVeto() bool {
	if x != nil {
...
var file_cosmos_gov_v1beta2_gov_proto_rawDesc = []byte{
	...
	0x73, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0xdd, 0x02, 0x0a, 0x0d, 0x44, 0x65, 0x70, 0x6f,
	...
	,
