...
var (
	md_SubmitProposal             protoreflect.MessageDescriptor
	fd_SubmitProposal_proposal_id protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_group_v1beta1_events_proto_init()
	md_SubmitProposal = File_cosmos_group_v1beta1_events_proto.Messages().ByName("SubmitProposal")
	fd_SubmitProposal_proposal_id = md_SubmitProposal.Fields().ByName("proposal_id")
}

var _ protoreflect.Message = (*fastReflection_SubmitProposal)(nil)

type fastReflection_SubmitProposal SubmitProposal

func (x *SubmitProposal) ProtoReflect() protoreflect.Message {
	return (*fastReflection_SubmitProposal)(x)
}

func (x *SubmitProposal) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_SubmitProposal_messageType fastReflection_SubmitProposal_messageType
var _ protoreflect.MessageType = fastReflection_SubmitProposal_messageType{}

type fastReflection_SubmitProposal_messageType struct{}

func (x fastReflection_SubmitProposal_messageType) Zero() protoreflect.Message {
	return (*fastReflection_SubmitProposal)(nil)
}
func (x fastReflection_SubmitProposal_messageType) New() protoreflect.Message {
	return new(fastReflection_SubmitProposal)
}
func (x fastReflection_SubmitProposal_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_SubmitProposal
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_SubmitProposal) Descriptor() protoreflect.MessageDescriptor {
	return md_SubmitProposal
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_SubmitProposal) Type() protoreflect.MessageType {
	return _fastReflection_SubmitProposal_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_SubmitProposal) New() protoreflect.Message {
	return new(fastReflection_SubmitProposal)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_SubmitProposal) Interface() protoreflect.ProtoMessage {
	return (*SubmitProposal)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_SubmitProposal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ProposalId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.ProposalId)
		if !f(fd_SubmitProposal_proposal_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_SubmitProposal) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.group.v1beta1.SubmitProposal.proposal_id":
		return x.ProposalId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.group.v1beta1.SubmitProposal"))
		}
		panic(fmt.Errorf("message cosmos.group.v1beta1.SubmitProposal does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SubmitProposal) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.group.v1beta1.SubmitProposal.proposal_id":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_SubmitProposal) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.group.v1beta1.SubmitProposal.proposal_id":
		value := x.ProposalId
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.group.v1beta1.SubmitProposal does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SubmitProposal) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.group.v1beta1.SubmitProposal.proposal_id":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SubmitProposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.group.v1beta1.SubmitProposal.proposal_id":
		panic(fmt.Errorf("field proposal_id of message cosmos.group.v1beta1.SubmitProposal is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.group.v1beta1.SubmitProposal"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_SubmitProposal) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.group.v1beta1.SubmitProposal.proposal_id":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_SubmitProposal) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.group.v1beta1.SubmitProposal", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_SubmitProposal) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SubmitProposal) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_SubmitProposal) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_SubmitProposal) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*SubmitProposal)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SubmitProposal: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SubmitProposal: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *SubmitProposal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubmitProposal) ProtoMessage() {}

// Deprecated: Use SubmitProposal.ProtoReflect.Descriptor instead.
func (*SubmitProposal) Descriptor() ([]byte, []int) {
	return file_cosmos_group_v1beta1_events_proto_rawDescGZIP(), []int{4}
}

func (x *SubmitProposal) GetProposalId() uint64 {
	if x != nil {
		return x.ProposalId
	}
	return 0
...
var file_cosmos_group_v1beta1_events_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x31,
	...
	0x2c, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x45, 0x78, 0x65, 0x63, 0x12, 0x1f, 0x0a, 0x0b,
	0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x49, 0x64, 0x42, 0xdd, 0x01,
	0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_cosmos_group_v1beta1_events_proto_goTypes = []interface{}{
	...
	(*SubmitProposal)(nil),         // 4: cosmos.group.v1beta1.SubmitProposal
