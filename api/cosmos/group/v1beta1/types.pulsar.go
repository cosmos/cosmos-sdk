...
func init() {
	file_cosmos_group_v1beta1_types_proto_init()
	md_GroupAccountInfo = File_cosmos_group_v1beta1_types_proto.Messages().ByName("GroupAccountInfo")
...
func (x *fastReflection_GroupAccountInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.group.v1beta1.GroupAccountInfo.address":
		return x.Address != ""
	case "cosmos.group.v1beta1.GroupAccountInfo.group_id":
		return x.GroupId != uint64(0)
	case "cosmos.group.v1beta1.GroupAccountInfo.admin":
		return x.Admin != ""
	case "cosmos.group.v1beta1.GroupAccountInfo.metadata":
		return len(x.Metadata) != 0
	case "cosmos.group.v1beta1.GroupAccountInfo.version":
		return x.Version != uint64(0)
	case "cosmos.group.v1beta1.GroupAccountInfo.decision_policy":
		return x.DecisionPolicy != nil
	case "cosmos.group.v1beta1.GroupAccountInfo.derivation_key":
		return len(x.DerivationKey) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.group.v1beta1.GroupAccountInfo"))
		}
		panic(fmt.Errorf("message cosmos.group.v1beta1.GroupAccountInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GroupAccountInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.group.v1beta1.GroupAccountInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GroupAccountInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.group.v1beta1.GroupAccountInfo.address":
		panic(fmt.Errorf("field address of message cosmos.group.v1beta1.GroupAccountInfo is not mutable"))
	case "cosmos.group.v1beta1.GroupAccountInfo.group_id":
		panic(fmt.Errorf("field group_id of message cosmos.group.v1beta1.GroupAccountInfo is not mutable"))
	case "cosmos.group.v1beta1.GroupAccountInfo.admin":
		panic(fmt.Errorf("field admin of message cosmos.group.v1beta1.GroupAccountInfo is not mutable"))
	case "cosmos.group.v1beta1.GroupAccountInfo.metadata":
		panic(fmt.Errorf("field metadata of message cosmos.group.v1beta1.GroupAccountInfo is not mutable"))
	case "cosmos.group.v1beta1.GroupAccountInfo.version":
		panic(fmt.Errorf("field version of message cosmos.group.v1beta1.GroupAccountInfo is not mutable"))
	case "cosmos.group.v1beta1.GroupAccountInfo.derivation_key":
		panic(fmt.Errorf("field derivation_key of message cosmos.group.v1beta1.GroupAccountInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.group.v1beta1.GroupAccountInfo"))
		}
...
func (x *fastReflection_GroupAccountInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.group.v1beta1.GroupAccountInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Proposal) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.group.v1beta1.Proposal.group_account_version":
...
func (x *fastReflection_Proposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.group.v1beta1.Proposal.group_account_version":
		panic(fmt.Errorf("field group_account_version of message cosmos.group.v1beta1.Proposal is not mutable"))
	case "cosmos.group.v1beta1.Proposal.status":
