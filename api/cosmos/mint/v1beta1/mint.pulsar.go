...
var _ protoreflect.Map = (*_Minter_3_map)(nil)

type _Minter_3_map struct {
	m *map[string]string
}

func (x *_Minter_3_map) Len() int {
	if x.m == nil {
		return 0
	}
	return len(*x.m)
...
func (x *_Minter_3_map) Range(f func(protoreflect.MapKey, protoreflect.Value) bool) {
	if x.m == nil {
		return
	}
	for k, v := range *x.m {
...
func (x *_Minter_3_map) Has(key protoreflect.MapKey) bool {
	if x.m == nil {
		return false
	}
...
func (x *_Minter_3_map) Clear(key protoreflect.MapKey) {
	if x.m == nil {
		return
	}
	keyUnwrapped := key.String()
...
func (x *_Minter_3_map) Get(key protoreflect.MapKey) protoreflect.Value {
	if x.m == nil {
...
func (x *_Minter_3_map) Set(key protoreflect.MapKey, value protoreflect.Value) {
...
func (x *_Minter_3_map) Mutable(key protoreflect.MapKey) protoreflect.Value {
	panic("should not call Mutable on protoreflect.Map whose value is not of type protoreflect.Message")
}

func (x *_Minter_3_map) NewValue() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Minter_3_map) IsValid() bool {
	return x.m != nil
}
...
var (
	...
	fd_Minter_arbitrary_params  protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Minter_arbitrary_params = md_Minter.Fields().ByName("arbitrary_params")
}
...
func (x *fastReflection_Minter) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ArbitraryParams) != 0 {
		value := protoreflect.ValueOfMap(&_Minter_3_map{m: &x.ArbitraryParams})
		if !f(fd_Minter_arbitrary_params, value) {
			return
		}
	}
}
...
func (x *fastReflection_Minter) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.mint.v1beta1.Minter.arbitrary_params":
		return len(x.ArbitraryParams) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Minter) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.mint.v1beta1.Minter.arbitrary_params":
		if len(x.ArbitraryParams) == 0 {
			return protoreflect.ValueOfMap(&_Minter_3_map{})
		}
		mapValue := &_Minter_3_map{m: &x.ArbitraryParams}
...
func (x *fastReflection_Minter) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.mint.v1beta1.Minter.arbitrary_params":
		mv := value.Map()
		cmv := mv.(*_Minter_3_map)
		x.ArbitraryParams = *cmv.m
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.mint.v1beta1.Minter"))
		}
...
func (x *fastReflection_Minter) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.mint.v1beta1.Minter.arbitrary_params":
		if x.ArbitraryParams == nil {
			x.ArbitraryParams = make(map[string]string)
		}
		value := &_Minter_3_map{m: &x.ArbitraryParams}
...
func (x *fastReflection_Minter) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.mint.v1beta1.Minter.arbitrary_params":
		...
		return protoreflect.ValueOfMap(&_Minter_3_map{m: &m})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.mint.v1beta1.Minter"))
		}
...
func (x *fastReflection_Minter) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ArbitraryParams) > 0 {
			...
			if options.Deterministic {
				sortme := make([]string, 0, len(x.ArbitraryParams))
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ArbitraryParams) > 0 {
			...
			if options.Deterministic {
				keysForArbitraryParams := make([]string, 0, len(x.ArbitraryParams))
				for k := range x.ArbitraryParams {
					keysForArbitraryParams = append(keysForArbitraryParams, string(k))
				}
				sort.Slice(keysForArbitraryParams, func(i, j int) bool {
					return keysForArbitraryParams[i] < keysForArbitraryParams[j]
				})
				for iNdEx := len(keysForArbitraryParams) - 1; iNdEx >= 0; iNdEx-- {
					v := x.ArbitraryParams[string(keysForArbitraryParams[iNdEx])]
					out, err := MaRsHaLmAp(keysForArbitraryParams[iNdEx], v)
					if err != nil {
						return out, err
					}
				}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ArbitraryParams", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ArbitraryParams[mapkey] = mapvalue
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *Minter) GetArbitraryParams() map[string]string {
	if x != nil {
		return x.ArbitraryParams
	}
	return nil
}
...
var file_cosmos_mint_v1beta1_mint_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xda, 0x02, 0x0a, 0x06, 0x4d, 0x69,
	...
	,
	...
	,
...
var file_cosmos_mint_v1beta1_mint_proto_goTypes = []interface{}{
	...
	nil,            // 2: cosmos.mint.v1beta1.Minter.ArbitraryParamsEntry
}
var file_cosmos_mint_v1beta1_mint_proto_depIdxs = []int32{
	2, // 0: cosmos.mint.v1beta1.Minter.arbitrary_params:type_name -> cosmos.mint.v1beta1.Minter.ArbitraryParamsEntry
