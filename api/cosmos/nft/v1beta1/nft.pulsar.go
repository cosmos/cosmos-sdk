...
var (
	...
	fd_NFT_send_enabled protoreflect.FieldDescriptor
...
func init() {
	...
	fd_NFT_send_enabled = md_NFT.Fields().ByName("send_enabled")
...
func (x *fastReflection_NFT) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SendEnabled != false {
		...
		if !f(fd_NFT_send_enabled, value) {
			return
		}
	}
	if x.Data != nil {
...
func (x *fastReflection_NFT) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.nft.v1beta1.NFT.uri_hash":
		return x.UriHash != ""
	case "cosmos.nft.v1beta1.NFT.send_enabled":
...
func (x *fastReflection_NFT) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.nft.v1beta1.NFT.send_enabled":
		panic(fmt.Errorf("field send_enabled of message cosmos.nft.v1beta1.NFT is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.nft.v1beta1.NFT"))
		}
...
func (x *NFT) GetSendEnabled() bool {
	if x != nil {
...
var file_cosmos_nft_v1beta1_nft_proto_rawDesc = []byte{
	...
	0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xaa, 0x01, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x72, 0x69, 0x48, 0x61, 0x73, 0x68, 0x12, 0x21, 0x0a, 0x0c,
	0x73, 0x65, 0x6e, 0x64, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0b, 0x73, 0x65, 0x6e, 0x64, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12,
	0x28, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x41, 0x6e, 0x79, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0xbc, 0x01, 0x0a, 0x16, 0x63, 0x6f,
	0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x6e, 0x66, 0x74, 0x2e, 0x76, 0x31, 0x62,
