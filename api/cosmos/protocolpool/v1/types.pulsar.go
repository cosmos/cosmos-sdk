...
var (
	...
	fd_ContinuousFund_max_distributed_capital protoreflect.FieldDescriptor
...
func init() {
	...
	fd_ContinuousFund_max_distributed_capital = md_ContinuousFund.Fields().ByName("max_distributed_capital")
...
var (
	md_FundDistribution            protoreflect.MessageDescriptor
	fd_FundDistribution_percentage protoreflect.FieldDescriptor
	fd_FundDistribution_ToClaim    protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_protocolpool_v1_types_proto_init()
	md_FundDistribution = File_cosmos_protocolpool_v1_types_proto.Messages().ByName("FundDistribution")
	fd_FundDistribution_percentage = md_FundDistribution.Fields().ByName("percentage")
	fd_FundDistribution_ToClaim = md_FundDistribution.Fields().ByName("ToClaim")
}

var _ protoreflect.Message = (*fastReflection_FundDistribution)(nil)

type fastReflection_FundDistribution FundDistribution

func (x *FundDistribution) ProtoReflect() protoreflect.Message {
	return (*fastReflection_FundDistribution)(x)
}

func (x *FundDistribution) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_FundDistribution_messageType fastReflection_FundDistribution_messageType
var _ protoreflect.MessageType = fastReflection_FundDistribution_messageType{}

type fastReflection_FundDistribution_messageType struct{}

func (x fastReflection_FundDistribution_messageType) Zero() protoreflect.Message {
	return (*fastReflection_FundDistribution)(nil)
}
func (x fastReflection_FundDistribution_messageType) New() protoreflect.Message {
	return new(fastReflection_FundDistribution)
}
func (x fastReflection_FundDistribution_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_FundDistribution
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_FundDistribution) Descriptor() protoreflect.MessageDescriptor {
	return md_FundDistribution
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_FundDistribution) Type() protoreflect.MessageType {
	return _fastReflection_FundDistribution_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_FundDistribution) New() protoreflect.Message {
	return new(fastReflection_FundDistribution)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_FundDistribution) Interface() protoreflect.ProtoMessage {
	return (*FundDistribution)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_FundDistribution) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Percentage != "" {
		value := protoreflect.ValueOfString(x.Percentage)
		if !f(fd_FundDistribution_percentage, value) {
			return
		}
	}
	if x.ToClaim != nil {
		value := protoreflect.ValueOfMessage(x.ToClaim.ProtoReflect())
		if !f(fd_FundDistribution_ToClaim, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_FundDistribution) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.FundDistribution.percentage":
		return x.Percentage != ""
	case "cosmos.protocolpool.v1.FundDistribution.ToClaim":
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.protocolpool.v1.FundDistribution does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FundDistribution) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.FundDistribution.percentage":
		x.Percentage = ""
	case "cosmos.protocolpool.v1.FundDistribution.ToClaim":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_FundDistribution) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.protocolpool.v1.FundDistribution.percentage":
		value := x.Percentage
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.protocolpool.v1.FundDistribution does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FundDistribution) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.FundDistribution.percentage":
		x.Percentage = value.Interface().(string)
	case "cosmos.protocolpool.v1.FundDistribution.ToClaim":
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_FundDistribution) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.protocolpool.v1.FundDistribution.percentage":
		return protoreflect.ValueOfString("")
	case "cosmos.protocolpool.v1.FundDistribution.ToClaim":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_FundDistribution) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.protocolpool.v1.FundDistribution", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_FundDistribution) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_FundDistribution) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_FundDistribution) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_FundDistribution) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*FundDistribution)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: FundDistribution: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: FundDistribution: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
type FundDistribution struct {
	...
	ToClaim *v1beta1.Coin `protobuf:"bytes,2,opt,name=ToClaim,proto3" json:"ToClaim,omitempty"`
}
...
func (x *FundDistribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FundDistribution) ProtoMessage() {}

// Deprecated: Use FundDistribution.ProtoReflect.Descriptor instead.
func (*FundDistribution) Descriptor() ([]byte, []int) {
	return file_cosmos_protocolpool_v1_types_proto_rawDescGZIP(), []int{2}
}

func (x *FundDistribution) GetPercentage() string {
	if x != nil {
		return x.Percentage
	}
	return ""
...
var file_cosmos_protocolpool_v1_types_proto_rawDesc = []byte{
	...
	0x22, 0x96, 0x01, 0x0a, 0x10, 0x46, 0x75, 0x6e, 0x64, 0x44, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62,
	...
	0x74, 0x61, 0x67, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x54, 0x6f, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62,
	0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e,
	0x52, 0x07, 0x54, 0x6f, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x42, 0xda, 0x01, 0x0a, 0x1a, 0x63, 0x6f,
	0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	0x6c, 0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50,
...
var file_cosmos_protocolpool_v1_types_proto_goTypes = []interface{}{
	...
	(*FundDistribution)(nil),      // 2: cosmos.protocolpool.v1.FundDistribution
	(*v1beta1.Coin)(nil),          // 3: cosmos.base.v1beta1.Coin
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 5: google.protobuf.Duration
}
var file_cosmos_protocolpool_v1_types_proto_depIdxs = []int32{
	3, // 0: cosmos.protocolpool.v1.Budget.total_budget:type_name -> cosmos.base.v1beta1.Coin
	3, // 1: cosmos.protocolpool.v1.Budget.claimed_amount:type_name -> cosmos.base.v1beta1.Coin
	...
	3, // 7: cosmos.protocolpool.v1.FundDistribution.ToClaim:type_name -> cosmos.base.v1beta1.Coin
