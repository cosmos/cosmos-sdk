...
func (x *fastReflection_ContinuousFund) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MaxDistributedCapital != "" {
		value := protoreflect.ValueOfString(x.MaxDistributedCapital)
...
func (x *fastReflection_ContinuousFund) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.protocolpool.v1.ContinuousFund.max_distributed_capital":
		x.MaxDistributedCapital = value.Interface().(string)
	case "cosmos.protocolpool.v1.ContinuousFund.expiry":
...
func (x *fastReflection_ContinuousFund) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MaxDistributedCapital) > 0 {
			i -= len(x.MaxDistributedCapital)
			copy(dAtA[i:], x.MaxDistributedCapital)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MaxDistributedCapital)))
			i--
			dAtA[i] = 0x1a
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				x.MaxDistributedCapital = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
...
type ContinuousFund struct {
	...
	MaxDistributedCapital string `protobuf:"bytes,3,opt,name=max_distributed_capital,json=maxDistributedCapital,proto3" json:"max_distributed_capital,omitempty"`
...
func (x *ContinuousFund) GetMaxDistributedCapital() string {
	if x != nil {
		return x.MaxDistributedCapital
	}
	return ""
...
var file_cosmos_protocolpool_v1_types_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x69, 0x6f, 0x64, 0x22, 0xba, 0x02, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x69, 0x6e,
	...
	0x61, 0x67, 0x65, 0x12, 0x63, 0x0a, 0x17, 0x6d, 0x61, 0x78, 0x5f, 0x64, 0x69, 0x73, 0x74, 0x72,
	...
	0x74, 0x52, 0x15, 0x6d, 0x61, 0x78, 0x44, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x64, 0x43, 0x61, 0x70, 0x69, 0x74, 0x61, 0x6c, 0x12, 0x38, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69,
	0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x42, 0x04, 0x90, 0xdf, 0x1f, 0x01, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69,
	0x72, 0x79, 0x42, 0xda, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
