...
func (x *fastReflection_StakeAuthorization) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Validatorslist != nil {
		switch o := x.Validatorslist.(type) {
...
func (x *fastReflection_StakeAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.StakeAuthorization.allow_list":
		if x.Validatorslist == nil {
			return false
		} else if _, ok := x.Validatorslist.(*StakeAuthorization_AllowList); ok {
			return true
		} else {
			return false
		}
	case "cosmos.staking.v1beta1.StakeAuthorization.deny_list":
		if x.Validatorslist == nil {
			return false
		} else if _, ok := x.Validatorslist.(*StakeAuthorization_DenyList); ok {
			return true
		} else {
			return false
		}
...
func (x *fastReflection_StakeAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.StakeAuthorization.allow_list":
		...
		} else if v, ok := x.Validatorslist.(*StakeAuthorization_AllowList); ok {
	...
	case "cosmos.staking.v1beta1.StakeAuthorization.deny_list":
		if x.Validatorslist == nil {
			return protoreflect.ValueOfMessage((*StakeAuthorization_Validators)(nil).ProtoReflect())
		} else if v, ok := x.Validatorslist.(*StakeAuthorization_DenyList); ok {
...
func (x *fastReflection_StakeAuthorization) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.StakeAuthorization.allow_list":
		...
		x.Validatorslist = &StakeAuthorization_AllowList{AllowList: cv}
	case "cosmos.staking.v1beta1.StakeAuthorization.deny_list":
		cv := value.Message().Interface().(*StakeAuthorization_Validators)
		x.Validatorslist = &StakeAuthorization_DenyList{DenyList: cv}
	case "cosmos.staking.v1beta1.StakeAuthorization.authorization_type":
...
func (x *fastReflection_StakeAuthorization) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.StakeAuthorization.allow_list":
		if x.Validatorslist == nil {
			...
			x.Validatorslist = oneofValue
			return protoreflect.ValueOfMessage(value.ProtoReflect())
		}
		switch m := x.Validatorslist.(type) {
		case *StakeAuthorization_AllowList:
...
func (x *fastReflection_StakeAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "cosmos.staking.v1beta1.StakeAuthorization.validatorslist":
		if x.Validatorslist == nil {
			return nil
		}
		switch x.Validatorslist.(type) {
		case *StakeAuthorization_AllowList:
...
func (x *fastReflection_StakeAuthorization) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		switch x := x.Validatorslist.(type) {
		case *StakeAuthorization_AllowList:
			if x == nil {
				break
			}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.Validatorslist = &StakeAuthorization_AllowList{v}
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
				...
				x.Validatorslist = &StakeAuthorization_DenyList{v}
				iNdEx = postIndex
			case 4:
				if wireType != 0 {
...
type StakeAuthorization struct {
	...
	//
	// Types that are assignable to Validatorslist:
	//
...
func (x *StakeAuthorization) GetValidatorslist() isStakeAuthorization_Validatorslist {
	if x != nil {
...
func (x *StakeAuthorization) GetAllowList() *StakeAuthorization_Validators {
	if x, ok := x.GetValidatorslist().(*StakeAuthorization_AllowList); ok {
		return x.AllowList
	}
	return nil
}
...
func (x *StakeAuthorization) GetDenyList() *StakeAuthorization_Validators {
	if x, ok := x.GetValidatorslist().(*StakeAuthorization_DenyList); ok {
		return x.DenyList
	}
	return nil
}
...
var file_cosmos_staking_v1beta1_authz_proto_rawDesc = []byte{
	...
	0x22, 0xfe, 0x04, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
	...
	0x10, 0x0a, 0x0e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x6c, 0x69, 0x73,
	0x74, 0x2a, 0xd2, 0x01, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74,
	...
	,
