...
var (
	...
	fd_Validator_total_exempt_shares         protoreflect.FieldDescriptor
	fd_Validator_total_tokenized_shares      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Validator_total_exempt_shares = md_Validator.Fields().ByName("total_exempt_shares")
	fd_Validator_total_tokenized_shares = md_Validator.Fields().ByName("total_tokenized_shares")
}
...
func (x *fastReflection_Validator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TotalExemptShares != "" {
		value := protoreflect.ValueOfString(x.TotalExemptShares)
		if !f(fd_Validator_total_exempt_shares, value) {
			return
		}
	}
	if x.TotalTokenizedShares != "" {
		value := protoreflect.ValueOfString(x.TotalTokenizedShares)
		if !f(fd_Validator_total_tokenized_shares, value) {
			return
		}
	}
}
...
func (x *fastReflection_Validator) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.Validator.total_exempt_shares":
		return x.TotalExemptShares != ""
	case "cosmos.staking.v1beta1.Validator.total_tokenized_shares":
		return x.TotalTokenizedShares != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Validator) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.Validator.unbonding_ids":
		...
		return protoreflect.ValueOfList(listValue)
	case "cosmos.staking.v1beta1.Validator.total_exempt_shares":
		value := x.TotalExemptShares
		return protoreflect.ValueOfString(value)
	case "cosmos.staking.v1beta1.Validator.total_tokenized_shares":
		value := x.TotalTokenizedShares
		return protoreflect.ValueOfString(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Validator"))
...
func (x *fastReflection_Validator) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.Validator.total_exempt_shares":
		x.TotalExemptShares = value.Interface().(string)
	case "cosmos.staking.v1beta1.Validator.total_tokenized_shares":
		x.TotalTokenizedShares = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Validator"))
		}
...
func (x *fastReflection_Validator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.Validator.total_exempt_shares":
		panic(fmt.Errorf("field total_exempt_shares of message cosmos.staking.v1beta1.Validator is not mutable"))
	case "cosmos.staking.v1beta1.Validator.total_tokenized_shares":
		panic(fmt.Errorf("field total_tokenized_shares of message cosmos.staking.v1beta1.Validator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Validator"))
		}
...
func (x *fastReflection_Validator) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.TotalExemptShares)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.TotalTokenizedShares)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TotalTokenizedShares) > 0 {
			i -= len(x.TotalTokenizedShares)
			copy(dAtA[i:], x.TotalTokenizedShares)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalTokenizedShares)))
			i--
			dAtA[i] = 0x7a
		}
		if len(x.TotalExemptShares) > 0 {
			i -= len(x.TotalExemptShares)
			copy(dAtA[i:], x.TotalExemptShares)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalExemptShares)))
			i--
			dAtA[i] = 0x72
		}
		if len(x.UnbondingIds) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 14:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalExemptShares", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalExemptShares = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 15:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalTokenizedShares", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalTokenizedShares = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
var (
	...
	fd_Delegation_exempt            protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Delegation_exempt = md_Delegation.Fields().ByName("exempt")
}
...
func (x *fastReflection_Delegation) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Exempt != false {
		value := protoreflect.ValueOfBool(x.Exempt)
		if !f(fd_Delegation_exempt, value) {
			return
		}
	}
}
...
func (x *fastReflection_Delegation) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.Delegation.shares":
		return x.Shares != ""
	case "cosmos.staking.v1beta1.Delegation.exempt":
		return x.Exempt != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Delegation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.Delegation.exempt":
		panic(fmt.Errorf("field exempt of message cosmos.staking.v1beta1.Delegation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Delegation"))
		}
...
func (x *fastReflection_Delegation) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Exempt", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
var (
	...
	fd_Params_exemption_factor    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_exemption_factor = md_Params.Fields().ByName("exemption_factor")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ExemptionFactor != "" {
		value := protoreflect.ValueOfString(x.ExemptionFactor)
		if !f(fd_Params_exemption_factor, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.Params.exemption_factor":
		return x.ExemptionFactor != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.Params.exemption_factor":
		x.ExemptionFactor = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.Params.exemption_factor":
		panic(fmt.Errorf("field exemption_factor of message cosmos.staking.v1beta1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ExemptionFactor) > 0 {
			i -= len(x.ExemptionFactor)
			copy(dAtA[i:], x.ExemptionFactor)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ExemptionFactor)))
			i--
			dAtA[i] = 0x3a
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ExemptionFactor", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ExemptionFactor = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type Validator struct {
	...
	TotalExemptShares string `protobuf:"bytes,14,opt,name=total_exempt_shares,json=totalExemptShares,proto3" json:"total_exempt_shares,omitempty"`
	// total tokenized shares issued by the validator
	TotalTokenizedShares string `protobuf:"bytes,15,opt,name=total_tokenized_shares,json=totalTokenizedShares,proto3" json:"total_tokenized_shares,omitempty"`
}
...
func (x *Validator) GetTotalExemptShares() string {
	if x != nil {
		return x.TotalExemptShares
	}
	return ""
...
func (x *Validator) GetTotalTokenizedShares() string {
	if x != nil {
		return x.TotalTokenizedShares
	}
	return ""
...
func (x *Delegation) GetExempt() bool {
	if x != nil {
		return x.Exempt
	}
	return false
...
type Params struct {
	...
	//
	// Since: cosmos-sdk 0.47
	ExemptionFactor string `protobuf:"bytes,7,opt,name=exemption_factor,json=exemptionFactor,proto3" json:"exemption_factor,omitempty"`
}
...
func (x *Params) GetExemptionFactor() string {
	if x != nil {
		return x.ExemptionFactor
	}
	return ""
...
var file_cosmos_staking_v1beta1_staking_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6c, 0x73, 0x3a, 0x08, 0x98, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xf4,
	0x08, 0x0a, 0x09, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x43, 0x0a, 0x10,
	...
	0x1f, 0x00, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x6e,
	0x0a, 0x13, 0x6d, 0x69, 0x6e, 0x5f, 0x73, 0x65, 0x6c, 0x66, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x67,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x42, 0x3e, 0x18, 0x01, 0xc8,
	...
	,
	...
	0x63, 0x52, 0x14, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x69, 0x7a, 0x65,
	0x64, 0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x3a, 0x0c, 0x88, 0xa0, 0x1f, 0x00, 0x98, 0xa0, 0x1f,
	0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x50, 0x0a, 0x0c, 0x56, 0x61, 0x6c, 0x41, 0x64, 0x64, 0x72,
	...
	0x6e, 0x67, 0x52, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x3a, 0x08, 0x98,
	0xa0, 0x1f, 0x00, 0x80, 0xdc, 0x20, 0x01, 0x22, 0xa4, 0x01, 0x0a, 0x06, 0x44, 0x56, 0x50, 0x61,
	...
	0x3a, 0x0c, 0x88, 0xa0, 0x1f, 0x00, 0x98, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x45,
	0x0a, 0x07, 0x44, 0x56, 0x50, 0x61, 0x69, 0x72, 0x73, 0x12, 0x3a, 0x0a, 0x05, 0x70, 0x61, 0x69,
	0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6