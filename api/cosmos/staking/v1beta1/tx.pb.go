...
type MsgCreateValidator struct {
	...
	Value            v1beta1.Coin `protobuf:"bytes,7,opt,name=value,proto3" json:"value"`
}
...
type MsgBeginRedelegate struct {
	...
	Amount              v1beta1.Coin `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount"`
}
...
type MsgUndelegateResponse struct {
	...
	Amount v1beta1.Coin `protobuf:"bytes,2,opt,name=amount,proto3" json:"amount"`
}
...
func (m *MsgUndelegateResponse) GetAmount() v1beta1.Coin {
	if m != nil {
		return m.Amount
	}
	return v1beta1.Coin{}
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}
