...
var (
	...
	fd_CommitInfo_commit_hash protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_store_v2_commit_info_proto_init()
	md_CommitInfo = File_cosmos_store_v2_commit_info_proto.Messages().ByName("CommitInfo")
	...
	fd_CommitInfo_commit_hash = md_CommitInfo.Fields().ByName("commit_hash")
}
...
func (x *CommitInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_store_v2_commit_info_proto_msgTypes[0]
...
func (x *fastReflection_CommitInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.CommitHash) != 0 {
		...
		if !f(fd_CommitInfo_commit_hash, value) {
			return
		}
	}
}
...
func (x *fastReflection_CommitInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.store.v2.CommitInfo.version":
		return x.Version != int64(0)
	case "cosmos.store.v2.CommitInfo.store_infos":
		return len(x.StoreInfos) != 0
	case "cosmos.store.v2.CommitInfo.timestamp":
		return x.Timestamp != nil
	case "cosmos.store.v2.CommitInfo.commit_hash":
		return len(x.CommitHash) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.CommitInfo"))
		}
		panic(fmt.Errorf("message cosmos.store.v2.CommitInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommitInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.store.v2.CommitInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommitInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.store.v2.CommitInfo.version":
		panic(fmt.Errorf("field version of message cosmos.store.v2.CommitInfo is not mutable"))
	case "cosmos.store.v2.CommitInfo.commit_hash":
		panic(fmt.Errorf("field commit_hash of message cosmos.store.v2.CommitInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.CommitInfo"))
		}
...
func (x *fastReflection_CommitInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.store.v2.CommitInfo", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_StoreInfo_structure protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_store_v2_commit_info_proto_init()
	md_StoreInfo = File_cosmos_store_v2_commit_info_proto.Messages().ByName("StoreInfo")
	fd_StoreInfo_name = md_StoreInfo.Fields().ByName("name")
	fd_StoreInfo_commit_id = md_StoreInfo.Fields().ByName("commit_id")
	fd_StoreInfo_structure = md_StoreInfo.Fields().ByName("structure")
}
...
func (x *StoreInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_store_v2_commit_info_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_StoreInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Structure != "" {
		value := protoreflect.ValueOfString(x.Structure)
		if !f(fd_StoreInfo_structure, value) {
			return
		}
	}
}
...
func (x *fastReflection_StoreInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.store.v2.StoreInfo.name":
		return x.Name != ""
	case "cosmos.store.v2.StoreInfo.commit_id":
		return x.CommitId != nil
	case "cosmos.store.v2.StoreInfo.structure":
		return x.Structure != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.StoreInfo"))
		}
		panic(fmt.Errorf("message cosmos.store.v2.StoreInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoreInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.store.v2.StoreInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoreInfo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.store.v2.StoreInfo.structure":
		x.Structure = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.StoreInfo"))
		}
...
func (x *fastReflection_StoreInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.store.v2.StoreInfo.name":
		panic(fmt.Errorf("field name of message cosmos.store.v2.StoreInfo is not mutable"))
	case "cosmos.store.v2.StoreInfo.structure":
		panic(fmt.Errorf("field structure of message cosmos.store.v2.StoreInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.StoreInfo"))
		}
...
func (x *fastReflection_StoreInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.store.v2.StoreInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_StoreInfo) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Structure) > 0 {
			i -= len(x.Structure)
			copy(dAtA[i:], x.Structure)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Structure)))
			i--
			dAtA[i] = 0x1a
		}
		if x.CommitId != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				x.Structure = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func init() {
	file_cosmos_store_v2_commit_info_proto_init()
	md_CommitID = File_cosmos_store_v2_commit_info_proto.Messages().ByName("CommitID")
...
func (x *CommitID) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_store_v2_commit_info_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CommitID) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.store.v2.CommitID.version":
		return x.Version != int64(0)
	case "cosmos.store.v2.CommitID.hash":
		return len(x.Hash) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.CommitID"))
		}
		panic(fmt.Errorf("message cosmos.store.v2.CommitID does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommitID) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.store.v2.CommitID does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommitID) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.store.v2.CommitID.version":
		panic(fmt.Errorf("field version of message cosmos.store.v2.CommitID is not mutable"))
	case "cosmos.store.v2.CommitID.hash":
		panic(fmt.Errorf("field hash of message cosmos.store.v2.CommitID is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.store.v2.CommitID"))
		}
...
func (x *fastReflection_CommitID) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.store.v2.CommitID", d.FullName()))
	}
	panic("unreachable")
}
...
func (*CommitInfo) Descriptor() ([]byte, []int) {
	return file_cosmos_store_v2_commit_info_proto_rawDescGZIP(), []int{0}
}
...
func (*StoreInfo) Descriptor() ([]byte, []int) {
	return file_cosmos_store_v2_commit_info_proto_rawDescGZIP(), []int{1}
}
...
func (*CommitID) Descriptor() ([]byte, []int) {
	return file_cosmos_store_v2_commit_info_proto_rawDescGZIP(), []int{2}
}
...
var file_cosmos_store_v2_commit_info_proto_rawDesc = []byte{
	,
	...
	,
}

var (
	file_cosmos_store_v2_commit_info_proto_rawDescOnce sync.Once
	file_cosmos_store_v2_commit_info_proto_rawDescData = file_cosmos_store_v2_commit_info_proto_rawDesc
)

func file_cosmos_store_v2_commit_info_proto_rawDescGZIP() []byte {
	file_cosmos_store_v2_commit_info_proto_rawDescOnce.Do(func() {
		file_cosmos_store_v2_commit_info_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_store_v2_commit_info_proto_rawDescData)
	})
	return file_cosmos_store_v2_commit_info_proto_rawDescData
}

var file_cosmos_store_v2_commit_info_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_cosmos_store_v2_commit_info_proto_goTypes = []interface{}{
	(*CommitInfo)(nil),            // 0: cosmos.store.v2.CommitInfo
	(*StoreInfo)(nil),             // 1: cosmos.store.v2.StoreInfo
	(*CommitID)(nil),              // 2: cosmos.store.v2.CommitID
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_cosmos_store_v2_commit_info_proto_depIdxs = []int32{
	1, // 0: cosmos.store.v2.CommitInfo.store_infos:type_name -> cosmos.store.v2.StoreInfo
	3, // 1: cosmos.store.v2.CommitInfo.timestamp:type_name -> google.protobuf.Timestamp
	2, // 2: cosmos.store.v2.StoreInfo.commit_id:type_name -> cosmos.store.v2.CommitID
...
func init() { file_cosmos_store_v2_commit_info_proto_init() }
func file_cosmos_store_v2_commit_info_proto_init() {
	if File_cosmos_store_v2_commit_info_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_store_v2_commit_info_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_store_v2_commit_info_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_store_v2_commit_info_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_store_v2_commit_info_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_store_v2_commit_info_proto_goTypes,
	...
	File_cosmos_store_v2_commit_info_proto = out.File
	file_cosmos_store_v2_commit_info_proto_rawDesc = nil
	file_cosmos_store_v2_commit_info_proto_goTypes = nil
	file_cosmos_store_v2_commit_info_proto_depIdxs = nil
}
