...
var _ protoreflect.List = (*_ListenDeliverBlockRequest_1_list)(nil)

type _ListenDeliverBlockRequest_1_list struct {
	list *[]*Transaction
}

func (x *_ListenDeliverBlockRequest_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_ListenDeliverBlockRequest_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_ListenDeliverBlockRequest_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Transaction)
	(*x.list)[i] = concreteValue
}

func (x *_ListenDeliverBlockRequest_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Transaction)
	*x.list = append(*x.list, concreteValue)
}

func (x *_ListenDeliverBlockRequest_1_list) AppendMutable() protoreflect.Value {
	v := new(Transaction)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ListenDeliverBlockRequest_1_list) Truncate(n int) {
...
func (x *_ListenDeliverBlockRequest_1_list) NewElement() protoreflect.Value {
	v := new(Transaction)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_ListenDeliverBlockRequest_1_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_ListenDeliverBlockRequest_height               protoreflect.FieldDescriptor
	fd_ListenDeliverBlockRequest_events               protoreflect.FieldDescriptor
	fd_ListenDeliverBlockRequest_hash                 protoreflect.FieldDescriptor
	fd_ListenDeliverBlockRequest_time                 protoreflect.FieldDescriptor
	fd_ListenDeliverBlockRequest_next_validators_hash protoreflect.FieldDescriptor
	fd_ListenDeliverBlockRequest_proposer_address     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ListenDeliverBlockRequest_height = md_ListenDeliverBlockRequest.Fields().ByName("height")
	fd_ListenDeliverBlockRequest_events = md_ListenDeliverBlockRequest.Fields().ByName("events")
	fd_ListenDeliverBlockRequest_hash = md_ListenDeliverBlockRequest.Fields().ByName("hash")
	fd_ListenDeliverBlockRequest_time = md_ListenDeliverBlockRequest.Fields().ByName("time")
	fd_ListenDeliverBlockRequest_next_validators_hash = md_ListenDeliverBlockRequest.Fields().ByName("next_validators_hash")
	fd_ListenDeliverBlockRequest_proposer_address = md_ListenDeliverBlockRequest.Fields().ByName("proposer_address")
}
...
func (x *fastReflection_ListenDeliverBlockRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Txs) != 0 {
		value := protoreflect.ValueOfList(&_ListenDeliverBlockRequest_1_list{list: &x.Txs})
	...
	if x.Height != int64(0) {
		...
		if !f(fd_ListenDeliverBlockRequest_height, value) {
			return
		}
	}
	if len(x.Events) != 0 {
...
func (x *fastReflection_ListenDeliverBlockRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.txs":
		return len(x.Txs) != 0
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.height":
		return x.Height != int64(0)
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.events":
		return len(x.Events) != 0
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.hash":
		return len(x.Hash) != 0
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.time":
		return x.Time != nil
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.next_validators_hash":
		return len(x.NextValidatorsHash) != 0
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.proposer_address":
...
func (x *fastReflection_ListenDeliverBlockRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.txs":
		if len(x.Txs) == 0 {
			return protoreflect.ValueOfList(&_ListenDeliverBlockRequest_1_list{})
		}
		listValue := &_ListenDeliverBlockRequest_1_list{list: &x.Txs}
...
func (x *fastReflection_ListenDeliverBlockRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.txs":
		lv := value.List()
		clv := lv.(*_ListenDeliverBlockRequest_1_list)
		x.Txs = *clv.list
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.height":
		x.Height = value.Int()
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.events":
...
func (x *fastReflection_ListenDeliverBlockRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.txs":
		...
		value := &_ListenDeliverBlockRequest_1_list{list: &x.Txs}
	...
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.height":
		panic(fmt.Errorf("field height of message cosmos.streaming.v1.ListenDeliverBlockRequest is not mutable"))
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.hash":
		panic(fmt.Errorf("field hash of message cosmos.streaming.v1.ListenDeliverBlockRequest is not mutable"))
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.next_validators_hash":
		panic(fmt.Errorf("field next_validators_hash of message cosmos.streaming.v1.ListenDeliverBlockRequest is not mutable"))
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.proposer_address":
		panic(fmt.Errorf("field proposer_address of message cosmos.streaming.v1.ListenDeliverBlockRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.streaming.v1.ListenDeliverBlockRequest"))
		}
...
func (x *fastReflection_ListenDeliverBlockRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.txs":
		list := []*Transaction{}
		return protoreflect.ValueOfList(&_ListenDeliverBlockRequest_1_list{list: &list})
	case "cosmos.streaming.v1.ListenDeliverBlockRequest.height":
...
func (x *fastReflection_StoreKVPair) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.streaming.v1.StoreKVPair.store_key":
		return x.StoreKey != ""
...
func (x *fastReflection_StoreKVPair) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.streaming.v1.StoreKVPair.store_key":
		panic(fmt.Errorf("field store_key of message cosmos.streaming.v1.StoreKVPair is not mutable"))
	case "cosmos.streaming.v1.StoreKVPair.delete":
...
func (x *ListenDeliverBlockRequest) GetHeight() int64 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *ListenDeliverBlockRequest) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *ListenDeliverBlockRequest) GetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *ListenDeliverBlockRequest) GetNextValidatorsHash() []byte {
	if x != nil {
...
func (x *ListenDeliverBlockRequest) GetProposerAddress() []byte {
	if x != nil {
...
var file_cosmos_streaming_v1_grpc_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x06, 0x20, 0x01,
	...
	0x65, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x0f, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x22, 0x1c, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x44, 0x65, 0x6c, 0x69, 0x76,
	0x65, 0x72, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x9a, 0x01, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x43,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x60, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
...
var file_cosmos_streaming_v1_grpc_proto_depIdxs = []int32{
	...
	9, // 2: cosmos.streaming.v1.ListenDeliverBlockRequest.time:type_name -> google.protobuf.Timestamp
	4, // 3: cosmos.streaming.v1.ListenStateChangesRequest.change_set:type_name -> cosmos.streaming.v1.StoreKVPair
	6, // 4: cosmos.streaming.v1.Event.attributes:type_name -> cosmos.streaming.v1.EventAttribute
	8, // 5: cosmos.streaming.v1.Transaction.result:type_name -> cosmos.streaming.v1.ExecTxResult
	5, // 6: cosmos.streaming.v1.ExecTxResult.events:type_name -> cosmos.streaming.v1.Event
	0, // 7: cosmos.streaming.v1.ListenerService.ListenDeliverBlock:input_type -> cosmos.streaming.v1.ListenDeliverBlockRequest
	2, // 8: cosmos.streaming.v1.ListenerService.ListenStateChanges:input_type -> cosmos.streaming.v1.ListenStateChangesRequest
	1, // 9: cosmos.streaming.v1.ListenerService.ListenDeliverBlock:output_type -> cosmos.streaming.v1.ListenDeliverBlockResponse
	3, // 10: cosmos.streaming.v1.ListenerService.ListenStateChanges:output_type -> cosmos.streaming.v1.ListenStateChangesResponse
