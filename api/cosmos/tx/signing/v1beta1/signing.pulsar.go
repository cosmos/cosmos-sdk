...
func (x *SignatureDescriptor_Data_Multi) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_tx_signing_v1beta1_signing_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func init() {
	file_cosmos_tx_signing_v1beta1_signing_proto_init()
	md_SignerData = File_cosmos_tx_signing_v1beta1_signing_proto.Messages().ByName("SignerData")
...
func (x *fastReflection_SignerData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.signing.v1beta1.SignerData.address":
		return x.Address != ""
	case "cosmos.tx.signing.v1beta1.SignerData.chain_id":
		return x.ChainId != ""
	case "cosmos.tx.signing.v1beta1.SignerData.account_number":
		return x.AccountNumber != uint64(0)
	case "cosmos.tx.signing.v1beta1.SignerData.sequence":
		return x.Sequence != uint64(0)
	case "cosmos.tx.signing.v1beta1.SignerData.pub_key":
		return x.PubKey != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.signing.v1beta1.SignerData"))
		}
		panic(fmt.Errorf("message cosmos.tx.signing.v1beta1.SignerData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SignerData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.tx.signing.v1beta1.SignerData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SignerData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.tx.signing.v1beta1.SignerData.address":
		panic(fmt.Errorf("field address of message cosmos.tx.signing.v1beta1.SignerData is not mutable"))
	case "cosmos.tx.signing.v1beta1.SignerData.chain_id":
		panic(fmt.Errorf("field chain_id of message cosmos.tx.signing.v1beta1.SignerData is not mutable"))
	case "cosmos.tx.signing.v1beta1.SignerData.account_number":
		panic(fmt.Errorf("field account_number of message cosmos.tx.signing.v1beta1.SignerData is not mutable"))
	case "cosmos.tx.signing.v1beta1.SignerData.sequence":
		panic(fmt.Errorf("field sequence of message cosmos.tx.signing.v1beta1.SignerData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.signing.v1beta1.SignerData"))
		}
...
func (x *fastReflection_SignerData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.signing.v1beta1.SignerData", d.FullName()))
	}
	panic("unreachable")
}
...
func (*SignerData) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_signing_v1beta1_signing_proto_rawDescGZIP(), []int{2}
}
...
var file_cosmos_tx_signing_v1beta1_signing_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x66, 0x0a, 0x14, 0x53, 0x69, 0x67,
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72,
	0x73, 0x12, 0x4e, 0x0a, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74,
	...
	,
	...
	0x72, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x48, 0x00, 0x52, 0x05,
	0x6d, 0x75, 0x6c, 0x74, 0x69, 0x1a, 0x5f, 0x0a, 0x06, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x12,
	...
	,
	...
	0x67, 0x6e, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x53, 0x69,
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f,
	0x72, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72,
	0x65, 0x73, 0x42, 0x05, 0x0a, 0x03, 0x73, 0x75, 0x6d, 0x22, 0xc6, 0x01, 0x0a, 0x0a, 0x53, 0x69,
	0x67, 0x6e, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2b, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x11, 0xd2, 0xb4, 0x2d, 0x0d, 0x41,
	...
	0x6e, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x07, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x06, 0x70, 0x75, 0x62, 0x4b,
	0x65, 0x79, 0x2a, 0xa5, 0x01, 0x0a, 0x08, 0x53, 0x69, 0x67, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x12,
	...
	0x58, 0x54, 0x55, 0x41, 0x4c, 0x10, 0x02, 0x12, 0x18, 0x0a, 0x14, 0x53, 0x49, 0x47, 0x4e, 0x5f,
	0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x44, 0x49, 0x52, 0x45, 0x43, 0x54, 0x5f, 0x41, 0x55, 0x58, 0x10,
	0x03, 0x12, 0x1f, 0x0a, 0x1b, 0x53, 0x49, 0x47, 0x4e, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x4c,
	0x45, 0x47, 0x41, 0x43, 0x59, 0x5f, 0x41, 0x4d, 0x49, 0x4e, 0x4f, 0x5f, 0x4a, 0x53, 0x4f, 0x4e,
	0x10, 0x7f, 0x12, 0x16, 0x0a, 0x11, 0x53, 0x49, 0x47, 0x4e, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f,
	0x45, 0x49, 0x50, 0x5f, 0x31, 0x39, 0x31, 0x10, 0xbf, 0x01, 0x42, 0xef, 0x01, 0x0a, 0x1d, 0x63,
...
var file_cosmos_tx_signing_v1beta1_signing_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cosmos_tx_signing_v1beta1_signing_proto_goTypes = []interface{}{
	...
	(*SignerData)(nil),                      // 3: cosmos.tx.signing.v1beta1.SignerData
	(*SignatureDescriptor_Data)(nil),        // 4: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data
	(*SignatureDescriptor_Data_Single)(nil), // 5: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single
	(*SignatureDescriptor_Data_Multi)(nil),  // 6: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi
	(*anypb.Any)(nil),                       // 7: google.protobuf.Any
	(*v1beta1.CompactBitArray)(nil),         // 8: cosmos.crypto.multisig.v1beta1.CompactBitArray
}
var file_cosmos_tx_signing_v1beta1_signing_proto_depIdxs = []int32{
	...
	7, // 1: cosmos.tx.signing.v1beta1.SignatureDescriptor.public_key:type_name -> google.protobuf.Any
	4, // 2: cosmos.tx.signing.v1beta1.SignatureDescriptor.data:type_name -> cosmos.tx.signing.v1beta1.SignatureDescriptor.Data
	7, // 3: cosmos.tx.signing.v1beta1.SignerData.pub_key:type_name -> google.protobuf.Any
	5, // 4: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.single:type_name -> cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single
	6, // 5: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.multi:type_name -> cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi
	0, // 6: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single.mode:type_name -> cosmos.tx.signing.v1beta1.SignMode
	8, // 7: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi.bitarray:type_name -> cosmos.crypto.multisig.v1beta1.CompactBitArray
	4, // 8: cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi.signatures:type_name -> cosmos.tx.signing.v1beta1.SignatureDescriptor.Data
...
func file_cosmos_tx_signing_v1beta1_signing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_tx_signing_v1beta1_signing_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cosmos_tx_signing_v1beta1_signing_proto_msgTypes[3].OneofWrappers = []interface{}{
