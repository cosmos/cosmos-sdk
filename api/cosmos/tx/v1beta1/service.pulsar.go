...
var (
	...
	fd_SimulateRequest_mode     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_SimulateRequest_mode = md_SimulateRequest.Fields().ByName("mode")
}
...
func (x *fastReflection_SimulateRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Mode != 0 {
		value := protoreflect.ValueOfEnum((protoreflect.EnumNumber)(x.Mode))
		if !f(fd_SimulateRequest_mode, value) {
			return
		}
	}
}
...
func (x *fastReflection_SimulateRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.tx.v1beta1.SimulateRequest.tx_bytes":
		return len(x.TxBytes) != 0
	case "cosmos.tx.v1beta1.SimulateRequest.mode":
		return x.Mode != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_SimulateRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.tx.v1beta1.SimulateRequest.tx_bytes":
		x.TxBytes = value.Bytes()
	case "cosmos.tx.v1beta1.SimulateRequest.mode":
		x.Mode = (SimulateMode)(value.Enum())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.SimulateRequest"))
		}
...
func (x *fastReflection_SimulateRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.tx.v1beta1.SimulateRequest.mode":
		panic(fmt.Errorf("field mode of message cosmos.tx.v1beta1.SimulateRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.SimulateRequest"))
		}
		...
		for iNdEx < l {
			...
			case 3:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.Mode |= SimulateMode(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
var (
	...
	fd_SimulateResponse_message  protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_SimulateResponse_message = md_SimulateResponse.Fields().ByName("message")
}
...
func (x *fastReflection_SimulateResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Message != "" {
		...
		if !f(fd_SimulateResponse_message, value) {
			return
		}
	}
}
...
func (x *fastReflection_SimulateResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.tx.v1beta1.SimulateResponse.result":
		return x.Result != nil
	case "cosmos.tx.v1beta1.SimulateResponse.message":
		return x.Message != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_SimulateResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.tx.v1beta1.SimulateResponse.message":
		panic(fmt.Errorf("field message of message cosmos.tx.v1beta1.SimulateResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.SimulateResponse"))
		}
...
// SimulateMode specifies the mode for the TxService.Simulate RPC method.
type SimulateMode int32

const (
	// Default mode of simulate, which returns
	// the result of the simulation or error
	SimulateMode_WITH_RESULT SimulateMode = 0
	// Returns the gas used for the transaction
	// even when an error is produced
	SimulateMode_GAS_USED SimulateMode = 1
)

// Enum value maps for SimulateMode.
var (
	SimulateMode_name = map[int32]string{
		0: "WITH_RESULT",
		1: "GAS_USED",
	}
	SimulateMode_value = map[string]int32{
		"WITH_RESULT": 0,
		"GAS_USED":    1,
	}
)

func (x SimulateMode) Enum() *SimulateMode {
	p := new(SimulateMode)
	*p = x
	return p
}

func (x SimulateMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SimulateMode) Descriptor() protoreflect.EnumDescriptor {
	return file_cosmos_tx_v1beta1_service_proto_enumTypes[2].Descriptor()
}

func (SimulateMode) Type() protoreflect.EnumType {
	return &file_cosmos_tx_v1beta1_service_proto_enumTypes[2]
}

func (x SimulateMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SimulateMode.Descriptor instead.
func (SimulateMode) EnumDescriptor() ([]byte, []int) {
...
type SimulateRequest struct {
	...
	Mode SimulateMode `protobuf:"varint,3,opt,name=mode,proto3,enum=cosmos.tx.v1beta1.SimulateMode" json:"mode,omitempty"`
}
...
func (x *SimulateRequest) GetMode() SimulateMode {
	if x != nil {
		return x.Mode
	}
	return SimulateMode_WITH_RESULT
}
...
var file_cosmos_tx_v1beta1_service_proto_rawDesc = []byte{
	...
	,
	...
	0x42, 0x59, 0x5f, 0x44, 0x45, 0x53, 0x43, 0x10, 0x02, 0x2a, 0x80, 0x01, 0x0a, 0x0d, 0x42, 0x72,
	0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x1e, 0x0a, 0x1a, 0x42,
	0x52, 0x4f, 0x41, 0x44, 0x43, 0x41, 0x53, 0x54, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x55, 0x4e,
	0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1c, 0x0a, 0x14, 0x42,
	0x52, 0x4f, 0x41, 0x44, 0x43, 0x41, 0x53, 0x54, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x42, 0x4c,
	0x4f, 0x43, 0x4b, 0x10, 0x01, 0x1a, 0x02, 0x08, 0x01, 0x12, 0x17, 0x0a, 0x13, 0x42, 0x52, 0x4f,
	...
	0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x41, 0x53, 0x59, 0x4e, 0x43, 0x10, 0x03, 0x2a, 0x2d, 0x0a, 0x0c,
	0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x0f, 0x0a, 0x0b,
	0x57, 0x49, 0x54, 0x48, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x00, 0x12, 0x0c, 0x0a,
	0x08, 0x47, 0x41, 0x53, 0x5f, 0x55, 0x53, 0x45, 0x44, 0x10, 0x01, 0x32, 0x92, 0x05, 0x0a, 0x07,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x7b, 0x0a, 0x08, 0x53, 0x69, 0x6d, 0x75, 0x6c,
	0x61, 0x74, 0x65, 0x12, 0x22, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e,
	...
	0x6c, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x26, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x20, 0x22, 0x1b, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x74, 0x78,
	0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x73, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74,
	0x65, 0x3a, 0x01, 0x2a, 0x12, 0x71, 0x0a, 0x05, 0x47, 0x65, 0x74, 0x54, 0x78, 0x12, 0x1f, 0x2e,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20,
	...
	0x2f, 0x7b, 0x68, 0x61, 0x73, 0x68, 0x7d, 0x12, 0x7f, 0x0a, 0x0b, 0x42, 0x72, 0x6f, 0x61, 0x64,
	...
	0x31, 0x2f, 0x74, 0x78, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x7c, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x54,
	...
	,
}
...
var file_cosmos_tx_v1beta1_service_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_cosmos_tx_v1beta1_service_proto_goTypes = []interface{}{
	...
	(SimulateMode)(0),               // 2: cosmos.tx.v1beta1.SimulateMode
	(*GetTxsEventRequest)(nil),      // 3: cosmos.tx.v1beta1.GetTxsEventRequest
	(*GetTxsEventResponse)(nil),     // 4: cosmos.tx.v1beta1.GetTxsEventResponse
	(*BroadcastTxRequest)(nil),      // 5: cosmos.tx.v1beta1.BroadcastTxRequest
	(*BroadcastTxResponse)(nil),     // 6: cosmos.tx.v1beta1.BroadcastTxResponse
	(*SimulateRequest)(nil),         // 7: cosmos.tx.v1beta1.SimulateRequest
	(*SimulateResponse)(nil),        // 8: cosmos.tx.v1beta1.SimulateResponse
	(*GetTxRequest)(nil),            // 9: cosmos.tx.v1beta1.GetTxRequest
	(*GetTxResponse)(nil),           // 10: cosmos.tx.v1beta1.GetTxResponse
	(*GetBlockWithTxsRequest)(nil),  // 11: cosmos.tx.v1beta1.GetBlockWithTxsRequest
	(*GetBlockWithTxsResponse)(nil), // 12: cosmos.tx.v1beta1.GetBlockWithTxsResponse
	(*v1beta1.PageRequest)(nil),     // 13: cosmos.base.query.v1beta1.PageRequest
	(*Tx)(nil),                      // 14: cosmos.tx.v1beta1.Tx
	(*v1beta11.TxResponse)(nil),     // 15: cosmos.base.abci.v1beta1.TxResponse
	(*v1beta1.PageResponse)(nil),    // 16: cosmos.base.query.v1beta1.PageResponse
	(*v1beta11.GasInfo)(nil),        // 17: cosmos.base.abci.v1beta1.GasInfo
	(*v1beta11.Result)(nil),         // 18: cosmos.base.abci.v1beta1.Result
...
var file_cosmos_tx_v1beta1_service_proto_depIdxs = []int32{
	13, // 0: cosmos.tx.v1beta1.GetTxsEventRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	0,  // 1: cosmos.tx.v1beta1.GetTxsEventRequest.order_by:type_name -> cosmos.tx.v1beta1.OrderBy
	14, // 2: cosmos.tx.v1beta1.GetTxsEventResponse.txs:type_name -> cosmos.tx.v1beta1.Tx
	15, // 3: cosmos.tx.v1beta1.GetTxsEventResponse.tx_responses:type_name -> cosmos.base.abci.v1beta1.TxResponse
	16, // 4: cosmos.tx.v1beta1.GetTxsEventResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	1,  // 5: cosmos.tx.v1beta1.BroadcastTxRequest.mode:type_name -> cosmos.tx.v1beta1.BroadcastMode
	15, // 6: cosmos.tx.v1beta1.BroadcastTxResponse.tx_response:type_name -> cosmos.base.abci.v1beta1.TxResponse
	14, // 7: cosmos.tx.v1beta1.SimulateRequest.tx:type_name -> cosmos.tx.v1beta1.Tx
	2,  // 8: cosmos.tx.v1beta1.SimulateRequest.mode:type_name -> cosmos.tx.v1beta1.SimulateMode
	17, // 9: cosmos.tx.v1beta1.SimulateResponse.gas_info:type_name -> cosmos.base.abci.v1beta1.GasInfo
	18, // 10: cosmos.tx.v1beta1.SimulateResponse.result:type_name -> cosmos.base.abci.v1beta1.Result
	14, // 11: cosmos.tx.v1beta1.GetTxResponse.tx:type_name -> cosmos.tx.v1beta1.Tx
	15, // 12: cosmos.tx.v1beta1.GetTxResponse.tx_response:type_name -> cosmos.base.abci.v1beta1.TxResponse
	13, // 13: cosmos.tx.v1beta1.GetBlockWithTxsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	14, // 14: cosmos.tx.v1beta1.GetBlockWithTxsResponse.txs:type_name -> cosmos.tx.v1beta1.Tx
	19, // 15: cosmos.tx.v1beta1.GetBlockWithTxsResponse.block_id:type_name -> tendermint.types.BlockID
	20, // 16: cosmos.tx.v1beta1.GetBlockWithTxsResponse.block:type_name -> tendermint.types.Block
	16, // 17: cosmos.tx.v1beta1.GetBlockWithTxsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	7,  // 18: cosmos.tx.v1beta1.Service.Simulate:input_type -> cosmos.tx.v1beta1.SimulateRequest
	9,  // 19: cosmos.tx.v1beta1.Service.GetTx:input_type -> cosmos.tx.v1beta1.GetTxRequest
	5,  // 20: cosmos.tx.v1beta1.Service.BroadcastTx:input_type -> cosmos.tx.v1beta1.BroadcastTxRequest
	3,  // 21: cosmos.tx.v1beta1.Service.GetTxsEvent:input_type -> cosmos.tx.v1beta1.GetTxsEventRequest
	11, // 22: cosmos.tx.v1beta1.Service.GetBlockWithTxs:input_type -> cosmos.tx.v1beta1.GetBlockWithTxsRequest
	8,  // 23: cosmos.tx.v1beta1.Service.Simulate:output_type -> cosmos.tx.v1beta1.SimulateResponse
	10, // 24: cosmos.tx.v1beta1.Service.GetTx:output_type -> cosmos.tx.v1beta1.GetTxResponse
	6,  // 25: cosmos.tx.v1beta1.Service.BroadcastTx:output_type -> cosmos.tx.v1beta1.BroadcastTxResponse
	4,  // 26: cosmos.tx.v1beta1.Service.GetTxsEvent:output_type -> cosmos.tx.v1beta1.GetTxsEventResponse
	12, // 27: cosmos.tx.v1beta1.Service.GetBlockWithTxs:output_type -> cosmos.tx.v1beta1.GetBlockWithTxsResponse
