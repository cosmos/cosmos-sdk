...
var (
	md_GetMemTxsRequest       protoreflect.MessageDescriptor
	fd_GetMemTxsRequest_limit protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_tx_v1beta1_service_proto_init()
	md_GetMemTxsRequest = File_cosmos_tx_v1beta1_service_proto.Messages().ByName("GetMemTxsRequest")
	fd_GetMemTxsRequest_limit = md_GetMemTxsRequest.Fields().ByName("limit")
}

var _ protoreflect.Message = (*fastReflection_GetMemTxsRequest)(nil)

type fastReflection_GetMemTxsRequest GetMemTxsRequest

func (x *GetMemTxsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_GetMemTxsRequest)(x)
}

func (x *GetMemTxsRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_GetMemTxsRequest_messageType fastReflection_GetMemTxsRequest_messageType
var _ protoreflect.MessageType = fastReflection_GetMemTxsRequest_messageType{}

type fastReflection_GetMemTxsRequest_messageType struct{}

func (x fastReflection_GetMemTxsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_GetMemTxsRequest)(nil)
}
func (x fastReflection_GetMemTxsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_GetMemTxsRequest)
}
func (x fastReflection_GetMemTxsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_GetMemTxsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_GetMemTxsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_GetMemTxsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_GetMemTxsRequest) Type() protoreflect.MessageType {
	return _fastReflection_GetMemTxsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_GetMemTxsRequest) New() protoreflect.Message {
	return new(fastReflection_GetMemTxsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_GetMemTxsRequest) Interface() protoreflect.ProtoMessage {
	return (*GetMemTxsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_GetMemTxsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Limit != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Limit)
		if !f(fd_GetMemTxsRequest_limit, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_GetMemTxsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsRequest.limit":
		return x.Limit != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsRequest"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.GetMemTxsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsRequest.limit":
		x.Limit = uint64(0)
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_GetMemTxsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsRequest.limit":
		value := x.Limit
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.tx.v1beta1.GetMemTxsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsRequest.limit":
		x.Limit = value.Uint()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsRequest.limit":
		panic(fmt.Errorf("field limit of message cosmos.tx.v1beta1.GetMemTxsRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_GetMemTxsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsRequest.limit":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_GetMemTxsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.v1beta1.GetMemTxsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_GetMemTxsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_GetMemTxsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_GetMemTxsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*GetMemTxsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: GetMemTxsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: GetMemTxsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var _ protoreflect.List = (*_GetMemTxsResponse_4_list)(nil)

type _GetMemTxsResponse_4_list struct {
	list *[]*Tx
}

func (x *_GetMemTxsResponse_4_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_GetMemTxsResponse_4_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_GetMemTxsResponse_4_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Tx)
	(*x.list)[i] = concreteValue
}

func (x *_GetMemTxsResponse_4_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Tx)
	*x.list = append(*x.list, concreteValue)
}

func (x *_GetMemTxsResponse_4_list) AppendMutable() protoreflect.Value {
	v := new(Tx)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_GetMemTxsResponse_4_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_GetMemTxsResponse_4_list) NewElement() protoreflect.Value {
	v := new(Tx)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_GetMemTxsResponse_4_list) IsValid() bool {
	return x.list != nil
}

var (
	md_GetMemTxsResponse             protoreflect.MessageDescriptor
	fd_GetMemTxsResponse_count       protoreflect.FieldDescriptor
	fd_GetMemTxsResponse_total_count protoreflect.FieldDescriptor
	fd_GetMemTxsResponse_total_bytes protoreflect.FieldDescriptor
	fd_GetMemTxsResponse_txs         protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_tx_v1beta1_service_proto_init()
	md_GetMemTxsResponse = File_cosmos_tx_v1beta1_service_proto.Messages().ByName("GetMemTxsResponse")
	fd_GetMemTxsResponse_count = md_GetMemTxsResponse.Fields().ByName("count")
	fd_GetMemTxsResponse_total_count = md_GetMemTxsResponse.Fields().ByName("total_count")
	fd_GetMemTxsResponse_total_bytes = md_GetMemTxsResponse.Fields().ByName("total_bytes")
	fd_GetMemTxsResponse_txs = md_GetMemTxsResponse.Fields().ByName("txs")
}

var _ protoreflect.Message = (*fastReflection_GetMemTxsResponse)(nil)

type fastReflection_GetMemTxsResponse GetMemTxsResponse

func (x *GetMemTxsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_GetMemTxsResponse)(x)
}

func (x *GetMemTxsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_GetMemTxsResponse_messageType fastReflection_GetMemTxsResponse_messageType
var _ protoreflect.MessageType = fastReflection_GetMemTxsResponse_messageType{}

type fastReflection_GetMemTxsResponse_messageType struct{}

func (x fastReflection_GetMemTxsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_GetMemTxsResponse)(nil)
}
func (x fastReflection_GetMemTxsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_GetMemTxsResponse)
}
func (x fastReflection_GetMemTxsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_GetMemTxsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_GetMemTxsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_GetMemTxsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_GetMemTxsResponse) Type() protoreflect.MessageType {
	return _fastReflection_GetMemTxsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_GetMemTxsResponse) New() protoreflect.Message {
	return new(fastReflection_GetMemTxsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_GetMemTxsResponse) Interface() protoreflect.ProtoMessage {
	return (*GetMemTxsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_GetMemTxsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Count != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Count)
		if !f(fd_GetMemTxsResponse_count, value) {
			return
		}
	}
	if x.TotalCount != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalCount)
		if !f(fd_GetMemTxsResponse_total_count, value) {
			return
		}
	}
	if x.TotalBytes != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalBytes)
		if !f(fd_GetMemTxsResponse_total_bytes, value) {
			return
		}
	}
	if len(x.Txs) != 0 {
		value := protoreflect.ValueOfList(&_GetMemTxsResponse_4_list{list: &x.Txs})
		if !f(fd_GetMemTxsResponse_txs, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_GetMemTxsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsResponse.count":
		return x.Count != uint64(0)
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_count":
		return x.TotalCount != uint64(0)
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_bytes":
		return x.TotalBytes != uint64(0)
	case "cosmos.tx.v1beta1.GetMemTxsResponse.txs":
		return len(x.Txs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsResponse"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.GetMemTxsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsResponse.count":
		x.Count = uint64(0)
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_count":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_GetMemTxsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsResponse.count":
		value := x.Count
		return protoreflect.ValueOfUint64(value)
	...
	case "cosmos.tx.v1beta1.GetMemTxsResponse.txs":
		if len(x.Txs) == 0 {
			return protoreflect.ValueOfList(&_GetMemTxsResponse_4_list{})
		}
		listValue := &_GetMemTxsResponse_4_list{list: &x.Txs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsResponse"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.GetMemTxsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsResponse.count":
		x.Count = value.Uint()
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_count":
	...
	case "cosmos.tx.v1beta1.GetMemTxsResponse.txs":
		lv := value.List()
		clv := lv.(*_GetMemTxsResponse_4_list)
		x.Txs = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsResponse.txs":
		if x.Txs == nil {
			x.Txs = []*Tx{}
		}
		value := &_GetMemTxsResponse_4_list{list: &x.Txs}
		return protoreflect.ValueOfList(value)
	case "cosmos.tx.v1beta1.GetMemTxsResponse.count":
		panic(fmt.Errorf("field count of message cosmos.tx.v1beta1.GetMemTxsResponse is not mutable"))
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_count":
		panic(fmt.Errorf("field total_count of message cosmos.tx.v1beta1.GetMemTxsResponse is not mutable"))
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_bytes":
		panic(fmt.Errorf("field total_bytes of message cosmos.tx.v1beta1.GetMemTxsResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_GetMemTxsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.GetMemTxsResponse.count":
		return protoreflect.ValueOfUint64(uint64(0))
	case "cosmos.tx.v1beta1.GetMemTxsResponse.total_count":
	...
	case "cosmos.tx.v1beta1.GetMemTxsResponse.txs":
		list := []*Tx{}
		return protoreflect.ValueOfList(&_GetMemTxsResponse_4_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.GetMemTxsResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_GetMemTxsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.v1beta1.GetMemTxsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_GetMemTxsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_GetMemTxsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_GetMemTxsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_GetMemTxsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*GetMemTxsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: GetMemTxsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: GetMemTxsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *TxDecodeAminoRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_tx_v1beta1_service_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *TxDecodeAminoResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_tx_v1beta1_service_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
// GetMemTxsRequest is the request type for the Service.GetMemTxs
// RPC method.
type GetMemTxsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// limit is the total number of results to be returned in the result page, max 100.
	// If left empty it will default to a value to be set, default 30.
	Limit uint64 `protobuf:"varint,1,opt,name=limit,proto3" json:"limit,omitempty"`
}

func (x *GetMemTxsRequest) Reset() {
	*x = GetMemTxsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_tx_v1beta1_service_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *GetMemTxsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMemTxsRequest) ProtoMessage() {}

// Deprecated: Use GetMemTxsRequest.ProtoReflect.Descriptor instead.
func (*GetMemTxsRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_service_proto_rawDescGZIP(), []int{8}
}

func (x *GetMemTxsRequest) GetLimit() uint64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
// GetMemTxsResponse is the response type for the Service.GetMemTxs
type GetMemTxsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetMemTxsResponse) Reset() {
	*x = GetMemTxsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_tx_v1beta1_service_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *GetMemTxsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMemTxsResponse) ProtoMessage() {}

// Deprecated: Use GetMemTxsResponse.ProtoReflect.Descriptor instead.
func (*GetMemTxsResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_service_proto_rawDescGZIP(), []int{9}
}

func (x *GetMemTxsResponse) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *GetMemTxsResponse) GetTotalCount() uint64 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
func (x *GetMemTxsResponse) GetTotalBytes() uint64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
func (x *GetMemTxsResponse) GetTxs() []*Tx {
	if x != nil {
		return x.Txs
	}
	return nil
...
func (*TxDecodeAminoRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_service_proto_rawDescGZIP(), []int{18}
}
...
func (*TxDecodeAminoResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_service_proto_rawDescGZIP(), []int{19}
}
...
var file_cosmos_tx_v1beta1_service_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x74, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x28, 0x0a, 0x10,
	0x47, 0x65, 0x74, 0x4d, 0x65, 0x6d, 0x54, 0x78, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x94, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x4d, 0x65,
	0x6d, 0x54, 0x78, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05,
	...
	0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42,
	0x79, 0x74, 0x65, 0x73, 0x12, 0x27, 0x0a, 0x03, 0x74, 0x78, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x54, 0x78, 0x52, 0x03, 0x74, 0x78, 0x73, 0x22, 0x78, 0x0a,
	0x16, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x57, 0x69, 0x74, 0x68, 0x54, 0x78, 0x73,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xf0, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x57, 0x69, 0x74, 0x68, 0x54, 0x78, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x54, 0x78, 0x52, 0x03, 0x74, 0x78, 0x73, 0x12, 0x34, 0x0a, 0x08,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19,
	...
	0x49, 0x64, 0x12, 0x2d, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2c, 0x0a, 0x0f, 0x54, 0x78,
	0x44, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x74, 0x78, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x07, 0x74, 0x78, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x39, 0x0a, 0x10, 0x54, 0x78, 0x44, 0x65,
	0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x02,
	...
	,
	...
	,
	...
	0x73, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x71, 0x0a, 0x05, 0x47, 0x65, 0x74, 0x54,
	0x78, 0x12, 0x1f, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x20, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e, 0x76,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x78, 0x52, 0x65, 0x73, 0x70,
	...
	,
	...
	0x74, 0x61, 0x31, 0x2f, 0x74, 0x78, 0x73, 0x12, 0x97, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x57, 0x69, 0x74, 0x68, 0x54, 0x78, 0x73, 0x12, 0x29, 0x2e, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e,
	...
	,
...
var file_cosmos_tx_v1beta1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_cosmos_tx_v1beta1_service_proto_goTypes = []interface{}{
	...
	(*GetMemTxsRequest)(nil),        // 10: cosmos.tx.v1beta1.GetMemTxsRequest
	(*GetMemTxsResponse)(nil),       // 11: cosmos.tx.v1beta1.GetMemTxsResponse
	(*GetBlockWithTxsRequest)(nil),  // 12: cosmos.tx.v1beta1.GetBlockWithTxsRequest
	(*GetBlockWithTxsResponse)(nil), // 13: cosmos.tx.v1beta1.GetBlockWithTxsResponse
	(*TxDecodeRequest)(nil),         // 14: cosmos.tx.v1beta1.TxDecodeRequest
	(*TxDecodeResponse)(nil),        // 15: cosmos.tx.v1beta1.TxDecodeResponse
	(*TxEncodeRequest)(nil),         // 16: cosmos.tx.v1beta1.TxEncodeRequest
	(*TxEncodeResponse)(nil),        // 17: cosmos.tx.v1beta1.TxEncodeResponse
	(*TxEncodeAminoRequest)(nil),    // 18: cosmos.tx.v1beta1.TxEncodeAminoRequest
	(*TxEncodeAminoResponse)(nil),   // 19: cosmos.tx.v1beta1.TxEncodeAminoResponse
	(*TxDecodeAminoRequest)(nil),    // 20: cosmos.tx.v1beta1.TxDecodeAminoRequest
	(*TxDecodeAminoResponse)(nil),   // 21: cosmos.tx.v1beta1.TxDecodeAminoResponse
	(*v1beta1.PageRequest)(nil),     // 22: cosmos.base.query.v1beta1.PageRequest
	(*Tx)(nil),                      // 23: cosmos.tx.v1beta1.Tx
	(*v1beta11.TxResponse)(nil),     // 24: cosmos.base.abci.v1beta1.TxResponse
	(*v1beta1.PageResponse)(nil),    // 25: cosmos.base.query.v1beta1.PageResponse
	(*v1beta11.GasInfo)(nil),        // 26: cosmos.base.abci.v1beta1.GasInfo
	(*v1beta11.Result)(nil),         // 27: cosmos.base.abci.v1beta1.Result
	(*types.BlockID)(nil),           // 28: tendermint.types.BlockID
	(*types.Block)(nil),             // 29: tendermint.types.Block
}
var file_cosmos_tx_v1beta1_service_proto_depIdxs = []int32{
	22, // 0: cosmos.tx.v1beta1.GetTxsEventRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	0,  // 1: cosmos.tx.v1beta1.GetTxsEventRequest.order_by:type_name -> cosmos.tx.v1beta1.OrderBy
	23, // 2: cosmos.tx.v1beta1.GetTxsEventResponse.txs:type_name -> cosmos.tx.v1beta1.Tx
	24, // 3: cosmos.tx.v1beta1.GetTxsEventResponse.tx_responses:type_name -> cosmos.base.abci.v1beta1.TxResponse
	25, // 4: cosmos.tx.v1beta1.GetTxsEventResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	1,  // 5: cosmos.tx.v1beta1.BroadcastTxRequest.mode:type_name -> cosmos.tx.v1beta1.BroadcastMode
	24, // 6: cosmos.tx.v1beta1.BroadcastTxResponse.tx_response:type_name -> cosmos.base.abci.v1beta1.TxResponse
	23, // 7: cosmos.tx.v1beta1.SimulateRequest.tx:type_name -> cosmos.tx.v1beta1.Tx
	26, // 8: cosmos.tx.v1beta1.SimulateResponse.gas_info:type_name -> cosmos.base.abci.v1beta1.GasInfo
	27, // 9: cosmos.tx.v1beta1.SimulateResponse.result:type_name -> cosmos.base.abci.v1beta1.Result
	23, // 10: cosmos.tx.v1beta1.GetTxResponse.tx:type_name -> cosmos.tx.v1beta1.Tx
	24, // 11: cosmos.tx.v1beta1.GetTxResponse.tx_response:type_name -> cosmos.base.abci.v1beta1.TxResponse
	23, // 12: cosmos.tx.v1beta1.GetMemTxsResponse.txs:type_name -> cosmos.tx.v1beta1.Tx
	22, // 13: cosmos.tx.v1beta1.GetBlockWithTxsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	23, // 14: cosmos.tx.v1beta1.GetBlockWithTxsResponse.txs:type_name -> cosmos.tx.v1beta1.Tx
	28, // 15: cosmos.tx.v1beta1.GetBlockWithTxsResponse.block_id:type_name -> tendermint.types.BlockID
	29, // 16: cosmos.tx.v1beta1.GetBlockWithTxsResponse.block:type_name -> tendermint.types.Block
	25, // 17: cosmos.tx.v1beta1.GetBlockWithTxsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	23, // 18: cosmos.tx.v1beta1.TxDecodeResponse.tx:type_name -> cosmos.tx.v1beta1.Tx
	23, // 19: cosmos.tx.v1beta1.TxEncodeRequest.tx:type_name -> cosmos.tx.v1beta1.Tx
	6,  // 20: cosmos.tx.v1beta1.Service.Simulate:input_type -> cosmos.tx.v1beta1.SimulateRequest
	8,  // 21: cosmos.tx.v1beta1.Service.GetTx:input_type -> cosmos.tx.v1beta1.GetTxRequest
	10, // 22: cosmos.tx.v1beta1.Service.GetMemTxs:input_type -> cosmos.tx.v1beta1.GetMemTxsRequest
	4,  // 23: cosmos.tx.v1beta1.Service.BroadcastTx:input_type -> cosmos.tx.v1beta1.BroadcastTxRequest
	2,  // 24: cosmos.tx.v1beta1.Service.GetTxsEvent:input_type -> cosmos.tx.v1beta1.GetTxsEventRequest
	12, // 25: cosmos.tx.v1beta1.Service.GetBlockWithTxs:input_type -> cosmos.tx.v1beta1.GetBlockWithTxsRequest
	14, // 26: cosmos.tx.v1beta1.Service.TxDecode:input_type -> cosmos.tx.v1beta1.TxDecodeRequest
	16, // 27: cosmos.tx.v1beta1.Service.TxEncode:input_type -> cosmos.tx.v1beta1.TxEncodeRequest
	18, // 28: cosmos.tx.v1beta1.Service.TxEncodeAmino:input_type -> cosmos.tx.v1beta1.TxEncodeAminoRequest
	20, // 29: cosmos.tx.v1beta1.Service.TxDecodeAmino:input_type -> cosmos.tx.v1beta1.TxDecodeAminoRequest
	7,  // 30: cosmos.tx.v1beta1.Service.Simulate:output_type -> cosmos.tx.v1beta1.SimulateResponse
	9,  // 31: cosmos.tx.v1beta1.Service.GetTx:output_type -> cosmos.tx.v1beta1.GetTxResponse
	11, // 32: cosmos.tx.v1beta1.Service.GetMemTxs:output_type -> cosmos.tx.v1beta1.GetMemTxsResponse
	5,  // 33: cosmos.tx.v1beta1.Service.BroadcastTx:output_type -> cosmos.tx.v1beta1.BroadcastTxResponse
	3,  // 34: cosmos.tx.v1beta1.Service.GetTxsEvent:output_type -> cosmos.tx.v1beta1.GetTxsEventResponse
	13, // 35: cosmos.tx.v1beta1.Service.GetBlockWithTxs:output_type -> cosmos.tx.v1beta1.GetBlockWithTxsResponse
	15, // 36: cosmos.tx.v1beta1.Service.TxDecode:output_type -> cosmos.tx.v1beta1.TxDecodeResponse
	17, // 37: cosmos.tx.v1beta1.Service.TxEncode:output_type -> cosmos.tx.v1beta1.TxEncodeResponse
	19, // 38: cosmos.tx.v1beta1.Service.TxEncodeAmino:output_type -> cosmos.tx.v1beta1.TxEncodeAminoResponse
	21, // 39: cosmos.tx.v1beta1.Service.TxDecodeAmino:output_type -> cosmos.tx.v1beta1.TxDecodeAminoResponse
...
func file_cosmos_tx_v1beta1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_tx_v1beta1_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetMemTxsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_tx_v1beta1_service_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_tx_v1beta1_service_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
