...
func (x *ModeInfo_Multi) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_tx_v1beta1_tx_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func init() {
	file_cosmos_tx_v1beta1_tx_proto_init()
	md_AminoSignFee = File_cosmos_tx_v1beta1_tx_proto.Messages().ByName("AminoSignFee")
...
func (x *fastReflection_AminoSignFee) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.AminoSignFee.amount":
		return len(x.Amount) != 0
	case "cosmos.tx.v1beta1.AminoSignFee.gas":
		return x.Gas != uint64(0)
	case "cosmos.tx.v1beta1.AminoSignFee.payer":
		return x.Payer != ""
	case "cosmos.tx.v1beta1.AminoSignFee.granter":
		return x.Granter != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.AminoSignFee"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.AminoSignFee does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AminoSignFee) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.tx.v1beta1.AminoSignFee does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AminoSignFee) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.tx.v1beta1.AminoSignFee.amount":
		...
		return protoreflect.ValueOfList(value)
	case "cosmos.tx.v1beta1.AminoSignFee.gas":
		panic(fmt.Errorf("field gas of message cosmos.tx.v1beta1.AminoSignFee is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignFee.payer":
		panic(fmt.Errorf("field payer of message cosmos.tx.v1beta1.AminoSignFee is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignFee.granter":
		panic(fmt.Errorf("field granter of message cosmos.tx.v1beta1.AminoSignFee is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.AminoSignFee"))
		}
...
func (x *fastReflection_AminoSignFee) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.v1beta1.AminoSignFee", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *_AminoSignDoc_7_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message AminoSignDoc at list field Msgs as it is not of Message kind"))
}
...
func init() {
	file_cosmos_tx_v1beta1_tx_proto_init()
	md_AminoSignDoc = File_cosmos_tx_v1beta1_tx_proto.Messages().ByName("AminoSignDoc")
...
func (x *fastReflection_AminoSignDoc) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Fee) != 0 {
		value := protoreflect.ValueOfBytes(x.Fee)
...
func (x *fastReflection_AminoSignDoc) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.AminoSignDoc.account_number":
		return x.AccountNumber != uint64(0)
	case "cosmos.tx.v1beta1.AminoSignDoc.sequence":
		return x.Sequence != uint64(0)
	case "cosmos.tx.v1beta1.AminoSignDoc.timeout_height":
		return x.TimeoutHeight != uint64(0)
	case "cosmos.tx.v1beta1.AminoSignDoc.chain_id":
		return x.ChainId != ""
	case "cosmos.tx.v1beta1.AminoSignDoc.memo":
		return x.Memo != ""
	case "cosmos.tx.v1beta1.AminoSignDoc.fee":
		return len(x.Fee) != 0
	case "cosmos.tx.v1beta1.AminoSignDoc.msgs":
		return len(x.Msgs) != 0
	case "cosmos.tx.v1beta1.AminoSignDoc.tip":
		return x.Tip != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.AminoSignDoc"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.AminoSignDoc does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AminoSignDoc) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.tx.v1beta1.AminoSignDoc does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AminoSignDoc) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.tx.v1beta1.AminoSignDoc.tip":
		...
		return protoreflect.ValueOfMessage(x.Tip.ProtoReflect())
	case "cosmos.tx.v1beta1.AminoSignDoc.account_number":
		panic(fmt.Errorf("field account_number of message cosmos.tx.v1beta1.AminoSignDoc is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignDoc.sequence":
		panic(fmt.Errorf("field sequence of message cosmos.tx.v1beta1.AminoSignDoc is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignDoc.timeout_height":
		panic(fmt.Errorf("field timeout_height of message cosmos.tx.v1beta1.AminoSignDoc is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignDoc.chain_id":
		panic(fmt.Errorf("field chain_id of message cosmos.tx.v1beta1.AminoSignDoc is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignDoc.memo":
		panic(fmt.Errorf("field memo of message cosmos.tx.v1beta1.AminoSignDoc is not mutable"))
	case "cosmos.tx.v1beta1.AminoSignDoc.fee":
		panic(fmt.Errorf("field fee of message cosmos.tx.v1beta1.AminoSignDoc is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.AminoSignDoc"))
		}
...
func (x *fastReflection_AminoSignDoc) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.v1beta1.AminoSignDoc", d.FullName()))
	}
	panic("unreachable")
}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				...
				x.Fee = append(x.Fee[:0], dAtA[iNdEx:postIndex]...)
				if x.Fee == nil {
					x.Fee = []byte{}
				}
				iNdEx = postIndex
			case 7:
				...
				x.Msgs = append(x.Msgs, make([]byte, postIndex-iNdEx))
				copy(x.Msgs[len(x.Msgs)-1], dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 8:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Tip", wireType)
...
func (x *AminoSignFee) GetAmount() []*v1beta12.Coin {
	if x != nil {
		return x.Amount
	}
	return nil
...
func (*AminoSignDoc) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_tx_proto_rawDescGZIP(), []int{12}
}
...
func (x *AminoSignDoc) GetFee() []byte {
	if x != nil {
		return x.Fee
	}
	return nil
...
func (x *AminoSignDoc) GetMsgs() [][]byte {
	if x != nil {
		return x.Msgs
	}
	return nil
...
func (x *AminoSignDoc) GetTip() *Tip {
	if x != nil {
		return x.Tip
	}
	return nil
...
var file_cosmos_tx_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x22, 0x83, 0x01, 0x0a, 0x0c, 0x41, 0x6d, 0x69, 0x6e, 0x6f, 0x53, 0x69, 0x67, 0x6e,
	0x46, 0x65, 0x65, 0x12, 0x31, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20,
	...
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x67, 0x61, 0x73, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x03, 0x67, 0x61, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x79, 0x65,
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x61, 0x79, 0x65, 0x72, 0x12, 0x18,
	0x0a, 0x07, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x72, 0x22, 0xf7, 0x01, 0x0a, 0x0c, 0x41, 0x6d, 0x69,
	0x6e, 0x6f, 0x53, 0x69, 0x67, 0x6e, 0x44, 0x6f, 0x63, 0x12, 0x25, 0x0a, 0x0e, 0x61, 0x63, 0x63,
	...
	,
	...
	0x2f, 0x74, 0x78, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x3b, 0x74, 0x78, 0x76, 0x31,
	0x62, 0x65, 0x74, 0x61, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x54, 0x58, 0xaa, 0x02, 0x11, 0x43, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x54, 0x78, 0x2e, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xca,
	0x02, 0x11, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5c, 0x54, 0x78, 0x5c, 0x56, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0xe2, 0x02, 0x1d, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5c, 0x54, 0x78, 0x5c,
	0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0xea, 0x02, 0x13, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x3a, 0x3a, 0x54, 0x78,
...
var file_cosmos_tx_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_cosmos_tx_v1beta1_tx_proto_goTypes = []interface{}{
	...
	(*AminoSignFee)(nil),             // 11: cosmos.tx.v1beta1.AminoSignFee
	(*AminoSignDoc)(nil),             // 12: cosmos.tx.v1beta1.AminoSignDoc
	(*ModeInfo_Single)(nil),          // 13: cosmos.tx.v1beta1.ModeInfo.Single
	(*ModeInfo_Multi)(nil),           // 14: cosmos.tx.v1beta1.ModeInfo.Multi
...
var file_cosmos_tx_v1beta1_tx_proto_depIdxs = []int32{
	...
	15, // 2: cosmos.tx.v1beta1.SignDocDirectAux.public_key:type_name -> google.protobuf.Any
	9,  // 3: cosmos.tx.v1beta1.SignDocDirectAux.tip:type_name -> cosmos.tx.v1beta1.Tip
	15, // 4: cosmos.tx.v1beta1.TxBody.messages:type_name -> google.protobuf.Any
	15, // 5: cosmos.tx.v1beta1.TxBody.extension_options:type_name -> google.protobuf.Any
	15, // 6: cosmos.tx.v1beta1.TxBody.non_critical_extension_options:type_name -> google.protobuf.Any
	...
	15, // 10: cosmos.tx.v1beta1.SignerInfo.public_key:type_name -> google.protobuf.Any
	7,  // 11: cosmos.tx.v1beta1.SignerInfo.mode_info:type_name -> cosmos.tx.v1beta1.ModeInfo
	13, // 12: cosmos.tx.v1beta1.ModeInfo.single:type_name -> cosmos.tx.v1beta1.ModeInfo.Single
	14, // 13: cosmos.tx.v1beta1.ModeInfo.multi:type_name -> cosmos.tx.v1beta1.ModeInfo.Multi
	16, // 14: cosmos.tx.v1beta1.Fee.amount:type_name -> cosmos.base.v1beta1.Coin
	16, // 15: cosmos.tx.v1beta1.Tip.amount:type_name -> cosmos.base.v1beta1.Coin
	3,  // 16: cosmos.tx.v1beta1.AuxSignerData.sign_doc:type_name -> cosmos.tx.v1beta1.SignDocDirectAux
	17, // 17: cosmos.tx.v1beta1.AuxSignerData.mode:type_name -> cosmos.tx.signing.v1beta1.SignMode
	16, // 18: cosmos.tx.v1beta1.AminoSignFee.amount:type_name -> cosmos.base.v1beta1.Coin
	9,  // 19: cosmos.tx.v1beta1.AminoSignDoc.tip:type_name -> cosmos.tx.v1beta1.Tip
	17, // 20: cosmos.tx.v1beta1.ModeInfo.Single.mode:type_name -> cosmos.tx.signing.v1beta1.SignMode
	18, // 21: cosmos.tx.v1beta1.ModeInfo.Multi.bitarray:type_name -> cosmos.crypto.multisig.v1beta1.CompactBitArray
	7,  // 22: cosmos.tx.v1beta1.ModeInfo.Multi.mode_infos:type_name -> cosmos.tx.v1beta1.ModeInfo
...
func file_cosmos_tx_v1beta1_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_tx_v1beta1_tx_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
