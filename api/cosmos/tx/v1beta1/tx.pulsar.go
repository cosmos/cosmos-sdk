...
var file_cosmos_tx_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0xc4, 0x01, 0x0a, 0x10,
	...
	0x63, 0x65, 0x22, 0x95, 0x02, 0x0a, 0x06, 0x54, 0x78, 0x42, 0x6f, 0x64, 0x79, 0x12, 0x30, 0x0a,
	...
	0x65, 0x6d, 0x6f, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x68,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x74, 0x69, 0x6d,
	0x65, 0x6f, 0x75, 0x74, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x42, 0x0a, 0x11, 0x65, 0x78,
	...
	,
	...
	0x74, 0x65, 0x72, 0x22, 0xce, 0x01, 0x0a, 0x0d, 0x41, 0x75, 0x78, 0x53, 0x69, 0x67, 0x6e, 0x65,
	...
	0x03, 0x73, 0x69, 0x67, 0x42, 0xb4, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73,
...
var file_cosmos_tx_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_cosmos_tx_v1beta1_tx_proto_goTypes = []interface{}{
	...
	(*AuxSignerData)(nil),            // 9: cosmos.tx.v1beta1.AuxSignerData
	(*ModeInfo_Single)(nil),          // 10: cosmos.tx.v1beta1.ModeInfo.Single
	(*ModeInfo_Multi)(nil),           // 11: cosmos.tx.v1beta1.ModeInfo.Multi
	(*anypb.Any)(nil),                // 12: google.protobuf.Any
	(*v1beta12.Coin)(nil),            // 13: cosmos.base.v1beta1.Coin
	(v1beta1.SignMode)(0),            // 14: cosmos.tx.signing.v1beta1.SignMode
	(*v1beta11.CompactBitArray)(nil), // 15: cosmos.crypto.multisig.v1beta1.CompactBitArray
}
var file_cosmos_tx_v1beta1_tx_proto_depIdxs = []int32{
	...
	12, // 2: cosmos.tx.v1beta1.SignDocDirectAux.public_key:type_name -> google.protobuf.Any
	12, // 3: cosmos.tx.v1beta1.TxBody.messages:type_name -> google.protobuf.Any
	12, // 4: cosmos.tx.v1beta1.TxBody.extension_options:type_name -> google.protobuf.Any
	12, // 5: cosmos.tx.v1beta1.TxBody.non_critical_extension_options:type_name -> google.protobuf.Any
	6,  // 6: cosmos.tx.v1beta1.AuthInfo.signer_infos:type_name -> cosmos.tx.v1beta1.SignerInfo
	8,  // 7: cosmos.tx.v1beta1.AuthInfo.fee:type_name -> cosmos.tx.v1beta1.Fee
	12, // 8: cosmos.tx.v1beta1.SignerInfo.public_key:type_name -> google.protobuf.Any
	7,  // 9: cosmos.tx.v1beta1.SignerInfo.mode_info:type_name -> cosmos.tx.v1beta1.ModeInfo
	10, // 10: cosmos.tx.v1beta1.ModeInfo.single:type_name -> cosmos.tx.v1beta1.ModeInfo.Single
	11, // 11: cosmos.tx.v1beta1.ModeInfo.multi:type_name -> cosmos.tx.v1beta1.ModeInfo.Multi
	13, // 12: cosmos.tx.v1beta1.Fee.amount:type_name -> cosmos.base.v1beta1.Coin
	3,  // 13: cosmos.tx.v1beta1.AuxSignerData.sign_doc:type_name -> cosmos.tx.v1beta1.SignDocDirectAux
	14, // 14: cosmos.tx.v1beta1.AuxSignerData.mode:type_name -> cosmos.tx.signing.v1beta1.SignMode
	14, // 15: cosmos.tx.v1beta1.ModeInfo.Single.mode:type_name -> cosmos.tx.signing.v1beta1.SignMode
	15, // 16: cosmos.tx.v1beta1.ModeInfo.Multi.bitarray:type_name -> cosmos.crypto.multisig.v1beta1.CompactBitArray
	7,  // 17: cosmos.tx.v1beta1.ModeInfo.Multi.mode_infos:type_name -> cosmos.tx.v1beta1.ModeInfo
