...
func (app *BaseApp) runTx(mode execMode, txBytes []byte) (gInfo sdk.GasInfo, result *sdk.Result, anteEvents []abci.Event, err error) {
	...
	if err == nil {
		result, err = app.runMsgs(runMsgCtx, msgs, msgsV2, mode, tx.IsNonAtomic())
	}
	if err == nil {
...
func (app *BaseApp) runMsgs(ctx sdk.Context, msgs []sdk.Msg, msgsV2 []protov2.Message, mode execMode, isNonAtomic bool) (*sdk.Result, error) {
