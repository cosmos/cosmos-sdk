...
// SetLazyLoading enables(false)/disables(true) IAVL store should be loaded lazily or not.
func SetLazyLoading(disable bool) func(*BaseApp) {
	return func(bapp *BaseApp) { bapp.cms.SetLazyLoading(disable) }
}
