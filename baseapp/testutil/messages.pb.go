...
func (*MsgCounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_dbb73e1df7c3a42e, []int{0}
}
...
func (*MsgCounter2) Descriptor() ([]byte, []int) {
	return fileDescriptor_dbb73e1df7c3a42e, []int{1}
}
...
func (*MsgCreateCounterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dbb73e1df7c3a42e, []int{2}
}
...
func (*MsgKeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_dbb73e1df7c3a42e, []int{3}
}
...
func (*MsgCreateKeyValueResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dbb73e1df7c3a42e, []int{4}
}
...
func init() {
	proto.RegisterType((*MsgCounter)(nil), "testpb.MsgCounter")
	proto.RegisterType((*MsgCounter2)(nil), "testpb.MsgCounter2")
	proto.RegisterType((*MsgCreateCounterResponse)(nil), "testpb.MsgCreateCounterResponse")
	proto.RegisterType((*MsgKeyValue)(nil), "testpb.MsgKeyValue")
	proto.RegisterType((*MsgCreateKeyValueResponse)(nil), "testpb.MsgCreateKeyValueResponse")
}

func init() { proto.RegisterFile("testpb/messages.proto", fileDescriptor_dbb73e1df7c3a42e) }

var fileDescriptor_dbb73e1df7c3a42e = []byte{
	// 379 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *counterClient) IncrementCounter(ctx context.Context, in *MsgCounter, opts ...grpc.CallOption) (*MsgCreateCounterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/testpb.Counter/IncrementCounter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Counter_IncrementCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testpb.Counter/IncrementCounter",
	}
...
var _Counter_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "testpb/messages.proto",
}
...
func (c *counter2Client) IncrementCounter(ctx context.Context, in *MsgCounter2, opts ...grpc.CallOption) (*MsgCreateCounterResponse, error) {
	out := new(MsgCreateCounterResponse)
	err := c.cc.Invoke(ctx, "/testpb.Counter2/IncrementCounter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Counter2_IncrementCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testpb.Counter2/IncrementCounter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *keyValueClient) Set(ctx context.Context, in *MsgKeyValue, opts ...grpc.CallOption) (*MsgCreateKeyValueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/testpb.KeyValue/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeyValue_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testpb.KeyValue/Set",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
