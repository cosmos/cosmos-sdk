...
func AddTxFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().String(FlagGas, "", fmt.Sprintf("gas limit to set per-transaction; set to %q to calculate sufficient gas automatically. Note: %q option doesn't always report accurate results. Use %q to adjust the result. Can be used instead of %q. (default %d)",
