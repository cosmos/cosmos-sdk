...
func getTransaction(t *testing.T, port string, hash string) sdk.ResponseFormat {
	var tx sdk.ResponseFormat
...
func getTransactions(t *testing.T, port string, tags ...string) []sdk.ResponseFormat {
...
func doBroadcast(t *testing.T, port string, msg auth.StdTx) sdk.ResponseFormat {
...
func doTransfer(t *testing.T, port, seed, name, memo, password string, addr sdk.AccAddress, fees sdk.Coins) (receiveAddr sdk.AccAddress, resultTx sdk.ResponseFormat) {
...
func doDelegate(t *testing.T, port, name, password string,
	delAddr sdk.AccAddress, valAddr sdk.ValAddress, amount int64, fees sdk.Coins) (resultTx sdk.ResponseFormat) {
...
func doBeginRedelegation(t *testing.T, port, name, password string,
	delAddr sdk.AccAddress, valSrcAddr, valDstAddr sdk.ValAddress, amount int64, fees sdk.Coins) (resultTx sdk.ResponseFormat) {
...
func getBondingTxs(t *testing.T, port string, delegatorAddr sdk.AccAddress, query string) []sdk.ResponseFormat {
	var res *http.Response
	var body string
...
func doSubmitProposal(t *testing.T, port, seed, name, password string, proposerAddr sdk.AccAddress, amount int64, fees sdk.Coins) (resultTx sdk.ResponseFormat) {
	...
	var results sdk.ResponseFormat
...
func doDeposit(t *testing.T, port, seed, name, password string, proposerAddr sdk.AccAddress, proposalID uint64, amount int64, fees sdk.Coins) (resultTx sdk.ResponseFormat) {
...
func doVote(t *testing.T, port, seed, name, password string, proposerAddr sdk.AccAddress, proposalID uint64, option string, fees sdk.Coins) (resultTx sdk.ResponseFormat) {
...
func doUnjail(t *testing.T, port, seed, name, password string,
	valAddr sdk.ValAddress, fees sdk.Coins) (resultTx sdk.ResponseFormat) {
	chainID := viper.GetString(client.FlagChainID)
