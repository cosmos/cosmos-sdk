...
// 2019-10-11 17:16:46.410177 -0400 EDT m=+0.657330207
        ...
        "/staking/redelegations": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "validator_from address",
                        "name": "validator_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "validator_to address",
                        "name": "validator_to",
                        "in": "query"
                    },
                    {
        ...
        "/staking/validators": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "validator status, (bonded | unbonded | unbonding). Default bonded",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "the page number to query, default 0",
                        "name": "page",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "the number of results per page, default 20",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/staking/validators/{validatorAddr}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Returned if the request doesn't have a valid heigh.",
                        "schema": {
                            "$ref": "#/definitions/rest.ErrorResponse"
                        }
                    },
