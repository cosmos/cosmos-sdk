...
// 2019-12-02 12:16:01.2436 +0100 CET m=+0.327179168
...
var doc = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.coinsReturn"
                        }
                    },
                    "400": {
        ...
        "/distribution/community_pool_spend": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The data required to spend the community pool",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/rest.CommunityPoolSpendProposalReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.communityPoolSpendProposal"
                        }
                    },
                    "400": {
                        "description": "Returned if the request is invalid",
        ...
        "/distribution/delegators/{delegatorAddr}/rewards": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The data required to withdraw rewards",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.withdrawDelegatorReward"
                        }
                    },
                    "400": {
                        "description": "Returned if the request is invalid",
        ...
        "/distribution/delegators/{delegatorAddr}/rewards/{validatorAddr}": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "delegator validator",
                        "name": "validatorAddr",
                        "in": "path",
                        "required": true
                    },
        ...
        "/distribution/delegators/{delegatorAddr}/withdraw_address": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.delegatorWithdrawalAddr"
                        }
                    },
                    "400": {
                        "description": "Returned if the request doesn't have a valid height",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "The data required to set withdraw address",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.setDelegatorWithdrawalAddr"
                        }
                    },
                    "400": {
                        "description": "Returned if the request is invalid",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.distrParams"
                        }
                    },
                    "400": {
                        "description": "Returned if the request doesn't have a valid height",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.validatorInfo"
                        }
                    },
                    "400": {
                        "description": "Returned if the request doesn't have a valid height",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.withdrawValidatorRewards"
                        }
                    },
                    "400": {
                        "description": "Returned if the request is invalid",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.slashingParams"
                        }
                    },
                    "500": {
                        "description": "Returned on server error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.stakingParams"
                        }
                    },
                    "400": {
                        "description": "Returned if the request doesn't have valid query params",
    ...
    "definitions": {
        ...
        "rest.CommunityPoolSpendProposalReq": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "string"
        ...
        "rest.communityPoolSpendProposal": {
            "type": "object",
            "properties": {
                "fee": {
                    "type": "object",
                ...
                "msg": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.CommunityPoolSpendProposal"
                    }
                },
                "signatures": {
                    "type": "array",
        ...
        "rest.distrParams": {
            ...
            "properties": {
                ...
                "result": {
                    "type": "object",
                    "$ref": "#/definitions/common.PrettyParams"
                }
            }
        },
        "rest.editValidator": {
        ...
        "rest.mintParams": {
            ...
            "properties": {
                ...
                "result": {
                    "type": "object",
                    "$ref": "#/definitions/types.MintParams"
                }
            }
        },
        "rest.pool": {
        ...
        "rest.slashingParams": {
            ...
            "properties": {
                ...
                "result": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.SlashParams"
                    }
                }
            }
        },
        "rest.stakingParams": {
            ...
            "properties": {
                ...
                "result": {
                    "type": "object",
                    "$ref": "#/definitions/types.StakeParams"
                }
            }
        },
        ...
        "rest.withdrawValidatorRewards": {
            ...
            "properties": {
                ...
                "msg": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.MsgWithdrawValidatorCommission"
                    }
                },
                "signatures": {
                    "type": "array",
