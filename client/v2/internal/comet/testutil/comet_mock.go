...
func (m *MockCometRPC) ABCIInfo(ctx context.Context) (*types.ResultABCIInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) ABCIQuery(ctx context.Context, path string, data bytes.HexBytes) (*types.ResultABCIQuery, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) ABCIQueryWithOptions(ctx context.Context, path string, data bytes.HexBytes, opts client.ABCIQueryOptions) (*types.ResultABCIQuery, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) Block(ctx context.Context, height *int64) (*types.ResultBlock, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) BlockByHash(ctx context.Context, hash []byte) (*types.ResultBlock, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) BlockResults(ctx context.Context, height *int64) (*types.ResultBlockResults, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) BlockSearch(ctx context.Context, query string, page, perPage *int, orderBy string) (*types.ResultBlockSearch, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockSearch", ctx, query, page, perPage, orderBy)
	ret0, _ := ret[0].(*types.ResultBlockSearch)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockCometRPC) BlockchainInfo(ctx context.Context, minHeight, maxHeight int64) (*types.ResultBlockchainInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) BroadcastTxAsync(ctx context.Context, tx types0.Tx) (*types.ResultBroadcastTx, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) BroadcastTxCommit(ctx context.Context, tx types0.Tx) (*types.ResultBroadcastTxCommit, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) BroadcastTxSync(ctx context.Context, tx types0.Tx) (*types.ResultBroadcastTx, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) Commit(ctx context.Context, height *int64) (*types.ResultCommit, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) Tx(ctx context.Context, hash []byte, prove bool) (*types.ResultTx, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) TxSearch(ctx context.Context, query string, prove bool, page, perPage *int, orderBy string) (*types.ResultTxSearch, error) {
	m.ctrl.T.Helper()
...
func (m *MockCometRPC) Validators(ctx context.Context, height *int64, page, perPage *int) (*types.ResultValidators, error) {
	m.ctrl.T.Helper()
