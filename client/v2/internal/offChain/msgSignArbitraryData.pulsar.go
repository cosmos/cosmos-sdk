...
var (
	...
	fd_MsgSignArbitraryData_appDomain     protoreflect.FieldDescriptor
	fd_MsgSignArbitraryData_signerAddress protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgSignArbitraryData_appDomain = md_MsgSignArbitraryData.Fields().ByName("appDomain")
	fd_MsgSignArbitraryData_signerAddress = md_MsgSignArbitraryData.Fields().ByName("signerAddress")
...
func (x *fastReflection_MsgSignArbitraryData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AppDomain != "" {
		...
		if !f(fd_MsgSignArbitraryData_appDomain, value) {
			return
		}
	}
	if x.SignerAddress != "" {
		value := protoreflect.ValueOfString(x.SignerAddress)
		if !f(fd_MsgSignArbitraryData_signerAddress, value) {
			return
		}
	}
	if x.Data != "" {
...
func (x *fastReflection_MsgSignArbitraryData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "offChain.MsgSignArbitraryData.appDomain":
		return x.AppDomain != ""
	case "offChain.MsgSignArbitraryData.signerAddress":
...
func (x *fastReflection_MsgSignArbitraryData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "offChain.MsgSignArbitraryData.appDomain":
		panic(fmt.Errorf("field appDomain of message offChain.MsgSignArbitraryData is not mutable"))
	case "offChain.MsgSignArbitraryData.signerAddress":
		panic(fmt.Errorf("field signerAddress of message offChain.MsgSignArbitraryData is not mutable"))
	case "offChain.MsgSignArbitraryData.data":
...
func (x *MsgSignArbitraryData) GetSignerAddress() string {
	if x != nil {
		return x.SignerAddress
	}
	return ""
...
var file_offChain_msgSignArbitraryData_proto_rawDesc = []byte{
	0x0a, 0x23, 0x6f, 0x66, 0x66, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x6d, 0x73, 0x67, 0x53, 0x69,
	0x67, 0x6e, 0x41, 0x72, 0x62, 0x69, 0x74, 0x72, 0x61, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x6f, 0x66, 0x66, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x1a,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x01, 0x0a, 0x14, 0x4d, 0x73, 0x67, 0x53, 0x69,
	0x67, 0x6e, 0x41, 0x72, 0x62, 0x69, 0x74, 0x72, 0x61, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x1c, 0x0a, 0x09, 0x61, 0x70, 0x70, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x61, 0x70, 0x70, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x3e, 0x0a,
	...
	,
	...
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x6f, 0x66, 0x66, 0x43, 0x68, 0x61, 0x69, 0x6e, 0xa2,
	0x02, 0x03, 0x4f, 0x58, 0x58, 0xaa, 0x02, 0x08, 0x4f, 0x66, 0x66, 0x43, 0x68, 0x61, 0x69, 0x6e,
	0xca, 0x02, 0x08, 0x4f, 0x66, 0x66, 0x43, 0x68, 0x61, 0x69, 0x6e, 0xe2, 0x02, 0x14, 0x4f, 0x66,
	0x66, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0xea, 0x02, 0x08, 0x4f, 0x66, 0x66, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x62, 0x06, 0x70,
