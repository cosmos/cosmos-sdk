...
type AccountRetriever interface {
	GetAccount(addr sdk.AccAddress) (Account, error)
	GetAccountWithHeight(addr sdk.AccAddress) (Account, int64, error)
	EnsureExists(addr sdk.AccAddress) error
	GetAccountNumberSequence(addr sdk.AccAddress) (accNum, accSeq uint64, err error)
}
