...
func main() {
	...
	rootCmd.AddCommand(genutilcli.CollectGenTxsCmd(ctx, cdc, app.ModuleBasics, genaccounts.AppModuleBasic{}))
	...
	rootCmd.AddCommand(testnet.InitFilesCmd(ctx, cdc, app.ModuleBasics, genaccounts.AppModuleBasic{}))
