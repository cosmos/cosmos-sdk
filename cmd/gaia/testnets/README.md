...
_**NOTE:**_ The `gaia-7000` network is expected to launch before noon on 16 July.
...
cd cosmos-sdk && git checkout v0.21.0
...
cp -a $GOPATH/src/github.com/cosmos/cosmos-sdk/cmd/gaia/testnets/gaia-7000/genesis.json $HOME/.gaiad/config/genesis.json
```
...
seeds = "38aa9bec3998f12ae9088b21a2d910d19d565c27@gaia-7000.coinculture.net:46656,1e124dd15bd9955a7ea844ab003b1b47f0998b70@seed.cosmos.cryptium.ch:46656"
```
