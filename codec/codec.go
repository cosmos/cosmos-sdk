...
type (
	...
	// GRPCCodecProvider is implemented by the Codec implementations which return
	// a gRPC encoding.Codec.
	//
	// And it is used to decode requests and encode responses passed through gRPC.
