/*
enforceproto implements functionality to "type check" protobuf serialized byte sequences
against an expected proto.Message to report:

a) Extraneous fields in the stream -- this is indicative of mismatched services, perhaps a malicious actor
...
Its API signature is similar to proto.Unmarshal([]byte, proto.Message) as
    ...
    if err := enforceproto.CheckMismatchedProtoFields(protoBlob, protoMessage); err != nil {
            // Handle the error.
    }
