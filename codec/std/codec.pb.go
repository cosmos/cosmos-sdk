...
import (
	...
	types7 "github.com/cosmos/cosmos-sdk/x/feegrant/types"
...
type FeeAllowance_BasicFeeAllowance struct {
	BasicFeeAllowance *types7.BasicFeeAllowance `protobuf:"bytes,1,opt,name=BasicFeeAllowance,proto3,oneof" json:"BasicFeeAllowance,omitempty"`
}
type FeeAllowance_PeriodicFeeAllowance struct {
	PeriodicFeeAllowance *types7.PeriodicFeeAllowance `protobuf:"bytes,2,opt,name=PeriodicFeeAllowance,proto3,oneof" json:"PeriodicFeeAllowance,omitempty"`
}
...
func (m *FeeAllowance) GetBasicFeeAllowance() *types7.BasicFeeAllowance {
...
func (m *FeeAllowance) GetPeriodicFeeAllowance() *types7.PeriodicFeeAllowance {
...
type MsgGrantFeeAllowance struct {
	Allowance                       *FeeAllowance `protobuf:"bytes,1,opt,name=Allowance,proto3" json:"Allowance,omitempty"`
	types7.MsgGrantFeeAllowanceBase `protobuf:"bytes,2,opt,name=base,proto3,embedded=base" json:"base"`
}
...
type FeeAllowanceGrant struct {
	...
	types7.FeeAllowanceGrantBase `protobuf:"bytes,2,opt,name=base,proto3,embedded=base" json:"base"`
}
...
func init() {
	...
	proto.RegisterType((*FeeAllowance)(nil), "cosmos_sdk.codec.std.v1.FeeAllowance")
	proto.RegisterType((*MsgGrantFeeAllowance)(nil), "cosmos_sdk.codec.std.v1.MsgGrantFeeAllowance")
	proto.RegisterType((*FeeAllowanceGrant)(nil), "cosmos_sdk.codec.std.v1.FeeAllowanceGrant")
}
...
var fileDescriptor_daf09dc2dfa19bb4 = []byte{
	...
	,
}
...
func (this *MsgGrantFeeAllowance) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MsgGrantFeeAllowance)
	if !ok {
		that2, ok := that.(MsgGrantFeeAllowance)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.MsgGrantFeeAllowanceBase.Equal(&that1.MsgGrantFeeAllowanceBase) {
		return false
	}
	return true
}
func (this *FeeAllowanceGrant) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*FeeAllowanceGrant)
	if !ok {
		that2, ok := that.(FeeAllowanceGrant)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.FeeAllowanceGrantBase.Equal(&that1.FeeAllowanceGrantBase) {
		return false
	}
	return true
}
...
func (this *FeeAllowance) SetFeeAllowance(value github_com_cosmos_cosmos_sdk_x_feegrant_exported.FeeAllowance) error {
	...
	switch vt := value.(type) {
	case *types7.BasicFeeAllowance:
		this.Sum = &FeeAllowance_BasicFeeAllowance{vt}
		return nil
	case types7.BasicFeeAllowance:
		this.Sum = &FeeAllowance_BasicFeeAllowance{&vt}
		return nil
	case *types7.PeriodicFeeAllowance:
...
func (m *MsgGrantFeeAllowance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.MsgGrantFeeAllowanceBase.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FeeAllowanceGrant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.FeeAllowanceGrantBase.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgGrantFeeAllowance) Size() (n int) {
	...
	l = m.MsgGrantFeeAllowanceBase.Size()
	n += 1 + l + sovCodec(uint64(l))
	return n
}
...
func (m *FeeAllowanceGrant) Size() (n int) {
	...
	var l int
	_ = l
	l = m.FeeAllowanceGrantBase.Size()
	n += 1 + l + sovCodec(uint64(l))
	if m.Allowance != nil {
		l = m.Allowance.Size()
		n += 1 + l + sovCodec(uint64(l))
...
func (m *MsgGrantFeeAllowance) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MsgGrantFeeAllowanceBase", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MsgGrantFeeAllowanceBase.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FeeAllowanceGrant) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FeeAllowanceGrantBase", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FeeAllowanceGrantBase.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
