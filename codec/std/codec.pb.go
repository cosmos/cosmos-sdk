...
import (
	...
	types15 "github.com/cosmos/cosmos-sdk/types"
	...
	types8 "github.com/cosmos/cosmos-sdk/x/bank/types"
	types9 "github.com/cosmos/cosmos-sdk/x/crisis/types"
	...
	types12 "github.com/cosmos/cosmos-sdk/x/ibc/03-connection/types"
	types13 "github.com/cosmos/cosmos-sdk/x/ibc/04-channel/types"
	types4 "github.com/cosmos/cosmos-sdk/x/ibc/07-tendermint/types"
	types14 "github.com/cosmos/cosmos-sdk/x/ibc/20-transfer/types"
	proposal "github.com/cosmos/cosmos-sdk/x/params/types/proposal"
	types10 "github.com/cosmos/cosmos-sdk/x/slashing/types"
	types11 "github.com/cosmos/cosmos-sdk/x/staking/types"
...
type Message_MsgSend struct {
	MsgSend *types8.MsgSend `protobuf:"bytes,1,opt,name=msg_send,json=msgSend,proto3,oneof" json:"msg_send,omitempty"`
}
type Message_MsgMultiSend struct {
	MsgMultiSend *types8.MsgMultiSend `protobuf:"bytes,2,opt,name=msg_multi_send,json=msgMultiSend,proto3,oneof" json:"msg_multi_send,omitempty"`
}
type Message_MsgVerifyInvariant struct {
	MsgVerifyInvariant *types9.MsgVerifyInvariant `protobuf:"bytes,3,opt,name=msg_verify_invariant,json=msgVerifyInvariant,proto3,oneof" json:"msg_verify_invariant,omitempty"`
}
...
type Message_MsgUnjail struct {
	MsgUnjail *types10.MsgUnjail `protobuf:"bytes,12,opt,name=msg_unjail,json=msgUnjail,proto3,oneof" json:"msg_unjail,omitempty"`
}
type Message_MsgCreateValidator struct {
	MsgCreateValidator *types11.MsgCreateValidator `protobuf:"bytes,13,opt,name=msg_create_validator,json=msgCreateValidator,proto3,oneof" json:"msg_create_validator,omitempty"`
}
type Message_MsgEditValidator struct {
	MsgEditValidator *types11.MsgEditValidator `protobuf:"bytes,14,opt,name=msg_edit_validator,json=msgEditValidator,proto3,oneof" json:"msg_edit_validator,omitempty"`
}
type Message_MsgDelegate struct {
	MsgDelegate *types11.MsgDelegate `protobuf:"bytes,15,opt,name=msg_delegate,json=msgDelegate,proto3,oneof" json:"msg_delegate,omitempty"`
}
type Message_MsgBeginRedelegate struct {
	MsgBeginRedelegate *types11.MsgBeginRedelegate `protobuf:"bytes,16,opt,name=msg_begin_redelegate,json=msgBeginRedelegate,proto3,oneof" json:"msg_begin_redelegate,omitempty"`
}
type Message_MsgUndelegate struct {
	MsgUndelegate *types11.MsgUndelegate `protobuf:"bytes,17,opt,name=msg_undelegate,json=msgUndelegate,proto3,oneof" json:"msg_undelegate,omitempty"`
}
type Message_MsgConnectionOpenInit struct {
	MsgConnectionOpenInit *types12.MsgConnectionOpenInit `protobuf:"bytes,18,opt,name=msg_connection_open_init,json=msgConnectionOpenInit,proto3,oneof" json:"msg_connection_open_init,omitempty"`
}
type Message_MsgConnectionOpenTry struct {
	MsgConnectionOpenTry *types12.MsgConnectionOpenTry `protobuf:"bytes,19,opt,name=msg_connection_open_try,json=msgConnectionOpenTry,proto3,oneof" json:"msg_connection_open_try,omitempty"`
}
type Message_MsgConnectionOpenAck struct {
	MsgConnectionOpenAck *types12.MsgConnectionOpenAck `protobuf:"bytes,20,opt,name=msg_connection_open_ack,json=msgConnectionOpenAck,proto3,oneof" json:"msg_connection_open_ack,omitempty"`
}
type Message_MsgConnectionOpenConfirm struct {
	MsgConnectionOpenConfirm *types12.MsgConnectionOpenConfirm `protobuf:"bytes,21,opt,name=msg_connection_open_confirm,json=msgConnectionOpenConfirm,proto3,oneof" json:"msg_connection_open_confirm,omitempty"`
}
type Message_MsgChannelOpenInit struct {
	MsgChannelOpenInit *types13.MsgChannelOpenInit `protobuf:"bytes,22,opt,name=msg_channel_open_init,json=msgChannelOpenInit,proto3,oneof" json:"msg_channel_open_init,omitempty"`
}
type Message_MsgChannelOpenTry struct {
	MsgChannelOpenTry *types13.MsgChannelOpenTry `protobuf:"bytes,23,opt,name=msg_channel_open_try,json=msgChannelOpenTry,proto3,oneof" json:"msg_channel_open_try,omitempty"`
}
type Message_MsgChannelOpenAck struct {
	MsgChannelOpenAck *types13.MsgChannelOpenAck `protobuf:"bytes,24,opt,name=msg_channel_open_ack,json=msgChannelOpenAck,proto3,oneof" json:"msg_channel_open_ack,omitempty"`
}
type Message_MsgChannelOpenConfirm struct {
	MsgChannelOpenConfirm *types13.MsgChannelOpenConfirm `protobuf:"bytes,25,opt,name=msg_channel_open_confirm,json=msgChannelOpenConfirm,proto3,oneof" json:"msg_channel_open_confirm,omitempty"`
}
type Message_MsgChannelCloseInit struct {
	MsgChannelCloseInit *types13.MsgChannelCloseInit `protobuf:"bytes,26,opt,name=msg_channel_close_init,json=msgChannelCloseInit,proto3,oneof" json:"msg_channel_close_init,omitempty"`
}
type Message_MsgChannelCloseConfirm struct {
	MsgChannelCloseConfirm *types13.MsgChannelCloseConfirm `protobuf:"bytes,27,opt,name=msg_channel_close_confirm,json=msgChannelCloseConfirm,proto3,oneof" json:"msg_channel_close_confirm,omitempty"`
}
type Message_MsgPacket struct {
	MsgPacket *types13.MsgPacket `protobuf:"bytes,28,opt,name=msg_packet,json=msgPacket,proto3,oneof" json:"msg_packet,omitempty"`
}
type Message_MsgAcknowledgement struct {
	MsgAcknowledgement *types13.MsgAcknowledgement `protobuf:"bytes,29,opt,name=msg_acknowledgement,json=msgAcknowledgement,proto3,oneof" json:"msg_acknowledgement,omitempty"`
}
...
type Message_MsgTransfer struct {
	MsgTransfer *types14.MsgTransfer `protobuf:"bytes,33,opt,name=msg_transfer,json=msgTransfer,proto3,oneof" json:"msg_transfer,omitempty"`
}
...
func (m *Message) GetMsgSend() *types8.MsgSend {
...
func (m *Message) GetMsgMultiSend() *types8.MsgMultiSend {
...
func (m *Message) GetMsgVerifyInvariant() *types9.MsgVerifyInvariant {
...
func (m *Message) GetMsgUnjail() *types10.MsgUnjail {
...
func (m *Message) GetMsgCreateValidator() *types11.MsgCreateValidator {
...
func (m *Message) GetMsgEditValidator() *types11.MsgEditValidator {
...
func (m *Message) GetMsgDelegate() *types11.MsgDelegate {
...
func (m *Message) GetMsgBeginRedelegate() *types11.MsgBeginRedelegate {
...
func (m *Message) GetMsgUndelegate() *types11.MsgUndelegate {
...
func (m *Message) GetMsgConnectionOpenInit() *types12.MsgConnectionOpenInit {
...
func (m *Message) GetMsgConnectionOpenTry() *types12.MsgConnectionOpenTry {
...
func (m *Message) GetMsgConnectionOpenAck() *types12.MsgConnectionOpenAck {
...
func (m *Message) GetMsgConnectionOpenConfirm() *types12.MsgConnectionOpenConfirm {
...
func (m *Message) GetMsgChannelOpenInit() *types13.MsgChannelOpenInit {
...
func (m *Message) GetMsgChannelOpenTry() *types13.MsgChannelOpenTry {
...
func (m *Message) GetMsgChannelOpenAck() *types13.MsgChannelOpenAck {
...
func (m *Message) GetMsgChannelOpenConfirm() *types13.MsgChannelOpenConfirm {
...
func (m *Message) GetMsgChannelCloseInit() *types13.MsgChannelCloseInit {
...
func (m *Message) GetMsgChannelCloseConfirm() *types13.MsgChannelCloseConfirm {
...
func (m *Message) GetMsgPacket() *types13.MsgPacket {
...
func (m *Message) GetMsgAcknowledgement() *types13.MsgAcknowledgement {
...
func (m *Message) GetMsgTransfer() *types14.MsgTransfer {
...
func (*StdTxBase) Descriptor() ([]byte, []int) {
	return fileDescriptor_daf09dc2dfa19bb4, []int{18}
}
...
func (*StdSignDocBase) Descriptor() ([]byte, []int) {
	return fileDescriptor_daf09dc2dfa19bb4, []int{19}
}
...
func init() {
	...
	proto.RegisterType((*StdFee)(nil), "cosmos_sdk.codec.std.v1.StdFee")
	proto.RegisterType((*StdSignature)(nil), "cosmos_sdk.codec.std.v1.StdSignature")
	proto.RegisterType((*StdTxBase)(nil), "cosmos_sdk.codec.std.v1.StdTxBase")
	proto.RegisterType((*StdSignDocBase)(nil), "cosmos_sdk.codec.std.v1.StdSignDocBase")
}
...
var fileDescriptor_daf09dc2dfa19bb4 = []byte{
	...
	,
}
...
func (this *Message) SetMsg(value github_com_cosmos_cosmos_sdk_types.Msg) error {
	...
	case types8.MsgSend:
		this.Sum = &Message_MsgSend{&vt}
		return nil
	case *types8.MsgMultiSend:
		this.Sum = &Message_MsgMultiSend{vt}
		return nil
	case types8.MsgMultiSend:
		this.Sum = &Message_MsgMultiSend{&vt}
		return nil
	case *types9.MsgVerifyInvariant:
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			...
			v := &types12.MsgConnectionOpenInit{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 19:
			...
			v := &types12.MsgConnectionOpenTry{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 20:
			...
			v := &types12.MsgConnectionOpenAck{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 21:
			...
			v := &types12.MsgConnectionOpenConfirm{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 25:
			...
			v := &types13.MsgChannelOpenConfirm{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 27:
			...
			v := &types13.MsgChannelCloseConfirm{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *StdFee) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Amount = append(m.Amount, types15.Coin{})
