...
import (
	...
	github_com_cosmos_cosmos_sdk_x_capability_types "github.com/cosmos/cosmos-sdk/x/capability/types"
	...
	types4 "github.com/cosmos/cosmos-sdk/x/evidence/types"
...
// Capability defines the application-level Capability type.
type Capability struct {
	// sum defines a list of all acceptable concrete Capability implementations.
	//
	// Types that are valid to be assigned to Sum:
	//	*Capability_CapabilityKey
	Sum isCapability_Sum `protobuf_oneof:"sum"`
}
...
type isCapability_Sum interface {
	isCapability_Sum()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Capability_CapabilityKey struct {
	CapabilityKey *types3.CapabilityKey `protobuf:"bytes,1,opt,name=capability_key,json=capabilityKey,proto3,oneof" json:"capability_key,omitempty"`
}

func (*Capability_CapabilityKey) isCapability_Sum() {}

func (m *Capability) GetSum() isCapability_Sum {
	if m != nil {
		return m.Sum
	}
	return nil
...
func (m *Capability) GetCapabilityKey() *types3.CapabilityKey {
	if x, ok := m.GetSum().(*Capability_CapabilityKey); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*Capability) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Capability_CapabilityKey)(nil),
	}
}
...
type Evidence_Equivocation struct {
	Equivocation *types4.Equivocation `protobuf:"bytes,1,opt,name=equivocation,proto3,oneof" json:"equivocation,omitempty"`
}
...
func (m *Evidence) GetEquivocation() *types4.Equivocation {
...
type MsgSubmitEvidence struct {
	types4.MsgSubmitEvidenceBase `protobuf:"bytes,1,opt,name=base,proto3,embedded=base" json:"base"`
...
func init() {
	...
	proto.RegisterType((*Capability)(nil), "cosmos_sdk.codec.std.v1.Capability")
...
var fileDescriptor_daf09dc2dfa19bb4 = []byte{
	...
	,
}
...
func (this *Capability) GetCapability() github_com_cosmos_cosmos_sdk_x_capability_types.Capability {
	if x := this.GetCapabilityKey(); x != nil {
		return x
	}
	return nil
}

func (this *Capability) SetCapability(value github_com_cosmos_cosmos_sdk_x_capability_types.Capability) error {
	if value == nil {
		this.Sum = nil
		return nil
	}
	switch vt := value.(type) {
	case *types3.CapabilityKey:
		this.Sum = &Capability_CapabilityKey{vt}
		return nil
	}
	return fmt.Errorf("can't encode value of type %T as message Capability", value)
}
...
func (m *Capability_CapabilityKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Capability_CapabilityKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CapabilityKey != nil {
		{
			size, err := m.CapabilityKey.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Capability_CapabilityKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Capability) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CapabilityKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &types3.CapabilityKey{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Capability_CapabilityKey{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCodec(dAtA[iNdEx:])
