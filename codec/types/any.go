...
type Any struct {
	...
	TypeUrl string `protobuf:"bytes,1,opt,name=type_url,json=typeUrl,proto3" json:"type_url,omitempty"` //nolint:revive // ignore var-naming rules here for proto compatibility

	// Must be a valid serialized protocol buffer of the above specified type.
	Value []byte `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`

	XXX_NoUnkeyedLiteral struct{} `json:"-"` //nolint:revive // ignore var-naming rules here for proto compatibility
	XXX_unrecognized     []byte   `json:"-"` //nolint:revive // ignore var-naming rules here for proto compatibility
	XXX_sizecache        int32    `json:"-"` //nolint:revive // ignore var-naming rules here for proto compatibility
