...
func (m Map[K, V]) Set(ctx context.Context, key K, value V) error {
	...
	if err != nil {
		return fmt.Errorf("%w: value encode: %w", ErrEncoding, err) // TODO: use multi err wrapping in go1.20: https://github.com/golang/go/issues/53435
	}
...
func (m Map[K, V]) Get(ctx context.Context, key K) (v V, err error) {
	...
	if err != nil {
		return v, fmt.Errorf("%w: value decode: %w", ErrEncoding, err) // TODO: use multi err wrapping in go1.20: https://github.com/golang/go/issues/53435
	}
	return v, nil
}
...
func EncodeKeyWithPrefix[K any](prefix []byte, kc codec.KeyCodec[K], key K) ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: key encode: %w", ErrEncoding, err) // TODO: use multi err wrapping in go1.20: https://github.com/golang/go/issues/53435
	}
	return keyBytes, nil
}
