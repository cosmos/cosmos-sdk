...
const (
	Query_GroupInfo_FullMethodName              = "/contrib.group.v1.Query/GroupInfo"
	Query_GroupPolicyInfo_FullMethodName        = "/contrib.group.v1.Query/GroupPolicyInfo"
	Query_GroupMembers_FullMethodName           = "/contrib.group.v1.Query/GroupMembers"
	Query_GroupsByAdmin_FullMethodName          = "/contrib.group.v1.Query/GroupsByAdmin"
	Query_GroupPoliciesByGroup_FullMethodName   = "/contrib.group.v1.Query/GroupPoliciesByGroup"
	Query_GroupPoliciesByAdmin_FullMethodName   = "/contrib.group.v1.Query/GroupPoliciesByAdmin"
	Query_Proposal_FullMethodName               = "/contrib.group.v1.Query/Proposal"
	Query_ProposalsByGroupPolicy_FullMethodName = "/contrib.group.v1.Query/ProposalsByGroupPolicy"
	Query_VoteByProposalVoter_FullMethodName    = "/contrib.group.v1.Query/VoteByProposalVoter"
	Query_VotesByProposal_FullMethodName        = "/contrib.group.v1.Query/VotesByProposal"
	Query_VotesByVoter_FullMethodName           = "/contrib.group.v1.Query/VotesByVoter"
	Query_GroupsByMember_FullMethodName         = "/contrib.group.v1.Query/GroupsByMember"
	Query_TallyResult_FullMethodName            = "/contrib.group.v1.Query/TallyResult"
	Query_Groups_FullMethodName                 = "/contrib.group.v1.Query/Groups"
)
