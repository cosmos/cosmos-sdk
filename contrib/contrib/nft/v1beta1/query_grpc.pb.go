...
const (
	Query_Balance_FullMethodName = "/contrib.nft.v1beta1.Query/Balance"
	Query_Owner_FullMethodName   = "/contrib.nft.v1beta1.Query/Owner"
	Query_Supply_FullMethodName  = "/contrib.nft.v1beta1.Query/Supply"
	Query_NFTs_FullMethodName    = "/contrib.nft.v1beta1.Query/NFTs"
	Query_NFT_FullMethodName     = "/contrib.nft.v1beta1.Query/NFT"
	Query_Class_FullMethodName   = "/contrib.nft.v1beta1.Query/Class"
	Query_Classes_FullMethodName = "/contrib.nft.v1beta1.Query/Classes"
)
