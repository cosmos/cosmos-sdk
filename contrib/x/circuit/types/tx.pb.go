...
// source: contrib/circuit/v1/tx.proto
...
func (*MsgAuthorizeCircuitBreaker) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3170ee90c3c43d6, []int{0}
}
...
func (*MsgAuthorizeCircuitBreakerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3170ee90c3c43d6, []int{1}
}
...
func (*MsgTripCircuitBreaker) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3170ee90c3c43d6, []int{2}
}
...
func (*MsgTripCircuitBreakerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3170ee90c3c43d6, []int{3}
}
...
func (*MsgResetCircuitBreaker) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3170ee90c3c43d6, []int{4}
}
...
func (*MsgResetCircuitBreakerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3170ee90c3c43d6, []int{5}
}
...
func init() {
	proto.RegisterType((*MsgAuthorizeCircuitBreaker)(nil), "contrib.circuit.v1.MsgAuthorizeCircuitBreaker")
	proto.RegisterType((*MsgAuthorizeCircuitBreakerResponse)(nil), "contrib.circuit.v1.MsgAuthorizeCircuitBreakerResponse")
	proto.RegisterType((*MsgTripCircuitBreaker)(nil), "contrib.circuit.v1.MsgTripCircuitBreaker")
	proto.RegisterType((*MsgTripCircuitBreakerResponse)(nil), "contrib.circuit.v1.MsgTripCircuitBreakerResponse")
	proto.RegisterType((*MsgResetCircuitBreaker)(nil), "contrib.circuit.v1.MsgResetCircuitBreaker")
	proto.RegisterType((*MsgResetCircuitBreakerResponse)(nil), "contrib.circuit.v1.MsgResetCircuitBreakerResponse")
}

func init() { proto.RegisterFile("contrib/circuit/v1/tx.proto", fileDescriptor_b3170ee90c3c43d6) }

var fileDescriptor_b3170ee90c3c43d6 = []byte{
	// 447 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) AuthorizeCircuitBreaker(ctx context.Context, in *MsgAuthorizeCircuitBreaker, opts ...grpc.CallOption) (*MsgAuthorizeCircuitBreakerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/contrib.circuit.v1.Msg/AuthorizeCircuitBreaker", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TripCircuitBreaker(ctx context.Context, in *MsgTripCircuitBreaker, opts ...grpc.CallOption) (*MsgTripCircuitBreakerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/contrib.circuit.v1.Msg/TripCircuitBreaker", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResetCircuitBreaker(ctx context.Context, in *MsgResetCircuitBreaker, opts ...grpc.CallOption) (*MsgResetCircuitBreakerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/contrib.circuit.v1.Msg/ResetCircuitBreaker", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AuthorizeCircuitBreaker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/contrib.circuit.v1.Msg/AuthorizeCircuitBreaker",
	}
...
func _Msg_TripCircuitBreaker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/contrib.circuit.v1.Msg/TripCircuitBreaker",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ResetCircuitBreaker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/contrib.circuit.v1.Msg/ResetCircuitBreaker",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "contrib.circuit.v1.Msg",
	...
	Metadata: "contrib/circuit/v1/tx.proto",
}
