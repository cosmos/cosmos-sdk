...
func TestEquivocation_Valid(t *testing.T) {
	...
	require.Equal(t, e.Route(), types2.RouteEquivocation)
	...
	require.Equal(t, types2.RouteEquivocation, e.Route())
...
func TestEquivocationValidateBasic(t *testing.T) {
	...
	testCases := []struct {
		...
		{"valid", types2.Equivocation{100, n, 1000000, addr.String()}, false},
		{"invalid time", types2.Equivocation{100, zeroTime, 1000000, addr.String()}, true},
		{"invalid height", types2.Equivocation{0, n, 1000000, addr.String()}, true},
		{"invalid power", types2.Equivocation{100, n, 0, addr.String()}, true},
		{"invalid address", types2.Equivocation{100, n, 1000000, ""}, true},
	}
...
func TestEvidenceAddressConversion(t *testing.T) {
	...
	evidence := types2.FromABCIEvidence(tmEvidence, address.NewBech32Codec("testcnclcons"))
