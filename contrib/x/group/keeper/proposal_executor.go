...
func (s Keeper) doExecuteMsgs(ctx sdk.Context, router baseapp.MessageRouter, proposal group2.Proposal, groupPolicyAcc sdk.AccAddress, decisionPolicy group2.DecisionPolicy) ([]sdk.Result, error) {
