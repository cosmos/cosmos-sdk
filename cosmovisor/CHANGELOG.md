...
* [\#XXXXX](https://github.com/cosmos/cosmos-sdk/pull/XXXXX) Add a `DAEMON_RESTART_DELAY` for allowing a node operator to define a delay between the node halt (for upgrade) and backup.
