...
* `DAEMON_PREUPGRADE_MAX_RETRIES` Default: 0. The maximum number of times to call `pre-upgrade` in the application after exit status of `31`. After the maximum number of retries, cosmovisor fails the upgrade. 
