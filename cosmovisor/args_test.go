...
func (s *argsTestSuite) TestGetConfigFromEnv() {
	...
	tests := []struct {
		...
		{
			name:             "all good",
			envVals:          cosmovisorEnv{absPath, "testname", "true", "false", "600", "true", "", "303", "1"},
		...
		// Note: Home and Name tests are done in TestValidate
		{
			...
			envVals:          cosmovisorEnv{absPath, "testname", "bad", "false", "600", "true", "", "303", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "download bin not set",
			envVals:          cosmovisorEnv{absPath, "testname", "", "false", "600", "true", "", "303", "1"},
		...
		},
		{
			...
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "true", "", "303", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 600, true, absPath, 303, 1),
			expectedErrCount: 0,
		},
		{
			name:             "restart upgrade bad",
			envVals:          cosmovisorEnv{absPath, "testname", "true", "bad", "600", "true", "", "303", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "restart upgrade not set",
			envVals:          cosmovisorEnv{absPath, "testname", "true", "", "600", "true", "", "303", "1"},
			expectedCfg:      newConfig(absPath, "testname", true, true, 600, true, absPath, 303, 1),
			expectedErrCount: 0,
		},
		{
			name:             "restart upgrade true",
			envVals:          cosmovisorEnv{absPath, "testname", "true", "true", "600", "true", "", "303", "1"},
			expectedCfg:      newConfig(absPath, "testname", true, true, 600, true, absPath, 303, 1),
			expectedErrCount: 0,
		},
		{
		...
		},
		{
			...
			envVals:          cosmovisorEnv{absPath, "testname", "true", "false", "600", "bad", "", "303", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "skip unsafe backups not set",
			envVals:          cosmovisorEnv{absPath, "testname", "true", "false", "600", "", "", "303", "1"},
		...
		},
		{
			...
			envVals:          cosmovisorEnv{absPath, "testname", "true", "false", "600", "false", "", "303", "1"},
			expectedCfg:      newConfig(absPath, "testname", true, false, 600, false, absPath, 303, 1),
			expectedErrCount: 0,
		},
		{
			name:             "poll interval bad",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "bad", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "poll interval 0",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "0", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "poll interval not set",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 600, false, absPath, 300, 1),
			expectedErrCount: 0,
		},
		{
			name:             "poll interval 987",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "987", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 600, false, absPath, 987, 1),
			expectedErrCount: 0,
		},
		{
			name:             "poll interval 1s",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "1s", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 600, false, absPath, 1000, 1),
			expectedErrCount: 0,
		},
		{
			name:             "poll interval -3m",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "-3m", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "restart delay bad",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "bad", "false", "", "300", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "restart delay 0",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "0", "false", "", "300", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "restart delay not set",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "", "false", "", "300", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 0, false, absPath, 300, 1),
			expectedErrCount: 0,
		},
		{
			name:             "restart delay 987",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "987", "false", "", "300", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 987, false, absPath, 300, 1),
			expectedErrCount: 0,
		},
		{
			name:             "restart delay 1s",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "1s", "false", "", "300", "1"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 1000, false, absPath, 300, 1),
			expectedErrCount: 0,
		},
		{
			name:             "restart delay -3m",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "-3m", "false", "", "300", "1"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "prepupgrade max retries bad",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "406", "bad"},
			expectedCfg:      nil,
			expectedErrCount: 1,
		},
		{
			name:             "prepupgrade max retries 0",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "406", "0"},
			expectedCfg:      newConfig(absPath, "testname", false, false, 600, false, absPath, 406, 0),
			expectedErrCount: 0,
		},
		{
			name:             "prepupgrade max retries not set",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "406", ""},
			expectedCfg:      newConfig(absPath, "testname", false, false, 600, false, absPath, 406, 0),
			expectedErrCount: 0,
		},
		{
			name:             "prepupgrade max retries 5",
			envVals:          cosmovisorEnv{absPath, "testname", "false", "false", "600", "false", "", "406", "5"},
