...
```bash
go test -v --bench github.com/pointnetwork/cosmos-point-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/pointnetwork/cosmos-point-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/pointnetwork/cosmos-point-sdk/crypto/keys/mintkey	12.093s
```
