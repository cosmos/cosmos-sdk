...
[![API Reference](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase?status.svg)](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase)

## The Keybase interface

The [Keybase](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase#Keybase) interface defines
...
The [New](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase#New) constructor returns
...
The [NewInMemory](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase#NewInMemory) constructor returns
...
The [NewKeyring](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase#NewKeyring) constructor returns
...
Both [NewKeyringFile](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase#NewKeyringFile) and
[NewTestKeyring](https://godoc.org/github.com/cosmos/cosmos-sdk/crypto/keybase#NewTestKeyring) constructors return
