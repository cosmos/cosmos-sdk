...
```bash
go test -v --bench github.com/cosmos/cosmos-sdk/crypto/keybase/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/cosmos/cosmos-sdk/crypto/keybase/mintkey
...
PASS
ok  	github.com/cosmos/cosmos-sdk/crypto/keybase/mintkey	12.093s
```
