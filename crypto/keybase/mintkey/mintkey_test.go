...
func TestArmorUnarmorPrivKey(t *testing.T) {
	...
	require.Equal(t, string(keybase.Secp256k1), algo)
...
func TestArmorUnarmorPubKey(t *testing.T) {
	...
	cstore := keybase.NewInMemory()

	// Add keys and see they return in alphabetical order
	info, _, err := cstore.CreateMnemonic("Bob", keybase.English, "passphrase", keybase.Secp256k1)
	require.NoError(t, err)
