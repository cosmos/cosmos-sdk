...
var (
	...
	ErrUnableToSerialize = errors.New("failed to serialize keyring record to bytes")
	...
	ErrLedgerGenerateKey = errors.New("ledger device failed to generate private key")
