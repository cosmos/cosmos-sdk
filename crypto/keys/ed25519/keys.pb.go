...
import (
	...
	golang_org_x_crypto_ed25519 "golang.org/x/crypto/ed25519"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type PubKey struct {
	Key golang_org_x_crypto_ed25519.PublicKey `protobuf:"bytes,1,opt,name=key,proto3,casttype=golang.org/x/crypto/ed25519.PublicKey" json:"key,omitempty"`
}
...
func (m *PubKey) GetKey() golang_org_x_crypto_ed25519.PublicKey {
	if m != nil {
		return m.Key
	}
	return nil
...
type PrivKey struct {
	Key golang_org_x_crypto_ed25519.PrivateKey `protobuf:"bytes,1,opt,name=key,proto3,casttype=golang.org/x/crypto/ed25519.PrivateKey" json:"key,omitempty"`
}
...
func (m *PrivKey) GetKey() golang_org_x_crypto_ed25519.PrivateKey {
	if m != nil {
		return m.Key
	}
	return nil
...
var fileDescriptor_48fe3336771e732d = []byte{
	...
	0xb1, 0x20, 0x8a, 0x95, 0xbc, 0xb9, 0xd8, 0x02, 0x4a, 0x93, 0xbc, 0x53, 0x2b, 0x85, 0xac, 0xb9,
	0x98, 0xb3, 0x53, 0x2b, 0x25, 0x18, 0x15, 0x18, 0x35, 0x78, 0x9c, 0x34, 0x7f, 0xdd, 0x93, 0x57,
	0x4d, 0xcf, 0xcf, 0x49, 0xcc, 0x4b, 0xd7, 0xcb, 0x2f, 0x4a, 0xd7, 0xaf, 0x40, 0xb3, 0x4f, 0x2f,
	0xa0, 0x34, 0x29, 0x27, 0x33, 0xd9, 0x3b, 0xb5, 0x32, 0x08, 0xa4, 0xcb, 0x8a, 0x65, 0xc6, 0x02,
	0x79, 0x06, 0x25, 0x77, 0x2e, 0xf6, 0x80, 0xa2, 0xcc, 0x32, 0x90, 0x69, 0x36, 0xc8, 0xa6, 0x69,
	0xfd, 0xba, 0x27, 0xaf, 0x86, 0xd7, 0xb4, 0xa2, 0xcc, 0xb2, 0xc4, 0x92, 0x54, 0x98, 0x71, 0x4e,
	...
	0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f, 0x0b, 0x09, 0x30, 0xa5, 0x5b, 0x9c, 0x92, 0x0d,
	0x33, 0x16, 0x14, 0x18, 0x30, 0xb3, 0x93, 0xd8, 0xc0, 0x1e, 0x35, 0x06, 0x04, 0x00, 0x00, 0xff,
	0xff, 0xe1, 0x20, 0x09, 0x11, 0x39, 0x01, 0x00, 0x00,
}
