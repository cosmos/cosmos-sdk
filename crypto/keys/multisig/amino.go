...
func (m LegacyAminoPubKey) MarshalAminoJSON() (tmMultisig, error) { //nolint:revive // this is an unexported return but let's not mess with stuff in the crypto folder.
	return protoToTm(&m)
}
