...
func TestBech32KeysOutput(t *testing.T) {
	...
	bechTmpKey := sdk.MustBech32ifyPubKey(config, sdk.Bech32PubKeyTypeAccPub, tmpKey)
	...
	bechPubKey := sdk.MustBech32ifyPubKey(config, sdk.Bech32PubKeyTypeAccPub, multiInfo.GetPubKey())
	...
	outputs, err := Bech32KeysOutput(config, []Info{multiInfo})
