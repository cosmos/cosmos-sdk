 ...
 *  cosmos_secp256k1_context_destroy and cosmos_secp256k1_context_randomize.
 *
...
/** Flag to pass to cosmos_secp256k1_ec_pubkey_serialize and secp256k1_ec_privkey_export. */
 ...
 */
SECP256K1_API secp256k1_context* cosmos_secp256k1_context_create(
    unsigned int flags
 ...
 *        data: the opaque pointer to pass to fun above.
 */
SECP256K1_API void cosmos_secp256k1_context_set_error_callback(
    secp256k1_context* ctx,
    void (*fun)(const char* message, void* data),
    const void* data
) SECP256K1_ARG_NONNULL(1);
 ...
 */
SECP256K1_API int cosmos_secp256k1_ec_pubkey_serialize(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_ecdsa_verify(
    const secp256k1_context* ctx,
    const secp256k1_ecdsa_signature *sig,
    const unsigned char *msg32,
    const secp256k1_pubkey *pubkey
 ...
 * extra entropy.
 */
SECP256K1_API extern const secp256k1_nonce_function cosmos_secp256k1_nonce_function_rfc6979;

/** A default safe nonce generation function (currently equal to cosmos_secp256k1_nonce_function_rfc6979). */
SECP256K1_API extern const secp256k1_nonce_function cosmos_secp256k1_nonce_function_default;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_ec_seckey_verify(
    const secp256k1_context* ctx,
    const unsigned char *seckey
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_ec_pubkey_create(
    const secp256k1_context* ctx,
    secp256k1_pubkey *pubkey,
    const unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_ec_privkey_tweak_add(
    const secp256k1_context* ctx,
 ...
 * In:     tweak:  pointer to a 32-byte tweak.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_ec_privkey_tweak_mul(
    const secp256k1_context* ctx,
    unsigned char *seckey,
    const unsigned char *tweak
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_context_randomize(
    secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int cosmos_secp256k1_ec_pubkey_combine(
    const secp256k1_context* ctx,
