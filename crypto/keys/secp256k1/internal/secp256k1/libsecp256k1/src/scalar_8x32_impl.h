...
SECP256K1_INLINE static void secp256k1_scalar_set_int(cosmos_secp256k1_scalar *r, unsigned int v) {
    r->d[0] = v;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const cosmos_secp256k1_scalar *a, unsigned int offset, unsigned int count) {
...
SECP256K1_INLINE static int secp256k1_scalar_check_overflow(const cosmos_secp256k1_scalar *a) {
    int yes = 0;
    int no = 0;
...
SECP256K1_INLINE static int secp256k1_scalar_reduce(cosmos_secp256k1_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static void secp256k1_scalar_negate(cosmos_secp256k1_scalar *r, const cosmos_secp256k1_scalar *a) {
    uint32_t nonzero = 0xFFFFFFFFUL * (cosmos_secp256k1_scalar_is_zero(a) == 0);
...
SECP256K1_INLINE static int secp256k1_scalar_is_one(const cosmos_secp256k1_scalar *a) {
...
static int secp256k1_scalar_cond_negate(cosmos_secp256k1_scalar *r, int flag) {
    /* If we are flag = 0, mask = 00...00 and this is a no-op;
     * if we are flag = 1, mask = 11...11 and this is identical to secp256k1_scalar_negate */
    uint32_t mask = !flag - 1;
    uint32_t nonzero = 0xFFFFFFFFUL * (cosmos_secp256k1_scalar_is_zero(r) == 0);
...
static void secp256k1_scalar_reduce_512(cosmos_secp256k1_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void secp256k1_scalar_mul_512(uint32_t *l, const cosmos_secp256k1_scalar *a, const cosmos_secp256k1_scalar *b) {
    /* 96 bit accumulator. */
...
static void secp256k1_scalar_sqr_512(uint32_t *l, const cosmos_secp256k1_scalar *a) {
    /* 96 bit accumulator. */
    uint32_t c0 = 0, c1 = 0, c2 = 0;
...
SECP256K1_INLINE static int secp256k1_scalar_eq(const cosmos_secp256k1_scalar *a, const cosmos_secp256k1_scalar *b) {
    return ((a->d[0] ^ b->d[0]) | (a->d[1] ^ b->d[1]) | (a->d[2] ^ b->d[2]) | (a->d[3] ^ b->d[3]) | (a->d[4] ^ b->d[4]) | (a->d[5] ^ b->d[5]) | (a->d[6] ^ b->d[6]) | (a->d[7] ^ b->d[7])) == 0;
}

SECP256K1_INLINE static void secp256k1_scalar_mul_shift_var(cosmos_secp256k1_scalar *r, const cosmos_secp256k1_scalar *a, const cosmos_secp256k1_scalar *b, unsigned int shift) {
    uint32_t l[16];
