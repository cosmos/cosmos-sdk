...
cosmos_secp256k1_context* cosmos_secp256k1_context_create(unsigned int flags) {
    cosmos_secp256k1_context* ret = (cosmos_secp256k1_context*)checked_malloc(&default_error_callback, sizeof(cosmos_secp256k1_context));
...
cosmos_secp256k1_context* _cosmos_secp256k1_context_clone(const cosmos_secp256k1_context* ctx) {
    cosmos_secp256k1_context* ret = (cosmos_secp256k1_context*)checked_malloc(&ctx->error_callback, sizeof(cosmos_secp256k1_context));
...
void secp256k1_context_destroy(cosmos_secp256k1_context* ctx) {
    if (ctx != NULL) {
...
void cosmos_secp256k1_context_set_illegal_callback(cosmos_secp256k1_context* ctx, void (*fun)(const char* message, void* data), const void* data) {
    if (fun == NULL) {
...
void cosmos_secp256k1_context_set_error_callback(cosmos_secp256k1_context* ctx, void (*fun)(const char* message, void* data), const void* data) {
    if (fun == NULL) {
...
static void secp256k1_ecdsa_signature_load(const cosmos_secp256k1_context* ctx, cosmos_secp256k1_scalar* r, cosmos_secp256k1_scalar* s, const cosmos_secp256k1_ecdsa_signature* sig) {
    (void)ctx;
    if (sizeof(cosmos_secp256k1_scalar) == 32) {
        ...
        cosmos_secp256k1_scalar_set_b32(r, &sig->data[0], NULL);
        cosmos_secp256k1_scalar_set_b32(s, &sig->data[32], NULL);
    }
}
...
static void cosmos_secp256k1_ecdsa_signature_save(cosmos_secp256k1_ecdsa_signature* sig, const cosmos_secp256k1_scalar* r, const cosmos_secp256k1_scalar* s) {
    if (sizeof(cosmos_secp256k1_scalar) == 32) {
        ...
        cosmos_secp256k1_scalar_get_b32(&sig->data[0], r);
        cosmos_secp256k1_scalar_get_b32(&sig->data[32], s);
    }
}

int secp256k1_ecdsa_signature_parse_der(const cosmos_secp256k1_context* ctx, cosmos_secp256k1_ecdsa_signature* sig, const unsigned char *input, size_t inputlen) {
...
int cosmos_secp256k1_ecdsa_signature_parse_compact(const cosmos_secp256k1_context* ctx, cosmos_secp256k1_ecdsa_signature* sig, const unsigned char *input64) {
    cosmos_secp256k1_scalar r, s;
    int ret = 1;
    int overflow = 0;
    ...
    cosmos_secp256k1_scalar_set_b32(&r, &input64[0], &overflow);
    ret &= !overflow;
...
int cosmos_secp256k1_ecdsa_signature_serialize_compact(const cosmos_secp256k1_context* ctx, unsigned char *output64, const cosmos_secp256k1_ecdsa_signature* sig) {
    cosmos_secp256k1_scalar r, s;
    ...
    secp256k1_ecdsa_signature_load(ctx, &r, &s, sig);
    cosmos_secp256k1_scalar_get_b32(&output64[0], &r);
    cosmos_secp256k1_scalar_get_b32(&output64[32], &s);
    return 1;
}

int cosmos_secp256k1_ecdsa_signature_normalize(const cosmos_secp256k1_context* ctx, cosmos_secp256k1_ecdsa_signature *sigout, const cosmos_secp256k1_ecdsa_signature *sigin) {
    cosmos_secp256k1_scalar r, s;
    int ret = 0;
...
int cosmos_secp256k1_ecdsa_verify(const cosmos_secp256k1_context* ctx, const cosmos_secp256k1_ecdsa_signature *sig, const unsigned char *msg32, const cosmos_secp256k1_pubkey *pubkey) {
    ...
    cosmos_secp256k1_scalar_set_b32(&m, msg32, NULL);
    secp256k1_ecdsa_signature_load(ctx, &r, &s, sig);
...
static int cosmos_nonce_function_rfc6979(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *algo16, void *data, unsigned int counter) {
...
const cosmos_secp256k1_nonce_function cosmos_secp256k1_nonce_function_rfc6979 = cosmos_nonce_function_rfc6979;
const cosmos_secp256k1_nonce_function cosmos_secp256k1_nonce_function_default = cosmos_nonce_function_rfc6979;

int cosmos_secp256k1_ecdsa_sign(const cosmos_secp256k1_context* ctx, cosmos_secp256k1_ecdsa_signature *signature, const unsigned char *msg32, const unsigned char *seckey, cosmos_secp256k1_nonce_function noncefp, const void* noncedata) {
    cosmos_secp256k1_scalar r, s;
    cosmos_secp256k1_scalar sec, non, msg;
    int ret = 0;
    int overflow = 0;
    VERIFY_CHECK(ctx != NULL);
...
int cosmos_secp256k1_ec_privkey_tweak_mul(const cosmos_secp256k1_context* ctx, unsigned char *seckey, const unsigned char *tweak) {
    ...
    cosmos_secp256k1_scalar_set_b32(&factor, tweak, &overflow);
    cosmos_secp256k1_scalar_set_b32(&sec, seckey, NULL);
