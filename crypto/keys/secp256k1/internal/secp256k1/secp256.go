...
func init() {
	...
	C.secp256k1_context_set_illegal_callback(context, C.callbackFunc(C.cosmos_secp256k1GoPanicIllegal), nil)
	C.cosmos_secp256k1_context_set_error_callback(context, C.callbackFunc(C.secp256k1GoPanicError), nil)
}
