...
import (
	...
	"golang.org/x/crypto/ripemd160" //nolint: staticcheck // SA1019: package github.com/golang/crypto/ripemd160 is deprecated, but we need it for compatibility with Tendermint
