...
import (
	crypto_secp256r1 "crypto/secp256r1"
	fmt "fmt"
...
type PubKey struct {
	Key crypto_secp256r1.PublicKey `protobuf:"bytes,1,opt,name=key,proto3,casttype=crypto/secp256r1.PublicKey" json:"key,omitempty"`
}
...
func (m *PubKey) GetKey() crypto_secp256r1.PublicKey {
	if m != nil {
		return m.Key
	}
	return nil
...
type PrivKey struct {
	Key crypto_secp256r1.PrivateKey `protobuf:"bytes,1,opt,name=key,proto3,casttype=crypto/secp256r1.PrivateKey" json:"key,omitempty"`
}
...
func (m *PrivKey) GetKey() crypto_secp256r1.PrivateKey {
	if m != nil {
		return m.Key
	}
	return nil
...
var fileDescriptor_b90c18415095c0c3 = []byte{
	...
	,
}
