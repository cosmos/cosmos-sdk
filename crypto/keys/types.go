...
type Keybase interface {
	...
	// Derive derives a key from the mnemonic with the given mnemonicPasswd
	// using a BIP44 path and encrypts under the given encryptPasswd.
	Derive(name, mnemonic, mnemonicPasswd,
