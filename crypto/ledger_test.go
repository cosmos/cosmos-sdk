...
func TestPublicKeyUnsafe(t *testing.T) {
	...
	pubRaw := priv.PubKey().(secp256k1.PubKeySecp256k1)
	pk := &sdk.PublicKey{&types.PublicKey_Ed25519{pubRaw[:]}}
	pubKeyAddr, err := sdk.Bech32ifyPubKey(sdk.Bech32PubKeyTypeAccPub, pk)
