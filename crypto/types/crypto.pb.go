...
// source: cosmos/base/crypto/crypto.proto
...
func (*PublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_de2c660da449abde, []int{0}
}
...
func (*PubKeyMultisigThreshold) Descriptor() ([]byte, []int) {
	return fileDescriptor_de2c660da449abde, []int{1}
}
...
// See cosmos.tx.signing.ModeInfo.Multi for how to specify which signers signed
...
func (*MultiSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_de2c660da449abde, []int{2}
}
...
func (*CompactBitArray) Descriptor() ([]byte, []int) {
	return fileDescriptor_de2c660da449abde, []int{3}
}
...
func init() {
	proto.RegisterType((*PublicKey)(nil), "cosmos.base.crypto.PublicKey")
	proto.RegisterType((*PubKeyMultisigThreshold)(nil), "cosmos.base.crypto.PubKeyMultisigThreshold")
	proto.RegisterType((*MultiSignature)(nil), "cosmos.base.crypto.MultiSignature")
	proto.RegisterType((*CompactBitArray)(nil), "cosmos.base.crypto.CompactBitArray")
}

func init() { proto.RegisterFile("cosmos/base/crypto/crypto.proto", fileDescriptor_de2c660da449abde) }

var fileDescriptor_de2c660da449abde = []byte{
	// 502 bytes of a gzipped FileDescriptorProto
	,
}
