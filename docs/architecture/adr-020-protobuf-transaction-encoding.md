...
- 2020 August 07: Use ADR 026 for serializing `SignDoc`.
...
2. Create a `SignDoc` and serialize it using [ADR 026](./adr-026-deterministic-protobuf-serialization.md).
...
3. For each required signer:
   ...
   - Create a `SignDoc` and serialize it using [ADR 026](./adr-026-deterministic-protobuf-serialization.md).
