...
Please see the code sample below for more details on how this flow looks for clients.
...
// PublishChainTxEvents events using cmtclient. Waits for context shutdown signals to exit.
