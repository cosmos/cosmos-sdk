...
Currently, in the Cosmos SDK, there is no convention to sign an arbitrary message like in Ethereum. We propose with this specification, for the Cosmos SDK ecosystem, a way to sign and validate off-chain arbitrary messages.
