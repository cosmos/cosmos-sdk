...
::
    ...
    gaia cli init --chain-id=atlas --node=tcp://localhost:46657

And check our balance:

::

    gaia cli query account $MYADDR
...
::
    ...
    gaia cli tx bond --amount=5fermion --name=bob --pubkey=$PUBKEY
...
::
    ...
    gaia cli tx unbond --amount=5fermion --name=bob
