...
- `RegisterGRPCRoutes(client.Context, *runtime.ServeMux)`: Registers gRPC Gateway routes for the module. 
...
+++ https://github.com/cosmos/cosmos-sdk/blob/325be6ff215db457c6fc7668109640cd7fdac461/types/module/module.go#L160-L182
...
- `RegisterGRPCRoutes(clientCtx client.Context, rtr *runtime.ServeMux)`: Registers gRPC Gateway routes for modules.
