...
First, you need to [install the software](https://cosmos.network/docs/getting-started/installation.html).

Then, you can start [running a full-node](https://cosmos.network/docs/getting-started/join-testnet.html).
