...
- the `Validator` [object](https://github.com/cosmos/cosmos-sdk/blob/61bd6cbd12cdac19a514fcc610ee091c462edfc3/x/staking/types/staking.pb.go#L306-L337) which is fully encoded as `Any`. 
