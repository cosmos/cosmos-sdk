...
- [cosmos/orm/v1alpha1/orm.proto](#cosmos/orm/v1alpha1/orm.proto)
    - [PrimaryKeyDescriptor](#cosmos.orm.v1alpha1.PrimaryKeyDescriptor)
    - [SecondaryIndexDescriptor](#cosmos.orm.v1alpha1.SecondaryIndexDescriptor)
    - [SingletonDescriptor](#cosmos.orm.v1alpha1.SingletonDescriptor)
    - [TableDescriptor](#cosmos.orm.v1alpha1.TableDescriptor)
  
    - [File-level Extensions](#cosmos/orm/v1alpha1/orm.proto-extensions)
    - [File-level Extensions](#cosmos/orm/v1alpha1/orm.proto-extensions)
  
- [cosmos/orm/v1alpha1/schema.proto](#cosmos/orm/v1alpha1/schema.proto)
    - [SchemaDescriptor](#cosmos.orm.v1alpha1.SchemaDescriptor)
    - [SchemaDescriptor.FileEntry](#cosmos.orm.v1alpha1.SchemaDescriptor.FileEntry)
    - [SchemaDescriptor.ModuleEntry](#cosmos.orm.v1alpha1.SchemaDescriptor.ModuleEntry)
...
<a name="cosmos/orm/v1alpha1/orm.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## cosmos/orm/v1alpha1/orm.proto



<a name="cosmos.orm.v1alpha1.PrimaryKeyDescriptor"></a>
...
| `references` | [string](#string) |  | references specifies that this primary key references the primary key of another table. See the documentation for the SecondaryIndexDescriptor.references field for more details. An additional constraint placed on primary keys which reference another table is that those references cannot be circular. |
...
<a name="cosmos.orm.v1alpha1.SecondaryIndexDescriptor"></a>
...
<a name="cosmos.orm.v1alpha1.SingletonDescriptor"></a>
...
<a name="cosmos.orm.v1alpha1.TableDescriptor"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `primary_key` | [PrimaryKeyDescriptor](#cosmos.orm.v1alpha1.PrimaryKeyDescriptor) |  | primary_key defines the primary key for the table. |
| `index` | [SecondaryIndexDescriptor](#cosmos.orm.v1alpha1.SecondaryIndexDescriptor) | repeated | index defines one or more secondary indexes. |
| `id` | [uint32](#uint32) |  | id is a non-zero integer ID that must be unique within the tables and singletons in this file. It may be deprecated in the future when this can be auto-generated. |
...
<a name="cosmos/orm/v1alpha1/orm.proto-extensions"></a>
...
<a name="cosmos.orm.v1alpha1.SchemaDescriptor"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `files` | [google.protobuf.FileDescriptorSet](#google.protobuf.FileDescriptorSet) |  | files is the set of all FileDescriptorProto's needed to decode the stored data. A schema imposes the constraint that every file and every table within that schema have at most one instance in the store. |
| `modules` | [SchemaDescriptor.ModuleEntry](#cosmos.orm.v1alpha1.SchemaDescriptor.ModuleEntry) | repeated | modules is the set of modules in the schema. |
...
<a name="cosmos.orm.v1alpha1.SchemaDescriptor.FileEntry"></a>

### SchemaDescriptor.FileEntry
...
| `file_name` | [string](#string) |  | file_name is the name of a file in the FileDescriptor set that contains table definitions. |
...
<a name="cosmos.orm.v1alpha1.SchemaDescriptor.ModuleEntry"></a>

### SchemaDescriptor.ModuleEntry
ModuleEntry describes a single module's schema.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `name` | [string](#string) |  | name is the name of the module. In the multi-store model this name is used to locate the module's store. |
| `prefix` | [bytes](#bytes) |  | prefix is an optional prefix that precedes all keys in this module's store. |
| `files` | [SchemaDescriptor.FileEntry](#cosmos.orm.v1alpha1.SchemaDescriptor.FileEntry) | repeated | files describes the schema files used in this module. |
