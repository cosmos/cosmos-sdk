...
- [cosmos/distribution/v1beta1/distribution.proto](#cosmos/distribution/v1beta1/distribution.proto)
    - [BlacklistedPower](#cosmos.distribution.v1beta1.BlacklistedPower)
    ...
    - [ValidatorBlacklistedPower](#cosmos.distribution.v1beta1.ValidatorBlacklistedPower)
...
<a name="cosmos.distribution.v1beta1.BlacklistedPower"></a>

### BlacklistedPower
BlacklistedPower tracks the share of tokens that are staked but blacklisted from distribution,
per distribution epoch


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `total_blacklisted_power_share` | [string](#string) |  |  |
| `validator_blacklisted_powers` | [ValidatorBlacklistedPower](#cosmos.distribution.v1beta1.ValidatorBlacklistedPower) | repeated |  |
...
<a name="cosmos.distribution.v1beta1.ValidatorBlacklistedPower"></a>

### ValidatorBlacklistedPower
ValidatorBlacklistedPower tracks the total amount of power blacklisted for a
validator.
...
| ----- | ---- | ----- | ----------- |
| `validator_address` | [string](#string) |  |  |
| `blacklisted_power_share` | [string](#string) |  |  |
