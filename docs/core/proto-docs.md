...
| `time` | [google.protobuf.Timestamp](#google.protobuf.Timestamp) |  | Deprecated: Time based upgrades have been deprecated. Time based upgrade logic has been removed from the SDK. |
...
| `upgraded_client_state` | [google.protobuf.Any](#google.protobuf.Any) |  | Deprecated: UpgradedClientState field has been deprecated. IBC upgrade logic has been moved to the IBC module in the sub module 02-client. |
