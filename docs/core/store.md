...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L12-L15
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L217-L238
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L24-L28

The `Committer` is an interface that defines methods to persist changes to disk:

+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L17-L22
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L83-L112
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L120-L158

As for concrete implementation, the [`rootMulti.Store`] is the go-to implementation of the `CommitMultiStore` interface. 

+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/rootmulti/store.go#L27-L43
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/cachemulti/store.go#L17-L28
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/store.go#L163-L193
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/iavl/store.go#L32-L47
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/dbadapter/store.go#L13-L16
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/transient/store.go#L14-L17
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/x/params/subspace/subspace.go#L24-L32

Transient stores are typically accessed via the [`context`](./context.md) via the `TransientStore()` method:

+++ https://github.com/cosmos/cosmos-sdk/blob/master/types/context.go#L215-L218
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/cachekv/store.go#L26-L33
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/gaskv/store.go#L11-L17
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/gas.go#L141-L150
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/types/context.go#L210-L213

In this case, the default gas configuration is used:

+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/types/gas.go#L152-L163
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/tracekv/store.go#L20-L43
...
+++ https://github.com/cosmos/cosmos-sdk/blob/master/store/prefix/store.go#L17-L20
