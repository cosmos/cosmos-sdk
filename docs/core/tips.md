...
+++ https://github.com/pointnetwork/cosmos-point-sdk/blob/v0.46.0-rc1/proto/cosmos/tx/v1beta1/tx.proto#L230-L249

where we have defined `SignDocDirectAux` as:

+++ https://github.com/pointnetwork/cosmos-point-sdk/blob/v0.46.0-rc1/proto/cosmos/tx/v1beta1/tx.proto#L67-L93

where `Tip` is defined as

+++ https://github.com/pointnetwork/cosmos-point-sdk/blob/v0.46.0-rc1/proto/cosmos/tx/v1beta1/tx.proto#L219-L228
...
For the tipper, the SDK exposes a new transaction builder, the `AuxTxBuilder`, for generating an `AuxSignerData`. The API of `AuxTxBuilder` is defined [in `client/tx`](https://github.com/pointnetwork/cosmos-point-sdk/blob/v0.46.0-rc1/client/tx/aux_builder.go#L16), and can be used as follows:
