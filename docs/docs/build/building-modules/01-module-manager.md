...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L56-L66
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L71-L73
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L76-L79
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L195-L199
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L202-L205
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L208-L211
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L214-L220
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/core/appmodule/module.go#L56-L63
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/core/appmodule/module.go#L66-L72
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L222-L225
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/core/appmodule/module.go#L49-L52
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L82
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/types/module/module.go#L267-L276
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/simapp/app.go#L411-L434
```

This is the same example from `runtime` (the package that powers app di):

```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/runtime/module.go#L61
```

```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-alpha.0/runtime/module.go#L82
```
