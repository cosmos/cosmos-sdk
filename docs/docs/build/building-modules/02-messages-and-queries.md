...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/auth/v1beta1/query.proto#L14-L82
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/baseapp/abci.go#L1047-L1077
```
