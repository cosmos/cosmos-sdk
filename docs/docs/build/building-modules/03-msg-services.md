...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/bank/types/tx.pb.go#L540-L556
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/bank/keeper/msg_server.go#L7-L19
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/bank/keeper/msg_server.go#L46-L56
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/baseapp/msg_service_router.go#L198-L208
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/base/abci/v1beta1/abci.proto#L88-L106
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/auth/vesting/msg_server.go#L69-L91
```
