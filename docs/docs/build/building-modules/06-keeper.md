...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-rc.2/x/staking/keeper/keeper.go#L23-L31
```
...
For more, see an example of `keeper`'s [methods implementation from the `staking` module](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-rc.2/x/staking/keeper/keeper.go).
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-rc.2/x/auth/keeper/account.go
```
