...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/invariant.go#L1-L9
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/invariant.go#L4-L17
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/crisis/keeper/keeper.go#L41-L53
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/crisis/abci.go#L12-L22
```
