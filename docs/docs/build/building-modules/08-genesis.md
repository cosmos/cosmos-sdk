...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/auth/module.go#L51-L65
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/auth/types/genesis.go#L53-L76
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/auth/keeper/genesis.go#L1-L35
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/auth/keeper/genesis.go#L27-L49
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/core/genesis/txhandler.go#L1-L6
```
