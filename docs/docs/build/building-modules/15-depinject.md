...
* Message fields define the module configuration.
  ...
  ```go reference
  https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/simapp/app_config.go#L246-L262
  ```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/api/cosmos/group/module/v1/module.pulsar.go#L505-L527
```
...
1. Import the module configuration generated package:
    ...
    ```go reference
    https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/group/module/module.go#L1-L13
    ```
    ...
    ```go reference
    https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/group/module/module.go#L188-L203
    ```

2. Ensure that the module implements the `appmodule.AppModule` interface:

    ```go reference
    https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/group/module/module.go#L60-L67
    ```
...
3. Define a struct that inherits `depinject.In` and define the module inputs (i.e. module dependencies):
   ...
   * `depinject` also checks that all dependencies are provided.
    ...
    ```go reference
    https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/group/module/module.go#L195-L215
    ```
...
4. Define the module outputs with a public struct that inherits `depinject.Out`:
   The module outputs are the dependencies that the module provides to other modules. It is usually the module itself and its keeper.
    ...
    ```go reference
    https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/group/module/module.go#L207-L222
    ```
