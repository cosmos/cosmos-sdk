...
* [Collections](https://pkg.go.dev/cosmossdk.io/collections) - State management library

## Automation

* [Depinject]https://pkg.go.dev/cosmossdk.io/depinject) - Dependency injection framework
