...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/Makefile#L418-L439
```
...
`buf.gen.swagger.yaml` generates the swagger documentation for the query and messages of the chain. This will only define the REST API end points that were defined in the query and msg servers. You can find examples of this [here](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/bank/v1beta1/query.proto#L9-L19)
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/buf.lock#L1-L16
```

#### `buf.yaml`

`buf.yaml` defines the [name of your package](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/buf.yaml#L1-L3), which [breakage checker](https://docs.buf.build/tour/detect-breaking-changes) to use and how to [lint your protobuf files](https://buf.build/docs/tutorials/getting-started-with-buf-cli#lint-your-api). 

```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/buf.yaml#L1-L24
```
