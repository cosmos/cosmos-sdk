...
* [Anatomy of an SDK application](../high-level-concepts/00-app-anatomy.md)
...
In practice, the [constructor of the application](../high-level-concepts/00-app-anatomy.md#constructor-function) is passed as the `appCreator`.
