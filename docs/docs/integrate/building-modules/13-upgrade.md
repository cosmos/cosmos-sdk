...
:::note Synopsis
[In-Place Store Migrations](../../develop/advanced-concepts/15-upgrade.md) allow your modules to upgrade to new versions that include breaking changes. This document outlines how to build modules to take advantage of this functionality.
:::

:::note Pre-requisite Readings

* [In-Place Store Migration](../../develop/advanced-concepts/15-upgrade.md)
