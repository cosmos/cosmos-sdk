...
* **VoteInfo:** A list of the ABCI type [`VoteInfo`](https://docs.cometbft.com/v0.37/spec/abci/), which includes the name of a validator and a boolean indicating whether they have signed the block.
