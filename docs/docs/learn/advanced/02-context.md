...
* **Consensus Params:** The ABCI type [Consensus Parameters](https://docs.cometbft.com/v1.0/spec/consensus/), which specify certain limits for the blockchain, such as maximum gas for a block.
