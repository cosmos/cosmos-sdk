...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/tx_msg.go#L101-L115
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/account.go#L5-L32
```
...
* the [`Validator`](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/staking/types/staking.pb.go#L340-L375) struct that contains information about a validator.
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/staking/types/validator.go#L33-L66
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/codec/types/interface_registry.go#L42-L89
```
