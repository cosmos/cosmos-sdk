...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/tx_msg.go#L112-L115
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/account.go#L18-L30
```
...
* the [`Validator`](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/staking/types/staking.pb.go#L341-L375) struct that contains information about a validator.
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/staking/types/validator.go#L43-L64
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/codec/types/interface_registry.go#L48-L86
```
