...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/server/types/app.go#L46-L48
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/bank/v1beta1/query.proto#L23-L30
```
