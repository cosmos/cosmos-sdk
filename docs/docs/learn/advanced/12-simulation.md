...
Check the full list of flags [here](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/simulation/client/cli/flags.go#L44-L69).
...
check the Cosmos SDK [Makefile](https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/Makefile#L285-L314).
