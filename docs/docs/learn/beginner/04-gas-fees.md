...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/store/types/gas.go#L40-L51
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/types/tx_msg.go#L53-L57
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/tx/v1beta1/tx.proto#L15-L26
```
