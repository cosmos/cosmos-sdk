...
:::note Synopsis
This document describes how to configure and use the keyring and its various backends for an [**application**](../../develop/high-level-concepts/00-app-anatomy.md).
:::
