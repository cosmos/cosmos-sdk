...
```mermaid
graph TD
    A0[Account 0] --> A0A[Address 0]
    A0A --> A0PK[Public key 0]
    A0PK --> A0SK[Private key 0]

    A1[Account 1] --> A1A[Address 1]
    A1A --> A1PK[Public key 1]
    A1PK --> A1SK[Private key 1]

    A2[Account 2] --> A2A[Address 2]
    A2A --> A2PK[Public key 2]
    A2PK --> A2SK[Private key 2]

    A0SK --> MasterPK[Master PrivKey]
    A1SK --> MasterPK[Master PrivKey]
    A2SK --> MasterPK[Master PrivKey]

    MasterPK --> Mnemonic["Mnemonic (Seed)"]
```
