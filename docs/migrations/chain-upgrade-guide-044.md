...
The IBC module for the Cosmos SDK has moved to its [own repository](https://github.com/cosmos/ibc-go) for v0.42 later versions, go through these [docs](https://github.com/cosmos/ibc-go/blob/main/docs/migrations/ibc-migration-043.md) for migrations.
