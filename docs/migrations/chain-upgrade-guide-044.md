...
IBC module has been moved to a separate repo for v0.42 later versions, go through these [docs](https://github.com/cosmos/ibc-go/blob/main/docs/migrations/ibc-migration-043.md) for migrations.
