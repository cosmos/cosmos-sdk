...
This is a mess now, we need to figure out what formats we use, define go-codec, etc. or just point to the source???? Will do more later, need help here from the tendermint core team.
