...
* A [`querier`](04-query-services.md#query-services), to process the `query` once it has been [routed to the module](../../learn/advanced/00-baseapp.md#grpc-query-router).
