...
func (UnimplementedQueryServer) WithdrawableFees(context.Context, *QueryWithdrawableFeesRequest) (*QueryWithdrawableFeesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WithdrawableFees not implemented")
}
func (UnimplementedQueryServer) TotalPower(context.Context, *QueryTotalPowerRequest) (*QueryTotalPowerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TotalPower not implemented")
}
