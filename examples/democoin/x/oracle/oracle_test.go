...
func TestOracle(t *testing.T) {
	...
	valset := &mock.ValidatorSet{[]mock.Validator{
		{addr1, sdk.NewDec(7, 0)},
		{addr2, sdk.NewDec(7, 0)},
		{addr3, sdk.NewDec(1, 0)},
	}}
	...
	ork := NewKeeper(key, cdc, valset, sdk.NewDec(667, 3), 100) // 66.7%
	...
	valset.AddValidator(mock.Validator{addr4, sdk.NewDec(12, 0)})
	bz, err = json.Marshal(valset)
	require.Nil(t, err)
	ctx = ctx.WithBlockHeader(abci.Header{ValidatorsHash: bz})
