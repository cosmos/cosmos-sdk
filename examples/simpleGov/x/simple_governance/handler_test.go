...
// 	_, err = checkProposal(ctx, k, newTags)
// 	assert.Nil(t, err)
//
// 	// Voting Handler
//
...
// 	_ = stake.NewMsgCreateValidator(addrs[0], pks[0], validatorBond, declareDescription)
//
// 	delegateBond := sdk.Coin{"Atom", sdk.NewInt(int64(20))}
// 	_ = stake.NewMsgDelegate(addrs[1], addrs[0], delegateBond)
//
