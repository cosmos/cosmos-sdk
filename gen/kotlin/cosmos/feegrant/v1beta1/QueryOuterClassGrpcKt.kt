...
object QueryGrpcKt {
  ...
  class QueryCoroutineStub @JvmOverloads constructor(
     ...
     */
    suspend fun allowance(request: QueryOuterClass.QueryAllowanceRequest, headers: Metadata =
     ...
     * @return The single response from the server.
     */
    suspend fun allowances(request: QueryOuterClass.QueryAllowancesRequest, headers: Metadata =
