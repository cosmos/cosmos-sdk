...
public inline fun depositParams(block: cosmos.gov.v1beta2.DepositParamsKt.Dsl.() -> kotlin.Unit): cosmos.gov.v1beta2.Gov.DepositParams =
  cosmos.gov.v1beta2.DepositParamsKt.Dsl._create(cosmos.gov.v1beta2.Gov.DepositParams.newBuilder()).apply { block() }._build()
public object DepositParamsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.gov.v1beta2.Gov.DepositParams.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.gov.v1beta2.Gov.DepositParams.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.gov.v1beta2.Gov.DepositParams = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.gov.v1beta2.Gov.DepositParams.copy(block: cosmos.gov.v1beta2.DepositParamsKt.Dsl.() -> kotlin.Unit): cosmos.gov.v1beta2.Gov.DepositParams =
  cosmos.gov.v1beta2.DepositParamsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
