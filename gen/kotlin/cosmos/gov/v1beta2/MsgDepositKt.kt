...
public inline fun msgDeposit(block: cosmos.gov.v1beta2.MsgDepositKt.Dsl.() -> kotlin.Unit): cosmos.gov.v1beta2.Tx.MsgDeposit =
  cosmos.gov.v1beta2.MsgDepositKt.Dsl._create(cosmos.gov.v1beta2.Tx.MsgDeposit.newBuilder()).apply { block() }._build()
public object MsgDepositKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.gov.v1beta2.Tx.MsgDeposit.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.gov.v1beta2.Tx.MsgDeposit.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.gov.v1beta2.Tx.MsgDeposit = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.gov.v1beta2.Tx.MsgDeposit.copy(block: cosmos.gov.v1beta2.MsgDepositKt.Dsl.() -> kotlin.Unit): cosmos.gov.v1beta2.Tx.MsgDeposit =
  cosmos.gov.v1beta2.MsgDepositKt.Dsl._create(this.toBuilder()).apply { block() }._build()
