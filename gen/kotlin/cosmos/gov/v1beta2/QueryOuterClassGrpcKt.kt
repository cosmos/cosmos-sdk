...
import cosmos.gov.v1beta2.QueryGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for cosmos.gov.v1beta2.Query.
 */
object QueryGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) cosmos.gov.v1beta2.Query service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the cosmos.gov.v1beta2.Query service based on Kotlin coroutines.
   */
  abstract class QueryCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Proposal.
     *
    ...
    open suspend fun proposal(request: QueryOuterClass.QueryProposalRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Proposal is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Proposals.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun proposals(request: QueryOuterClass.QueryProposalsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Proposals is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Vote.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun vote(request: QueryOuterClass.QueryVoteRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Vote is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Votes.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun votes(request: QueryOuterClass.QueryVotesRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Votes is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Params.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun params(request: QueryOuterClass.QueryParamsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Params is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Deposit.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun deposit(request: QueryOuterClass.QueryDepositRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Deposit is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.Deposits.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun deposits(request: QueryOuterClass.QueryDepositsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.Deposits is unimplemented"))

    /**
     * Returns the response to an RPC for cosmos.gov.v1beta2.Query.TallyResult.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun tallyResult(request: QueryOuterClass.QueryTallyResultRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta2.Query.TallyResult is unimplemented"))
