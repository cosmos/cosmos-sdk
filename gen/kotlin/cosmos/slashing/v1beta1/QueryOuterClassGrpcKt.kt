...
object QueryGrpcKt {
  ...
  class QueryCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    suspend fun signingInfo(request: QueryOuterClass.QuerySigningInfoRequest, headers: Metadata =
        Metadata()): QueryOuterClass.QuerySigningInfoResponse = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    suspend fun signingInfos(request: QueryOuterClass.QuerySigningInfosRequest, headers: Metadata =
        Metadata()): QueryOuterClass.QuerySigningInfosResponse = unaryRpc(
      channel,
