...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NFTsOfClass = channel.unary_unary(
                '/cosmos.nft.v1beta1.Query/NFTsOfClass',
                request_serializer=cosmos_dot_nft_dot_v1beta1_dot_query__pb2.QueryNFTsOfClassRequest.SerializeToString,
                response_deserializer=cosmos_dot_nft_dot_v1beta1_dot_query__pb2.QueryNFTsOfClassResponse.FromString,
                )
...
class QueryServicer(object):
    ...
    def NFTsOfClass(self, request, context):
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'NFTsOfClass': grpc.unary_unary_rpc_method_handler(
                    servicer.NFTsOfClass,
                    request_deserializer=cosmos_dot_nft_dot_v1beta1_dot_query__pb2.QueryNFTsOfClassRequest.FromString,
                    response_serializer=cosmos_dot_nft_dot_v1beta1_dot_query__pb2.QueryNFTsOfClassResponse.SerializeToString,
            ),
...
class Query(object):
    ...
    def NFTsOfClass(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.nft.v1beta1.Query/NFTsOfClass',
            cosmos_dot_nft_dot_v1beta1_dot_query__pb2.QueryNFTsOfClassRequest.SerializeToString,
            cosmos_dot_nft_dot_v1beta1_dot_query__pb2.QueryNFTsOfClassResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
