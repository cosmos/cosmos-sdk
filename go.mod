...
replace (
	// TODO MUST BE REMOVED IN THE NEXT FOLLOWING PR (or this PR needs to be split and cosmossdk.io/api tagged)
	cosmossdk.io/api => cosmossdk.io/api v0.1.0-alpha10
