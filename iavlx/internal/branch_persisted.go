...
// BranchPersisted implements the Node interface for a pinned BranchLayout and
// a pinned ChangesetReader for the file within which the BranchLayout occurs.
// Both the ChangesetReader and BranchLayout must be actively pinned while this
