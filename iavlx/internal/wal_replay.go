...
func ReplayWALForStartup(ctx context.Context, root *NodePointer, walFile *os.File, rootVersion, expectedVersion uint32, logger *slog.Logger, autoRepair bool) (*NodePointer, uint32, bool, error) {
