...
// Kind represents the basic type of a column in the table schema.
...
const (
	...
	// or a type which implements fmt.Stringer. Columns of this type are expected to set the AddressPrefix field
	// in the column definition to the bech32 address prefix.
	Bech32AddressKind

	// EnumKind is an enum type and values of this type must be of the go type string or implement fmt.Stringer.
	// Columns of this type are expected to set the EnumDefinition field in the column definition to the enum
	// definition.
	EnumKind
