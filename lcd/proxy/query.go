...
import (
	...
	"github.com/cosmos/cosmos-sdk/lcd/client"
...
func GetWithProofOptions(path string, key []byte, opts rpcclient.ABCIQueryOptions,
	node rpcclient.Client, cert lcd.Certifier) (
...
func GetCertifiedCommit(h int64, node rpcclient.Client, cert lcd.Certifier) (lcd.Commit, error) {
