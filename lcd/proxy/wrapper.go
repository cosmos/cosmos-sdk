...
func SecureClient(c rpcclient.Client, cert *lcd.InquiringCertifier) Wrapper {
	wrap := Wrapper{c, cert}
...
// Commit downloads the Commit and certifies it with the lcd.
//
