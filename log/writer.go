...
// filterWriter filters log events based on module and level.
...
// NewFilterWriter returns a writer that filters out all log events that do not match the filter.
