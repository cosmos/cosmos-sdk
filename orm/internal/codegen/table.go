...
func newTableGen(fileGen fileGen, msg *protogen.Message, table *orm.TableDescriptor) (*tableGen, error) {
	...
	uniqIndexes := make([]*orm.SecondaryIndexDescriptor, 0)
...
func (t tableGen) genUniqueIndexSig(idx *orm.SecondaryIndexDescriptor) {
