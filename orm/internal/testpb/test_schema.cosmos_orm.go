...
func (this exampleAutoIncrementTableTable) CurrentSequence(ctx context.Context) (uint64, error) {
	return this.table.CurrentSequence(ctx)
}
...
func (this exampleTimestampTable) CurrentSequence(ctx context.Context) (uint64, error) {
	return this.table.CurrentSequence(ctx)
}
...
func (this exampleAutoIncFieldNameTable) CurrentSequence(ctx context.Context) (uint64, error) {
	return this.table.CurrentSequence(ctx)
}
