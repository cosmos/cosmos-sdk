...
func (p primaryKeyIndex) List(ctx context.Context, prefixKey []interface{}, options ...ormlist.Option) (Iterator, error) {
	...
	return prefixIterator(backend.CommitmentStoreReader(), backend, p, p.KeyCodec, encodeutil.ValuesOf(prefixKey...), options)
}
...
func (p primaryKeyIndex) ListRange(ctx context.Context, from, to []interface{}, options ...ormlist.Option) (Iterator, error) {
	...
	return rangeIterator(backend.CommitmentStoreReader(), backend, p, p.KeyCodec, encodeutil.ValuesOf(from...), encodeutil.ValuesOf(to...), options)
}
