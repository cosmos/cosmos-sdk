...
func (kss *KafkaStreamingService) ListenSuccess() <-chan bool {
...
func (kss *KafkaStreamingService) writeAsJsonToKafka(ctx sdk.Context, topic string, key string, data proto.Message) error {
	kodec := kss.codec.(*codec.ProtoCodec)
	...
	kss.producer.ProduceChannel() <- &kafka.Message{
