...
replace (
	...
	cosmossdk.io/server/v2/appmanager => ../../server/v2/appmanager // broken until https://github.com/cosmos/cosmos-sdk/pull/20315 is merged
	cosmossdk.io/server/v2/stf => ../../server/v2/stf // broken until https://github.com/cosmos/cosmos-sdk/pull/20286 is merged
...
require (
	...
	buf.build/gen/go/cosmos/gogo-proto/protocolbuffers/go v1.34.0-20230509103710-5e5b9fdd0180.1 // indirect
