...
// ValidateKeyValue validates that the value conforms to the set of fields as a Key in an ObjectUpdate.
// See ObjectUpdate.Key for documentation on the requirements of such keys.
func ValidateKeyValue(keyFields []Field, value interface{}) error {
	return validateFieldsValue(keyFields, value)
}

// ValidateValueValue validates that the value conforms to the set of fields as a Value in an ObjectUpdate.
// See ObjectUpdate.Value for documentation on the requirements of such values.
func ValidateValueValue(valueFields []Field, value interface{}) error {
