...
const (
	...
	// Key Wire Encoding: 1-byte two's complement encoding, with the first bit inverted for sorting.
	// Value Wire Encoding: 1-byte two's complement encoding.
	Int8Kind

	// Uint8Kind represents an 8-bit unsigned integer.
	// Go Encoding: uint8
	// JSON Encoding: number
	// Key Wire Encoding: 1-byte unsigned encoding.
	// Value Wire Encoding: 1-byte unsigned encoding.
	Uint8Kind

	// Int16Kind represents a 16-bit signed integer.
	// Go Encoding: int16
	// JSON Encoding: number
	// Key Wire Encoding: 2-byte two's complement big-endian encoding, with the first bit inverted for sorting.
	// Value Wire Encoding: 2 byte two's complement little-endian encoding.
	Int16Kind

	// Uint16Kind represents a 16-bit unsigned integer.
	// Go Encoding: uint16
	// JSON Encoding: number
	// Key Wire Encoding: 2-byte unsigned big-endian encoding.
	// Value Wire Encoding: 2-byte unsigned little-endian encoding.
	Uint16Kind

	// Int32Kind represents a 32-bit signed integer.
	// Go Encoding: int32
	// JSON Encoding: number
	// Key Wire Encoding: 4-byte two's complement big-endian encoding, with the first bit inverted for sorting.
	// Value Wire Encoding: 4-byte two's complement little-endian encoding.
	Int32Kind

	// Uint32Kind represents a 32-bit unsigned integer.
	// Go Encoding: uint32
	// JSON Encoding: number
	// Key Wire Encoding: 4-byte unsigned big-endian encoding.
	// Value Wire Encoding: 4-byte unsigned little-endian encoding.
	Uint32Kind
	...
	// Key Wire Encoding: 8-byte two's complement big-endian encoding, with the first bit inverted for sorting.
	// Value Wire Encoding: 8-byte two's complement little-endian encoding.
	Int64Kind
	...
	// Key Wire Encoding: 8-byte unsigned big-endian encoding.
	// Value Wire Encoding: 8-byte unsigned little-endian encoding.
	Uint64Kind
	...
	// Canonically encoded values should include no leading zeros.
	// Key Wire Encoding: string encoding with no leading zeros.
	// Value Wire Encoding: string encoding with no leading zeros.
	IntegerStringKind
	...
	// Key Wire Encoding: string encoding with the above canonicalization rules.
	// Value Wire Encoding: string encoding with the above canonicalization rules.
	DecimalStringKind

	// BoolKind represents a boolean true or false value.
	// Go Encoding: bool
	// JSON Encoding: boolean
	// Key Wire Encoding: 1-byte encoding where 0 is false and 1 is true.
	// Value Wire Encoding: 1-byte encoding where 0 is false and 1 is true.
	BoolKind
	...
	// Go Encoding: float32
	// JSON Encoding: number
	// Key Wire Encoding: 4-byte IEEE-754 encoding.
	// Value Wire Encoding: 4-byte IEEE-754 encoding.
	Float32Kind

	// Float64Kind represents an IEEE-754 64-bit floating point number.
	// Go Encoding: float64
	// JSON Encoding: number
	// Key Wire Encoding: 8-byte IEEE-754 encoding.
	// Value Wire Encoding: 8-byte IEEE-754 encoding.
	Float64Kind
	...
	// Key Wire Encoding: string encoding
