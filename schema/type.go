...
func (s emptyTypeSet) LookupEnumType(name string) (t EnumType, found bool) {
	return EnumType{}, false
}

func (s emptyTypeSet) LookupObjectType(name string) (t ObjectType, found bool) {
	return ObjectType{}, false
}

func (emptyTypeSet) AllTypes(func(Type) bool) {}

func (s emptyTypeSet) EnumTypes(f func(EnumType) bool) {}

func (s emptyTypeSet) ObjectTypes(f func(ObjectType) bool) {}
