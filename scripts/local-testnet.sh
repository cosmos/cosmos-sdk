...
$SIMD start --log_level=info --home "$HOME/.testnet/node0/simd" &
$SIMD start --log_level=info --home "$HOME/.testnet/node1/simd" &
$SIMD start --log_level=info --home "$HOME/.testnet/node2/simd" 
