...
$SIMD testnet init-files --chain-id=testing --output-dir="$HOME/.testnet" --validator-count=4 --keyring-backend=test --commit-timeout=900ms --single-host
...
# $SIMD start --log_level=info --home "$HOME/.testnet/node3/simdv2" 