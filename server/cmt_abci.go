...
func (w cometABCIWrapper) FetchOracleResults(_ context.Context, req *abci.RequestFetchOracleResults) (*abci.ResponseFetchOracleResults, error) {
	return w.app.FetchOracleResults(req)
}
