...
func (s *serverReflectionServer) ServerReflectionInfo(stream rpb.ServerReflection_ServerReflectionInfoServer) error {
	...
	for {
		...
		out := &rpb.ServerReflectionResponse{ //nolint:staticcheck
			ValidHost:       in.Host, //nolint:staticcheck
			OriginalRequest: in,
		}
		switch req := in.MessageRequest.(type) {
		case *rpb.ServerReflectionRequest_FileByFilename:
			b, err := s.fileDescEncodingByFilename(req.FileByFilename, sentFileDescriptors) //nolint:staticcheck
			if err != nil {
				out.MessageResponse = &rpb.ServerReflectionResponse_ErrorResponse{
					ErrorResponse: &rpb.ErrorResponse{ //nolint:staticcheck
				...
				out.MessageResponse = &rpb.ServerReflectionResponse_FileDescriptorResponse{
					FileDescriptorResponse: &rpb.FileDescriptorResponse{FileDescriptorProto: b}, //nolint:staticcheck
				}
			}
		case *rpb.ServerReflectionRequest_FileContainingSymbol:
			b, err := s.fileDescEncodingContainingSymbol(req.FileContainingSymbol, sentFileDescriptors) //nolint:staticcheck
			if err != nil {
				out.MessageResponse = &rpb.ServerReflectionResponse_ErrorResponse{
					ErrorResponse: &rpb.ErrorResponse{ //nolint:staticcheck
						ErrorCode:    int32(codes.NotFound),
		...
		case *rpb.ServerReflectionRequest_FileContainingExtension:
			typeName := req.FileContainingExtension.ContainingType //nolint:staticcheck
			extNum := req.FileContainingExtension.ExtensionNumber  //nolint:staticcheck
		...
		case *rpb.ServerReflectionRequest_AllExtensionNumbersOfType:
			extNums, err := s.allExtensionNumbersForTypeName(req.AllExtensionNumbersOfType) //nolint:staticcheck
			if err != nil {
				out.MessageResponse = &rpb.ServerReflectionResponse_ErrorResponse{
					ErrorResponse: &rpb.ErrorResponse{ //nolint:staticcheck
						ErrorCode:    int32(codes.NotFound),
				...
				out.MessageResponse = &rpb.ServerReflectionResponse_AllExtensionNumbersResponse{
					AllExtensionNumbersResponse: &rpb.ExtensionNumberResponse{ //nolint:staticcheck
						BaseTypeName:    req.AllExtensionNumbersOfType, //nolint:staticcheck
		...
		case *rpb.ServerReflectionRequest_ListServices:
			...
			serviceResponses := make([]*rpb.ServiceResponse, len(svcNames)) //nolint:staticcheck
			for i, n := range svcNames {
				serviceResponses[i] = &rpb.ServiceResponse{ //nolint:staticcheck
					Name: n,
				}
			}
			out.MessageResponse = &rpb.ServerReflectionResponse_ListServicesResponse{
				ListServicesResponse: &rpb.ListServiceResponse{ //nolint:staticcheck
