...
func _Msg_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) { //nolint:revive // this violates context-as-argument, but doesn't seem like it should be changed
	in := new(KVStoreTx)
