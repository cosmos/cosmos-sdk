...
func (msg *KVStoreTx) GetMsgsV2() ([]protoreflect.ProtoMessage, error) {
	return []protoreflect.ProtoMessage{&bankv1beta1.MsgSend{FromAddress: msg.address.String()}}, nil // this is a hack for tests
}
