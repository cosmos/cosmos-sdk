...
// Error defines an error that can be converted to a Rosetta OnlineAPI error.
type Error interface {
	error
	// RosettaError returns the error as a Rosetta OnlineAPI error.
...
// returned by the OnlineAPI, it's required for the
