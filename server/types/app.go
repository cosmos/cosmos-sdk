...
type (
	...
	AppCreator func(log.Logger, dbm.Connection, io.Writer, AppOptions) Application
	...
	AppExporter func(log.Logger, dbm.Connection, io.Writer, int64, bool, []string, AppOptions) (ExportedApp, error)
)
