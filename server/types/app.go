...
type (
	...
	AppCreator func(log.Logger, dbm.DBConnection, io.Writer, AppOptions) Application
	...
	AppExporter func(log.Logger, dbm.DBConnection, io.Writer, int64, bool, []string, AppOptions) (ExportedApp, error)
)
