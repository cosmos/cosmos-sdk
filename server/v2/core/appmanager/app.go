...
type PrepareHandler[T transaction.Tx] func(context.Context, store.ReadonlyAccountsState) ([]T, error)
...
type ProcessHandler[T transaction.Tx] func(context.Context, []T, store.ReadonlyAccountsState) error
