...
func NewSimApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	app.supplyKeeper = supply.NewKeeper(app.cdc, app.keySupply, app.accountKeeper, supply.DefaultCodespace)
	...
	app.govKeeper = gov.NewKeeper(app.cdc, app.keyGov, app.paramsKeeper, govSubspace,
		app.bankKeeper, app.supplyKeeper, &stakingKeeper, gov.DefaultCodespace, govRouter)
