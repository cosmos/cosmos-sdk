...
func NewSimApp(
	...
	env := runtime.NewEnvironment(keys, nil)
	...
	app.CircuitKeeper = circuitkeeper.NewKeeper(env, appCodec, authtypes.NewModuleAddress(govtypes.ModuleName).String(), app.AuthKeeper.AddressCodec())
