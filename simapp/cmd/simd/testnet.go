...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a simd testnet",
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		simConfigFilePath := filepath.Join(nodeDir, "config/simd.toml")
		srvconfig.WriteConfigFile(simConfigFilePath, simappConfig)
	}
