...
type MsgGovSubmitProposal struct {
	*types.MsgSubmitProposalBase `protobuf:"bytes,1,opt,name=base,proto3,embedded=base" json:"base,omitempty"`
	...
	Content isMsgGovSubmitProposal_Content `protobuf_oneof:"content"`
}
...
type isMsgGovSubmitProposal_Content interface {
	isMsgGovSubmitProposal_Content()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*MsgGovSubmitProposal_TextProposal) isMsgGovSubmitProposal_Content()      {}
func (*MsgGovSubmitProposal_SomeOtherProposal) isMsgGovSubmitProposal_Content() {}

func (m *MsgGovSubmitProposal) GetContent() isMsgGovSubmitProposal_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (m *MsgGovSubmitProposal) GetTextProposal() *types.TextProposal {
	if x, ok := m.GetContent().(*MsgGovSubmitProposal_TextProposal); ok {
...
func (m *MsgGovSubmitProposal) GetSomeOtherProposal() *SomeOtherProposal {
	if x, ok := m.GetContent().(*MsgGovSubmitProposal_SomeOtherProposal); ok {
...
var fileDescriptor_7a72d24c3c2e20ba = []byte{
	...
	,
}
...
func (m *MsgGovSubmitProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Content = &MsgGovSubmitProposal_TextProposal{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Content = &MsgGovSubmitProposal_SomeOtherProposal{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCodec(dAtA[iNdEx:])
