...
func NewTestnetCmd(mm module.BasicManager, genBalIterator banktypes.GenesisBalancesIterator, appName string) *cobra.Command {
	...
	testnetCmd.AddCommand(testnetInitFilesCmd(mm, genBalIterator, appName))
