...
func SignCheckDeliver(
	...
	_, res, tx, err := app.Simulate(txBytes)
...
// every transaction.
func GenSequenceOfTxs(txGen client.TxGenerator, msgs []sdk.Msg, accNums []uint64, initSeqNums []uint64, numToGenerate int, priv ...crypto.PrivKey) []sdk.Tx {
