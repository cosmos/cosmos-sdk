...
func TestManager_Take(t *testing.T) {
	...
	assert.Equal(t, &types.Snapshot{
		...
		Chunks: 1,
		Hash:   []uint8{0x30, 0x4d, 0xd7, 0x8, 0xd6, 0x37, 0xb3, 0x36, 0x15, 0x3b, 0x2b, 0x24, 0xa3, 0xdc, 0x43, 0x81, 0xb0, 0x3b, 0x4c, 0xbf, 0xaa, 0x6, 0x80, 0xe6, 0xed, 0x8, 0x4b, 0x9f, 0xe9, 0x18, 0x95, 0x3},
