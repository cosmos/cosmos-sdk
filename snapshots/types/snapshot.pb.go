...
type SnapshotItem_AppVersion struct {
	AppVersion *SnapshotAppVersion `protobuf:"bytes,5,opt,name=app_version,json=appVersion,proto3,oneof" json:"app_version,omitempty"`
}
...
func (*SnapshotItem_AppVersion) isSnapshotItem_Item()       {}
...
func (m *SnapshotItem) GetAppVersion() *SnapshotAppVersion {
	if x, ok := m.GetItem().(*SnapshotItem_AppVersion); ok {
		return x.AppVersion
	}
	return nil
}
...
type SnapshotAppVersion struct {
	Version uint64 `protobuf:"varint,1,opt,name=version,proto3" json:"version,omitempty"`
}

func (m *SnapshotAppVersion) Reset()         { *m = SnapshotAppVersion{} }
func (m *SnapshotAppVersion) String() string { return proto.CompactTextString(m) }
func (*SnapshotAppVersion) ProtoMessage()    {}
func (*SnapshotAppVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd7a3c9b0a19e1ee, []int{7}
}
func (m *SnapshotAppVersion) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SnapshotAppVersion) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SnapshotAppVersion.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SnapshotAppVersion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SnapshotAppVersion.Merge(m, src)
}
func (m *SnapshotAppVersion) XXX_Size() int {
	return m.Size()
}
func (m *SnapshotAppVersion) XXX_DiscardUnknown() {
	xxx_messageInfo_SnapshotAppVersion.DiscardUnknown(m)
}

var xxx_messageInfo_SnapshotAppVersion proto.InternalMessageInfo

func (m *SnapshotAppVersion) GetVersion() uint64 {
	if m != nil {
		return m.Version
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*SnapshotAppVersion)(nil), "cosmos.base.snapshots.v1beta1.SnapshotAppVersion")
}
...
var fileDescriptor_dd7a3c9b0a19e1ee = []byte{
	...
	,
}
...
func (m *SnapshotItem_AppVersion) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SnapshotItem_AppVersion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AppVersion != nil {
		{
...
func (m *SnapshotAppVersion) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SnapshotAppVersion) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SnapshotAppVersion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SnapshotItem_AppVersion) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SnapshotAppVersion) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SnapshotItem) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			v := &SnapshotAppVersion{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Item = &SnapshotItem_AppVersion{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSnapshot(dAtA[iNdEx:])
...
func (m *SnapshotAppVersion) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SnapshotAppVersion: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SnapshotAppVersion: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
