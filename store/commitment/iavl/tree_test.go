...
func TestCommitterSuite(t *testing.T) {
	s := &commitment.CommitStoreTestSuite{
		NewStore: func(db store.RawDB, storeKeys []string, pruneOPtions *store.PruneOptions, logger log.Logger) (*commitment.CommitStore, error) {
			...
			return commitment.NewCommitStore(multiTrees, db, pruneOPtions, logger)
		},
	}
