...
func TestImmutableTreePanics(t *testing.T) {
	...
	require.Panics(t, func() { it.SaveVersion() })           //nolint:errcheck // checking for a panic, not an error
	require.Panics(t, func() { it.DeleteVersion(int64(1)) }) //nolint:errcheck // checking for a panic, not an error
