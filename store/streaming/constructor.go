...
type ServiceConstructor func(opts serverTypes.AppOptions, keys []types.StoreKey, marshaller codec.BinaryCodec, logger log.Logger, homePath string) (baseapp.StreamingService, error)
...
func NewFileStreamingService(opts serverTypes.AppOptions, keys []types.StoreKey, marshaller codec.BinaryCodec, logger log.Logger, homePath string) (baseapp.StreamingService, error) {
...
func LoadStreamingServices(bApp *baseapp.BaseApp, appOpts serverTypes.AppOptions, appCodec codec.BinaryCodec, logger log.Logger, keys map[string]*types.KVStoreKey, homePath string) ([]baseapp.StreamingService, *sync.WaitGroup, error) {
