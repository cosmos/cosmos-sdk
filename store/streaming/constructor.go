...
type ServiceConstructor func(opts serverTypes.AppOptions, keys []types.StoreKey, marshaller codec.BinaryCodec, logger log.Logger) (baseapp.StreamingService, error)
