...
const (
	flagRemoveAfter    = "file-server.remove-after"
	flagFilePrefix     = "file-server.file-prefix"
	flagReadDir        = "file-server.read-dir"
	flagChainID        = "file-server.chain-id"
	flagGRPCAddress    = "file-server.grpc.address"
	flagGRPCWebEnable  = "file-server.grpc-web.enable"
	flagGRPCWebAddress = "file-server.grpc-web.address"
)
...
func StartCmd(appCreator types.AppCreator, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "start",
		Short: "Run the state change file server",
		Long: ``,
