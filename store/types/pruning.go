...
var (
	// PruneDefault defines a pruning strategy where the last 9072000 heights are
	// kept in addition to every 100th and where to-be pruned heights are pruned
	// at every 10th height. The last 9072000 heights are kept assuming the typical
	...
	PruneDefault = NewPruningOptions(9072000, 100, 10)
