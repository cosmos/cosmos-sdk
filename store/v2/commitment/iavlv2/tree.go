...
func NewTree(
	...
	return &Tree{tree: tree, log: log, telemetry: telemetry, path: dbOptions.Path}, nil
}
...
// TODO
// must support concurrent Get with concurrent Commit
// must support dirty version even if nothing was written at h+1
