...
func TestTokenizeSharesAndRedeemTokens(t *testing.T) {
	...
	// 		addrs := simtestutil.AddTestAddrs(app.BankKeeper, ctx, 2, app.StakingKeeper.TokensFromConsensusPower(ctx, 10000))
	...
	// 		val1 := stakingtypes.NewValidator(addrVal1, pk1, stakingtypes.Description{})
	...
	// 		val2 := stakingtypes.NewValidator(addrVal2, pk2, stakingtypes.Description{})
...
func setupTestTokenizeAndRedeemConversion(
	...
	// validator := stakingtypes.NewValidator(validatorAddress, pubKeys[0], stakingtypes.Description{})
...
func TestTransferTokenizeShareRecord(t *testing.T) {
	...
	// val := stakingtypes.NewValidator(addrVal, pk, stakingtypes.Description{})
...
func TestValidatorBond(t *testing.T) {
	...
	// 			validator := stakingtypes.NewValidator(validatorAddress, validatorPubKey, stakingtypes.Description{})
...
func TestChangeValidatorBond(t *testing.T) {
	...
	// validatorA := stakingtypes.NewValidator(validatorAAddress, validatorAPubKey, stakingtypes.Description{})
	// validatorB := stakingtypes.NewValidator(validatorBAddress, validatorBPubKey, stakingtypes.Description{})
	// validatorC := stakingtypes.NewValidator(validatorCAddress, validatorCPubKey, stakingtypes.Description{})
