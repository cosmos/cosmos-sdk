...
import (
	...
	testutil "github.com/cosmos/cosmos-sdk/testutil/integration"
)
...
func (app *App) RunMsg(msg sdk.Msg, option ...testutil.Option) (*codectypes.Any, error) {
	// set options
	cfg := &testutil.Config{}
