...
func (s *System) MustRunC(t TestingT, ctx context.Context, args ...string) RunResult { //nolint:context-as-argument // As a variation of MustRun, t is more important than ctx.
	t.Helper()
...
func (s *System) MustRunWithInputC(t TestingT, ctx context.Context, in io.Reader, args ...string) RunResult { //nolint:context-as-argument // As a variation of MustRun, t is more important than ctx.
	t.Helper()
