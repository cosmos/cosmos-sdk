...
func DefaultConfig() Config {
	...
	return Config{
		...
		AccountTokens:     sdk.TokensFromConsensusPower(1000, stakingtypes.DefaultConfig().PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500, stakingtypes.DefaultConfig().PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100, stakingtypes.DefaultConfig().PowerReduction),
