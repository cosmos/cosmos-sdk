...
type TestVersion2 struct {
	...
	// google.protobuf.Timestamp j = 11; // [(gogoproto.stdtime) = true];
	*Customer1    `protobuf:"bytes,12,opt,name=k,proto3,embedded=k" json:"k,omitempty"`
	NewAddedField uint64 `protobuf:"varint,25,opt,name=new_added_field,json=newAddedField,proto3" json:"new_added_field,omitempty"`
}
...
func (m *TestVersion2) GetNewAddedField() uint64 {
	if m != nil {
		return m.NewAddedField
	}
	return 0
}
...
var fileDescriptor_fe4560133be9209a = []byte{
	...
	,
}
...
func (m *TestVersion2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NewAddedField != 0 {
		i = encodeVarintUnknonwnproto(dAtA, i, uint64(m.NewAddedField))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc8
...
func (m *TestVersion2) Size() (n int) {
	...
	if m.NewAddedField != 0 {
		n += 2 + sovUnknonwnproto(uint64(m.NewAddedField))
	}
	return n
}
...
func (m *TestVersion2) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewAddedField", wireType)
			}
			m.NewAddedField = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NewAddedField |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
