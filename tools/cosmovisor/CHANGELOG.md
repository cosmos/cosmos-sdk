...
This is the first release since we started this changelog on 2021-07-01. See the [README](https://github.com/cosmos/cosmos-sdk/blob/main/tools/cosmovisor/README.md) file for the full list of features.
