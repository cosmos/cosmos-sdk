...
func initWatcher[T any](ctx context.Context, cfg *Config, dirWatcher *watchers.FSNotifyWatcher, filename string, unmarshal func([]byte) (T, error)) watchers.Watcher[T] {
	if dirWatcher != nil {
