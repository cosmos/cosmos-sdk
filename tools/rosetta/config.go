...
func FromFlags(flags *pflag.FlagSet) (*Config, error) {
	...
	cometRPC, err := flags.GetString(FlagCometEndpoint)
	if err != nil {
		return nil, err
	}
...
func SetFlags(flags *pflag.FlagSet) {
	...
	flags.String(FlagCometEndpoint, DefaultCometEndpoint, "the cometbft rpc endpoint, without tcp://")
