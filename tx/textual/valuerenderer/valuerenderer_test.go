...
func TestDispatcher(t *testing.T) {
	testcases := []struct {
		...
		{"COIN", false, valuerenderer.NewCoinsValueRenderer(nil, fieldDescriptorFromName("COIN"))},
		{"COINS", false, valuerenderer.NewCoinsValueRenderer(nil, fieldDescriptorFromName("COINS"))},
