...
type LegacyRequestBeginBlock struct {
	Request *types1.RequestBeginBlock `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
}

func (m *LegacyRequestBeginBlock) Reset()      { *m = LegacyRequestBeginBlock{} }
...
func (m *LegacyRequestBeginBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LegacyRequestBeginBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LegacyRequestBeginBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LegacyRequestBeginBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LegacyRequestBeginBlock.Merge(m, src)
}
func (m *LegacyRequestBeginBlock) XXX_Size() int {
	return m.Size()
}
func (m *LegacyRequestBeginBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_LegacyRequestBeginBlock.DiscardUnknown(m)
}

var xxx_messageInfo_LegacyRequestBeginBlock proto.InternalMessageInfo

func (m *LegacyRequestBeginBlock) GetRequest() *types1.RequestBeginBlock {
	if m != nil {
		return m.Request
	}
	return nil
...
type LegacyResponseBeginBlock struct {
	Response *types1.ResponseBeginBlock `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
}

func (m *LegacyResponseBeginBlock) Reset()      { *m = LegacyResponseBeginBlock{} }
func (*LegacyResponseBeginBlock) ProtoMessage() {}
func (*LegacyResponseBeginBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e37629bc7eb0df8, []int{12}
}
func (m *LegacyResponseBeginBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LegacyResponseBeginBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LegacyResponseBeginBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LegacyResponseBeginBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LegacyResponseBeginBlock.Merge(m, src)
}
func (m *LegacyResponseBeginBlock) XXX_Size() int {
	return m.Size()
}
func (m *LegacyResponseBeginBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_LegacyResponseBeginBlock.DiscardUnknown(m)
}

var xxx_messageInfo_LegacyResponseBeginBlock proto.InternalMessageInfo

func (m *LegacyResponseBeginBlock) GetResponse() *types1.ResponseBeginBlock {
	if m != nil {
		return m.Response
	}
	return nil
...
type LegacyRequestEndBlock struct {
	Request *types1.RequestEndBlock `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
}

func (m *LegacyRequestEndBlock) Reset()      { *m = LegacyRequestEndBlock{} }
func (*LegacyRequestEndBlock) ProtoMessage() {}
func (*LegacyRequestEndBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e37629bc7eb0df8, []int{13}
}
func (m *LegacyRequestEndBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LegacyRequestEndBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LegacyRequestEndBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LegacyRequestEndBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LegacyRequestEndBlock.Merge(m, src)
}
func (m *LegacyRequestEndBlock) XXX_Size() int {
	return m.Size()
}
func (m *LegacyRequestEndBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_LegacyRequestEndBlock.DiscardUnknown(m)
}

var xxx_messageInfo_LegacyRequestEndBlock proto.InternalMessageInfo

func (m *LegacyRequestEndBlock) GetRequest() *types1.RequestEndBlock {
	if m != nil {
		return m.Request
	}
	return nil
...
type LegacyResponseEndBlock struct {
	Response *types1.ResponseEndBlock `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
}

func (m *LegacyResponseEndBlock) Reset()      { *m = LegacyResponseEndBlock{} }
func (*LegacyResponseEndBlock) ProtoMessage() {}
func (*LegacyResponseEndBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e37629bc7eb0df8, []int{14}
}
func (m *LegacyResponseEndBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LegacyResponseEndBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LegacyResponseEndBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LegacyResponseEndBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LegacyResponseEndBlock.Merge(m, src)
}
func (m *LegacyResponseEndBlock) XXX_Size() int {
	return m.Size()
}
func (m *LegacyResponseEndBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_LegacyResponseEndBlock.DiscardUnknown(m)
}

var xxx_messageInfo_LegacyResponseEndBlock proto.InternalMessageInfo

func (m *LegacyResponseEndBlock) GetResponse() *types1.ResponseEndBlock {
	if m != nil {
		return m.Response
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LegacyRequestBeginBlock)(nil), "cosmos.base.abci.v1beta1.LegacyRequestBeginBlock")
	proto.RegisterType((*LegacyResponseBeginBlock)(nil), "cosmos.base.abci.v1beta1.LegacyResponseBeginBlock")
	proto.RegisterType((*LegacyRequestEndBlock)(nil), "cosmos.base.abci.v1beta1.LegacyRequestEndBlock")
	proto.RegisterType((*LegacyResponseEndBlock)(nil), "cosmos.base.abci.v1beta1.LegacyResponseEndBlock")
}
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (m *LegacyRequestBeginBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LegacyRequestBeginBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LegacyRequestBeginBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LegacyResponseBeginBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LegacyResponseBeginBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LegacyResponseBeginBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LegacyRequestEndBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LegacyRequestEndBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LegacyRequestEndBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LegacyResponseEndBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LegacyResponseEndBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LegacyResponseEndBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LegacyRequestBeginBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LegacyResponseBeginBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LegacyRequestEndBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LegacyResponseEndBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LegacyRequestBeginBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LegacyRequestBeginBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LegacyRequestBeginBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Request == nil {
				m.Request = &types1.RequestBeginBlock{}
			}
...
func (m *LegacyResponseBeginBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LegacyResponseBeginBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LegacyResponseBeginBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Response == nil {
				m.Response = &types1.ResponseBeginBlock{}
			}
...
func (m *LegacyRequestEndBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LegacyRequestEndBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LegacyRequestEndBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Request == nil {
				m.Request = &types1.RequestEndBlock{}
			}
			if err := m.Request.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *LegacyResponseEndBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LegacyResponseEndBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LegacyResponseEndBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Response == nil {
				m.Response = &types1.ResponseEndBlock{}
			}
			if err := m.Response.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
