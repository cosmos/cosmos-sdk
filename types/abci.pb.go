...
type LegacyRequestBeginBlock struct {
	Req *types1.RequestBeginBlock `protobuf:"bytes,1,opt,name=req,proto3" json:"req,omitempty"`
}
...
func (m *LegacyRequestBeginBlock) GetReq() *types1.RequestBeginBlock {
	if m != nil {
		return m.Req
	}
	return nil
...
type LegacyResponseBeginBlock struct {
	Res *types1.ResponseBeginBlock `protobuf:"bytes,1,opt,name=res,proto3" json:"res,omitempty"`
}
...
func (m *LegacyResponseBeginBlock) GetRes() *types1.ResponseBeginBlock {
	if m != nil {
		return m.Res
	}
	return nil
...
type LegacyRequestEndBlock struct {
	Req *types1.RequestEndBlock `protobuf:"bytes,1,opt,name=req,proto3" json:"req,omitempty"`
}
...
func (m *LegacyRequestEndBlock) GetReq() *types1.RequestEndBlock {
	if m != nil {
		return m.Req
	}
	return nil
...
type LegacyResponseEndBlock struct {
	Res *types1.ResponseEndBlock `protobuf:"bytes,1,opt,name=res,proto3" json:"res,omitempty"`
}
...
func (m *LegacyResponseEndBlock) GetRes() *types1.ResponseEndBlock {
	if m != nil {
		return m.Res
	}
	return nil
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (m *LegacyRequestBeginBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Req == nil {
				m.Req = &types1.RequestBeginBlock{}
			}
...
func (m *LegacyResponseBeginBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Res == nil {
				m.Res = &types1.ResponseBeginBlock{}
			}
