...
type TxMsgData struct {
	...
	// msg_responses contains the Msg handler responses, serialized using
	// Protobuf. The bytes at index i correspond to the Protobuf serialization
	// of the i-th Msg's response type in the tx. It can be decoded into the
	// corresponding `Msg{...}Response` type.
	//
	// Since: cosmos-sdk 0.45
	MsgResponses [][]byte `protobuf:"bytes,2,rep,name=msg_responses,json=msgResponses,proto3" json:"msg_responses,omitempty"`
}
...
func (m *TxMsgData) GetMsgResponses() [][]byte {
	if m != nil {
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (m *TxMsgData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MsgResponses) > 0 {
		for iNdEx := len(m.MsgResponses) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAbci(dAtA, i, uint64(len(m.MsgResponses[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (this *TxMsgData) String() string {
	...
	s := strings.Join([]string{`&TxMsgData{`,
		...
		`MsgResponses:` + fmt.Sprintf("%v", this.MsgResponses) + `,`,
		`}`,
	}, "")
	return s
}
