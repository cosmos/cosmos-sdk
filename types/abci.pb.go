...
type UnconfirmedTxsResult struct {
	...
	// List of txs in current page
	Txs []*types.Any `protobuf:"bytes,4,rep,name=txs,proto3" json:"txs,omitempty"`
}

func (m *UnconfirmedTxsResult) Reset()      { *m = UnconfirmedTxsResult{} }
...
func (m *UnconfirmedTxsResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnconfirmedTxsResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UnconfirmedTxsResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UnconfirmedTxsResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnconfirmedTxsResult.Merge(m, src)
}
func (m *UnconfirmedTxsResult) XXX_Size() int {
	return m.Size()
}
func (m *UnconfirmedTxsResult) XXX_DiscardUnknown() {
	xxx_messageInfo_UnconfirmedTxsResult.DiscardUnknown(m)
}

var xxx_messageInfo_UnconfirmedTxsResult proto.InternalMessageInfo

func (m *UnconfirmedTxsResult) GetCount() uint64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *UnconfirmedTxsResult) GetTotalCount() uint64 {
	if m != nil {
		return m.TotalCount
	}
	return 0
...
func (m *UnconfirmedTxsResult) GetTotalBytes() uint64 {
	if m != nil {
		return m.TotalBytes
	}
	return 0
...
func (m *UnconfirmedTxsResult) GetTxs() []*types.Any {
	if m != nil {
		return m.Txs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UnconfirmedTxsResult)(nil), "cosmos.base.abci.v1beta1.UnconfirmedTxsResult")
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (m *UnconfirmedTxsResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UnconfirmedTxsResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UnconfirmedTxsResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.TotalBytes != 0 {
		i = encodeVarintAbci(dAtA, i, uint64(m.TotalBytes))
		i--
		dAtA[i] = 0x18
	}
	if m.TotalCount != 0 {
...
func (m *UnconfirmedTxsResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TotalBytes != 0 {
		n += 1 + sovAbci(uint64(m.TotalBytes))
	}
	if len(m.Txs) > 0 {
		for _, e := range m.Txs {
			l = e.Size()
...
func (this *UnconfirmedTxsResult) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForTxs := "[]*Any{"
	for _, f := range this.Txs {
		repeatedStringForTxs += strings.Replace(fmt.Sprintf("%v", f), "Any", "types.Any", 1) + ","
	}
	repeatedStringForTxs += "}"
	s := strings.Join([]string{`&UnconfirmedTxsResult{`,
		`Count:` + fmt.Sprintf("%v", this.Count) + `,`,
		`TotalCount:` + fmt.Sprintf("%v", this.TotalCount) + `,`,
...
func (m *UnconfirmedTxsResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnconfirmedTxsResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnconfirmedTxsResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
