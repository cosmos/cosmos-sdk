...
func (coins Coins) MulInt(x sdkmath.Int) Coins {
...
func (coins Coins) SafeMulInt(x sdkmath.Int) (Coins, bool) {
	if x.IsZero() {
		return nil, false
	}
...
func (coins Coins) QuoInt(x sdkmath.Int) Coins {
...
func (coins Coins) SafeQuoInt(x sdkmath.Int) (Coins, bool) {
	if x.IsZero() {
		return nil, false
	}
