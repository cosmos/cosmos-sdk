...
// aliases functionality in the github.com/cosmos/cosmos-sdk/errors/v3 module
// that used to be in this package, and provides some helpers for converting
// errors to ABCI response code.
//
// New code should generally import github.com/cosmos/cosmos-sdk/errors/v3 directly
