...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/Stride-Labs/cosmos-sdk/types/errors.Wrap",
		"github.com/Stride-Labs/cosmos-sdk/types/errors.Wrapf",
		"github.com/Stride-Labs/cosmos-sdk/types/errors.WithType",
