...
func TestEncodingTableInt(t *testing.T) {
	...
	cases := []struct {
		...
		{NewInt(0), []byte("\"0\""), []byte{0x30}},
		{NewInt(100), []byte("\"100\""), []byte{0x31, 0x30, 0x30}},
		{NewInt(-100), []byte("\"-100\""), []byte{0x2d, 0x31, 0x30, 0x30}},
		{NewInt(51842), []byte("\"51842\""), []byte{0x35, 0x31, 0x38, 0x34, 0x32}},
		{NewInt(-51842), []byte("\"-51842\""), []byte{0x2d, 0x35, 0x31, 0x38, 0x34, 0x32}},
		{NewInt(19513368), []byte("\"19513368\""), []byte{0x31, 0x39, 0x35, 0x31, 0x33, 0x33, 0x36, 0x38}},
		{NewInt(-19513368), []byte("\"-19513368\""), []byte{0x2d, 0x31, 0x39, 0x35, 0x31, 0x33, 0x33, 0x36, 0x38}},
		{NewInt(999999999999), []byte("\"999999999999\""), []byte{0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39}},
		{NewInt(-999999999999), []byte("\"-999999999999\""), []byte{0x2d, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39}},
	}
...
func TestEncodingTableUint(t *testing.T) {
	...
	cases := []struct {
		...
		{NewUint(0), []byte("\"0\""), []byte{0x30}},
		{NewUint(100), []byte("\"100\""), []byte{0x31, 0x30, 0x30}},
		{NewUint(51842), []byte("\"51842\""), []byte{0x35, 0x31, 0x38, 0x34, 0x32}},
		{NewUint(19513368), []byte("\"19513368\""), []byte{0x31, 0x39, 0x35, 0x31, 0x33, 0x33, 0x36, 0x38}},
		{NewUint(999999999999), []byte("\"999999999999\""), []byte{0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39, 0x39}},
	}
