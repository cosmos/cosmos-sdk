...
func (gam GenesisOnlyAppModule) BeginBlock(_ sdk.Context, _ abci.RequestBeginBlock) {}
...
type Manager struct {
	Modules            map[string]any // any is used now to support the legacy AppModule as well as new core appmodule.AppModule.
