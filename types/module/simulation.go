...
type AppModuleSimulation interface {
	...
	RegisterStoreDecoder(store.DecoderRegistry)
...
type SimulationManager struct {
	...
	StoreDecoders store.DecoderRegistry // functions to decode the key-value pairs from each module's store
}
...
func NewSimulationManager(modules ...AppModuleSimulation) *SimulationManager {
	return &SimulationManager{
		Modules:       modules,
		StoreDecoders: make(store.DecoderRegistry),
	}
}
