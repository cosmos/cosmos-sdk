...
type AppModuleSimulation interface {
	...
	RegisterStoreDecoder(store.StoreDecoderRegistry)
...
type SimulationManager struct {
	...
	StoreDecoders store.StoreDecoderRegistry // functions to decode the key-value pairs from each module's store
}
...
func NewSimulationManager(modules ...AppModuleSimulation) *SimulationManager {
	return &SimulationManager{
		Modules:       modules,
		StoreDecoders: make(store.StoreDecoderRegistry),
	}
}
