...
import (
	...
	// NewOperationMsg requires all the types to be imported for the amionJSON marshal to properly handle any types,
	// and any types are required to support gogo types being generated, since they are not proto reflect capable.
