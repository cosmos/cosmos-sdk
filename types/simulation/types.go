...
type (
	...
	WeightedProposalContent interface {
	...
	ContentSimulatorFn func(r *rand.Rand, ctx sdk.Context, accs []Account) Content
	...
	SelectOpFn func(r *rand.Rand) Operation

	// AppStateFn returns the app state json bytes and the genesis accounts
	AppStateFn func(r *rand.Rand, accs []Account, config Config) (
	...
	AppStateFnWithExtendedCb func(r *rand.Rand, accs []Account, config Config) (
		appState json.RawMessage, accounts []Account, chainId string, genesisTimestamp time.Time,
	)

	// RandomAccountFn returns a slice of n random simulation accounts
	RandomAccountFn func(r *rand.Rand, n int) []Account
	...
	// simulation.
	StoreDecoderRegistry map[string]func(kvA, kvB kv.Pair) string
	...
	Operation func(r *rand.Rand, app *baseapp.BaseApp,
...
func (sp AppParams) GetOrGenerate(_ codec.JSONCodec, key string, ptr any, r *rand.Rand, ps ParamSimulator) {
