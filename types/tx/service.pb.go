...
var SimulateMode_name = map[int32]string{
	0: "WITH_RESULT",
	1: "GAS_USED",
}

var SimulateMode_value = map[string]int32{
	"WITH_RESULT": 0,
	"GAS_USED":    1,
}

func (x SimulateMode) String() string {
	return proto.EnumName(SimulateMode_name, int32(x))
}
...
func (m *SimulateRequest) GetMode() SimulateMode {
	if m != nil {
		return m.Mode
	}
...
func (m *SimulateResponse) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("cosmos.tx.v1beta1.SimulateMode", SimulateMode_name, SimulateMode_value)
...
var fileDescriptor_e0b00a618705eca7 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Mode |= SimulateMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
