...
type SignerData struct {
	...
	PubKey *types.Any `protobuf:"bytes,5,opt,name=pub_key,json=pubKey,proto3" json:"pub_key,omitempty"`
}

func (m *SignerData) Reset()         { *m = SignerData{} }
func (m *SignerData) String() string { return proto.CompactTextString(m) }
func (*SignerData) ProtoMessage()    {}
func (*SignerData) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a54958ff3d0b1b9, []int{2}
}
func (m *SignerData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignerData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignerData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignerData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignerData.Merge(m, src)
}
func (m *SignerData) XXX_Size() int {
	return m.Size()
}
func (m *SignerData) XXX_DiscardUnknown() {
	xxx_messageInfo_SignerData.DiscardUnknown(m)
}

var xxx_messageInfo_SignerData proto.InternalMessageInfo

func (m *SignerData) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *SignerData) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
func (m *SignerData) GetAccountNumber() uint64 {
	if m != nil {
...
func (m *SignerData) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
func (m *SignerData) GetPubKey() *types.Any {
	if m != nil {
		return m.PubKey
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SignerData)(nil), "cosmos.tx.signing.v1beta1.SignerData")
}
...
var fileDescriptor_9a54958ff3d0b1b9 = []byte{
	...
	,
}
...
func (m *SignerData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignerData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignerData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Address) > 0 {
		...
		i = encodeVarintSigning(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SignerData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignerData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignerData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
