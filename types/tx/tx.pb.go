...
func (m *TxBody) GetNonAtomic() bool {
	if m != nil {
		return m.NonAtomic
	}
	return false
...
func init() {
	...
	proto.RegisterType((*MsgFailureResponse)(nil), "cosmos.tx.v1beta1.MsgFailureResponse")
}
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
...
func (m *TxBody) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NonAtomic", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
