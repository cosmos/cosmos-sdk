...
func (m *AminoSignFee) Reset()         { *m = AminoSignFee{} }
func (m *AminoSignFee) String() string { return proto.CompactTextString(m) }
func (*AminoSignFee) ProtoMessage()    {}
func (*AminoSignFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_96d1575ffde80842, []int{11}
}
func (m *AminoSignFee) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AminoSignFee) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AminoSignFee.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AminoSignFee) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AminoSignFee.Merge(m, src)
}
func (m *AminoSignFee) XXX_Size() int {
	return m.Size()
}
func (m *AminoSignFee) XXX_DiscardUnknown() {
	xxx_messageInfo_AminoSignFee.DiscardUnknown(m)
}

var xxx_messageInfo_AminoSignFee proto.InternalMessageInfo

func (m *AminoSignFee) GetAmount() []*types2.Coin {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *AminoSignFee) GetGas() uint64 {
	if m != nil {
		return m.Gas
	}
	return 0
...
func (m *AminoSignFee) GetPayer() string {
	if m != nil {
		return m.Payer
	}
	return ""
...
func (m *AminoSignFee) GetGranter() string {
	if m != nil {
		return m.Granter
	}
	return ""
...
func (m *AminoSignDoc) Reset()         { *m = AminoSignDoc{} }
func (m *AminoSignDoc) String() string { return proto.CompactTextString(m) }
func (*AminoSignDoc) ProtoMessage()    {}
func (*AminoSignDoc) Descriptor() ([]byte, []int) {
	return fileDescriptor_96d1575ffde80842, []int{12}
}
func (m *AminoSignDoc) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AminoSignDoc) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AminoSignDoc.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AminoSignDoc) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AminoSignDoc.Merge(m, src)
}
func (m *AminoSignDoc) XXX_Size() int {
	return m.Size()
}
func (m *AminoSignDoc) XXX_DiscardUnknown() {
	xxx_messageInfo_AminoSignDoc.DiscardUnknown(m)
}

var xxx_messageInfo_AminoSignDoc proto.InternalMessageInfo

func (m *AminoSignDoc) GetAccountNumber() uint64 {
	if m != nil {
		return m.AccountNumber
	}
	return 0
...
func (m *AminoSignDoc) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
func (m *AminoSignDoc) GetTimeoutHeight() uint64 {
	if m != nil {
		return m.TimeoutHeight
	}
	return 0
...
func (m *AminoSignDoc) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
func (m *AminoSignDoc) GetMemo() string {
	if m != nil {
		return m.Memo
	}
	return ""
...
func (m *AminoSignDoc) GetFee() *AminoSignFee {
	if m != nil {
		return m.Fee
	}
	return nil
...
func (m *AminoSignDoc) GetMsgs() []*types.Any {
	if m != nil {
		return m.Msgs
	}
	return nil
...
func (m *AminoSignDoc) GetTip() *Tip {
	if m != nil {
		return m.Tip
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AminoSignFee)(nil), "cosmos.tx.v1beta1.AminoSignFee")
	proto.RegisterType((*AminoSignDoc)(nil), "cosmos.tx.v1beta1.AminoSignDoc")
}
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
...
func (m *AminoSignFee) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AminoSignFee) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AminoSignFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AminoSignDoc) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AminoSignDoc) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AminoSignDoc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AminoSignFee) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AminoSignDoc) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AminoSignFee) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AminoSignFee: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AminoSignFee: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AminoSignDoc) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AminoSignDoc: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AminoSignDoc: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
