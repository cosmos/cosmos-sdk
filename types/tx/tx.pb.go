...
// ServiceMsg is the struct which represents a service message, it can be
// thought as an Any whose typeUrl matches a service method format
// (ex. `/cosmos.gov.Msg/SubmitProposal`), and whose value is the marshalled
// bytes of the request.
type ServiceMsg struct {
	// method_name is the fully-qualified service method name of the service
	// message. Note that is contains two '/' characters.
	MethodName string `protobuf:"bytes,1,opt,name=method_name,json=methodName,proto3" json:"method_name,omitempty"`
	// request is the encoded raw bytes of the request which corresponds to the
	// service method.
...
func (m *ServiceMsg) GetRequest() []byte {
	if m != nil {
		return m.Request
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ServiceMsg)(nil), "cosmos.tx.v1beta1.ServiceMsg")
}
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
