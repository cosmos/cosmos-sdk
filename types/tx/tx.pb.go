...
import (
	...
	signing "github.com/pointnetwork/cosmos-point-sdk/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/pointnetwork/cosmos-point-sdk/issues/9122).
