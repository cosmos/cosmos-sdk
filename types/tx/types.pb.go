...
func (SignMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{0}
}
...
func (*SignDoc) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{1}
}
...
func (*TxBody) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{2}
}
...
func (*AuthInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{3}
}
...
func (*SignerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{4}
}
...
func (*ModeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{5}
}
...
type ModeInfo_Single struct {
	...
	Mode SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=cosmos.tx.SignMode" json:"mode,omitempty"`
}
...
func (*ModeInfo_Single) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{5, 0}
}
...
func (*ModeInfo_Multi) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{5, 1}
}
...
func (*Fee) Descriptor() ([]byte, []int) {
	return fileDescriptor_29b2a0b3359fc6b1, []int{6}
}
...
func init() {
	proto.RegisterEnum("cosmos.tx.SignMode", SignMode_name, SignMode_value)
...
func init() { proto.RegisterFile("cosmos/tx/types.proto", fileDescriptor_29b2a0b3359fc6b1) }

var fileDescriptor_29b2a0b3359fc6b1 = []byte{
	...
	,
}
