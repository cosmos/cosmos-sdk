...
type ValidatorI interface {
	...
	GetConsAddr() (ConsAddress, error)                   // validation consensus address
	...
	TokensFromShares(Dec) math.LegacyDec                 // token worth of provided delegator shares
	TokensFromSharesTruncated(Dec) math.LegacyDec        // token worth of provided delegator shares, truncated
	TokensFromSharesRoundUp(Dec) math.LegacyDec          // token worth of provided delegator shares, rounded up
	SharesFromTokens(amt math.Int) (Dec, error)          // shares worth of delegator's bond
	SharesFromTokensTruncated(amt math.Int) (Dec, error) // truncated shares worth of delegator's bond
}
