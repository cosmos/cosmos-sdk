...
type sendFunc = func(ctx context.Context, from, to []byte, amount math.Int) ([][]byte, error)
type mintFunc = func(ctx context.Context, to []byte, amount math.Int) ([][]byte, error)
type burnFunc = func(ctx context.Context, from []byte, amount math.Int) ([][]byte, error)
