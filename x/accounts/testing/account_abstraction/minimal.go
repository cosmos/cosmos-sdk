...
func (a MinimalAbstractedAccount) Authenticate(_ context.Context, _ *account_abstractionv1.MsgAuthenticate) (*account_abstractionv1.MsgAuthenticateResponse, error) {
