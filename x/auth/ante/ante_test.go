...
func TestSimulateGasCost(t *testing.T) {
	...
	anteHandler := ante.NewAnteHandler(app.AccountKeeper, app.BankKeeper, app.SupplyKeeper, ante.DefaultSigVerificationGasConsumer)
...
func TestCustomSignatureVerificationGasConsumer(t *testing.T) {
	...
	anteHandler := ante.NewAnteHandler(app.AccountKeeper, app.BankKeeper, app.SupplyKeeper, func(meter sdk.GasMeter, sig []byte, pubkey crypto.PubKey, params types.Params) error {
