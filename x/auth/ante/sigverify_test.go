...
func TestSetPubKey(t *testing.T) {
	...
	spkd := ante.NewSetPubKeyDecorator(suite.accountKeeper, suite.encCfg.TxConfig.SigningContext())
...
func TestSigVerification(t *testing.T) {
	...
	spkd := ante.NewSetPubKeyDecorator(suite.accountKeeper, suite.clientCtx.TxConfig.SigningContext())
	txConfigOpts = authtx.ConfigOptions{
