...
func (m *MockConsensusKeeper) GetCometInfo(arg0 context.Context, arg1 *types1.QueryCometInfoRequest) (*types1.QueryCometInfoResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCometInfo", arg0, arg1)
	ret0, _ := ret[0].(*types1.QueryCometInfoResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
