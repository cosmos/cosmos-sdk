...
// MockCircuitBreakerKeeper is a mock of CircuitBreakerKeeper interface.
type MockCircuitBreakerKeeper struct {
	ctrl     *gomock.Controller
	recorder *MockCircuitBreakerKeeperMockRecorder
}

// MockCircuitBreakerKeeperMockRecorder is the mock recorder for MockCircuitBreakerKeeper.
type MockCircuitBreakerKeeperMockRecorder struct {
	mock *MockCircuitBreakerKeeper
}

// NewMockCircuitBreakerKeeper creates a new mock instance.
func NewMockCircuitBreakerKeeper(ctrl *gomock.Controller) *MockCircuitBreakerKeeper {
	mock := &MockCircuitBreakerKeeper{ctrl: ctrl}
	mock.recorder = &MockCircuitBreakerKeeperMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCircuitBreakerKeeper) EXPECT() *MockCircuitBreakerKeeperMockRecorder {
	return m.recorder
}

// CloseCircuit mocks base method.
func (m *MockCircuitBreakerKeeper) CloseCircuit(ctx types.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CloseCircuit", ctx)
}

// CloseCircuit indicates an expected call of CloseCircuit.
func (mr *MockCircuitBreakerKeeperMockRecorder) CloseCircuit(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseCircuit", reflect.TypeOf((*MockCircuitBreakerKeeper)(nil).CloseCircuit), ctx)
}

// IsCircuitOpen mocks base method.
func (m *MockCircuitBreakerKeeper) IsCircuitOpen(ctx types.Context) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsCircuitOpen", ctx)
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsCircuitOpen indicates an expected call of IsCircuitOpen.
func (mr *MockCircuitBreakerKeeperMockRecorder) IsCircuitOpen(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsCircuitOpen", reflect.TypeOf((*MockCircuitBreakerKeeper)(nil).IsCircuitOpen), ctx)
}

// OpenCircuit mocks base method.
func (m *MockCircuitBreakerKeeper) OpenCircuit(ctx types.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OpenCircuit", ctx)
}

// OpenCircuit indicates an expected call of OpenCircuit.
func (mr *MockCircuitBreakerKeeperMockRecorder) OpenCircuit(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OpenCircuit", reflect.TypeOf((*MockCircuitBreakerKeeper)(nil).OpenCircuit), ctx)
}
