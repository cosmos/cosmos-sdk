...
func QueryTxsByEvents(cliCtx client.Context, events []string, page, limit int, orderBy string) (*sdk.SearchTxsResult, error) {
	if len(events) == 0 {
...
func QueryTx(cliCtx client.Context, hashHexStr string) (sdk.TxResponse, error) {
