...
// broadcasted.
func GenerateOrBroadcastMsgs(cliCtx client.Context, txBldr authtypes.TxBuilder, msgs []sdk.Msg) error {
...
func CompleteAndBroadcastTxCLI(txBldr authtypes.TxBuilder, cliCtx client.Context, msgs []sdk.Msg) error {
...
func EnrichWithGas(txBldr authtypes.TxBuilder, cliCtx client.Context, msgs []sdk.Msg) (authtypes.TxBuilder, error) {
...
func PrintUnsignedStdTx(txBldr authtypes.TxBuilder, cliCtx client.Context, msgs []sdk.Msg) error {
...
func SignStdTx(
	txBldr authtypes.TxBuilder, cliCtx client.Context, name string,
...
func SignStdTxWithSignerAddress(
	txBldr authtypes.TxBuilder, cliCtx client.Context,
...
func populateAccountFromState(
	txBldr authtypes.TxBuilder, cliCtx client.Context, addr sdk.AccAddress,
...
func simulateMsgs(txBldr authtypes.TxBuilder, cliCtx client.Context, msgs []sdk.Msg) (sdk.SimulationResponse, uint64, error) {
...
func PrepareTxBuilder(txBldr authtypes.TxBuilder, cliCtx client.Context) (authtypes.TxBuilder, error) {
