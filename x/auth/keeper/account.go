...
func (ak AccountKeeper) NewAccountWithAddress(ctx sdk.Context, addr sdk.AccAddress) types.BaseAccount {
	acc := ak.proto
...
func (ak AccountKeeper) NewAccount(ctx sdk.Context, acc types.BaseAccount) types.BaseAccount {
...
func (ak AccountKeeper) GetAccount(ctx sdk.Context, addr sdk.AccAddress) types.BaseAccount {
	store := ctx.KVStore(ak.storeKey)
...
func (ak AccountKeeper) GetAllAccounts(ctx sdk.Context) (accounts []types.BaseAccount) {
	ak.IterateAccounts(ctx, func(acc types.BaseAccount) (stop bool) {
...
func (ak AccountKeeper) SetAccount(ctx sdk.Context, acc types.BaseAccount) {
	addr := acc.GetAddress()
	store := ctx.KVStore(ak.storeKey)
...
func (ak AccountKeeper) RemoveAccount(ctx sdk.Context, acc types.BaseAccount) {
	addr := acc.GetAddress()
	store := ctx.KVStore(ak.storeKey)
...
func (ak AccountKeeper) IterateAccounts(ctx sdk.Context, cb func(account types.BaseAccount) (stop bool)) {
	store := ctx.KVStore(ak.storeKey)
