...
func (suite *DeterministicTestSuite) TestGRPCQueryAccount() {
	rapid.Check(suite.T(), func(t *rapid.T) {
		...
		testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.Account, 0, true)
	})
	...
	testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.Account, 1543, false)
}
...
func (suite *DeterministicTestSuite) TestGRPCQueryAccounts() {
	rapid.Check(suite.T(), func(t *rapid.T) {
		...
		testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.Accounts, 0, true)
	...
	testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.Accounts, 1716, false)
}
...
func (suite *DeterministicTestSuite) TestGRPCQueryAccountAddressByID() {
	rapid.Check(suite.T(), func(t *rapid.T) {
		...
		testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.AccountAddressByID, 0, true)
	})
	...
	suite.accountKeeper.SetAccount(suite.ctx, acc1)
	req := &types.QueryAccountAddressByIDRequest{AccountId: accNum}
	testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.AccountAddressByID, 1123, false)
}
...
func (suite *DeterministicTestSuite) TestGRPCQueryParameters() {
	...
	req := &types.QueryParamsRequest{}
	testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.Params, 1042, false)
}
...
func (suite *DeterministicTestSuite) TestGRPCQueryAccountInfo() {
	rapid.Check(suite.T(), func(t *rapid.T) {
		...
		testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.AccountInfo, 0, true)
	})
	...
	testdata.DeterministicIterations(suite.ctx, req, suite.queryClient.AccountInfo, 1543, false)
}
...
func (suite *DeterministicTestSuite) TestGRPCQueryModuleAccounts() {
	rapid.Check(suite.T(), func(t *rapid.T) {
		...
		testdata.DeterministicIterations(suite.ctx, req, queryClient.ModuleAccounts, 0, true)
	})
	...
	req := &types.QueryModuleAccountsRequest{}
	testdata.DeterministicIterations(suite.ctx, req, queryClient.ModuleAccounts, 8565, false)
}
...
func (suite *DeterministicTestSuite) TestGRPCQueryModuleAccountByName() {
	rapid.Check(suite.T(), func(t *rapid.T) {
		...
		testdata.DeterministicIterations(suite.ctx, req, queryClient.ModuleAccountByName, 0, true)
	})
	...
	testdata.DeterministicIterations(suite.ctx, req, queryClient.ModuleAccountByName, 1372, false)
}
