...
type AccountKeeper struct {
	...
	// The prototypical IAccount constructor.
	proto      func() types.IAccount
...
var _ IAccountKeeper = &AccountKeeper{}

// NewAccountKeeper returns a new IAccountKeeper that uses go-amino to
...
func NewAccountKeeper(
	cdc codec.BinaryCodec, storeKey storetypes.StoreKey, proto func() types.IAccount,
...
func (ak AccountKeeper) decodeAccount(bz []byte) types.IAccount {
...
func (ak AccountKeeper) MarshalAccount(accountI types.IAccount) ([]byte, error) { //nolint:interfacer
...
func (ak AccountKeeper) UnmarshalAccount(bz []byte) (types.IAccount, error) {
	var acc types.IAccount
