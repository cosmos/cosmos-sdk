...
import (
	...
	authaddress "github.com/cosmos/cosmos-sdk/x/auth/address"
...
func NewAccountKeeper(
	...
	bech32Codec := authaddress.NewBech32Codec(bech32Prefix)
...
func (ak AccountKeeper) getBech32Prefix() (string, error) {
	bech32Codec, ok := ak.addressCdc.(authaddress.Bech32Codec)
	if !ok {
