...
func (m Migrator) Migrate1to2(ctx sdk.Context) error {
	...
	m.keeper.IterateAccounts(ctx, func(account types.AccountAliasI) (stop bool) {
...
func (m Migrator) V45_SetAccount(ctx sdk.Context, acc types.AccountAliasI) error { //nolint:revive
	addr := acc.GetAddress()
