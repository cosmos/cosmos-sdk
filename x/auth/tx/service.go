...
import (
	"context"
	"fmt"
	"github.com/Stride-Labs/cosmos-sdk/client/grpc/tmservice"
	...
	pagination "github.com/Stride-Labs/cosmos-sdk/types/query"
...
func (s txServer) GetTx(ctx context.Context, req *txtypes.GetTxRequest) (*txtypes.GetTxResponse, error) {
	...
	// https://github.com/Stride-Labs/cosmos-sdk/issues/7036.
...
// ref: https://github.com/Stride-Labs/cosmos-sdk/issues/10347
