...
func (m *AddressToPubKey) Reset()         { *m = AddressToPubKey{} }
func (m *AddressToPubKey) String() string { return proto.CompactTextString(m) }
func (*AddressToPubKey) ProtoMessage()    {}
func (*AddressToPubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e1f7e915d020d2d, []int{3}
}
func (m *AddressToPubKey) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddressToPubKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddressToPubKey.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddressToPubKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddressToPubKey.Merge(m, src)
}
func (m *AddressToPubKey) XXX_Size() int {
	return m.Size()
}
func (m *AddressToPubKey) XXX_DiscardUnknown() {
	xxx_messageInfo_AddressToPubKey.DiscardUnknown(m)
}

var xxx_messageInfo_AddressToPubKey proto.InternalMessageInfo

func (m *AddressToPubKey) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *AddressToPubKey) GetPubKey() string {
	if m != nil {
		return m.PubKey
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*AddressToPubKey)(nil), "cosmos.auth.v1beta1.AddressToPubKey")
}
...
var fileDescriptor_7e1f7e915d020d2d = []byte{
	...
	,
}
...
func (m *AddressToPubKey) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddressToPubKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddressToPubKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AddressToPubKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddressToPubKey) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddressToPubKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddressToPubKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
