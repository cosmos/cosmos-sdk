...
func (msg MsgNonAtomicExec) GetMessages() ([]coretransaction.Type, error) {
	msgs := make([]coretransaction.Type, len(msg.Msgs))
	for i, msgAny := range msg.Msgs {
		msg, ok := msgAny.GetCachedValue().(coretransaction.Type)
		if !ok {
