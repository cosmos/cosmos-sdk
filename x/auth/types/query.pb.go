...
type AddressStringResponse struct {
	AccountAddr string `protobuf:"bytes,1,opt,name=account_addr,json=accountAddr,proto3" json:"account_addr,omitempty"`
}

func (m *AddressStringResponse) Reset()         { *m = AddressStringResponse{} }
func (m *AddressStringResponse) String() string { return proto.CompactTextString(m) }
func (*AddressStringResponse) ProtoMessage()    {}
func (*AddressStringResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{9}
}
func (m *AddressStringResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddressStringResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddressStringResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddressStringResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddressStringResponse.Merge(m, src)
}
func (m *AddressStringResponse) XXX_Size() int {
	return m.Size()
}
func (m *AddressStringResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AddressStringResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AddressStringResponse proto.InternalMessageInfo

func (m *AddressStringResponse) GetAccountAddr() string {
	if m != nil {
		return m.AccountAddr
	}
	return ""
...
type AddressBytesResponse struct {
	AccountAddr []byte `protobuf:"bytes,1,opt,name=account_addr,json=accountAddr,proto3" json:"account_addr,omitempty"`
}

func (m *AddressBytesResponse) Reset()         { *m = AddressBytesResponse{} }
func (m *AddressBytesResponse) String() string { return proto.CompactTextString(m) }
func (*AddressBytesResponse) ProtoMessage()    {}
func (*AddressBytesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{11}
}
func (m *AddressBytesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddressBytesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddressBytesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddressBytesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddressBytesResponse.Merge(m, src)
}
func (m *AddressBytesResponse) XXX_Size() int {
	return m.Size()
}
func (m *AddressBytesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AddressBytesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AddressBytesResponse proto.InternalMessageInfo

func (m *AddressBytesResponse) GetAccountAddr() []byte {
	if m != nil {
		return m.AccountAddr
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AddressStringResponse)(nil), "cosmos.auth.v1beta1.AddressStringResponse")
	proto.RegisterType((*AddressBytesRequest)(nil), "cosmos.auth.v1beta1.AddressBytesRequest")
	proto.RegisterType((*AddressBytesResponse)(nil), "cosmos.auth.v1beta1.AddressBytesResponse")
}
...
var fileDescriptor_c451370b3929a27c = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// AddressStr converts Bech32 bytes to Account string
	AddressString(ctx context.Context, in *AddressStringRequest, opts ...grpc.CallOption) (*AddressStringResponse, error)
	// AddressBytes converts Account string to Bech32 bytes
	AddressBytes(ctx context.Context, in *AddressBytesRequest, opts ...grpc.CallOption) (*AddressBytesResponse, error)
}
...
func (c *queryClient) AddressString(ctx context.Context, in *AddressStringRequest, opts ...grpc.CallOption) (*AddressStringResponse, error) {
	out := new(AddressStringResponse)
	err := c.cc.Invoke(ctx, "/cosmos.auth.v1beta1.Query/AddressString", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AddressBytes(ctx context.Context, in *AddressBytesRequest, opts ...grpc.CallOption) (*AddressBytesResponse, error) {
	out := new(AddressBytesResponse)
	err := c.cc.Invoke(ctx, "/cosmos.auth.v1beta1.Query/AddressBytes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// AddressStr converts Bech32 bytes to Account string
	AddressString(context.Context, *AddressStringRequest) (*AddressStringResponse, error)
	// AddressBytes converts Account string to Bech32 bytes
	AddressBytes(context.Context, *AddressBytesRequest) (*AddressBytesResponse, error)
}
...
func (*UnimplementedQueryServer) AddressString(ctx context.Context, req *AddressStringRequest) (*AddressStringResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddressString not implemented")
}
func (*UnimplementedQueryServer) AddressBytes(ctx context.Context, req *AddressBytesRequest) (*AddressBytesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddressBytes not implemented")
}
...
func _Query_AddressString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddressStringRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).AddressString(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.auth.v1beta1.Query/AddressString",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).AddressString(ctx, req.(*AddressStringRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_AddressBytes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddressBytesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).AddressBytes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.auth.v1beta1.Query/AddressBytes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).AddressBytes(ctx, req.(*AddressBytesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddressString",
			Handler:    _Query_AddressString_Handler,
		},
		{
			MethodName: "AddressBytes",
			Handler:    _Query_AddressBytes_Handler,
		},
	},
...
func (m *AddressStringResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddressStringResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddressStringResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AddressBytesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddressBytesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddressBytesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AddressStringResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddressBytesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddressStringResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddressStringResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddressStringResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AddressBytesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddressBytesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddressBytesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
