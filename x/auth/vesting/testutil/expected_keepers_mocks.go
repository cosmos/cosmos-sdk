...
func (mr *MockStakingKeeperMockRecorder) TransferDelegation(ctx, fromAddr, toAddr, valAddr, wantShares any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStakingKeeperMockRecorder) TransferUnbonding(ctx, fromAddr, toAddr, valAddr, wantAmt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
