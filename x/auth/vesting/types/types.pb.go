...
type TestVestingAccount struct {
	// sum defines a list of all acceptable concrete vesting Account
	// implementations.
	//
	// Types that are valid to be assigned to Sum:
	//	*TestVestingAccount_ContinuousVestingAccount
	//	*TestVestingAccount_DelayedVestingAccount
	//	*TestVestingAccount_PeriodicVestingAccount
	Sum isTestVestingAccount_Sum `protobuf_oneof:"sum"`
}

func (m *TestVestingAccount) Reset()         { *m = TestVestingAccount{} }
func (m *TestVestingAccount) String() string { return proto.CompactTextString(m) }
func (*TestVestingAccount) ProtoMessage()    {}
func (*TestVestingAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_b7f744d63a45e116, []int{0}
}
func (m *TestVestingAccount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestVestingAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestVestingAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *TestVestingAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestVestingAccount.Merge(m, src)
}
func (m *TestVestingAccount) XXX_Size() int {
	return m.Size()
}
func (m *TestVestingAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_TestVestingAccount.DiscardUnknown(m)
}

var xxx_messageInfo_TestVestingAccount proto.InternalMessageInfo

type isTestVestingAccount_Sum interface {
	isTestVestingAccount_Sum()
	MarshalTo([]byte) (int, error)
	Size() int
}

type TestVestingAccount_ContinuousVestingAccount struct {
...
type TestVestingAccount_DelayedVestingAccount struct {
...
type TestVestingAccount_PeriodicVestingAccount struct {
...
func (*TestVestingAccount_ContinuousVestingAccount) isTestVestingAccount_Sum() {}
func (*TestVestingAccount_DelayedVestingAccount) isTestVestingAccount_Sum()    {}
func (*TestVestingAccount_PeriodicVestingAccount) isTestVestingAccount_Sum()   {}

func (m *TestVestingAccount) GetSum() isTestVestingAccount_Sum {
	if m != nil {
		return m.Sum
	}
	return nil
...
func (m *TestVestingAccount) GetContinuousVestingAccount() *ContinuousVestingAccount {
	if x, ok := m.GetSum().(*TestVestingAccount_ContinuousVestingAccount); ok {
		return x.ContinuousVestingAccount
	}
	return nil
}

func (m *TestVestingAccount) GetDelayedVestingAccount() *DelayedVestingAccount {
	if x, ok := m.GetSum().(*TestVestingAccount_DelayedVestingAccount); ok {
		return x.DelayedVestingAccount
	}
	return nil
}

func (m *TestVestingAccount) GetPeriodicVestingAccount() *PeriodicVestingAccount {
	if x, ok := m.GetSum().(*TestVestingAccount_PeriodicVestingAccount); ok {
...
func (*TestVestingAccount) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TestVestingAccount_ContinuousVestingAccount)(nil),
		(*TestVestingAccount_DelayedVestingAccount)(nil),
		(*TestVestingAccount_PeriodicVestingAccount)(nil),
	}
}
...
func init() {
	proto.RegisterType((*TestVestingAccount)(nil), "cosmos_sdk.x.auth.vesting.v1.TestVestingAccount")
...
var fileDescriptor_b7f744d63a45e116 = []byte{
	...
	,
}

func (this *TestVestingAccount) GetAccount() github_com_cosmos_cosmos_sdk_x_auth_exported.Account {
...
func (this *TestVestingAccount) SetAccount(value github_com_cosmos_cosmos_sdk_x_auth_exported.Account) error {
	if value == nil {
		this.Sum = nil
		return nil
	}
	...
	case *ContinuousVestingAccount:
		this.Sum = &TestVestingAccount_ContinuousVestingAccount{vt}
		return nil
	case ContinuousVestingAccount:
		this.Sum = &TestVestingAccount_ContinuousVestingAccount{&vt}
		return nil
	case *DelayedVestingAccount:
		this.Sum = &TestVestingAccount_DelayedVestingAccount{vt}
		return nil
	case DelayedVestingAccount:
		this.Sum = &TestVestingAccount_DelayedVestingAccount{&vt}
		return nil
	case *PeriodicVestingAccount:
		this.Sum = &TestVestingAccount_PeriodicVestingAccount{vt}
		return nil
	case PeriodicVestingAccount:
		this.Sum = &TestVestingAccount_PeriodicVestingAccount{&vt}
		return nil
	}
	return fmt.Errorf("can't encode value of type %T as message TestVestingAccount", value)
}

func (m *TestVestingAccount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *TestVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestVestingAccount_ContinuousVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestVestingAccount_ContinuousVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *TestVestingAccount_DelayedVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestVestingAccount_DelayedVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *TestVestingAccount_PeriodicVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestVestingAccount_PeriodicVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *TestVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestVestingAccount_ContinuousVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestVestingAccount_DelayedVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestVestingAccount_PeriodicVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestVestingAccount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: TestVestingAccount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestVestingAccount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Sum = &TestVestingAccount_ContinuousVestingAccount{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Sum = &TestVestingAccount_DelayedVestingAccount{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Sum = &TestVestingAccount_PeriodicVestingAccount{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
