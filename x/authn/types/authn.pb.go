...
// source: cosmos/authn/v1beta1/authn.proto
...
func (*BaseAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfcd9c13ab913afc, []int{0}
}
...
func (*ModuleAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfcd9c13ab913afc, []int{1}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfcd9c13ab913afc, []int{2}
}
...
func init() {
	proto.RegisterType((*BaseAccount)(nil), "cosmos.authn.v1beta1.BaseAccount")
	proto.RegisterType((*ModuleAccount)(nil), "cosmos.authn.v1beta1.ModuleAccount")
	proto.RegisterType((*Params)(nil), "cosmos.authn.v1beta1.Params")
}

func init() { proto.RegisterFile("cosmos/authn/v1beta1/authn.proto", fileDescriptor_cfcd9c13ab913afc) }

var fileDescriptor_cfcd9c13ab913afc = []byte{
	// 672 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *BaseAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Sequence != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.Sequence))
		i--
		dAtA[i] = 0x20
	}
	if m.AccountNumber != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.AccountNumber))
		i--
		dAtA[i] = 0x18
	}
	if m.PubKey != nil {
		{
			...
			i -= size
			i = encodeVarintAuthn(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintAuthn(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ModuleAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Permissions) > 0 {
		for iNdEx := len(m.Permissions) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAuthn(dAtA, i, uint64(len(m.Permissions[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintAuthn(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SigVerifyCostSecp256k1 != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.SigVerifyCostSecp256k1))
		i--
		dAtA[i] = 0x28
	}
	if m.SigVerifyCostED25519 != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.SigVerifyCostED25519))
		i--
		dAtA[i] = 0x20
	}
	if m.TxSizeCostPerByte != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.TxSizeCostPerByte))
		i--
		dAtA[i] = 0x18
	}
	if m.TxSigLimit != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.TxSigLimit))
		i--
		dAtA[i] = 0x10
	}
	if m.MaxMemoCharacters != 0 {
		i = encodeVarintAuthn(dAtA, i, uint64(m.MaxMemoCharacters))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *BaseAccount) Size() (n int) {
	...
	if m.AccountNumber != 0 {
		n += 1 + sovAuthn(uint64(m.AccountNumber))
	}
	if m.Sequence != 0 {
		n += 1 + sovAuthn(uint64(m.Sequence))
	}
	return n
}
...
func (m *Params) Size() (n int) {
	...
	_ = l
	if m.MaxMemoCharacters != 0 {
		n += 1 + sovAuthn(uint64(m.MaxMemoCharacters))
	}
	if m.TxSigLimit != 0 {
		n += 1 + sovAuthn(uint64(m.TxSigLimit))
	}
	if m.TxSizeCostPerByte != 0 {
		n += 1 + sovAuthn(uint64(m.TxSizeCostPerByte))
	}
	if m.SigVerifyCostED25519 != 0 {
		n += 1 + sovAuthn(uint64(m.SigVerifyCostED25519))
	}
	if m.SigVerifyCostSecp256k1 != 0 {
		n += 1 + sovAuthn(uint64(m.SigVerifyCostSecp256k1))
	}
	return n
}
