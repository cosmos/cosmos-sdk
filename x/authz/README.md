...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/authz/authorizations.go#L13-L27
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/authz/v1beta1/authz.proto#L3-L21
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/bank/types/send_authorization.go#L31-L64
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/staking/v1beta1/authz.proto#L14-L38
```

```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/staking/types/authz.go#L19-L41
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/authz/v1beta1/authz.proto#L13-L31
```
...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/x/authz/keeper/keys.go#L77-L93
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/authz/v1beta1/tx.proto#L24-L44
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/authz/v1beta1/tx.proto#L58-L77
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/authz/v1beta1/tx.proto#L39-L60
```
