...
// 	"github.com/cosmos/cosmos-sdk/x/authz/internal/types"
// )

// func registerTxRoutes(cliCtx context.CLIContext, r *mux.Router) {
// 	r.HandleFunc("/authz/grant", grantHandler(cliCtx)).Methods("POST")
// 	r.HandleFunc("/authz/revoke", revokeHandler(cliCtx)).Methods("POST")
// }
