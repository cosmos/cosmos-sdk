...
type QueryGranterGrantsResponse struct {
	// Deprecated: grants is a list of grants granted by the granter.
	Grants []*Grant `protobuf:"bytes,1,rep,name=grants,proto3" json:"grants,omitempty"` // Deprecated: Do not use.
	// pagination defines an pagination for the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
	// full_grants is a list of grants including the grantee and granter addresses
	FullGrants []*GrantAuthorization `protobuf:"bytes,3,rep,name=full_grants,json=fullGrants,proto3" json:"full_grants,omitempty"`
}
...
func (m *QueryGranterGrantsResponse) GetFullGrants() []*GrantAuthorization {
	if m != nil {
		return m.FullGrants
	}
	return nil
...
var fileDescriptor_376d714ffdeb1545 = []byte{
	...
	,
}
...
func (m *QueryGranterGrantsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.FullGrants) > 0 {
		for iNdEx := len(m.FullGrants) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.FullGrants[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryGranterGrantsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FullGrants", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FullGrants = append(m.FullGrants, &GrantAuthorization{})
			if err := m.FullGrants[len(m.FullGrants)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
