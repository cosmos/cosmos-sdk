...
func (m *MockAccountKeeper) NewAccountWithAddress(ctx types.Context, addr types.AccAddress) types0.IAccount {
	m.ctrl.T.Helper()
...
func (m *MockAccountKeeper) SetAccount(ctx types.Context, acc types0.IAccount) {
	m.ctrl.T.Helper()
