...
func (c *queryClient) Authorization(ctx context.Context, in *QueryAuthorizationRequest, opts ...grpc.CallOption) (*QueryAuthorizationResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._Authorization, err = invokerConn.Invoker("/cosmos.authz.v1beta1.Query/Authorization")
		if err != nil {
			var out QueryAuthorizationResponse
...
func (c *queryClient) Authorizations(ctx context.Context, in *QueryAuthorizationsRequest, opts ...grpc.CallOption) (*QueryAuthorizationsResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._Authorizations, err = invokerConn.Invoker("/cosmos.authz.v1beta1.Query/Authorizations")
		if err != nil {
			var out QueryAuthorizationsResponse
...
const (
	QueryAuthorizationMethod  = "/cosmos.authz.v1beta1.Query/Authorization"
	QueryAuthorizationsMethod = "/cosmos.authz.v1beta1.Query/Authorizations"
)
