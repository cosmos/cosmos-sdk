...
func (c *msgClient) GrantAuthorization(ctx context.Context, in *MsgGrantAuthorizationRequest, opts ...grpc.CallOption) (*MsgGrantAuthorizationResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._GrantAuthorization, err = invokerConn.Invoker("/cosmos.authz.v1beta1.MsgGrantAuthorization")
		if err != nil {
			var out MsgGrantAuthorizationResponse
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v1beta1.MsgGrantAuthorization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ExecAuthorized(ctx context.Context, in *MsgExecAuthorizedRequest, opts ...grpc.CallOption) (*MsgExecAuthorizedResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._ExecAuthorized, err = invokerConn.Invoker("/cosmos.authz.v1beta1.MsgExecAuthorized")
		if err != nil {
			var out MsgExecAuthorizedResponse
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v1beta1.MsgExecAuthorized", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevokeAuthorization(ctx context.Context, in *MsgRevokeAuthorizationRequest, opts ...grpc.CallOption) (*MsgRevokeAuthorizationResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._RevokeAuthorization, err = invokerConn.Invoker("/cosmos.authz.v1beta1.MsgRevokeAuthorization")
		if err != nil {
			var out MsgRevokeAuthorizationResponse
	...
	err := c.cc.Invoke(ctx, "/cosmos.authz.v1beta1.MsgRevokeAuthorization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_GrantAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v1beta1.MsgGrantAuthorization",
	}
...
func _Msg_ExecAuthorized_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v1beta1.MsgExecAuthorized",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RevokeAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v1beta1.MsgRevokeAuthorization",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	MsgGrantAuthorizationMethod  = "/cosmos.authz.v1beta1.MsgGrantAuthorization"
	MsgExecAuthorizedMethod      = "/cosmos.authz.v1beta1.MsgExecAuthorized"
	MsgRevokeAuthorizationMethod = "/cosmos.authz.v1beta1.MsgRevokeAuthorization"
)
