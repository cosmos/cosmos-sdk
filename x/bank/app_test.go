...
func TestMsgSendWithAccounts(t *testing.T) {
	...
	// Run a CheckDeliver
	mock.SignCheckDeliver(t, mapp.BaseApp, sendMsg1, []int64{0}, []int64{0}, true, true, priv1)
	...
	mock.SignCheckDeliver(t, mapp.BaseApp, sendMsg1, []int64{0}, []int64{0}, false, false, priv1)
	...
	mock.SignCheckDeliver(t, mapp.BaseApp, sendMsg1, []int64{0}, []int64{1}, true, true, priv1)
}
...
func TestMsgSendMultipleOut(t *testing.T) {
	...
	// Simulate a Block
	mock.SignCheckDeliver(t, mapp.BaseApp, sendMsg2, []int64{0}, []int64{0}, true, true, priv1)
...
func TestSengMsgMultipleInOut(t *testing.T) {
	...
	// CheckDeliver
	mock.SignCheckDeliver(t, mapp.BaseApp, sendMsg3, []int64{0, 2}, []int64{0, 0}, true, true, priv1, priv4)
...
func TestMsgSendDependent(t *testing.T) {
	...
	// Simulate a Block
	mock.SignCheckDeliver(t, mapp.BaseApp, sendMsg4, []int64{1}, []int64{0}, true, true, priv2)
