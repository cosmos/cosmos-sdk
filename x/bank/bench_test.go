...
func BenchmarkOneBankSendTxPerBlock(b *testing.B) {
	...
	// Precompute all txs
	txs := simapp.GenSequenceOfTxs(simapp.MakeEncodingConfig().TxGenerator, []sdk.Msg{sendMsg1}, []uint64{0}, []uint64{uint64(0)}, b.N, priv1)
	b.ResetTimer()
...
func BenchmarkOneBankMultiSendTxPerBlock(b *testing.B) {
	...
	// Precompute all txs
	txs := simapp.GenSequenceOfTxs(simapp.MakeEncodingConfig().TxGenerator, []sdk.Msg{multiSendMsg1}, []uint64{0}, []uint64{uint64(0)}, b.N, priv1)
	b.ResetTimer()
