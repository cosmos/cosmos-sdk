...
func QueryBalancesRequestHandlerFn(ctx context.Context) http.HandlerFunc {
...
func totalSupplyHandlerFn(cliCtx context.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func supplyOfHandlerFn(cliCtx context.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
