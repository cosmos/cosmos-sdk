...
func (suite *KeeperTestSuite) TestExportGenesis() {
	...
	for i := range []int{1, 2} {
		...
		accAddr, err1 := sdk.AccAddressFromBech32(expectedBalances[i].Address, nil)
		if err1 != nil {
			panic(err1)
		}
...
func (suite *KeeperTestSuite) getTestBalancesAndSupply() ([]types.Balance, sdk.Coins) {
	addr2, _ := sdk.AccAddressFromBech32("cosmos1f9xjhxm0plzrh9cskf4qee4pc2xwp0n0556gh0", nil)
	addr1, _ := sdk.AccAddressFromBech32("cosmos1t5u0jfg3ljsjrh2m9e47d4ny2hea7eehxrzdgd", nil)
