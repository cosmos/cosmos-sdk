...
// It is copied verbatim here to test the helper function MigrateV0464ToV0465
...
func TestMigrateV0464ToV0465(t *testing.T) {
	...
	require.NoError(t, v046.MigrateV0464ToV0465(store))
