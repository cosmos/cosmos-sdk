...
func (suite *SimTestSuite) TestSimulateMsgMultiSend() {
	...
	suite.Require().Equal("cosmos1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.Inputs[1].Address.String())
	suite.Require().Equal("185121068stake", msg.Inputs[1].Coins.String())
	suite.Require().Len(msg.Outputs, 2)
	suite.Require().Equal("cosmos1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Outputs[1].Address.String())
