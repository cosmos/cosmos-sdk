...
Send coins from a single account to a series of one or more accounts. If any of
the receiving addresses do not correspond to an existing account, a new account
is created.
