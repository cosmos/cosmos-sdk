...
func (m *Op) GetValueLength() uint32 {
	if m != nil {
...
var fileDescriptor_dca1624628907df9 = []byte{
	...
	0x18, 0x15, 0x18, 0x35, 0x98, 0x83, 0xc0, 0x6c, 0x21, 0x11, 0x2e, 0xd6, 0xc4, 0xe4, 0x92, 0xfc,
	0x22, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x08, 0x47, 0x48, 0x96, 0x8b, 0x2b, 0x3b, 0xb5,
	0x32, 0x3e, 0x27, 0x35, 0x2f, 0xbd, 0x24, 0x43, 0x82, 0x59, 0x81, 0x51, 0x83, 0x37, 0x88, 0x33,
	0x3b, 0xb5, 0xd2, 0x07, 0x2c, 0x20, 0xa4, 0xc8, 0xc5, 0x53, 0x96, 0x98, 0x53, 0x9a, 0x0a, 0x53,
	0xc0, 0x02, 0x56, 0xc0, 0x0d, 0x16, 0x83, 0x2a, 0x91, 0xe3, 0xe2, 0xca, 0x2c, 0x49, 0x2d, 0x4a,
	0x2c, 0xc9, 0xcc, 0xcf, 0x2b, 0x96, 0x60, 0x05, 0x2b, 0x40, 0x12, 0x11, 0x12, 0xe3, 0x62, 0x4b,
	...
	0x00, 0xff, 0xff, 0x1a, 0x11, 0x8b, 0x0e, 0x21, 0x01, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ValueLength |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
