...
func (m *CapabilityKey) Reset()      { *m = CapabilityKey{} }
func (*CapabilityKey) ProtoMessage() {}
func (*CapabilityKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_d73d5c48b3550cdd, []int{0}
}
func (m *CapabilityKey) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CapabilityKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CapabilityKey.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *CapabilityKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CapabilityKey.Merge(m, src)
}
func (m *CapabilityKey) XXX_Size() int {
	return m.Size()
}
func (m *CapabilityKey) XXX_DiscardUnknown() {
	xxx_messageInfo_CapabilityKey.DiscardUnknown(m)
}

var xxx_messageInfo_CapabilityKey proto.InternalMessageInfo

func (m *CapabilityKey) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func init() {
	proto.RegisterType((*CapabilityKey)(nil), "cosmos_sdk.x.capability.v1.CapabilityKey")
...
var fileDescriptor_d73d5c48b3550cdd = []byte{
	...
	,
}

func (m *CapabilityKey) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *CapabilityKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CapabilityKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CapabilityKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CapabilityKey) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: CapabilityKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CapabilityKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
