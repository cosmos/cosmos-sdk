...
```go reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/baseapp/msg_service_router.go#L104-L115
``` 
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/circuit/v1/tx.proto#L36-L75
```
