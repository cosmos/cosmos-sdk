...
$ hashgardcli distribution withdraw-rewards gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey
$ hashgardcli distribution withdraw-rewards gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey --commission
`),
...
$ hashgardcli distribution withdraw-all-rewards --from mykey
`),
		Args: cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
...
$ hashgardcli set-withdraw-addr gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p --from mykey
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
