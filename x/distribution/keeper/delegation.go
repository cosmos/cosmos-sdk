...
func (k Keeper) calculateDelegationRewardsBetween(ctx sdk.Context, val staking.ValidatorInterface,
...
func (k Keeper) calculateDelegationRewards(ctx sdk.Context, val staking.ValidatorInterface, del staking.DelegationInterface, endingPeriod uint64) (rewards sdk.DecCoins) {
...
func (k Keeper) withdrawDelegationRewards(ctx sdk.Context, val staking.ValidatorInterface, del staking.DelegationInterface) (sdk.Coins, sdk.Error) {
