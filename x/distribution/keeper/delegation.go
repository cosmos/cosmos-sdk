...
func (k Keeper) calculateDelegationRewardsBetween(ctx sdk.Context, val staking.Validator,
...
func (k Keeper) calculateDelegationRewards(ctx sdk.Context, val staking.Validator, del staking.Delegation, endingPeriod uint64) (rewards sdk.DecCoins) {
...
func (k Keeper) withdrawDelegationRewards(ctx sdk.Context, val staking.Validator, del staking.Delegation) (sdk.Coins, sdk.Error) {
