...
func (k Keeper) initializeValidator(ctx sdk.Context, val stakingtypes.IValidator) {
...
func (k Keeper) IncrementValidatorPeriod(ctx sdk.Context, val stakingtypes.IValidator) uint64 {
