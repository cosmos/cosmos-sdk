...
func (mr *MockDistributionHooksMockRecorder) AfterDelegationReward(ctx, delAddr, withdrawAddr, reward any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDistributionHooksMockRecorder) AllowWithdrawAddr(ctx, delAddr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
