...
type Params struct {
	...
	SecretFoundationTax     github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=secret_foundation_tax,json=secretFoundationTax,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"secret_foundation_tax" yaml:"secret_foundation_tax"`
	SecretFoundationAddress string                                 `protobuf:"bytes,6,opt,name=secret_foundation_address,json=secretFoundationAddress,proto3" json:"secret_foundation_address,omitempty" yaml:"secret_foundation_address"`
}
...
func (m *Params) GetSecretFoundationAddress() string {
	if m != nil {
		return m.SecretFoundationAddress
	}
	return ""
}
...
type EventAddAutoRestake struct {
}

func (m *EventAddAutoRestake) Reset()         { *m = EventAddAutoRestake{} }
func (m *EventAddAutoRestake) String() string { return proto.CompactTextString(m) }
func (*EventAddAutoRestake) ProtoMessage()    {}
func (*EventAddAutoRestake) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{12}
}
func (m *EventAddAutoRestake) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventAddAutoRestake) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventAddAutoRestake.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventAddAutoRestake) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventAddAutoRestake.Merge(m, src)
}
func (m *EventAddAutoRestake) XXX_Size() int {
	return m.Size()
}
func (m *EventAddAutoRestake) XXX_DiscardUnknown() {
	xxx_messageInfo_EventAddAutoRestake.DiscardUnknown(m)
}

var xxx_messageInfo_EventAddAutoRestake proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*EventAddAutoRestake)(nil), "cosmos.distribution.v1beta1.EventAddAutoRestake")
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.SecretFoundationTax.Equal(that1.SecretFoundationTax) {
		return false
	}
	if this.SecretFoundationAddress != that1.SecretFoundationAddress {
		return false
	}
	return true
}
...
func (this *EventAddAutoRestake) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EventAddAutoRestake)
	if !ok {
		that2, ok := that.(EventAddAutoRestake)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SecretFoundationAddress) > 0 {
		i -= len(m.SecretFoundationAddress)
		copy(dAtA[i:], m.SecretFoundationAddress)
		i = encodeVarintDistribution(dAtA, i, uint64(len(m.SecretFoundationAddress)))
		i--
		dAtA[i] = 0x32
	}
	{
		size := m.SecretFoundationTax.Size()
		i -= size
		if _, err := m.SecretFoundationTax.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *EventAddAutoRestake) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventAddAutoRestake) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventAddAutoRestake) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Params) Size() (n int) {
	...
	l = m.SecretFoundationTax.Size()
	n += 1 + l + sovDistribution(uint64(l))
	l = len(m.SecretFoundationAddress)
	if l > 0 {
		n += 1 + l + sovDistribution(uint64(l))
	}
	return n
...
func (m *EventAddAutoRestake) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretFoundationTax", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SecretFoundationTax.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretFoundationAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecretFoundationAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *EventAddAutoRestake) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventAddAutoRestake: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventAddAutoRestake: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
