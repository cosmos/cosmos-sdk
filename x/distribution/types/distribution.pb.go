...
type Params struct {
	...
	NoRewardsValidatorAddresses []string                               `protobuf:"bytes,5,rep,name=no_rewards_validator_addresses,json=noRewardsValidatorAddresses,proto3" json:"no_rewards_validator_addresses,omitempty"`
	NoRewardsDelegatorAddresses []string                               `protobuf:"bytes,6,rep,name=no_rewards_delegator_addresses,json=noRewardsDelegatorAddresses,proto3" json:"no_rewards_delegator_addresses,omitempty"`
}
...
func (m *Params) GetNoRewardsValidatorAddresses() []string {
	if m != nil {
		return m.NoRewardsValidatorAddresses
	}
	return nil
}

func (m *Params) GetNoRewardsDelegatorAddresses() []string {
	if m != nil {
		return m.NoRewardsDelegatorAddresses
	}
	return nil
}
...
// validator.
type ValidatorBlacklistedPower struct {
	ValidatorAddress      string                                 `protobuf:"bytes,1,opt,name=validator_address,json=validatorAddress,proto3" json:"validator_address,omitempty" yaml:"validator_address"`
	BlacklistedPowerShare github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=blacklisted_power_share,json=blacklistedPowerShare,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"blacklisted_power_share"`
}

func (m *ValidatorBlacklistedPower) Reset()         { *m = ValidatorBlacklistedPower{} }
func (m *ValidatorBlacklistedPower) String() string { return proto.CompactTextString(m) }
func (*ValidatorBlacklistedPower) ProtoMessage()    {}
func (*ValidatorBlacklistedPower) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{12}
}
func (m *ValidatorBlacklistedPower) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorBlacklistedPower) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorBlacklistedPower.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidatorBlacklistedPower) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorBlacklistedPower.Merge(m, src)
}
func (m *ValidatorBlacklistedPower) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorBlacklistedPower) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorBlacklistedPower.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorBlacklistedPower proto.InternalMessageInfo

func (m *ValidatorBlacklistedPower) GetValidatorAddress() string {
	if m != nil {
...
type BlacklistedPower struct {
	TotalBlacklistedPowerShare github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=total_blacklisted_power_share,json=totalBlacklistedPowerShare,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"total_blacklisted_power_share"`
	ValidatorBlacklistedPowers []ValidatorBlacklistedPower            `protobuf:"bytes,2,rep,name=validator_blacklisted_powers,json=validatorBlacklistedPowers,proto3" json:"validator_blacklisted_powers"`
}

func (m *BlacklistedPower) Reset()         { *m = BlacklistedPower{} }
func (m *BlacklistedPower) String() string { return proto.CompactTextString(m) }
func (*BlacklistedPower) ProtoMessage()    {}
func (*BlacklistedPower) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{13}
}
func (m *BlacklistedPower) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlacklistedPower) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlacklistedPower.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlacklistedPower) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlacklistedPower.Merge(m, src)
}
func (m *BlacklistedPower) XXX_Size() int {
	return m.Size()
}
func (m *BlacklistedPower) XXX_DiscardUnknown() {
	xxx_messageInfo_BlacklistedPower.DiscardUnknown(m)
}

var xxx_messageInfo_BlacklistedPower proto.InternalMessageInfo

func (m *BlacklistedPower) GetValidatorBlacklistedPowers() []ValidatorBlacklistedPower {
	if m != nil {
		return m.ValidatorBlacklistedPowers
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*ValidatorBlacklistedPower)(nil), "cosmos.distribution.v1beta1.ValidatorBlacklistedPower")
	proto.RegisterType((*BlacklistedPower)(nil), "cosmos.distribution.v1beta1.BlacklistedPower")
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if len(this.NoRewardsValidatorAddresses) != len(that1.NoRewardsValidatorAddresses) {
		return false
	}
	for i := range this.NoRewardsValidatorAddresses {
		if this.NoRewardsValidatorAddresses[i] != that1.NoRewardsValidatorAddresses[i] {
			return false
		}
	}
	if len(this.NoRewardsDelegatorAddresses) != len(that1.NoRewardsDelegatorAddresses) {
		return false
	}
	for i := range this.NoRewardsDelegatorAddresses {
		if this.NoRewardsDelegatorAddresses[i] != that1.NoRewardsDelegatorAddresses[i] {
			return false
		}
	}
	return true
...
func (this *ValidatorBlacklistedPower) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ValidatorBlacklistedPower)
	if !ok {
		that2, ok := that.(ValidatorBlacklistedPower)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.BlacklistedPowerShare.Equal(that1.BlacklistedPowerShare) {
		return false
	}
	return true
}
func (this *BlacklistedPower) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*BlacklistedPower)
	if !ok {
		that2, ok := that.(BlacklistedPower)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.TotalBlacklistedPowerShare.Equal(that1.TotalBlacklistedPowerShare) {
		return false
	}
	if len(this.ValidatorBlacklistedPowers) != len(that1.ValidatorBlacklistedPowers) {
		return false
	}
	for i := range this.ValidatorBlacklistedPowers {
		if !this.ValidatorBlacklistedPowers[i].Equal(&that1.ValidatorBlacklistedPowers[i]) {
			return false
		}
	}
	return true
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NoRewardsDelegatorAddresses) > 0 {
		for iNdEx := len(m.NoRewardsDelegatorAddresses) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.NoRewardsDelegatorAddresses[iNdEx])
			copy(dAtA[i:], m.NoRewardsDelegatorAddresses[iNdEx])
			i = encodeVarintDistribution(dAtA, i, uint64(len(m.NoRewardsDelegatorAddresses[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
	if len(m.NoRewardsValidatorAddresses) > 0 {
		for iNdEx := len(m.NoRewardsValidatorAddresses) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.NoRewardsValidatorAddresses[iNdEx])
			copy(dAtA[i:], m.NoRewardsValidatorAddresses[iNdEx])
			i = encodeVarintDistribution(dAtA, i, uint64(len(m.NoRewardsValidatorAddresses[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *ValidatorBlacklistedPower) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidatorBlacklistedPower) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidatorBlacklistedPower) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size := m.BlacklistedPowerShare.Size()
		i -= size
		if _, err := m.BlacklistedPowerShare.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintDistribution(dAtA, i, uint64(size))
	}
...
func (m *BlacklistedPower) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlacklistedPower) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlacklistedPower) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ValidatorBlacklistedPowers) > 0 {
		for iNdEx := len(m.ValidatorBlacklistedPowers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ValidatorBlacklistedPowers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	{
		size := m.TotalBlacklistedPowerShare.Size()
		i -= size
		if _, err := m.TotalBlacklistedPowerShare.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintDistribution(dAtA, i, uint64(size))
	}
...
func (m *Params) Size() (n int) {
	...
	if len(m.NoRewardsValidatorAddresses) > 0 {
		for _, s := range m.NoRewardsValidatorAddresses {
			l = len(s)
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
	if len(m.NoRewardsDelegatorAddresses) > 0 {
		for _, s := range m.NoRewardsDelegatorAddresses {
			l = len(s)
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *ValidatorBlacklistedPower) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = m.BlacklistedPowerShare.Size()
	n += 1 + l + sovDistribution(uint64(l))
	return n
}

func (m *BlacklistedPower) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.TotalBlacklistedPowerShare.Size()
	n += 1 + l + sovDistribution(uint64(l))
	if len(m.ValidatorBlacklistedPowers) > 0 {
		for _, e := range m.ValidatorBlacklistedPowers {
			l = e.Size()
			n += 1 + l + sovDistribution(uint64(l))
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoRewardsValidatorAddresses", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NoRewardsValidatorAddresses = append(m.NoRewardsValidatorAddresses, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoRewardsDelegatorAddresses", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NoRewardsDelegatorAddresses = append(m.NoRewardsDelegatorAddresses, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ValidatorBlacklistedPower) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorBlacklistedPower: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorBlacklistedPower: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlacklistedPowerShare", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BlacklistedPowerShare.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *BlacklistedPower) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlacklistedPower: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlacklistedPower: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalBlacklistedPowerShare", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TotalBlacklistedPowerShare.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidatorBlacklistedPowers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValidatorBlacklistedPowers = append(m.ValidatorBlacklistedPowers, ValidatorBlacklistedPower{})
			if err := m.ValidatorBlacklistedPowers[len(m.ValidatorBlacklistedPowers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
