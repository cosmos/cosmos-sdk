...
// recipient account.
//
// Deprecated: After the release of v0.46.x of the Cosmos SDK, there is no
// longer a need for an explicit CommunityPoolSpendProposal as the fee pool has
// been migrated to the x/gov module account. To spend community pool funds, a
// simple MsgSend can be invoked from the x/gov module via a v1 governance
// proposal.
//
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	0x17, 0xf7, 0x34, 0x8e, 0x93, 0xbe, 0x7e, 0x9b, 0x7c, 0x99, 0x38, 0xa9, 0xe3, 0x56, 0x76, 0xb4,
	0x12, 0x25, 0xa8, 0xc4, 0x69, 0xda, 0x5b, 0xc4, 0x25, 0x76, 0x82, 0xe0, 0xd4, 0x68, 0x83, 0x00,
	0x71, 0x59, 0x8d, 0x77, 0x27, 0xf6, 0x28, 0xbb, 0x33, 0xcb, 0xcc, 0xac, 0x93, 0x9e, 0x11, 0xe2,
	...
	,
}
