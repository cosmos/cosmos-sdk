...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio []types.DecCoin `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3" json:"cumulative_reward_ratio"`
...
type FeePool struct {
	CommunityPool []types.DecCoin `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3" json:"community_pool"`
}
