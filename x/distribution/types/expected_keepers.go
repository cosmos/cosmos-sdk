...
type StakingKeeper interface {
	...
	// slash the validator and delegators of the validator, specifying offence height, offence power, slash fraction and
	// an optional boolean communicating the offense type
