...
type GenesisState struct {
	...
	// longer a need for an explicit CommunityPoolSpendProposal as the community
	// pool has been migrated to a true module account. To spend community pool
	// funds, a simple MsgCommunityPoolSpend can be invoked from the x/gov module
	// via a v1 governance proposal.
	FeePool FeePool `protobuf:"bytes,2,opt,name=fee_pool,json=feePool,proto3" json:"fee_pool"` // Deprecated: Do not use.
...
var fileDescriptor_76eed0f9489db580 = []byte{
	...
	,
}
