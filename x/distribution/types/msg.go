...
// NewMsgDepositValidatorRewardsPool returns a new MsgDepositValidatorRewardsPool with a sender and
// a funding amount.
...
// GetSignBytes returns the raw bytes for a MsgDepositValidatorRewardsPool message that
// the expected signer needs to sign.
