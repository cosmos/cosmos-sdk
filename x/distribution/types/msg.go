...
const (
	...
	TypeMsgWithdrawShareReward         = "withdraw__share_reward"
	TypeMsgWithdrawAllShareReward      = "withdraw_all__share_reward"
)
...
func NewMsgWithdrawAllShareReward(ownerAddr sdk.AccAddress) *MsgWithdrawAllShareReward {
