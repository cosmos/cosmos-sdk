...
func (k Keeper) QueueMsgForEpoch(ctx sdk.Context, epochNumber int64, action interface{}) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) GetEpochActionByIterator(iterator db.Iterator) interface{} {
	bz := iterator.Value()
