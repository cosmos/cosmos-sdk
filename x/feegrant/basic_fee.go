...
func (a *BasicAllowance) Accept(ctx context.Context, env appmodule.Environment, fee sdk.Coins, _ []sdk.Msg) (bool, error) {
	if a.Expiration != nil && a.Expiration.Before(env.HeaderService.GetHeaderInfo(ctx).Time) {
