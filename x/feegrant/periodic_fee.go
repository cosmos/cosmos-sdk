...
func (a *PeriodicAllowance) Accept(ctx context.Context, env appmodule.Environment, fee sdk.Coins, _ []sdk.Msg) (bool, error) {
	blockTime := env.HeaderService.GetHeaderInfo(ctx).Time
