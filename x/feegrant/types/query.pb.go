...
func (c *queryClient) FeeAllowance(ctx context.Context, in *QueryFeeAllowanceRequest, opts ...grpc.CallOption) (*QueryFeeAllowanceResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._FeeAllowance, err = invokerConn.Invoker("/cosmos.feegrant.v1beta1.QueryFeeAllowance")
		if err != nil {
			var out QueryFeeAllowanceResponse
	...
	err := c.cc.Invoke(ctx, "/cosmos.feegrant.v1beta1.QueryFeeAllowance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FeeAllowances(ctx context.Context, in *QueryFeeAllowancesRequest, opts ...grpc.CallOption) (*QueryFeeAllowancesResponse, error) {
	...
	if invokerConn, ok := c.cc.(types.InvokerConn); ok {
		var err error
		c._FeeAllowances, err = invokerConn.Invoker("/cosmos.feegrant.v1beta1.QueryFeeAllowances")
		if err != nil {
			var out QueryFeeAllowancesResponse
	...
	err := c.cc.Invoke(ctx, "/cosmos.feegrant.v1beta1.QueryFeeAllowances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_FeeAllowance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.feegrant.v1beta1.QueryFeeAllowance",
	}
...
func _Query_FeeAllowances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.feegrant.v1beta1.QueryFeeAllowances",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	QueryFeeAllowanceMethod  = "/cosmos.feegrant.v1beta1.QueryFeeAllowance"
	QueryFeeAllowancesMethod = "/cosmos.feegrant.v1beta1.QueryFeeAllowances"
)
