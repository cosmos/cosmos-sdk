...
func CollectGenTxsCmd(genBalIterator types.GenesisBalancesIterator, defaultNodeHome string, m genutil.AppModuleBasic) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "collect-gentxs",
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			appMessage, err := genutil.GenAppStateFromConfig(cdc,
				clientCtx.TxConfig,
				config, initCfg, *genDoc, genBalIterator, m.GenTxValidator)
			if err != nil {
