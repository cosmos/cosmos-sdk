...
func CollectGenTxsCmd(genBalIterator types.GenesisBalancesIterator, defaultNodeHome string, validator types.MessageValidator, valAddrCodec address.Codec) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "collect-gentxs",
