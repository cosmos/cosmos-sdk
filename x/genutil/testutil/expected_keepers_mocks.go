...
func (m *MockAccountKeeper) IterateAccounts(ctx types.Context, process func(types0.IAccount) bool) {
	m.ctrl.T.Helper()
...
func (m *MockAccountKeeper) NewAccount(arg0 types.Context, arg1 types0.IAccount) types0.IAccount {
	m.ctrl.T.Helper()
...
func (m *MockAccountKeeper) SetAccount(arg0 types.Context, arg1 types0.IAccount) {
	m.ctrl.T.Helper()
...
func (m *MockGenesisAccountsIterator) IterateGenesisAccounts(cdc *codec.LegacyAmino, appGenesis map[string]json.RawMessage, cb func(types0.IAccount) bool) {
	m.ctrl.T.Helper()
