...
func TestTickExpiredDepositPeriod(t *testing.T) {
	...
	newProposalMsg, err := v1.NewMsgSubmitProposal(
		...
		sdk.Coins{sdk.NewInt64Coin(sdk.DefaultBondDenom, 10000)},
		addrs[0].String(),
		"",
		"Proposal",
...
func TestTickPassedDepositPeriod(t *testing.T) {
	...
	newDepositMsg := v1.NewMsgDeposit(addrs[1], proposalID, sdk.Coins{sdk.NewInt64Coin(sdk.DefaultBondDenom, 10000)})
