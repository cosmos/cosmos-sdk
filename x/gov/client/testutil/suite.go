...
func (s *IntegrationTestSuite) TestCmdParam() {
	...
	testCases := []struct {
		...
		},
		{
			...
			`{"min_deposit":[{"denom":"stake","amount":"10000000"}],"max_deposit_period":"172800000000000","burn_vote_quorum":true,"burn_proposal_deposit":true,"burn_vote_veto":true}`,
		},
	}
