...
func QueryDepositsByTxQuery(cliCtx context.Context, params types.QueryProposalParams) ([]byte, error) {
	events := []string{
...
func QueryVotesByTxQuery(cliCtx context.Context, params types.QueryProposalVotesParams) ([]byte, error) {
	var (
		events = []string{
...
func QueryVoteByTxQuery(cliCtx context.Context, params types.QueryVoteParams) ([]byte, error) {
	events := []string{
		fmt.Sprintf("%s.%s='%s'", sdk.EventTypeMessage, sdk.AttributeKeyAction, types.TypeMsgVote),
		fmt.Sprintf("%s.%s='%s'", types.EventTypeProposalVote, types.AttributeKeyProposalID, []byte(fmt.Sprintf("%d", params.ProposalID))),
...
// query.
func QueryDepositByTxQuery(cliCtx context.Context, params types.QueryDepositParams) ([]byte, error) {
	events := []string{
		fmt.Sprintf("%s.%s='%s'", sdk.EventTypeMessage, sdk.AttributeKeyAction, types.TypeMsgDeposit),
		fmt.Sprintf("%s.%s='%s'", types.EventTypeProposalDeposit, types.AttributeKeyProposalID, []byte(fmt.Sprintf("%d", params.ProposalID))),
...
// ID.
func QueryProposerByTxQuery(cliCtx context.Context, proposalID uint64) (Proposer, error) {
	events := []string{
...
func QueryProposalByID(proposalID uint64, cliCtx context.Context, queryRoute string) ([]byte, error) {
