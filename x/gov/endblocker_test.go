...
func newMsgSubmitProposal(title, description, pty string, addr sdk.AccAddress, coins sdk.Coins) sdk.Msg {
	return MsgSubmitProposal{
		Content:        ContentFromProposalType(title, description, pty),
		Proposer:       addr,
