...
func TestQueries(t *testing.T) {
	...
	endTime := proposal2.VotingEndTime.Add(types.DefaultPeriod)
	...
	proposal3EndTime := proposal3.VotingEndTime.Add(types.DefaultPeriod)
	proposal3.VotingEndTime = &proposal3EndTime
