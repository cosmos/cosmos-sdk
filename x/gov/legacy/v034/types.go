...
type GenesisState struct {
	...
	Deposits           []DepositWithMetadata `json:"deposits" yaml:"deposits"`
	Votes              []VoteWithMetadata    `json:"votes" yaml:"votes"`
...
type DepositWithMetadata struct {
	...
	Deposit    Deposit `json:"deposit" yaml:"deposit"`
}

type VoteWithMetadata struct {
	ProposalID uint64 `json:"proposal_id" yaml:"proposal_id"`
	Vote       Vote   `json:"vote" yaml:"vote"`
}
...
type Proposal struct {
	ProposalContent `json:"proposal_content" yaml:"proposal_content"` // Proposal content interface
