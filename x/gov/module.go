...
func (AppModule) ProposalContents(simState module.SimulationState) []simtypes.WeightedProposalContent { //nolint:staticcheck // returns old-style proposal content and is an intentional use of a deprecated call
