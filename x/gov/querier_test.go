...
func testQueries(t *testing.T) {
	...
	res := handler(ctx, NewMsgSubmitProposal("title", "description", ProposalTypeText, addrs[0], sdk.Coins{sdk.NewUint64Coin("dummycoin", 1)}))
	...
	res = handler(ctx, NewMsgSubmitProposal("title", "description", ProposalTypeText, addrs[1], sdk.Coins{sdk.NewUint64Coin("dummycoin", 1)}))
