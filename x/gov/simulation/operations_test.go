...
func TestWeightedOperations(t *testing.T) {
	...
	expected := []struct {
		...
		{simappparams.DefaultWeightMsgDeposit, types.ModuleName, v1beta2.TypeMsgDeposit},
		{simappparams.DefaultWeightMsgVote, types.ModuleName, v1beta2.TypeMsgVote},
		{simappparams.DefaultWeightMsgVoteWeighted, types.ModuleName, v1beta2.TypeMsgVoteWeighted},
	}
...
func TestSimulateMsgSubmitProposal(t *testing.T) {
	...
	v1beta2.ModuleCdc.UnmarshalJSON(operationMsg.Msg, &proposal)
	...
	contentMsg, ok := msgs[0].(*v1beta2.MsgExecLegacyContent)
	require.True(t, ok)
	...
	require.Equal(t, v1beta2.TypeMsgSubmitProposal, proposal.Type())
}
...
func TestSimulateMsgDeposit(t *testing.T) {
	...
	v1beta2.ModuleCdc.UnmarshalJSON(operationMsg.Msg, &msg)
	...
	require.Equal(t, v1beta2.TypeMsgDeposit, msg.Type())
}
...
func TestSimulateMsgVote(t *testing.T) {
	...
	require.Equal(t, "gov", msg.Route())
	require.Equal(t, v1beta2.TypeMsgVote, msg.Type())
}
...
func TestSimulateMsgVoteWeighted(t *testing.T) {
	...
	require.Equal(t, "gov", msg.Route())
	require.Equal(t, v1beta2.TypeMsgVoteWeighted, msg.Type())
}
