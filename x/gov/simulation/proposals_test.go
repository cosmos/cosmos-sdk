...
func TestProposalContents(t *testing.T) {
	...
	weightedProposalMessages := simulation.ProposalMessages()
	require.Len(t, weightedProposalMessages, 1)

	w0 := weightedProposalMessages[0]
	...
	content := w0.ProposalSimulatorFn()(r, ctx, accounts)
