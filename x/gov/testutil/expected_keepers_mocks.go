...
func (m *MockBankKeeper) BytesToString(bz []byte) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBankKeeperMockRecorder) BytesToString(bz interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BytesToString", reflect.TypeOf((*MockBankKeeper)(nil).BytesToString), bz)
}
...
func (m *MockBankKeeper) StringToBytes(text string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBankKeeperMockRecorder) StringToBytes(text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StringToBytes", reflect.TypeOf((*MockBankKeeper)(nil).StringToBytes), text)
}
