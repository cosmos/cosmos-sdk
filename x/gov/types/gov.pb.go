...
type MsgContent struct {
	Content   *types1.Any `protobuf:"bytes,1,opt,name=content,proto3" json:"content,omitempty"`
...
func (m *MsgContent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgContent.Merge(m, src)
}
...
func (m *MsgContent) GetContent() *types1.Any {
	if m != nil {
		return m.Content
	}
	return nil
...
func (m *MsgContent) GetAuthority() string {
	if m != nil {
		return m.Authority
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgContent)(nil), "cosmos.gov.v1beta2.MsgContent")
}
...
var fileDescriptor_5abf7b8852811c49 = []byte{
	...
	,
}
...
func (m *MsgContent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgContent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgContent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Authority) > 0 {
		...
		i = encodeVarintGov(dAtA, i, uint64(len(m.Authority)))
		i--
		dAtA[i] = 0x12
	}
	if m.Content != nil {
...
func (m *MsgContent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgContent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgContent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
