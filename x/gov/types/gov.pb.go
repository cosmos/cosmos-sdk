...
import (
	...
	types1 "github.com/KiraCore/cosmos-sdk/types"
...
type MsgSubmitProposal struct {
	...
	InitialDeposit github_com_cosmos_cosmos_sdk_types.Coins      `protobuf:"bytes,2,rep,name=initial_deposit,json=initialDeposit,proto3,castrepeated=github.com/KiraCore/cosmos-sdk/types.Coins" json:"initial_deposit" yaml:"initial_deposit"`
	Proposer       github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,3,opt,name=proposer,proto3,casttype=github.com/KiraCore/cosmos-sdk/types.AccAddress" json:"proposer,omitempty"`
}
...
type Proposal struct {
	...
	TotalDeposit     github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,7,rep,name=total_deposit,json=totalDeposit,proto3,castrepeated=github.com/KiraCore/cosmos-sdk/types.Coins" json:"total_deposit" yaml:"total_deposit"`
