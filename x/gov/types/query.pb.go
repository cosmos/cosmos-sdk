...
type QueryParamsResponse struct {
	VotingParams  VotingParams  `protobuf:"bytes,1,opt,name=voting_params,json=votingParams,proto3,customtype=VotingParams" json:"voting_params"`
	DepositParams DepositParams `protobuf:"bytes,2,opt,name=deposit_params,json=depositParams,proto3,customtype=DepositParams" json:"deposit_params"`
	TallyParams   TallyParams   `protobuf:"bytes,3,opt,name=tally_params,json=tallyParams,proto3,customtype=TallyParams" json:"tally_params"`
}
...
func (m *QueryTallyResultRequest) GetReq() *query.PageRequest {
	if m != nil {
		return m.Req
	}
	return nil
...
var fileDescriptor_6efb1c1bc2595eda = []byte{
	...
	,
}
