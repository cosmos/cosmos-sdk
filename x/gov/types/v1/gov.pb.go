...
const (
	...
	// canceled.
	ProposalStatus_PROPOSAL_STATUS_CANCELED ProposalStatus = 6
)
...
type Params struct {
	...
	// The burn rate of deposits when cancel the proposal
	ProposalCancelBurnRate string `protobuf:"bytes,8,opt,name=proposal_cancel_burn_rate,json=proposalCancelBurnRate,proto3" json:"proposal_cancel_burn_rate,omitempty"`
}
...
func (m *Params) GetProposalCancelBurnRate() string {
	if m != nil {
		return m.ProposalCancelBurnRate
	}
	return ""
}
...
var fileDescriptor_e05cb1c0d030febb = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ProposalCancelBurnRate) > 0 {
		i -= len(m.ProposalCancelBurnRate)
		copy(dAtA[i:], m.ProposalCancelBurnRate)
		i = encodeVarintGov(dAtA, i, uint64(len(m.ProposalCancelBurnRate)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *Params) Size() (n int) {
	...
	l = len(m.ProposalCancelBurnRate)
	if l > 0 {
		n += 1 + l + sovGov(uint64(l))
	}
	return n
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposalCancelBurnRate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProposalCancelBurnRate = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGov(dAtA[iNdEx:])
