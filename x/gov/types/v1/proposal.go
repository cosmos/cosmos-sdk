...
func NewProposal(messages []sdk.Msg, id uint64, submitTime, depositEndTime time.Time, metadata string, title, summary string, proposer sdk.AccAddress) (Proposal, error) {
