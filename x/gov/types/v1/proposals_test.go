...
func TestNestedAnys(t *testing.T) {
	...
	proposal, err := v1.NewProposal([]sdk.Msg{msgContent}, 1, time.Now(), time.Now(), "", "title", "summary", sdk.AccAddress("cosmos1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r"), false, nil)
	require.NoError(t, err)
...
func TestProposalSetExpedited(t *testing.T) {
	...
	proposal, err := v1.NewProposal([]sdk.Msg{}, 1, time.Now(), time.Now(), "", "title", "summary", sdk.AccAddress("cosmos1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r"), startExpedited, nil)
	require.NoError(t, err)
...
func TestProposalGetMinDepositFromParams(t *testing.T) {
	...
	for _, tc := range testcases {
		proposal, err := v1.NewProposal([]sdk.Msg{}, 1, time.Now(), time.Now(), "", "title", "summary", sdk.AccAddress("cosmos1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r"), tc.expedited, nil)
		require.NoError(t, err)
