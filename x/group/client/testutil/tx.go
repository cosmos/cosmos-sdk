		...
		out, err = cli.ExecTestCLICmd(val.ClientCtx, client.MsgCreateGroupPolicyCmd(),
			append(
				[]string{
					...
					"1",
					validMetadata,
					fmt.Sprintf("{\"@type\":\"/cosmos.group.v1beta1.ThresholdDecisionPolicy\", \"threshold\":\"%d\", \"voting_period\":\"30000s\"}", threshold),
				},
				commonFlags...,
			),
		)
	...
	out, err = cli.ExecTestCLICmd(val.ClientCtx, client.MsgCreateGroupPolicyCmd(),
		append(
			[]string{
				...
				"1",
				validMetadata,
				fmt.Sprintf("{\"@type\":\"/cosmos.group.v1beta1.PercentageDecisionPolicy\", \"percentage\":\"%f\", \"voting_period\":\"30000s\"}", percentage),
			},
			commonFlags...,
		),
	)
	...
	}{
		{
			...
			append(
				[]string{
					...
					validMetadata,
					validMembersFile.Name(),
					"{\"@type\":\"/cosmos.group.v1beta1.ThresholdDecisionPolicy\", \"threshold\":\"1\", \"voting_period\":\"1s\"}",
		...
		},
		{
			...
			append(
				[]string{
					...
					fmt.Sprintf("%v", groupID),
					validMetadata,
					"{\"@type\":\"/cosmos.group.v1beta1.PercentageDecisionPolicy\", \"percentage\":\"0.5\", \"voting_period\":\"1s\"}",
				},
				commonFlags...,
			),
			false,
		...
		},
		{
			...
			append(
				[]string{
					...
					fmt.Sprintf("%v", groupID),
					validMetadata,
					"{\"@type\":\"/cosmos.group.v1beta1.PercentageDecisionPolicy\", \"percentage\":\"2\", \"voting_period\":\"1s\"}",
				},
				commonFlags...,
			),
			true,
	...
	}{
		{
			...
			append(
				[]string{
					groupPolicy.Admin,
					groupPolicy.Address,
					"{\"@type\":\"/cosmos.group.v1beta1.ThresholdDecisionPolicy\", \"threshold\":\"1\", \"voting_period\":\"40000s\"}",
				},
				commonFlags...,
			),
			false,
		...
		},
		{
			...
			append(
				[]string{
					groupPolicy.Admin,
					groupPolicy.Address,
					"{\"@type\":\"/cosmos.group.v1beta1.PercentageDecisionPolicy\", \"percentage\":\"0.5\", \"voting_period\":\"40000s\"}",
				},
				commonFlags...,
			),
			false,
		...
		},
		{
			...
			append(
				[]string{
					groupPolicy.Admin,
					groupPolicy.Address,
					"{\"@type\":\"/cosmos.group.v1beta1.ThresholdDecisionPolicy\", \"threshold\":\"1\", \"voting_period\":\"50000s\"}",
					fmt.Sprintf("--%s=%s", flags.FlagSignMode, flags.SignModeLegacyAminoJSON),
				},
				commonFlags...,
			),
		...
		},
		{
			...
			append(
				[]string{
					groupPolicy.Admin,
					groupPolicy.Address,
					"{\"@type\":\"/cosmos.group.v1beta1.PercentageDecisionPolicy\", \"percentage\":\"2\", \"voting_period\":\"40000s\"}",
				},
				commonFlags...,
			),
			true,
