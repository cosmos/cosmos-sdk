	...
	testCases := []struct {
	...
	}{
		{
			...
			GenesisState{
				...
				Votes:          []*Vote{{ProposalId: proposal.Id, Voter: memberAddr.String(), SubmitTime: submittedAt, Options: NewNonSplitVoteOption(VOTE_OPTION_YES)}},
			},
			false,
		},
		{
				...
				Votes: []*Vote{
					{
						...
						Voter:      "invalid voter",
						SubmitTime: submittedAt,
						Options:    NewNonSplitVoteOption(VOTE_OPTION_YES),
					},
				},
			},
			true,
				...
				Votes: []*Vote{
					{
						...
						Voter:      memberAddr.String(),
						SubmitTime: submittedAt,
						Options:    NewNonSplitVoteOption(VOTE_OPTION_UNSPECIFIED),
					},
				},
			},
			true,
