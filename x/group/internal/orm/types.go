...
type (
	...
	AfterSetInterceptor func(store storetypes.KVStore, rowID RowID, newValue, oldValue proto.Message) error

	// AfterDeleteInterceptor defines a callback function to be called on Delete operations.
	AfterDeleteInterceptor func(store storetypes.KVStore, rowID RowID, value proto.Message) error
	...
	RowGetter func(store storetypes.KVStore, rowID RowID, dest proto.Message) error
