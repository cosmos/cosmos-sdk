	...
	specs := map[string]struct {
		...
		"invariant not broken": {
			prevProposal: &group.Proposal{
				...
				FinalTallyResult:   group.TallyResult{Yes: "1", No: "0", Abstain: "0", NoWithVeto: "0"},
			...
			curProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "2", No: "0", Abstain: "0", NoWithVeto: "0"},
		...
		"current block no vote count must be greater than previous block no vote count": {
			prevProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "0", No: "2", Abstain: "0", NoWithVeto: "0"},
				Timeout:            prevCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			curProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "0", No: "1", Abstain: "0", NoWithVeto: "0"},
				Timeout:            curCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			expBroken: true,
		...
		"current block abstain vote count must be greater than previous block abstain vote count": {
			prevProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "0", No: "0", Abstain: "2", NoWithVeto: "0"},
				Timeout:            prevCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			curProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "0", No: "0", Abstain: "1", NoWithVeto: "0"},
				Timeout:            curCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			expBroken: true,
		...
		"current block veto vote count must be greater than previous block veto vote count": {
			prevProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "0", No: "0", Abstain: "0", NoWithVeto: "2"},
				Timeout:            prevCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			curProposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "0", No: "0", Abstain: "0", NoWithVeto: "1"},
				Timeout:            curCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			expBroken: true,
	...
	specs := map[string]struct {
		...
		"invariant not broken": {
			...
			proposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "4", No: "3", Abstain: "0", NoWithVeto: "0"},
				Timeout:            curCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			votes: []*group.Vote{
		...
		"proposal tally must correspond to the sum of vote weights": {
			...
			proposal: &group.Proposal{
				...
				Status:             group.PROPOSAL_STATUS_SUBMITTED,
				Result:             group.PROPOSAL_RESULT_UNFINALIZED,
				FinalTallyResult:   group.TallyResult{Yes: "6", No: "0", Abstain: "0", NoWithVeto: "0"},
				Timeout:            curCtx.BlockTime().Add(time.Second * 600),
				ExecutorResult:     group.PROPOSAL_EXECUTOR_RESULT_NOT_RUN,
			},
			votes: []*group.Vote{
