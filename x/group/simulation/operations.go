...
) (groupInfo *group.GroupInfo, acc simtypes.Account, account authtypes.AccountAliasI, err error) {
...
func randomGroupPolicy(r *rand.Rand, k keeper.Keeper, ak group.AccountKeeper,
	ctx sdk.Context, accounts []simtypes.Account,
) (groupInfo *group.GroupInfo, groupPolicyInfo *group.GroupPolicyInfo, acc simtypes.Account, account authtypes.AccountAliasI, err error) {
...
) (acc simtypes.Account, account authtypes.AccountAliasI, err error) {
