...
type MsgVoteWeighted struct {
	...
	Voter      string                `protobuf:"bytes,2,opt,name=voter,proto3" json:"voter,omitempty"`
	Choices    []*WeightedVoteOption `protobuf:"bytes,3,rep,name=choices,proto3" json:"choices,omitempty"`
	// metadata is any arbitrary metadata to attached to the vote.
	Metadata []byte `protobuf:"bytes,4,opt,name=metadata,proto3" json:"metadata,omitempty"`
	// exec defines whether the proposal should be executed
	// immediately after voting or not.
...
func (m *MsgVoteWeighted) GetChoices() []*WeightedVoteOption {
	if m != nil {
		return m.Choices
	}
	return nil
...
func (m *MsgVoteWeighted) GetMetadata() []byte {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *MsgVoteWeighted) GetExec() Exec {
	if m != nil {
		return m.Exec
	}
	return Exec_EXEC_UNSPECIFIED
...
func init() {
	...
	proto.RegisterType((*MsgVoteWeighted)(nil), "cosmos.group.v1beta1.MsgVoteWeighted")
	proto.RegisterType((*MsgVoteWeightedResponse)(nil), "cosmos.group.v1beta1.MsgVoteWeightedResponse")
...
var fileDescriptor_da0de9d603d844fb = []byte{
	...
	,
}
