...
func (Proposal_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e091dfce5c49c8b6, []int{8, 0}
}
...
func (Proposal_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e091dfce5c49c8b6, []int{8, 1}
}
...
func (Proposal_ExecutorResult) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e091dfce5c49c8b6, []int{8, 2}
}
...
func (m *WeightedVoteOption) GetChoice() Choice {
	if m != nil {
		return m.Choice
	}
...
type Vote struct {
	...
	SubmittedAt time.Time `protobuf:"bytes,5,opt,name=submitted_at,json=submittedAt,proto3,stdtime" json:"submitted_at"`
	// choices is the split of votes.
	Choices []*WeightedVoteOption `protobuf:"bytes,6,rep,name=choices,proto3" json:"choices,omitempty"`
}
...
func (m *Vote) GetChoices() []*WeightedVoteOption {
	if m != nil {
		return m.Choices
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*WeightedVoteOption)(nil), "cosmos.group.v1beta1.WeightedVoteOption")
...
var fileDescriptor_e091dfce5c49c8b6 = []byte{
	...
	,
}
...
func (m *Vote) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Choices = append(m.Choices, &WeightedVoteOption{})
