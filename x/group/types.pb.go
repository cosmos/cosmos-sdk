...
type Proposal_ProposalStatus int32

const (
	// An empty value is invalid and not allowed.
	PROPOSAL_STATUS_UNSPECIFIED Proposal_ProposalStatus = 0
	// Initial status of a proposal when persisted.
	PROPOSAL_STATUS_SUBMITTED Proposal_ProposalStatus = 1
	// Final status of a proposal when the final tally was executed.
	PROPOSAL_STATUS_CLOSED Proposal_ProposalStatus = 2
	// Final status of a proposal when the group was modified before the final tally.
	PROPOSAL_STATUS_ABORTED Proposal_ProposalStatus = 3
)

var Proposal_ProposalStatus_name = map[int32]string{
...
var Proposal_ProposalStatus_value = map[string]int32{
...
func (x Proposal_ProposalStatus) String() string {
	return proto.EnumName(Proposal_ProposalStatus_name, int32(x))
}

func (Proposal_ProposalStatus) EnumDescriptor() ([]byte, []int) {
...
const (
	// An empty value is invalid and not allowed
	RESULT_UNSPECIFIED Proposal_Result = 0
	// Until a final tally has happened the status is unfinalized
	RESULT_UNFINALIZED Proposal_Result = 1
	// Final result of the tally
	RESULT_ACCEPTED Proposal_Result = 2
	// Final result of the tally
	RESULT_REJECTED Proposal_Result = 3
)
...
const (
	...
	EXECUTOR_RESULT_UNSPECIFIED Proposal_ExecutorResult = 0
	// We have not yet run the executor.
	EXECUTOR_RESULT_NOT_RUN Proposal_ExecutorResult = 1
	// The executor was successful and proposed action updated state.
	EXECUTOR_RESULT_SUCCESS Proposal_ExecutorResult = 2
	// The executor returned an error and proposed action didn't update state.
	EXECUTOR_RESULT_FAILURE Proposal_ExecutorResult = 3
)
...
type Proposal struct {
	...
	Status Proposal_ProposalStatus `protobuf:"varint,8,opt,name=status,proto3,enum=cosmos.group.v1beta1.Proposal_ProposalStatus" json:"status,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("cosmos.group.v1beta1.Proposal_ProposalStatus", Proposal_ProposalStatus_name, Proposal_ProposalStatus_value)
...
var fileDescriptor_e091dfce5c49c8b6 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= Proposal_ProposalStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
