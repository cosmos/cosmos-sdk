...
type PercentageDecisionPolicy struct {
	// percentageThreshold is the minimum threshold percentage the weighted sum of yes votes must met for a proposal to succeed.
	PercentageThreshold string `protobuf:"bytes,1,opt,name=percentageThreshold,proto3" json:"percentageThreshold,omitempty"`
	// timeout is the duration from submission of a proposal to the end of voting period
	// Within this times votes and exec messages can be submitted.
	Timeout time.Duration `protobuf:"bytes,2,opt,name=timeout,proto3,stdduration" json:"timeout"`
}
...
func (m *PercentageDecisionPolicy) GetPercentageThreshold() string {
	if m != nil {
		return m.PercentageThreshold
	}
	return ""
}
...
var fileDescriptor_e091dfce5c49c8b6 = []byte{
	...
	,
}
...
func (m *PercentageDecisionPolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x12
	if len(m.PercentageThreshold) > 0 {
		i -= len(m.PercentageThreshold)
		copy(dAtA[i:], m.PercentageThreshold)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PercentageThreshold)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PercentageDecisionPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PercentageThreshold", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PercentageThreshold = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Timeout", wireType)
