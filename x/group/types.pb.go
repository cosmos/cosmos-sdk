...
// GroupWithPolicyInfo represents the high-level on-chain information for a group with policy.
type GroupWithPolicyInfo struct {
	// group_id is the unique ID of the newly created group with policy.
	GroupId uint64 `protobuf:"varint,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// admin is the account address of the group admin.
	Admin string `protobuf:"bytes,2,opt,name=admin,proto3" json:"admin,omitempty"`
	// group_policy_address is the account address of the newly created group policy.
	GroupPolicyAddress string `protobuf:"bytes,3,opt,name=group_policy_address,json=groupPolicyAddress,proto3" json:"group_policy_address,omitempty"`
	// group_metadata is any arbitrary metadata attached to the group.
	GroupMetadata []byte `protobuf:"bytes,4,opt,name=group_metadata,json=groupMetadata,proto3" json:"group_metadata,omitempty"`
	// group_policy_metadata is any arbitrary metadata attached to the group policy.
	GroupPolicyMetadata []byte `protobuf:"bytes,5,opt,name=group_policy_metadata,json=groupPolicyMetadata,proto3" json:"group_policy_metadata,omitempty"`
	// total_weight is the sum of the groupWithPolicy members' weights.
	TotalWeight string `protobuf:"bytes,6,opt,name=total_weight,json=totalWeight,proto3" json:"total_weight,omitempty"`
	// version is used to track changes to a groupWithPolicy's membership structure that
	// would break existing proposals. Whenever any members weight is changed,
	// or any member is added or removed this version is incremented and will
	// cause proposals based on older versions of this groupWithPolicy to fail
	Version uint64 `protobuf:"varint,7,opt,name=version,proto3" json:"version,omitempty"`
	// decision_policy specifies the groupWithPolicy's decision policy.
	DecisionPolicy *types.Any `protobuf:"bytes,8,opt,name=decision_policy,json=decisionPolicy,proto3" json:"decision_policy,omitempty"`
	// created_at is a timestamp specifying when a groupWithPolicy was created.
	CreatedAt time.Time `protobuf:"bytes,9,opt,name=created_at,json=createdAt,proto3,stdtime" json:"created_at"`
}

func (m *GroupWithPolicyInfo) Reset()         { *m = GroupWithPolicyInfo{} }
func (m *GroupWithPolicyInfo) String() string { return proto.CompactTextString(m) }
func (*GroupWithPolicyInfo) ProtoMessage()    {}
func (*GroupWithPolicyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_e091dfce5c49c8b6, []int{5}
}
func (m *GroupWithPolicyInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GroupWithPolicyInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GroupWithPolicyInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GroupWithPolicyInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GroupWithPolicyInfo.Merge(m, src)
}
func (m *GroupWithPolicyInfo) XXX_Size() int {
	return m.Size()
}
func (m *GroupWithPolicyInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_GroupWithPolicyInfo.DiscardUnknown(m)
}

var xxx_messageInfo_GroupWithPolicyInfo proto.InternalMessageInfo

func (m *GroupWithPolicyInfo) GetGroupId() uint64 {
	if m != nil {
		return m.GroupId
	}
	return 0
...
func (m *GroupWithPolicyInfo) GetAdmin() string {
	if m != nil {
		return m.Admin
	}
	return ""
...
func (m *GroupWithPolicyInfo) GetGroupPolicyAddress() string {
	if m != nil {
...
func (m *GroupWithPolicyInfo) GetGroupMetadata() []byte {
	if m != nil {
...
func (m *GroupWithPolicyInfo) GetGroupPolicyMetadata() []byte {
	if m != nil {
...
func (m *GroupWithPolicyInfo) GetTotalWeight() string {
	if m != nil {
		return m.TotalWeight
	}
	return ""
...
func (m *GroupWithPolicyInfo) GetVersion() uint64 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *GroupWithPolicyInfo) GetDecisionPolicy() *types.Any {
	if m != nil {
...
func (m *GroupWithPolicyInfo) GetCreatedAt() time.Time {
	if m != nil {
		return m.CreatedAt
	}
	return time.Time{}
...
func init() {
	...
	proto.RegisterType((*GroupWithPolicyInfo)(nil), "cosmos.group.v1beta1.GroupWithPolicyInfo")
...
var fileDescriptor_e091dfce5c49c8b6 = []byte{
	...
	,
}
...
func (m *GroupWithPolicyInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GroupWithPolicyInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GroupWithPolicyInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.GroupPolicyMetadata) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.GroupPolicyMetadata)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.GroupMetadata) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.GroupMetadata)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n9, err9 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Timeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Timeout):])
	if err9 != nil {
		return 0, err9
	}
	i -= n9
...
func (m *Vote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n12, err12 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.SubmittedAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.SubmittedAt):])
	if err12 != nil {
		return 0, err12
	}
	i -= n12
...
func (m *GroupWithPolicyInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GroupWithPolicyInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GroupWithPolicyInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GroupWithPolicyInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
