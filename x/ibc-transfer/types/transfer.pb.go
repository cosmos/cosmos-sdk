...
type FungibleTokenPacketData struct {
	...
	// flag indicating if the sender chain is acting as a source zone or a sink
	// zone. A source zone will escrow the sending tokens while a sink zone
	// will burn the vouchers that were minted for the tokens. The Source bool
	// should only be false if the tokens are being sent back to the chain that
	// cause them to be created on the sender chain.
...
func (m *FungibleTokenPacketData) GetToken() types.Coin {
	if m != nil {
		return m.Token
	}
	return types.Coin{}
...
var fileDescriptor_08134a70fd29e656 = []byte{
	...
	,
}
