...
// QuerierAllClients defines the sdk.Querier to query all the light client states.
func QuerierAllClients(ctx sdk.Context, req abci.RequestQuery, k Keeper) ([]byte, sdk.Error) {
