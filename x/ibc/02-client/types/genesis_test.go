					...
					types.NewClientConsensusStates(
						...
						[]exported.ConsensusState{
							ibctmtypes.NewConsensusState(
								header.GetTime(), commitmenttypes.NewMerkleRoot(header.Header.AppHash), header.GetHeight(), header.Header.NextValidatorsHash,
							),
						},
					),
				},
			...
			genState: types.NewGenesisState(
				...
				[]types.ClientConsensusStates{
					types.NewClientConsensusStates(
						...
						[]exported.ConsensusState{
							ibctmtypes.NewConsensusState(
								header.GetTime(), commitmenttypes.NewMerkleRoot(header.Header.AppHash), 0, header.Header.NextValidatorsHash,
							),
						},
					),
				},
