...
func NewConnectionResponse(
	...
	return ConnectionResponse{
		...
		ProofPath:   commitmenttypes.NewMerklePath(strings.Split(common.ConnectionPath(connectionID), "/")),
...
func NewClientConnectionsResponse(
	...
	return ClientConnectionsResponse{
		...
		Proof:           commitmenttypes.MerkleProof{Proof: proof},
		ProofPath:       commitmenttypes.NewMerklePath(strings.Split(common.ClientConnectionsPath(clientID), "/")),
		ProofHeight:     uint64(height),
	}
}
