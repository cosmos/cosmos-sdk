...
func (k Keeper) Send(ctx sdk.Context, channelID string, packet exported.Packet, port types.Port) error {
...
func (k Keeper) Receive(ctx sdk.Context, proof []ics23.Proof, height uint64, channelID string, packet exported.Packet, port types.Port) error {
