...
func (suite *MsgTestSuite) TestMsgRecvPacketGetSignBytes() {
	...
	expected := fmt.Sprintf(
		`{"packet":{"data":%s,"destinationChannel":"testcpchannel","destinationPort":"testcpport","sequence":"1","sourceChannel":"testchannel","sourcePort":"testportid","timeoutHeight":"100","timeoutTimestamp":"100"},"proof":"Co0BCi4KCmljczIzOmlhdmwSA0tFWRobChkKA0tFWRIFVkFMVUUaCwgBGAEgASoDAAICClsKDGljczIzOnNpbXBsZRIMaWF2bFN0b3JlS2V5Gj0KOwoMaWF2bFN0b3JlS2V5EiAcIiDXSHQRSvh/Wa07MYpTK0B4XtbaXtzxBED76xk0WhoJCAEYASABKgEA","proofHeight":"1","signer":"cosmos1w3jhxarpv3j8yvg4ufs4x"}`,
