...
func NewChannelResponse(
	...
	return ChannelResponse{
		...
		ProofPath:   commitmenttypes.NewMerklePath(strings.Split(common.ChannelPath(portID, channelID), "/")),
...
func NewPacketResponse(
	...
	return PacketResponse{
		Packet:      packet,
		Proof:       commitmenttypes.MerkleProof{Proof: proof},
		ProofPath:   commitmenttypes.NewMerklePath(strings.Split(common.PacketCommitmentPath(portID, channelID, sequence), "/")),
		ProofHeight: uint64(height),
	}
}
...
func NewRecvResponse(
	...
	return RecvResponse{
		...
		Proof:            commitmenttypes.MerkleProof{Proof: proof},
		ProofPath:        commitmenttypes.NewMerklePath(strings.Split(common.NextSequenceRecvPath(portID, channelID), "/")),
		ProofHeight:      uint64(height),
	}
}
