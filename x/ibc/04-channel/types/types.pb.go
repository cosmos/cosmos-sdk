...
type PacketAck struct {
	...
	Ack isPacketAck_Ack `protobuf_oneof:"ack"`
}
...
type isPacketAck_Ack interface {
	isPacketAck_Ack()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*PacketAck_AckDataTransfer) isPacketAck_Ack() {}

func (m *PacketAck) GetAck() isPacketAck_Ack {
	if m != nil {
		return m.Ack
	}
	return nil
...
func (m *PacketAck) GetAckDataTransfer() *types1.AckDataTransfer {
	if x, ok := m.GetAck().(*PacketAck_AckDataTransfer); ok {
...
var fileDescriptor_a69005b45bd92d03 = []byte{
	...
	,
}
...
func (this *PacketAck) SetPacketAcknowledgementI(value github_com_cosmos_cosmos_sdk_x_ibc_04_channel_exported.PacketAcknowledgementI) error {
	...
	case *types1.AckDataTransfer:
		this.Ack = &PacketAck_AckDataTransfer{vt}
		return nil
	}
...
func (m *PacketAck) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Ack = &PacketAck_AckDataTransfer{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
