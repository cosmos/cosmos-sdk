...
func (suite *TendermintTestSuite) TestVerifyClientConsensusState() {
	...
	for i, tc := range testCases {
		...
		err := tc.clientState.VerifyClientConsensusState(
			suite.ctx, suite.aminoCdc, tc.consensusState.Root, height, "chainA", tc.consensusState.GetHeight(), tc.prefix, tc.proof, tc.consensusState,
		)
...
func (suite *TendermintTestSuite) TestVerifyConnectionState() {
	...
	for i, tc := range testCases {
		...
		err := tc.clientState.VerifyConnectionState(
			suite.ctx, suite.cdc, height, tc.prefix, tc.proof, testConnectionID, tc.connection, tc.consensusState,
		)
...
func (suite *TendermintTestSuite) TestVerifyChannelState() {
	...
	for i, tc := range testCases {
		...
		err := tc.clientState.VerifyChannelState(
			suite.ctx, suite.cdc, height, tc.prefix, tc.proof, testPortID, testChannelID, &tc.channel, tc.consensusState,
		)
...
func (suite *TendermintTestSuite) TestVerifyPacketCommitment() {
	...
	for i, tc := range testCases {
		...
		err := tc.clientState.VerifyPacketCommitment(
			suite.ctx, height, tc.prefix, tc.proof, testPortID, testChannelID, testSequence, tc.commitment, tc.consensusState,
		)
...
func (suite *TendermintTestSuite) TestVerifyPacketAcknowledgement() {
	...
	for i, tc := range testCases {
		...
		err := tc.clientState.VerifyPacketAcknowledgement(
			suite.ctx, height, tc.prefix, tc.proof, testPortID, testChannelID, testSequence, tc.ack, tc.consensusState,
		)
...
func (suite *TendermintTestSuite) TestVerifyPacketAcknowledgementAbsence() {
	...
	for i, tc := range testCases {
		...
		err := tc.clientState.VerifyPacketAcknowledgementAbsence(
			suite.ctx, height, tc.prefix, tc.proof, testPortID, testChannelID, testSequence, tc.consensusState,
		)
