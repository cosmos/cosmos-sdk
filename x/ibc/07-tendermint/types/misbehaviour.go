...
// GetHeight returns the epoch-height at which misbehaviour occurred
// This satisfies the evidenceexported.Evidence interface
//
// NOTE: assumes that misbehaviour headers have the same height
func (misbehaviour Misbehaviour) GetHeight() int64 {
	return misbehaviour.Header1.Header.Height
}

// GetIBCHeight returns the IBC Height at which the misbehaviour occurred
//
// NOTE: assumes that misbehaviour headers have the same height
func (misbehaviour Misbehaviour) GetIBCHeight() clientexported.Height {
...
func (misbehaviour Misbehaviour) ValidateBasic() error {
	...
	if misbehaviour.Header1.TrustedHeight.Valid() {
	...
	if misbehaviour.Header2.TrustedHeight.Valid() {
	...
	if !misbehaviour.Header1.GetHeight().EQ(misbehaviour.Header2.GetHeight()) {
		return sdkerrors.Wrapf(clienttypes.ErrInvalidMisbehaviour, "headers in misbehaviour are on different heights (%s ≠ %s)", misbehaviour.Header1.GetHeight(), misbehaviour.Header2.GetHeight())
	}
