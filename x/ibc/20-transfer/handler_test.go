...
func (chain *TestChain) GetContext() sdk.Context {
	return chain.App.BaseApp.NewContext(false, abci.Header{ChainID: chain.Header.SignedHeader.Header.ChainID, Height: chain.Header.SignedHeader.Header.GetHeight()})
}
...
func (chain *TestChain) CreateClient(client *TestChain) error {
	...
	client.App.BeginBlock(abci.RequestBeginBlock{Header: abci.Header{Height: client.Header.SignedHeader.Header.GetHeight(), Time: client.Header.GetTime()}})
