...
type MsgRecvPacket struct {
	Packet channelexported.PacketDataI `json:"packet" yaml:"packet"`
...
func NewMsgRecvPacket(packet channelexported.PacketDataI, proofs []commitment.Proof, height uint64, signer sdk.AccAddress) MsgRecvPacket {
