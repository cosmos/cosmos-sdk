...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, cdc sdk.Codec, kb keys.Keybase) {
...
func TransferRequestHandlerFn(cdc sdk.Codec, kb keys.Keybase, cliCtx context.CLIContext) http.HandlerFunc {
