...
type Params struct {
	...
	// historical_entries defines the max number of Historical Info stored.
...
type HistoricalInfo struct {
	...
	Valset []types2.Validator `protobuf:"bytes,2,rep,name=valset,proto3" json:"valset"`
}
...
func (m *HistoricalInfo) GetValset() []types2.Validator {
	if m != nil {
		return m.Valset
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HistoricalInfo)(nil), "ibc.core.client.v1.HistoricalInfo")
}
...
var fileDescriptor_b6bc4c8185546947 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HistoricalEntries != 0 {
		i = encodeVarintClient(dAtA, i, uint64(m.HistoricalEntries))
		i--
		dAtA[i] = 0x10
	}
...
func (m *Params) Size() (n int) {
	...
	if m.HistoricalEntries != 0 {
		n += 1 + sovClient(uint64(m.HistoricalEntries))
	}
	return n
}
...
func (m *HistoricalInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Valset = append(m.Valset, types2.Validator{})
