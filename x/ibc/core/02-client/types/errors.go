...
var (
	...
	ErrInvalidHistoricalInfo                  = sdkerrors.Register(SubModuleName, 26, "invalid historical info")
	ErrNoHistoricalInfo                       = sdkerrors.Register(SubModuleName, 27, "no historical info found")
)
