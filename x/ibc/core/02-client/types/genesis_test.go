	...
	testCases := []struct {
		...
		},
		{
			...
			genState: types.NewGenesisState(
				...
				types.NewParams(types.DefaultHistoricalEntries, exported.Tendermint, exported.Localhost),
				false,
				2,
			),
			expPass: true,
		},
		{
			...
			genState: types.NewGenesisState(
				...
				nil,
				types.NewParams(types.DefaultHistoricalEntries, exported.Tendermint),
				false,
				0,
			),
			expPass: false,
		...
		},
		{
			...
			genState: types.NewGenesisState(
				...
				nil,
				types.NewParams(types.DefaultHistoricalEntries, exported.Solomachine),
				false,
				0,
			),
			expPass: false,
		...
		},
		{
			...
			genState: types.NewGenesisState(
				...
				nil,
				types.NewParams(types.DefaultHistoricalEntries, " "),
				false,
				0,
			),
			expPass: false,
