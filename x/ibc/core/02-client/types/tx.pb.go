...
type MsgUpgradeClient struct {
	...
	ConsensusState *types.Any `protobuf:"bytes,3,opt,name=consensus_state,json=consensusState,proto3" json:"consensus_state,omitempty" yaml:"consensus_state"`
	// last height old chain commits before halting and upgrades (i.e last block executed)
	LastHeight *Height `protobuf:"bytes,4,opt,name=last_height,json=lastHeight,proto3" json:"last_height,omitempty" yaml:"upgrade_height"`
...
func (m *MsgUpgradeClient) GetLastHeight() *Height {
	if m != nil {
		return m.LastHeight
	}
	return nil
...
var fileDescriptor_cb5dc4651eb49a04 = []byte{
	...
	,
}
...
func (m *MsgUpgradeClient) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastHeight != nil {
		{
			size, err := m.LastHeight.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
