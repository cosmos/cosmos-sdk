	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				...
				expConnection = types.NewConnectionEnd(types.INIT, clientA, counterparty, types.ExportedToProto(types.GetCompatibleVersions()))
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				...
				conn1 := types.NewConnectionEnd(types.OPEN, clientA, counterparty1, types.ExportedToProto(types.GetCompatibleVersions()))
				conn2 := types.NewConnectionEnd(types.INIT, clientA, counterparty2, types.ExportedToProto(types.GetCompatibleVersions()))
				conn3 := types.NewConnectionEnd(types.OPEN, clientA1, counterparty3, types.ExportedToProto(types.GetCompatibleVersions()))
