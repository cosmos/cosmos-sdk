...
type ConnectionEnd struct {
	...
	Versions []*types.Any `protobuf:"bytes,2,rep,name=versions,proto3" json:"versions,omitempty"`
...
type IdentifiedConnection struct {
	...
	// IBC version which can be utilised to determine encodings or protocols for
	// channels or packets utilising this connection
	Versions []*types.Any `protobuf:"bytes,3,rep,name=versions,proto3" json:"versions,omitempty"`
	// current state of the connection end.
...
var fileDescriptor_90572467c054e43a = []byte{
	...
	,
}
...
func (m *ConnectionEnd) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Versions = append(m.Versions, &types.Any{})
