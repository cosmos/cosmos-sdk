...
// take an Mapper.
func NewMapper(cdc sdk.Codec, key sdk.StoreKey, codespace sdk.CodespaceType) Mapper {
...
func marshalBinaryPanic(cdc sdk.Codec, value interface{}) []byte {
...
func unmarshalBinaryPanic(cdc sdk.Codec, bz []byte, ptr interface{}) {
