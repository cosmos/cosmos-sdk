...
* [ICS 006 - Solo Machine Client](https://github.com/cosmos/ics/blob/master/spec/ics-006-solo-machine-client):  Implemented in [`x/ibc/06-solo`](https://github.com/cosmos/x/ibc/06-solo)
...
* [ICS 009 - Loopback Client](https://github.com/cosmos/ics/blob/master/spec/ics-009-loopback-client):  To be implemented in [`x/ibc/09-localhost`](https://github.com/cosmos/x/ibc/09-localhost)
...
* [ICS 020 - Fungible Token Transfer](https://github.com/cosmos/ics/tree/master/spec/ics-020-fungible-token-transfer): Implemented in [`x/transfer`](https://github.com/cosmos/x/ibc-transfer)
