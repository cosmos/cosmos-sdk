...
func (s *GenesisTestSuite) SetupTest() {
	...
	s.keeper = keeper.NewKeeper(s.cdc, runtime.NewKVStoreService(key), stakingKeeper, accountKeeper, bankKeeper, "", authtypes.NewModuleAddress(govtypes.ModuleName).String())
}
