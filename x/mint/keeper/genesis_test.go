...
func (s *GenesisTestSuite) SetupTest() {
	...
	s.keeper = keeper.NewKeeper(s.cdc, runtime.NewEnvironment(runtime.NewKVStoreService(key), log.NewNopLogger()), stakingKeeper, accountKeeper, bankKeeper, epochsKeeper, "", "")
}
