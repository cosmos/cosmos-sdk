...
func (m *Minter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AnnualProvisions) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AnnualProvisions)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Inflation) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Inflation)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GoalBonded) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.GoalBonded)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.InflationMin) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.InflationMin)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.InflationMax) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.InflationMax)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.InflationRateChange) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.InflationRateChange)))
		i--
		dAtA[i] = 0x12
	}
