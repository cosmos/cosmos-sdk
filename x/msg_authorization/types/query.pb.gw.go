...
var (
	filter_Query_Authorization_0 = &utilities.DoubleArray{Encoding: map[string]int{"granter_address": 0, "grantee_address": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	pattern_Query_Authorization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"cosmos", "msg_authorization", "v1beta1", "authorizations", "granter_address", "grantee_address"}, "", runtime.AssumeColonVerbOpt(true)))
)
