...
var (
	pattern_Query_Authorization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"cosmos", "msgauth", "v1beta1", "granters", "granter_addr", "grantees", "grantee_addr"}, "", runtime.AssumeColonVerbOpt(true)))
)
