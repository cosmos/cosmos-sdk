...
func WeightedOperations(
	appParams simtypes.AppParams, cdc codec.JSONCodec, ak nft.AccountKeeper, bk nft.BankKeeper, k keeper.Keeper, appCdc cdctypes.AnyUnpacker) simulation.WeightedOperations {
...
func SimulateMsgSend(ak nft.AccountKeeper, bk nft.BankKeeper, k keeper.Keeper) simtypes.Operation {
	return func(
