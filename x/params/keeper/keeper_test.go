...
func TestKeeper(t *testing.T) {
	kvs := []struct {
		...
		{"key1", pt.Int64Value{Value: 10}},
		{"key2", pt.Int64Value{Value: 55}},
		{"key3", pt.Int64Value{Value: 182}},
		{"key4", pt.Int64Value{Value: 17582}},
		{"key5", pt.Int64Value{Value: 2768554}},
		{"key6", pt.Int64Value{Value: 1157279}},
		{"key7", pt.Int64Value{Value: 9058701}},
	}

	table := types.NewKeyTable(
		types.NewParamSetPair([]byte("key1"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("key2"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("key3"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("key4"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("key5"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("key6"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("key7"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("extra1"), &pt.BoolValue{Value: false}, validateNoOp),
		types.NewParamSetPair([]byte("extra2"), &pt.StringValue{Value: ""}, validateNoOp),
	)
	...
	for i, kv := range kvs {
		kv := kv
		require.Panics(t, func() { space.Set(ctx, []byte(kv.key), &pt.BoolValue{Value: true}) }, "invalid space.Set not panics, tc #%d", i)
	}

	// Test GetSubspace
	for i, kv := range kvs {
		i, kv := int64(i), kv
		var gparam, param pt.Int64Value
		...
		require.NotPanics(t, func() { gspace.Set(ctx, []byte(kv.key), &pt.Int64Value{Value: i}) })
		require.NotPanics(t, func() { space.Get(ctx, []byte(kv.key), &param) })
		require.Equal(t, pt.Int64Value{Value: i}, param, "GetSubspace().Set not equal with space.Get, tc #%d", i)
	}
}
...
func TestSubspace(t *testing.T) {
	...
	kvs := []struct {
		key   string
		param codec.ProtoMarshaler
		zero  codec.ProtoMarshaler
		ptr   codec.ProtoMarshaler
	}{
		{"string", &pt.StringValue{Value: "test"}, &pt.StringValue{Value: ""}, &pt.StringValue{}},
		{"bool", &pt.BoolValue{Value: true}, &pt.BoolValue{Value: false}, &pt.BoolValue{}},
		{"int32", &pt.Int32Value{Value: 1}, &pt.Int32Value{Value: 0}, &pt.Int32Value{}},
		{"int64", &pt.Int64Value{Value: 1}, &pt.Int64Value{Value: 0}, &pt.Int64Value{}},
		{"uint32", &pt.UInt32Value{Value: 1}, &pt.UInt32Value{Value: 0}, &pt.UInt32Value{}},
		{"uint64", &pt.UInt64Value{Value: 1}, &pt.UInt64Value{Value: 0}, &pt.UInt64Value{}},
		{"int", &sdk.IntProto{Int: sdk.NewInt(1)}, &sdk.IntProto{Int: sdk.NewInt(0)}, &sdk.IntProto{}},
		{"dec", &sdk.DecProto{Dec: sdk.NewDec(1)}, &sdk.DecProto{Dec: sdk.NewDec(0)}, &sdk.DecProto{}},
	}

	table := types.NewKeyTable(
		types.NewParamSetPair([]byte("string"), &pt.StringValue{Value: ""}, validateNoOp),
		types.NewParamSetPair([]byte("bool"), &pt.BoolValue{Value: false}, validateNoOp),
		types.NewParamSetPair([]byte("int32"), &pt.Int32Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("int64"), &pt.Int64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("uint32"), &pt.UInt32Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("uint64"), &pt.UInt64Value{Value: 0}, validateNoOp),
		types.NewParamSetPair([]byte("int"), &sdk.IntProto{}, validateNoOp),
		types.NewParamSetPair([]byte("dec"), &sdk.DecProto{}, validateNoOp),
	)
	...
	for i, kv := range kvs {
		...
		require.Panics(t, func() { space.Get(ctx, []byte(kv.key), &pt.Duration{}) }, "invalid space.Get not panics when the pointer is different type, tc #%d", i)
	}
