...
func SimulateParamChangeProposalContent(paramChangePool []simulation.LegacyParamChange) simulation.ContentSimulatorFn { //nolint:staticcheck // SA1019: simulation.LegacyParamChange is deprecated: LegacyParamChange is deprecated
	numProposals := 0
