...
Subspace. A Subspace can only be generated by the manager, and the manager checks
the existence of the Subspace having the same name before generating the
Subspace.

Consumer modules must take a Subspace (via Keeper.Subspace), not the manager
