...
func (p *params) ParamSetPairs() ptypes.ParamSetPairs {
	return ptypes.ParamSetPairs{
...
func paramKeyTable() ptypes.KeyTable {
	return ptypes.NewKeyTable().RegisterParamSet(&params{})
}
