...
type GenesisState struct {
	...
	ToDistirbute cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=to_distirbute,json=toDistirbute,proto3,customtype=cosmossdk.io/math.Int" json:"to_distirbute"`
}
...
var fileDescriptor_72560a99455b4146 = []byte{
	...
	0x97, 0x64, 0x16, 0x25, 0x95, 0x96, 0xa4, 0x4a, 0x30, 0x2b, 0x30, 0x6a, 0x70, 0x3a, 0x69, 0x9f,
	...
	0x6c, 0x60, 0x31, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x76, 0x28, 0x2f, 0x90, 0xc4, 0x01,
	0x00, 0x00,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.ToDistirbute.Size()
		i -= size
		if _, err := m.ToDistirbute.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ToDistirbute", wireType)
			}
			...
			if err := m.ToDistirbute.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
