...
type MsgCreateContinuousFund struct {
	...
	Percentage cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=percentage,proto3,customtype=github.com/cosmos/cosmos-sdk/math/v2.LegacyDec" json:"percentage"`
