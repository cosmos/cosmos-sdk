...
type MsgCreateContinuousFund struct {
	...
	MaxDistributedCapital *types.Coin `protobuf:"bytes,4,opt,name=max_distributed_capital,json=maxDistributedCapital,proto3" json:"max_distributed_capital,omitempty"`
...
func (m *MsgCreateContinuousFund) GetMaxDistributedCapital() *types.Coin {
	if m != nil {
...
var fileDescriptor_09efe14517e7f6dc = []byte{
	...
	,
}
...
func (m *MsgCancelContinuousFundResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n8, err8 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.CanceledTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.CanceledTime):])
	if err8 != nil {
		return 0, err8
	}
	i -= n8
