...
type RecipientFundPercentageStatus struct {
	...
	// Percentage is the percentage of funds to be allocated from Community pool.
	Percentage cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=percentage,proto3,customtype=cosmossdk.io/math.Int" json:"percentage"`
}

func (m *RecipientFundPercentageStatus) Reset()         { *m = RecipientFundPercentageStatus{} }
func (m *RecipientFundPercentageStatus) String() string { return proto.CompactTextString(m) }
...
func (m *RecipientFundPercentageStatus) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecipientFundPercentageStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecipientFundPercentageStatus.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecipientFundPercentageStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecipientFundPercentageStatus.Merge(m, src)
}
func (m *RecipientFundPercentageStatus) XXX_Size() int {
	return m.Size()
}
func (m *RecipientFundPercentageStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_RecipientFundPercentageStatus.DiscardUnknown(m)
}

var xxx_messageInfo_RecipientFundPercentageStatus proto.InternalMessageInfo

func (m *RecipientFundPercentageStatus) GetReceived() bool {
	if m != nil {
		return m.Received
	}
	return false
...
func init() {
	...
	proto.RegisterType((*RecipientFundPercentageStatus)(nil), "cosmos.protocolpool.v1.RecipientFundPercentageStatus")
}
...
var fileDescriptor_c1b7d0ea246d7f44 = []byte{
	...
	,
}
...
func (m *RecipientFundPercentageStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecipientFundPercentageStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecipientFundPercentageStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RecipientFundPercentageStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RecipientFundPercentageStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecipientFundPercentageStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecipientFundPercentageStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
