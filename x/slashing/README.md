...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/slashing/v1beta1/slashing.proto#L13-L34
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.53.0/proto/cosmos/slashing/v1beta1/slashing.proto#L35-L56
```
