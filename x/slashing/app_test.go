...
func getMockApp(t *testing.T) (*mock.App, stake.Keeper, Keeper) {
	...
	mapp.Router().AddRoute("stake", []*sdk.KVStoreKey{keyStake}, stake.NewHandler(stakeKeeper))
	mapp.Router().AddRoute("slashing", []*sdk.KVStoreKey{keySlashing}, NewHandler(keeper))
