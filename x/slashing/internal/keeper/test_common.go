...
func CreateTestInput(t *testing.T, defaults types.Params) (sdk.Context, bank.Keeper, staking.Keeper, ptypes.Subspace, Keeper) {
	...
	paramsKeeper := keeper.NewKeeper(params.ModuleCdc, keyParams, tkeyParams)
