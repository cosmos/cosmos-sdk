...
func (suite *SimTestSuite) TestSimulateMsgUnjail() {
	...
	suite.Require().NoError(suite.distrKeeper.SetDelegatorStartingInfo(ctx, sdk.ValAddress(val0AccAddress), val0AccAddress.Bytes(), distrtypes.NewDelegatorStartingInfo(2, math.LegacyOneDec(), 200)))
