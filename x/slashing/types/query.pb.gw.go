...
var (
	filter_Query_SigningInfos_0 = &utilities.DoubleArray{Encoding: map[string]int{"pagination": 0, "key": 1, "offset": 2, "limit": 3, "count_total": 4}, Base: []int{1, 1, 1, 2, 3, 4, 0, 0, 0, 0}, Check: []int{0, 1, 2, 2, 2, 2, 3, 4, 5, 6}}
)
