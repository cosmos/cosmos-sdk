...
func TestStakeMsgs(t *testing.T) {
	...
	mock.SignCheckDeliver(t, mapp.BaseApp, createValidatorMsg, []int64{0}, []int64{0}, true, true, priv1)
	...
	mock.SignCheckDeliver(t, mapp.BaseApp, editValidatorMsg, []int64{0}, []int64{1}, true, true, priv1)
	validator = checkValidator(t, mapp, keeper, addr1, true)
	...
	mock.SignCheckDeliver(t, mapp.BaseApp, delegateMsg, []int64{1}, []int64{0}, true, true, priv2)
	...
	mock.SignCheckDeliver(t, mapp.BaseApp, unbondMsg, []int64{1}, []int64{1}, true, true, priv2)
	mock.CheckBalance(t, mapp, addr2, sdk.Coins{genCoin})
