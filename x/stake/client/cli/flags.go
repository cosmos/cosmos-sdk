...
func init() {
	...
	fsDescriptionEdit.String(FlagIdentity, types.DoNotModifyDesc, "identity signature (ex. UPort or Keybase)")
	fsDescriptionEdit.String(FlagWebsite, types.DoNotModifyDesc, "website")
	fsDescriptionEdit.String(FlagDetails, types.DoNotModifyDesc, "details")
