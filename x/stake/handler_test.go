...
func TestValidatorByPowerIndex(t *testing.T) {
	...
	keeper.Slash(ctx, keep.PKs[0], 0, initBond, sdk.NewDec(5, 1))
	...
	msgBeginUnbonding := NewMsgBeginUnbonding(validatorAddr, validatorAddr, sdk.NewDec(1000000, 0))
...
func TestDuplicatesMsgCreateValidator(t *testing.T) {
	...
	assert.Equal(t, sdk.NewDec(10, 0), validator.BondedTokens())
	assert.Equal(t, sdk.NewDec(10, 0), validator.DelegatorShares)
...
func TestIncrementsMsgDelegate(t *testing.T) {
	...
	pool := keeper.GetPool(ctx)
	exDece := validator.DelegatorShareExDece()
	require.True(t, exDece.Equal(sdk.OneDec()), "expected exDece 1 got %v", exDece)
	...
	for i := 0; i < 5; i++ {
		...
		exDece := validator.DelegatorShareExDece()
		require.True(t, exDece.Equal(sdk.OneDec()), "expected exDece 1 got %v, i = %v", exDece, i)
...
func TestIncrementsMsgUnbond(t *testing.T) {
	...
	for _, c := range errorCases {
		unbondShares := sdk.NewDec(int64(c), 0)
		msgBeginUnbonding := NewMsgBeginUnbonding(delegatorAddr, validatorAddr, unbondShares)
		got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
	...
	unbondShares = sdk.NewDec(leftBonded+1, 0)
	msgBeginUnbonding = NewMsgBeginUnbonding(delegatorAddr, validatorAddr, unbondShares)
	got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
	...
	unbondShares = sdk.NewDec(leftBonded, 0)
	msgBeginUnbonding = NewMsgBeginUnbonding(delegatorAddr, validatorAddr, unbondShares)
	got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
...
func TestMultipleMsgCreateValidator(t *testing.T) {
	...
	for i, validatorAddr := range validatorAddrs {
		_, found := keeper.GetValidator(ctx, validatorAddr)
		require.True(t, found)
		msgBeginUnbonding := NewMsgBeginUnbonding(delegatorAddrs[i], validatorAddr, sdk.NewDec(10, 0)) // remove delegation
...
func TestMultipleMsgDelegate(t *testing.T) {
	...
	// unbond them all
	for i, delegatorAddr := range delegatorAddrs {
		msgBeginUnbonding := NewMsgBeginUnbonding(delegatorAddr, validatorAddr, sdk.NewDec(10, 0))
		msgCompleteUnbonding := NewMsgCompleteUnbonding(delegatorAddr, validatorAddr)
		got := handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
		require.True(t, got.IsOK(), "expected msg %d to be ok, got %v", i, got)
		got = handleMsgCompleteUnbonding(ctx, msgCompleteUnbonding, keeper)
...
func TestRevokeValidator(t *testing.T) {
	...
	msgBeginUnbondingValidator := NewMsgBeginUnbonding(validatorAddr, validatorAddr, sdk.NewDec(10, 0))
	...
	msgBeginUnbondingDelegator := NewMsgBeginUnbonding(delegatorAddr, validatorAddr, sdk.NewDec(10, 0))
...
func TestUnbondingPeriod(t *testing.T) {
	...
	// begin unbonding
	msgBeginUnbonding := NewMsgBeginUnbonding(validatorAddr, validatorAddr, sdk.NewDec(10, 0))
	got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
	require.True(t, got.IsOK(), "expected no error")
...
func TestRedelegationPeriod(t *testing.T) {
	...
	// begin redelegate
	msgBeginRedelegate := NewMsgBeginRedelegate(validatorAddr, validatorAddr, validatorAddr2, sdk.NewDec(10, 0))
...
func TestTransitiveRedelegation(t *testing.T) {
	...
	msgBeginRedelegate = NewMsgBeginRedelegate(validatorAddr, validatorAddr2, validatorAddr3, sdk.NewDec(10, 0))
	got = handleMsgBeginRedelegate(ctx, msgBeginRedelegate, keeper)
...
func TestUnbondingWhenExcessValidators(t *testing.T) {
	...
	msgBeginUnbonding := NewMsgBeginUnbonding(validatorAddr2, validatorAddr2, sdk.NewDec(30, 0))
	got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
...
func TestCliffValidator(t *testing.T) {
	...
	// unbond valdator-1
	msgBeginUnbonding = NewMsgBeginUnbonding(validatorAddr1, validatorAddr1, sdk.NewDec(50, 0))
	got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
	require.True(t, got.IsOK(), "expected no error on runMsgBeginUnbonding")
...
func TestBondUnbondRedelegateSlashTwice(t *testing.T) {
	...
	msgBeginUnbonding := NewMsgBeginUnbonding(del, valA, sdk.NewDec(4, 0))
	got = handleMsgBeginUnbonding(ctx, msgBeginUnbonding, keeper)
	require.True(t, got.IsOK(), "expected no error on runMsgBeginUnbonding")

	// begin redelegate 6 stake
	msgBeginRedelegate := NewMsgBeginRedelegate(del, valA, valB, sdk.NewDec(6, 0))
	got = handleMsgBeginRedelegate(ctx, msgBeginRedelegate, keeper)
	...
	require.True(t, found)
	require.Equal(t, sdk.NewDec(6, 0), delegation.Shares)

	// slash the validator by half
	keeper.Slash(ctx, keep.PKs[0], 0, 20, sdk.NewDec(5, 1))
	...
	delegation, found = keeper.GetDelegation(ctx, del, valB)
	require.True(t, found)
	require.Equal(t, sdk.NewDec(3, 0), delegation.Shares)
	...
	keeper.Slash(ctx, keep.PKs[0], 2, 10, sdk.NewDec(5, 1))
