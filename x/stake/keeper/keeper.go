...
type Keeper struct {
	...
	storeTKey      sdk.TransientStoreKey
	cdc            *wire.Codec
...
func NewKeeper(cdc *wire.Codec, key sdk.StoreKey, tkey sdk.TransientStoreKey, ck bank.Keeper, codespace sdk.CodespaceType) Keeper {
	keeper := Keeper{
		storeKey:       key,
		storeTKey:      tkey,
		cdc:            cdc,
