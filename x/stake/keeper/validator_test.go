...
func TestSetValidator(t *testing.T) {
	...
	validator := types.NewValidator(addrVals[0], pks[0], Description{})
...
func TestValidatorBasics(t *testing.T) {
	...
	for i, amt := range amts {
		validators[i] = types.NewValidator(addrVals[i], pks[i], Description{})
...
func GetValidatorSortingUnmixed(t *testing.T) {
	...
	for i, amt := range amts {
		validators[i] = types.NewValidator(addrs[i], pks[i], Description{})
