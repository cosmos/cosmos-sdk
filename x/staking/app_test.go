...
func TestStakingMsgs(t *testing.T) {
	genTokens := sdk.TokensFromConsensusPower(42, types.DefaultConfig().PowerReduction)
	bondTokens := sdk.TokensFromConsensusPower(10, types.DefaultConfig().PowerReduction)
