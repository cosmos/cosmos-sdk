...
$ hashgardcli stake validator gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
...
$ hashgardcli stake unbonding-delegations-from gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli stake redelegations-from gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli stake delegation gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
...
$ hashgardcli stake delegations gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli stake delegations-to gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli stake unbonding-delegation gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli stake unbonding-delegation gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ hashgardcli stake redelegation gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p gardvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
...
$ hashgardcli stake redelegation gard1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
