...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clientCtx.PrintObject(&res.Validator)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clientCtx.PrintObject(result)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clientCtx.PrintObject(res.DelegationResponse)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clientCtx.PrintObject(&res.Unbond)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clientCtx.PrintObject(res.Hist)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clientCtx.PrintObject(&res.Pool)
		},
	}
