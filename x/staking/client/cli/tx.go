...
func NewBuildCreateValidatorMsg(cliCtx context.Context, txf tx.Factory) (tx.Factory, sdk.Msg, error) {
...
func BuildCreateValidatorMsg(cliCtx context.Context, txBldr auth.TxBuilder) (auth.TxBuilder, sdk.Msg, error) {
