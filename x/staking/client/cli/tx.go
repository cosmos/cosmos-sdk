...
$ hashgardcli stake delegate gardvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000gard --from mykey
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			txBldr := authtxb.NewTxBuilderFromCLI().WithTxEncoder(auth.DefaultTxEncoder(cdc))
			cliCtx := context.NewCLIContext().
...
$ hashgardcli stake redelegate gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj gardvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100gard --from mykey
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			txBldr := authtxb.NewTxBuilderFromCLI().WithTxEncoder(auth.DefaultTxEncoder(cdc))
			cliCtx := context.NewCLIContext().
...
$ hashgardcli stake unbond gardvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100gard --from mykey
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			txBldr := authtxb.NewTxBuilderFromCLI().WithTxEncoder(auth.DefaultTxEncoder(cdc))
			cliCtx := context.NewCLIContext().
