...
func delegatorUnbondingDelegationsHandlerFn(cliCtx context.Context) http.HandlerFunc {
...
func delegatorTxsHandlerFn(cliCtx context.Context) http.HandlerFunc {
...
func unbondingDelegationHandlerFn(cliCtx context.Context) http.HandlerFunc {
...
// HTTP request handler to query all unbonding delegations from a validator
func validatorUnbondingDelegationsHandlerFn(cliCtx context.Context) http.HandlerFunc {
...
func historicalInfoHandlerFn(cliCtx context.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		vars := mux.Vars(r)
...
func poolHandlerFn(cliCtx context.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		cliCtx, ok := rest.ParseQueryHeightOrReturnBadRequest(w, cliCtx, r)
		if !ok {
			return
