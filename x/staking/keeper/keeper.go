...
type Keeper struct {
	...
	UnbondingQueue              collections.Map[time.Time, types.DVPair]
...
func NewKeeper(
	...
	k := &Keeper{
		...
		UnbondingQueue: collections.NewMap(sb, types.UnbondingQueueKey, "unbonidng_queue", sdk.TimeKey, codec.CollValue[types.DVPair](cdc)),
