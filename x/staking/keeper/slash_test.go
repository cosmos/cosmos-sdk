...
func TestSlashAtNegativeHeight(t *testing.T) {
	...
	require.True(t, found)
	app.StakingKeeper.Slash(ctx, consAddr, -2, 10, fraction, false)
...
func TestSlashValidatorAtCurrentHeight(t *testing.T) {
	...
	validator, found := app.StakingKeeper.GetValidatorByConsAddr(ctx, consAddr)
	require.True(t, found)
	app.StakingKeeper.Slash(ctx, consAddr, ctx.BlockHeight(), 10, fraction, false)
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	validator, found := app.StakingKeeper.GetValidatorByConsAddr(ctx, consAddr)
	require.True(t, found)
	app.StakingKeeper.Slash(ctx, consAddr, 10, 10, fraction, false)
	...
	app.StakingKeeper.Slash(ctx, consAddr, 9, 10, fraction, false)
...
func TestSlashWithRedelegation(t *testing.T) {
	...
	require.NotPanics(t, func() { app.StakingKeeper.Slash(ctx, consAddr, 10, 10, fraction, false) })
	...
	require.NotPanics(t, func() { app.StakingKeeper.Slash(ctx, consAddr, 10, 10, sdk.OneDec(), false) })
...
func TestSlashBoth(t *testing.T) {
	...
	app.StakingKeeper.Slash(ctx, consAddr0, 10, 10, fraction, false)
