...
func TestMigrateJSON(t *testing.T) {
	...
	// Make sure about new params MinCommissionRate.

	// NOTE: the LSM module introduces:
	// params:
	// - GlobalLiquidStakingCap, ValidatorBondFactor, ValidatorLiquidStakingCap
	// states:
	// - LastTokenizeShareRecordId, TokenizeShareLocks, TokenizeShareRecords, TotalLiquidStakeTokens
	expected := `{
	"delegations": [],
	"exported": false,
