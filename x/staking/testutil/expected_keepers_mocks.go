...
func (mr *MockDistributionKeeperMockRecorder) GetFeePoolCommunityCoins(ctx any) *gomock.Call {
...
func (mr *MockValidatorSetMockRecorder) IterateLastValidators(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
