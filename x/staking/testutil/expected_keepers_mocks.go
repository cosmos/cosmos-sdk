...
func (m *MockValidatorSet) Delegation(arg0 context.Context, arg1 types1.AccAddress, arg2 types1.ValAddress) (types.DelegationI, error) {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) Validator(arg0 context.Context, arg1 types1.ValAddress) (types.ValidatorI, error) {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) ValidatorByConsAddr(arg0 context.Context, arg1 types1.ConsAddress) (types.ValidatorI, error) {
	m.ctrl.T.Helper()
...
func (m *MockDelegationSet) IterateDelegations(ctx context.Context, delegator types1.AccAddress, fn func(int64, types.DelegationI) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockStakingHooks) AfterConsensusPubKeyUpdate(ctx types1.Context, oldPubKey, newPubKey types0.PubKey, rotationFee types1.Coin) error {
	m.ctrl.T.Helper()
