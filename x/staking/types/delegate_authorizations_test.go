...
func TestDelegateAuthorizations(t *testing.T) {
	...
	// verify MethodName
	delAuth := stakingtypes.NewDelegateAuthorization([]sdk.ValAddress{val1, val2}, []sdk.ValAddress{val1, val2}, &coin100)
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			false,
			&stakingtypes.DelegateAuthorization{AllowList: []string{val1.String(), val2.String()}, DenyList: []string{}, MaxTokens: &coin50},
		},
		{
		...
		},
		{
			...
			false,
			false,
			&stakingtypes.DelegateAuthorization{AllowList: []string{val1.String(), val2.String()}, DenyList: []string{}, MaxTokens: nil},
		},
		{
		...
		},
		{
			...
			false,
			false,
			&stakingtypes.DelegateAuthorization{AllowList: []string{val1.String(), val2.String()}, DenyList: []string{val3.String()}, MaxTokens: nil},
		},
	}
	...
	for _, tc := range testCases {
		...
		t.Run(tc.msg, func(t *testing.T) {
			delAuth = stakingtypes.NewDelegateAuthorization(tc.allowed, tc.denied, tc.limit)
