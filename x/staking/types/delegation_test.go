...
func TestDelegationEqual(t *testing.T) {
	d1 := NewDelegation(sdk.AccAddress(valAddr1), valAddr2,
		sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(100))))
	d2 := d1
	...
	d2.Shares = sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(200)))
...
func TestDelegationString(t *testing.T) {
	d := NewDelegation(sdk.AccAddress(valAddr1), valAddr2,
		sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(100))))
...
func TestUnbondingDelegationEqual(t *testing.T) {
	ubd1 := NewUnbondingDelegation(sdk.AccAddress(valAddr1), valAddr2, 0,
		time.Unix(0, 0), sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(0))))
	ubd2 := ubd1
...
func TestRedelegationEqual(t *testing.T) {
	r1 := NewRedelegation(sdk.AccAddress(valAddr1), valAddr2, valAddr3, 0,
		time.Unix(0, 0), sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(0))),
		sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(0))))
	...
	r2.Entries[0].SharesDst = sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(10)))
...
func TestDelegationResponses(t *testing.T) {
	...
	dr1 := NewDelegationResp(sdk.AccAddress(valAddr1), valAddr2,
		sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(5))), sdk.NewInt(5))
...
func TestRedelegationResponses(t *testing.T) {
	...
	entries := []RedelegationEntryResponse{
		NewRedelegationEntryResponse(0, time.Unix(0, 0),
			sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(5))),
			sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(5))),
			sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(5)))),
		NewRedelegationEntryResponse(0, time.Unix(0, 0),
			sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(5))),
