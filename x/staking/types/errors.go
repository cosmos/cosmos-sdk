...
var (
	...
	ErrGlobalLiquidStakingCapExceeded           = sdkerrors.Register(ModuleName, 52, "delegation or tokenization exceeds the global cap")
	ErrValidatorLiquidStakingCapExceeded        = sdkerrors.Register(ModuleName, 53, "delegation or tokenization exceeds the validator cap")
