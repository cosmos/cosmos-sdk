...
var (
	...
	ErrInsufficientExemptShares                  = sdkerrors.Register(ModuleName, 49, "insufficient exempt shares")
	ErrRedelegationNotAllowedForExemptDelegation = sdkerrors.Register(ModuleName, 50, "redelegation is not allowed for exempt delegation")
)
