...
var (
	...
	ErrValidatorEVMAddressExists          = sdkerrors.Register(ModuleName, 42, "validator already exist for this EVM address; must use new validator EVM address")
	ErrValidatorEVMZeroAddress            = sdkerrors.Register(ModuleName, 43, "cannot use zero address for EVM address; must use a non zero validator EVM address")
	ErrEVMAddressNotHex                   = sdkerrors.Register(ModuleName, 44, "the provided eth address is not a valid hex address")
)
