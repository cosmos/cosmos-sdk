...
var (
	...
	TokenizeShareRecordPrefix          = []byte{0x62} // key for tokenizeshare record prefix
	TokenizeShareRecordIdByOwnerPrefix = []byte{0x63} // key for tokenizeshare record id by owner prefix
	TokenizeShareRecordIdByDenomPrefix = []byte{0x64} // key for tokenizeshare record id by denom prefix
	LastTokenizeShareRecordIdKey       = []byte{0x65} // key for last tokenize share record id
)
