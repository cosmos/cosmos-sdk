...
type MsgBeginRedelegateResponse struct {
	CompletionTime []byte `protobuf:"bytes,1,opt,name=completion_time,json=completionTime,proto3" json:"completion_time,omitempty"`
}
...
func (m *MsgBeginRedelegateResponse) GetCompletionTime() []byte {
	if m != nil {
...
func (m *MsgUndelegateResponse) GetCompletionTime() []byte {
	if m != nil {
		return m.CompletionTime
	}
	return nil
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}
...
func (m *MsgBeginRedelegateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.CompletionTime = append(m.CompletionTime[:0], dAtA[iNdEx:postIndex]...)
			if m.CompletionTime == nil {
				m.CompletionTime = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
