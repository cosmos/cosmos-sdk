...
func getCurrentPlanHandler(cliCtx context.Context) func(http.ResponseWriter, *http.Request) {
...
func getDonePlanHandler(cliCtx context.Context) func(http.ResponseWriter, *http.Request) {
