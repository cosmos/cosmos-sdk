...
type QueryUpgradedConsensusStateResponse struct {
	...
	// empty in v0.43+.
	UpgradedConsensusState      *types.Any `protobuf:"bytes,1,opt,name=upgraded_consensus_state,json=upgradedConsensusState,proto3" json:"upgraded_consensus_state,omitempty"` // Deprecated: Do not use.
	UpgradedConsensusStateBytes []byte     `protobuf:"bytes,2,opt,name=upgraded_consensus_state_bytes,json=upgradedConsensusStateBytes,proto3" json:"upgraded_consensus_state_bytes,omitempty"`
}
...
func (m *QueryUpgradedConsensusStateResponse) GetUpgradedConsensusStateBytes() []byte {
	if m != nil {
		return m.UpgradedConsensusStateBytes
	}
	return nil
}
...
var fileDescriptor_4a334d07ad8374f0 = []byte{
	...
	,
}
...
func (m *QueryUpgradedConsensusStateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UpgradedConsensusStateBytes) > 0 {
		i -= len(m.UpgradedConsensusStateBytes)
		copy(dAtA[i:], m.UpgradedConsensusStateBytes)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.UpgradedConsensusStateBytes)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *QueryUpgradedConsensusStateResponse) Size() (n int) {
	...
	l = len(m.UpgradedConsensusStateBytes)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
	}
	return n
...
func (m *QueryUpgradedConsensusStateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpgradedConsensusStateBytes", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UpgradedConsensusStateBytes = append(m.UpgradedConsensusStateBytes[:0], dAtA[iNdEx:postIndex]...)
			if m.UpgradedConsensusStateBytes == nil {
				m.UpgradedConsensusStateBytes = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
